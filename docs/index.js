var No=Object.defineProperty;var Ua=(n,t)=>{for(var a in t)No(n,a,{get:t[a],enumerable:!0,configurable:!0,set:(e)=>t[a]=()=>e})};var $n={};Ua($n,{xinValue:()=>X,xinProxy:()=>Te,xinPath:()=>Ln,xin:()=>O,version:()=>pt,vars:()=>r,varDefault:()=>u,updates:()=>Yo,unobserve:()=>lt,touchElement:()=>Gt,touch:()=>mn,tosi:()=>Z,throttle:()=>Nn,svgElements:()=>ut,settings:()=>ot,on:()=>ht,observe:()=>Yn,mathML:()=>je,makeComponent:()=>ta,invertLuminance:()=>Qt,initVars:()=>ji,hotReload:()=>kt,getListItem:()=>cn,getCssVar:()=>we,elements:()=>g,debounce:()=>dt,css:()=>Wn,boxedProxy:()=>na,boxed:()=>rt,blueprintLoader:()=>_i,blueprint:()=>Pi,bindings:()=>Q,bind:()=>N,StyleSheet:()=>Fn,MoreMath:()=>mi,Component:()=>y,Color:()=>v,BlueprintLoader:()=>aa,Blueprint:()=>mt});var ot={debug:!1,perf:!1};function un(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(un);let t={};for(let a in n){let e=n[a];if(n!=null&&typeof n==="object")t[a]=un(e);else t[a]=e}return t}var le="-xin-data",En=`.${le}`,re="-xin-event",Ka=`.${re}`,K="xinPath",zn="xinValue",Ho="xinObserve",Wo="xinBind",Lo="xinOn",Ln=(n)=>{return n&&n[K]||void 0};function X(n){return typeof n==="object"&&n!==null?n[zn]||n:n}var Vn=new WeakMap,pn=new WeakMap,Xn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let a=pn.get(n),e=Vn.get(n);if(a!=null)pn.set(t,un(a));if(e!=null)Vn.set(t,un(e))}for(let a of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(a instanceof Element||a instanceof DocumentFragment)t.appendChild(Xn(a));else t.appendChild(a.cloneNode());return t},et=new WeakMap,cn=(n)=>{let t=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==t){let a=et.get(n);if(a!=null)return a;n=n.parentElement}return!1},Qa=Symbol("observer should be removed"),it=[],st=[],Wt=!1,Lt,Yt;class de{description;test;callback;constructor(n,t){let a=typeof t==="string"?`"${t}"`:`function ${t.name}`,e;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),e=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),e=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,e=`test = function ${n.name}`;else throw new Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${e}, ${a}`,typeof t==="function")this.callback=t;else throw new Error("expect callback to be a path or function");it.push(this)}}var Yo=async()=>{if(Lt===void 0)return;await Lt},Fo=()=>{if(ot.perf)console.time("xin async update");let n=Array.from(st);for(let t of n)it.filter((a)=>{let e;try{e=a.test(t)}catch(o){throw new Error(`Listener ${a.description} threw "${o}" at "${t}"`)}if(e===Qa)return lt(a),!1;return e}).forEach((a)=>{let e;try{e=a.callback(t)}catch(o){console.error(`Listener ${a.description} threw "${o}" handling "${t}"`)}if(e===Qa)lt(a)});if(st.splice(0),Wt=!1,typeof Yt==="function")Yt();if(ot.perf)console.timeEnd("xin async update")},mn=(n)=>{let t=typeof n==="string"?n:Ln(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),new Error("touch was called on an invalid target");if(Wt===!1)Lt=new Promise((a)=>{Yt=a}),Wt=setTimeout(Fo);if(st.find((a)=>t.startsWith(a))==null)st.push(t)},he=(n,t)=>{return new de(n,t)},lt=(n)=>{let t=it.indexOf(n);if(t>-1)it.splice(t,1);else throw new Error("unobserve failed, listener not found")},$o=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},ue=(...n)=>new Error(n.map($o).join(" ")),Jo=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Ro=0,Go=()=>(parseInt("10000",36)+ ++Ro).toString(36).slice(-5),Uo=()=>Jo()+Go(),Ft={},pe={};function me(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let a=n.search(/\[[^\]]+\]/);if(a===-1){t.push(n.split("."));break}else{let e=n.slice(0,a);if(n=n.slice(a),e!=="")t.push(e.split("."));if(a=n.indexOf("]")+1,t.push(n.slice(1,a-1)),n.slice(a,a+1)===".")a+=1;n=n.slice(a)}}return t}}var U=new WeakMap;function ce(n,t){if(U.get(n)===void 0)U.set(n,{});if(U.get(n)[t]===void 0)U.get(n)[t]={};let a=U.get(n)[t];if(t==="_auto_")n.forEach((e,o)=>{if(e._auto_===void 0)e._auto_=Uo();a[e._auto_+""]=o});else n.forEach((e,o)=>{a[qn(e,t)+""]=o});return a}function Ko(n,t){if(U.get(n)===void 0||U.get(n)[t]===void 0)return ce(n,t);else return U.get(n)[t]}function Qo(n,t,a){a=a+"";let e=Ko(n,t)[a];if(e===void 0||qn(n[e],t)+""!==a)e=ce(n,t)[a];return e}function Zo(n,t,a){if(n[t]===void 0&&a!==void 0)n[t]=a;return n[t]}function be(n,t,a,e){let o=t!==""?Qo(n,t,a):a;if(e===Ft)return n.splice(o,1),U.delete(n),Symbol("deleted");else if(e===pe){if(t===""&&n[o]===void 0)n[o]={}}else if(e!==void 0)if(o!==void 0)n[o]=e;else if(t!==""&&qn(e,t)+""===a+"")n.push(e),o=n.length-1;else throw new Error(`byIdPath insert failed at [${t}=${a}]`);return n[o]}function Za(n){if(!Array.isArray(n))throw ue("setByPath failed: expected array, found",n)}function ka(n){if(n==null||!(n instanceof Object))throw ue("setByPath failed: expected Object, found",n)}function qn(n,t){let a=me(t),e=n,o,i,s,l;for(o=0,i=a.length;e!==void 0&&o<i;o++){let d=a[o];if(Array.isArray(d))for(s=0,l=d.length;e!==void 0&&s<l;s++){let h=d[s];e=e[h]}else if(e.length===0){if(e=e[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[h,...p]=d.split("=");e=be(e,h,p.join("="))}else s=parseInt(d,10),e=e[s]}return e}function ko(n,t,a){let e=n,o=me(t);while(e!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)ka(e);else Za(e);let l=i.slice(0,s),d=i.slice(s+1);if(e=be(e,l,d,o.length>0?pe:a),o.length===0)return!0}else{Za(e);let l=parseInt(i,10);if(o.length>0)e=e[l];else{if(a!==Ft){if(e[l]===a)return!1;e[l]=a}else e.splice(l,1);return!0}}}else if(Array.isArray(i)&&i.length>0){ka(e);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)e=Zo(e,s,i.length>0?{}:[]);else{if(a!==Ft){if(e[s]===a)return!1;e[s]=a}else{if(!Object.prototype.hasOwnProperty.call(e,s))return!1;delete e[s]}return!0}}}else throw new Error(`setByPath failed, bad path ${t}`)}throw new Error(`setByPath(${n}, ${t}, ${a}) failed`)}var ni=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Rt={},ti=!0,ai=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ei=(n)=>ai.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},oi={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function qt(n,t){let a=typeof n;if(n===void 0||a==="object"||a==="function")return n;else return new Proxy(oi[typeof n](n),Sn(t,!0))}var Sn=(n,t)=>({get(a,e){switch(e){case K:return n;case zn:return a.valueOf?a.valueOf():a;case Ho:return(s)=>{let l=he(n,s);return()=>lt(l)};case Lo:return(s,l)=>ht(s,l,X(a));case Wo:return(s,l,d)=>{N(s,n,l,d)}}if(typeof e==="symbol")return a[e];let o=e,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,l]=i,d=dn(n,s),h=qn(a,s);return h!==null&&typeof h==="object"?new Proxy(h,Sn(d,t))[l]:h}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(a)&&a[o]!==void 0||Array.isArray(a)&&o.includes("=")){let s;if(o.includes("=")){let[l,d]=o.split("=");s=a.find((h)=>`${qn(h,l)}`===d)}else s=a[o];if(s instanceof Object){let l=dn(n,o);return new Proxy(s instanceof Function?s.bind(a):s,Sn(l,t))}else return t?qt(s,dn(n,o)):s}else if(Array.isArray(a)){let s=a[o];return typeof s==="function"?(...l)=>{let d=s.apply(a,l);if(ni.includes(o))mn(n);return d}:typeof s==="object"?new Proxy(s,Sn(dn(n,o),t)):t?qt(s,dn(n,o)):s}else return t?qt(a[o],dn(n,o)):a[o]},set(a,e,o){o=X(o);let i=e!==zn?dn(n,e):n;if(ti&&!ei(i))throw new Error(`setting invalid path ${i}`);if(X(O[i])!==o&&ko(Rt,i,o))mn(i);return!0}}),Yn=(n,t)=>{let a=typeof t==="function"?t:O[t];if(typeof a!=="function")throw new Error(`observe expects a function or path to a function, ${t} is neither`);return he(n,a)},O=new Proxy(Rt,Sn("",!1)),rt=new Proxy(Rt,Sn("",!0)),ge=(n,t)=>{let a=new Event(t);n.dispatchEvent(a)},ye=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},ii=(n,t)=>{switch(ye(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let a of Array.from(n.querySelectorAll("option")))a.selected=t[a.value];break;default:n.value=t}},si=(n)=>{switch(ye(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,a)=>{return t[a.value]=a.selected,t},{});default:return n.value}},{ResizeObserver:ne}=globalThis,$t=ne!=null?new ne((n)=>{for(let t of n){let a=t.target;ge(a,"resize")}}):{observe(){},unobserve(){}},te=(n,t,a=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((e)=>{n.append(e instanceof Node&&a?Xn(e):e)});else if(t instanceof Node)n.append(a?Xn(t):t);else throw new Error("expect text content or document node")},dt=(n,t=250)=>{let a;return(...e)=>{if(a!==void 0)clearTimeout(a);a=setTimeout(()=>{n(...e)},t)}},Nn=(n,t=250)=>{let a,e=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(a),a=setTimeout(async()=>{n(...i),e=Date.now()},t),!o&&Date.now()-e>=t){o=!0;try{n(...i),e=Date.now()}finally{o=!1}}}},Jt=Symbol("list-binding"),li=16,ri=100;function ae(n,t){let a=Array.from(n.querySelectorAll(En));if(n.matches(En))a.unshift(n);for(let e of a){let o=pn.get(e);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(e,O[i.path])}}}class fe{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,a={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw new Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let e=n.children[0];if(e.content.children.length!==1)throw new Error("ListBinding expects a template with exactly one child element");this.template=Xn(e.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=a,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),a.virtual!=null)$t.observe(this.boundElement),this._update=Nn(()=>{this.update(this._array,!0)},li),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:a}=this.options,e=this._array;if(t!==void 0)e=e.filter((d)=>d[t]!==!0);if(a!==void 0)e=e.filter((d)=>d[a]===!0);if(this.options.filter&&this.needle!==void 0)e=this.options.filter(e,this.needle);let o=0,i=e.length-1,s=0,l=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,h=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(h/n.height)+(n.rowChunkSize||1),m=Math.ceil(e.length/n.visibleColumns),c=n.visibleColumns*p,x=Math.floor(this.boundElement.scrollTop/n.height);if(x>m-p+1)x=Math.max(0,m-p+1);if(n.rowChunkSize)x-=x%n.rowChunkSize;o=x*n.visibleColumns,i=o+c-1,s=x*n.height,l=Math.max((m-p)*n.height-s,0)}return{items:e,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:l}}needle;filter=Nn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},ri);update(n,t){if(n==null)n=[];this._array=n;let{hiddenProp:a,visibleProp:e}=this.options,o=Ln(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:l,lastItem:d,topBuffer:h,bottomBuffer:p}=i;if(a===void 0&&e===void 0&&t===!0&&s!=null&&l===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let m=0,c=0,x=0;for(let C of Array.from(this.boundElement.children)){if(C===this.listTop||C===this.listBottom)continue;let T=et.get(C);if(T==null)C.remove();else{let j=i.items.indexOf(T);if(j<l||j>d)C.remove(),this.itemToElement.delete(T),et.delete(C),m++}}this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(p)+"px";let _=[],{idPath:B}=this.options;for(let C=l;C<=d;C++){let T=i.items[C];if(T===void 0)continue;let j=this.itemToElement.get(X(T));if(j==null){if(x++,j=Xn(this.template),typeof T==="object")this.itemToElement.set(X(T),j),et.set(j,X(T));if(this.boundElement.insertBefore(j,this.listBottom),B!=null){let M=T[B],V=`${o}[${B}=${M}]`;ae(j,V)}else{let M=`${o}[${C}]`;ae(j,M)}}_.push(j)}let E=null;for(let C of _){if(C.previousElementSibling!==E)if(c++,E?.nextElementSibling!=null)this.boundElement.insertBefore(C,E.nextElementSibling);else this.boundElement.insertBefore(C,this.listBottom);E=C}if(ot.perf)console.log(o,"updated",{removed:m,created:x,moved:c})}}var di=(n,t,a)=>{let e=n[Jt];if(e===void 0)e=new fe(n,t,a),n[Jt]=e;return e},{document:Hn,MutationObserver:ee}=globalThis,Gt=(n,t)=>{let a=pn.get(n);if(a==null)return;for(let e of a){let{binding:o,options:i}=e,{path:s}=e,{toDOM:l}=o;if(l!=null){if(s.startsWith("^")){let d=cn(n);if(d!=null&&d[K]!=null)s=e.path=`${d[K]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),new Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))l(n,O[s],i)}}};if(ee!=null)new ee((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((a)=>{if(a instanceof Element)Array.from(a.querySelectorAll(En)).forEach((e)=>Gt(e))})})}).observe(Hn.body,{subtree:!0,childList:!0});Yn(()=>!0,(n)=>{let t=Array.from(Hn.querySelectorAll(En));for(let a of t)Gt(a,n)});var oe=(n)=>{let t=n.target.closest(En);while(t!=null){let a=pn.get(t);for(let e of a){let{binding:o,path:i}=e,{fromDOM:s}=o;if(s!=null){let l;try{l=s(t,e.options)}catch(d){throw console.error("Cannot get value from",t,"via",e),new Error("Cannot obtain value fromDOM")}if(l!=null){let d=O[i];if(d==null)O[i]=l;else{let h=d[K]!=null?d[zn]:d,p=l[K]!=null?l[zn]:l;if(h!==p)O[i]=p}}}}t=t.parentElement.closest(En)}};if(globalThis.document!=null)Hn.body.addEventListener("change",oe,!0),Hn.body.addEventListener("input",oe,!0);function N(n,t,a,e){if(n instanceof DocumentFragment)throw new Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[K]===void 0&&e===void 0){let{value:l}=t;o=typeof l==="string"?l:l[K],e=t,delete e.value}else o=typeof t==="string"?t:t[K];if(o==null)throw new Error("bind requires a path or object with xin Proxy");let{toDOM:i}=a;n.classList?.add(le);let s=pn.get(n);if(s==null)s=[],pn.set(n,s);if(s.push({path:o,binding:a,options:e}),i!=null&&!o.startsWith("^"))mn(o);if(e?.filter&&e?.needle)N(n,e.needle,{toDOM(l,d){console.log({needle:d}),l[Jt]?.filter(d)}});return n}var ie=new Set,hi=(n)=>{let t=n?.target.closest(Ka),a=!1,e=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),a=!0};else{let l=i[s];return typeof l==="function"?l.bind(i):l}}}),o=new Set;while(!a&&t!=null){let i=Vn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(e);else{let l=O[s];if(typeof l==="function")l(e);else throw new Error(`no event handler found at path ${s}`)}if(a)continue}t=t.parentElement!=null?t.parentElement.closest(Ka):null}};function ht(n,t,a){let e=Vn.get(n);if(n.classList.add(re),e==null)e={},Vn.set(n,e);if(!e[t])e[t]=new Set;if(e[t].add(a),!ie.has(t))ie.add(t),Hn.body.addEventListener(t,hi,!0);return()=>{e[t].delete(a)}}var Q={value:{toDOM:ii,fromDOM(n){return si(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,a){di(n,t,a).update(t)}}},ui=180/Math.PI,pi=Math.PI/180;function F(n,t,a){return a<n?NaN:t<n?n:t>a?a:t}function k(n,t,a,e=!0){if(e)a=F(0,a,1);return a*(t-n)+n}var mi={RADIANS_TO_DEGREES:ui,DEGREES_TO_RADIANS:pi,clamp:F,lerp:k};function we(n,t=document.body){let a=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return a.getPropertyValue(n).trim()}var ci=(n,t,a)=>{return(0.299*n+0.587*t+0.114*a)/255},hn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class ve{h;s;l;constructor(n,t,a){n/=255,t/=255,a/=255;let e=Math.max(n,t,a),o=e-Math.min(n,t,a),i=o!==0?e===n?(t-a)/o:e===t?2+(a-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?e<=0.5?o/(2*e-o):o/(2-(2*e-o)):0,this.l=(2*e-o)/2}}var jn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class v{r;g;b;a;static fromVar(n,t=document.body){return v.fromCss(we(n,t))}static fromCss(n){let t=n;if(jn instanceof HTMLSpanElement)jn.style.color="black",jn.style.color=n,document.body.appendChild(jn),t=getComputedStyle(jn).color,jn.remove();let[a,e,o,i]=t.match(/[\d.]+/g),s=t.startsWith("color(srgb")?255:1;return new v(Number(a)*s,Number(e)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,a,e=1){return v.fromCss(`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}% / ${(e*100).toFixed(0)}%)`)}static black=new v(0,0,0);static white=new v(255,255,255);constructor(n,t,a,e=1){this.r=F(0,n,255),this.g=F(0,t,255),this.b=F(0,a,255),this.a=e!==void 0?F(0,e,1):e=1}get inverse(){return new v(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:a}=this._hsl;return v.fromHsl(n,t,1-a,this.a)}contrasting(n=1){let{h:t,s:a,l:e}=this._hsl;return this.blend(this.brightness>0.5?v.black:v.white,n)}get rgb(){let{r:n,g:t,b:a}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${a.toFixed(0)})`}get rgba(){let{r:n,g:t,b:a,a:e}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${a.toFixed(0)},${e.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new ve(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:a}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:a}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new v(n,n,n)}get brightness(){return ci(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+hn(this.r)+hn(this.g)+hn(this.b):"#"+hn(this.r)+hn(this.g)+hn(this.b)+hn(Math.floor(255*this.a))}brighten(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,e+n*(1-e),1);return v.fromHsl(t,a,o,this.a)}darken(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,e*(1-n),1);return v.fromHsl(t,a,o,this.a)}saturate(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,a+n*(1-a),1);return v.fromHsl(t,o,e,this.a)}desaturate(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,a*(1-n),1);return v.fromHsl(t,o,e,this.a)}rotate(n){let{h:t,s:a,l:e}=this._hsl,o=(t+360+n)%360;return v.fromHsl(o,a,e,this.a)}opacity(n){let{h:t,s:a,l:e}=this._hsl;return v.fromHsl(t,a,e,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new v(k(this.r,n.r,t),k(this.g,n.g,t),k(this.b,n.b,t),k(this.a,n.a,t))}static blendHue(n,t,a){let e=(t-n+720)%360;if(e<180)return n+a*e;else return n-(360-e)*a}mix(n,t){let a=this._hsl,e=n._hsl;return v.fromHsl(a.s===0?e.h:e.s===0?a.h:v.blendHue(a.h,e.h,t),k(a.s,e.s,t),k(a.l,e.l,t),k(this.a,n.a,t))}colorMix(n,t){return v.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function nn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function bi(n){return n.replace(/-([a-z])/g,(t,a)=>{return a.toLocaleUpperCase()})}var gi="http://www.w3.org/1998/Math/MathML",yi="http://www.w3.org/2000/svg",at={},xe=(n,t,a)=>{let e=Se(nn(t),a);if(e.prop.startsWith("--"))n.style.setProperty(e.prop,e.value);else n.style[t]=e.value},fi=(n)=>{return{toDOM(t,a){xe(t,n,a)}}},Ce=(n,t,a)=>{if(t==="style")if(typeof a==="object")for(let e of Object.keys(a))if(Ln(a[e]))N(n,a[e],fi(e));else xe(n,e,a[e]);else n.setAttribute("style",a);else if(n[t]!==void 0){let{MathMLElement:e}=globalThis;if(n instanceof SVGElement||e!==void 0&&n instanceof e)n.setAttribute(t,a);else n[t]=a}else{let e=nn(t);if(e==="class")a.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[e]!==void 0)n[e]=a;else if(typeof a==="boolean")a?n.setAttribute(e,""):n.removeAttribute(e);else n.setAttribute(e,a)}},wi=(n)=>{return{toDOM(t,a){Ce(t,n,a)}}},vi=(n,t,a)=>{if(t==="apply")a(n);else if(t.match(/^on[A-Z]/)!=null){let e=t.substring(2).toLowerCase();ht(n,e,a)}else if(t==="bind")if((typeof a.binding==="string"?Q[a.binding]:a.binding)!==void 0&&a.value!==void 0)N(n,a.value,a.binding instanceof Function?{toDOM:a.binding}:a.binding);else throw new Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let e=t.substring(4,5).toLowerCase()+t.substring(5),o=Q[e];if(o!==void 0)N(n,a,o);else throw new Error(`${t} is not allowed, bindings.${e} is not defined`)}else if(Ln(a))N(n,a,wi(t));else Ce(n,t,a)},Ut=(n,...t)=>{if(at[n]===void 0){let[o,i]=n.split("|");if(i===void 0)at[n]=globalThis.document.createElement(o);else at[n]=globalThis.document.createElementNS(i,o)}let a=at[n].cloneNode(),e={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(a instanceof HTMLTemplateElement)a.content.append(o);else a.append(o);else if(o.xinPath)a.append(g.span({bindText:o}));else Object.assign(e,o);for(let o of Object.keys(e)){let i=e[o];vi(a,o,i)}return a},Kt=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let a of n)t.append(a);return t},g=new Proxy({fragment:Kt},{get(n,t){if(t=t.replace(/[A-Z]/g,(a)=>`-${a.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...a)=>Ut(t,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),ut=new Proxy({fragment:Kt},{get(n,t){if(n[t]===void 0)n[t]=(...a)=>Ut(`${t}|${yi}`,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),je=new Proxy({fragment:Kt},{get(n,t){if(n[t]===void 0)n[t]=(...a)=>Ut(`${t}|${gi}`,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}});function Fn(n,t){let a=g.style(Wn(t));a.id=n,document.head.append(a)}var xi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Se=(n,t)=>{if(typeof t==="number"&&!xi.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Ci=(n,t,a)=>{if(a===void 0)return"";if(a instanceof v)a=a.html;let e=Se(t,a);return`${n}  ${e.prop}: ${e.value};`},Ee=(n,t,a="")=>{let e=nn(n);if(typeof t==="object"&&!(t instanceof v)){let o=Object.keys(t).map((i)=>Ee(i,t[i],`${a}  `)).join(`
`);return`${a}  ${n} {
${o}
${a}  }`}else return Ci(a,e,t)},Wn=(n,t="")=>{return Object.keys(n).map((a)=>{let e=n[a];if(typeof e==="string"){if(a==="@import")return`@import url('${e}');`;throw new Error("top-level string value only allowed for `@import`")}let o=Object.keys(e).map((i)=>Ee(i,e[i])).join(`
`);return`${t}${a} {
${o}
}`}).join(`

`)},ji=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let a of Object.keys(n)){let e=n[a],o=nn(a);t[`--${o}`]=typeof e==="number"&&e!==0?String(e)+"px":e}return t},Qt=(n)=>{let t={};for(let a of Object.keys(n)){let e=n[a];if(e instanceof v)t[a]=e.inverseLuminance;else if(typeof e==="string"&&e.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[a]=v.fromCss(e).inverseLuminance}return t},u=new Proxy({},{get(n,t){if(n[t]===void 0){let a="--"+nn(t);n[t]=(e)=>`var(${a}, ${e})`}return n[t]}}),r=new Proxy({},{get(n,t){if(t==="default")return u;if(n[t]==null){t=nn(t);let[,a,,e,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${a}`;if(o!=null){let l=e==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=v.fromVar(s);n[t]=l>0?d.brighten(l).rgba:d.darken(-l).rgba}break;case"s":{let d=v.fromVar(s);n[t]=l>0?d.saturate(l).rgba:d.desaturate(-l).rgba}break;case"h":{let d=v.fromVar(s);n[t]=d.rotate(l*100).rgba}break;case"o":{let d=v.fromVar(s);n[t]=d.opacity(l).rgba}break;case"":n[t]=`calc(var(${s}) * ${l})`;break;default:throw console.error(i),new Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),Si=0;function Nt(){return`custom-elt${(Si++).toString(36)}`}var se=0,An={};function Ei(n,t){let a=An[n],e=Wn(t).replace(/:host\b/g,n);An[n]=a?a+`
`+e:e}function Ti(n){if(An[n])document.head.append(g.style({id:n+"-component"},An[n]));delete An[n]}class y extends HTMLElement{static elements=g;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=g.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),g.style(Wn(n))}static elementCreator(n={}){if(this._elementCreator==null){let{tag:t,styleSpec:a}=n,e=n!=null?t:null;if(e==null)if(typeof this.name==="string"&&this.name!==""){if(e=nn(this.name),e.startsWith("-"))e=e.slice(1)}else e=Nt();if(customElements.get(e)!=null)console.warn(`${e} is already defined`);if(e.match(/\w+(-\w+)+/)==null)console.warn(`${e} is not a legal tag for a custom-element`),e=Nt();while(customElements.get(e)!==void 0)e=Nt();if(this._tagName=e,a!==void 0)Ei(e,a);window.customElements.define(e,this,n),this._elementCreator=g[e]}return this._elementCreator}initAttributes(...n){let t={},a={};new MutationObserver((e)=>{let o=!1;if(e.forEach((i)=>{o=!!(i.attributeName&&n.includes(bi(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((e)=>{t[e]=un(this[e]);let o=nn(e);Object.defineProperty(this,e,{enumerable:!1,get(){if(typeof t[e]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[e]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(a[e]!==void 0)return a[e];else return t[e]},set(i){if(typeof t[e]==="boolean"){if(i!==this[e]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[e]==="number"){if(i!==parseFloat(this[e]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[e]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),a[e]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):un(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(a){if(t!==a)t=a,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,a){if(t[a]===void 0){let e=n.querySelector(`[part="${a}"]`);if(e==null)e=n.querySelector(a);if(e==null)throw new Error(`elementRef "${a}" does not exist!`);e.removeAttribute("data-ref"),t[a]=e}return t[a]}});return this._parts}constructor(){super();se+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${se}`,this._value=un(this.defaultValue)}connectedCallback(){if(Ti(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if($t.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){$t.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)ge(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content():this.content,{styleSpec:a}=this.constructor,{styleNode:e}=this.constructor;if(a)e=this.constructor.styleNode=g.style(Wn(a)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),e=this.styleNode;if(e){let o=this.attachShadow({mode:"open"});o.appendChild(e.cloneNode(!0)),te(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);te(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(Zt.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((l)=>{s[l.name]=l}),o.forEach((l)=>{let d=s[""],h=l instanceof Element?s[l.slot]:d;(h!==void 0?h:d).append(l)})}}this._hydrated=!0}}render(){}}class Zt extends y{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Bl=Zt.elementCreator({tag:"xin-slot"}),kt=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let e=JSON.parse(t);for(let o of Object.keys(e).filter(n))if(O[o]!==void 0)Object.assign(O[o],e[o]);else O[o]=e[o]}let a=dt(()=>{let e={},o=X(O);for(let i of Object.keys(o).filter(n))e[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(e)),console.log("xin state saved to localStorage")},500);Yn(n,a)},pt="1.0.3";function Z(n){return Object.assign(rt,n),rt}function na(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),Z(n)}function Te(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),na(n);return Object.keys(n).forEach((a)=>{O[a]=n[a]}),O}var Ii={};async function ta(n,t){let{type:a,styleSpec:e}=await t(n,{Color:v,Component:y,elements:g,svgElements:ut,mathML:je,varDefault:u,vars:r,xin:O,boxed:rt,xinProxy:Te,boxedProxy:na,makeComponent:ta,bind:N,on:ht,version:pt}),o={type:a,creator:a.elementCreator({tag:n,styleSpec:e})};return Ii[n]=o,o}var Ht={},Mi=(n)=>import(n);class mt extends y{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:a}=this,e=`${n}.${a}:${t}`;if(!this.loaded){if(Ht[e]===void 0)Ht[e]=Mi(t).then((o)=>{let i=o[a];return ta(n,i)});else console.log(`using cached ${n}`);this.loaded=await Ht[e],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var Pi=mt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class aa extends y{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(mt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var _i=aa.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Ra={};Ua(Ra,{xrControllersText:()=>qs,xrControllers:()=>Xs,xinTagList:()=>xl,xinTag:()=>Oo,xinSizer:()=>yl,xinSelect:()=>kn,xinSegmented:()=>gl,xinRating:()=>ol,xinPasswordStrength:()=>el,xinNotification:()=>To,xinMenu:()=>ps,xinLocalized:()=>_t,xinForm:()=>zs,xinFloat:()=>ca,xinField:()=>As,xinCarousel:()=>ns,version:()=>Ja,updateLocalized:()=>ja,trackDrag:()=>on,tosijs:()=>$n,tosiMonth:()=>Zs,tabSelector:()=>So,svgIcon:()=>Ki,svg2DataUrl:()=>Pt,styleSheet:()=>eo,spacer:()=>Bn,sizeBreak:()=>Ya,sideNav:()=>Wa,setLocale:()=>is,scriptTag:()=>vn,richTextWidgets:()=>Bo,richText:()=>ul,removeLastMenu:()=>Cn,postNotification:()=>tl,positionFloat:()=>ro,popMenu:()=>G,popFloat:()=>lo,menu:()=>go,markdownViewer:()=>Da,mapBox:()=>Us,makeSorter:()=>ho,makeExamplesLive:()=>Js,localize:()=>D,localePicker:()=>rs,liveExample:()=>Ot,isBreached:()=>Mo,initLocalization:()=>ls,icons:()=>f,i18n:()=>P,gamepadText:()=>Vs,gamepadState:()=>jo,findHighestZ:()=>Ca,filterPart:()=>Mt,filterBuilder:()=>Ms,elastic:()=>rl,editableRect:()=>js,dragAndDrop:()=>fo,digest:()=>Io,defineIcons:()=>Ui,dataTable:()=>xs,createSubMenu:()=>co,createMenuItem:()=>bo,createMenuAction:()=>mo,commandButton:()=>Y,colorInput:()=>so,codeEditor:()=>Tt,bringToFront:()=>Zn,bodymovinPlayer:()=>Zi,blockStyle:()=>Xa,b3d:()=>Qi,availableFilters:()=>Ma,abTest:()=>Gi,XinTagList:()=>$a,XinTag:()=>Dt,XinSizer:()=>Fa,XinSelect:()=>tt,XinSegmented:()=>Na,XinRating:()=>Va,XinPasswordStrength:()=>za,XinNotification:()=>xn,XinMenu:()=>Ta,XinLocalized:()=>R,XinForm:()=>nt,XinFloat:()=>sn,XinField:()=>Bt,XinCarousel:()=>xa,TosiMonth:()=>Aa,TabSelector:()=>Ba,SvgIcon:()=>wa,SizeBreak:()=>La,SideNav:()=>Ha,RichText:()=>qa,MarkdownViewer:()=>Oa,MapBox:()=>wn,LocalePicker:()=>Sa,LiveExample:()=>On,FilterPart:()=>Pa,FilterBuilder:()=>_a,EditableRect:()=>W,DataTable:()=>Ia,CodeEditor:()=>_n,BodymovinPlayer:()=>Pn,B3d:()=>va,AbTest:()=>Mn});function ea(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}var tn=ea();function Oe(n){tn=n}var De=/[&<>"']/,Bi=new RegExp(De.source,"g"),Ae=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Oi=new RegExp(Ae.source,"g"),Di={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ie=(n)=>Di[n];function A(n,t){if(t){if(De.test(n))return n.replace(Bi,Ie)}else if(Ae.test(n))return n.replace(Oi,Ie);return n}var Ai=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function ze(n){return n.replace(Ai,(t,a)=>{if(a=a.toLowerCase(),a==="colon")return":";if(a.charAt(0)==="#")return a.charAt(1)==="x"?String.fromCharCode(parseInt(a.substring(2),16)):String.fromCharCode(+a.substring(1));return""})}var zi=/(^|[^\[])\^/g;function I(n,t){n=typeof n==="string"?n:n.source,t=t||"";let a={replace:(e,o)=>{return o=o.source||o,o=o.replace(zi,"$1"),n=n.replace(e,o),a},getRegex:()=>{return new RegExp(n,t)}};return a}var Vi=/[^\w:]/g,Xi=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Me(n,t,a){if(n){let e;try{e=decodeURIComponent(ze(a)).replace(Vi,"").toLowerCase()}catch(o){return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}if(t&&!Xi.test(a))a=Wi(t,a);try{a=encodeURI(a).replace(/%25/g,"%")}catch(e){return null}return a}var ct={},qi=/^[^:]+:\/*[^/]*$/,Ni=/^([^:]+:)[\s\S]*$/,Hi=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Wi(n,t){if(!ct[" "+n])if(qi.test(n))ct[" "+n]=n+"/";else ct[" "+n]=bt(n,"/",!0);n=ct[" "+n];let a=n.indexOf(":")===-1;if(t.substring(0,2)==="//"){if(a)return t;return n.replace(Ni,"$1")+t}else if(t.charAt(0)==="/"){if(a)return t;return n.replace(Hi,"$1")+t}else return n+t}var gt={exec:function n(){}};function Pe(n,t){let a=n.replace(/\|/g,(i,s,l)=>{let d=!1,h=s;while(--h>=0&&l[h]==="\\")d=!d;if(d)return"|";else return" |"}),e=a.split(/ \|/),o=0;if(!e[0].trim())e.shift();if(e.length>0&&!e[e.length-1].trim())e.pop();if(e.length>t)e.splice(t);else while(e.length<t)e.push("");for(;o<e.length;o++)e[o]=e[o].trim().replace(/\\\|/g,"|");return e}function bt(n,t,a){let e=n.length;if(e===0)return"";let o=0;while(o<e){let i=n.charAt(e-o-1);if(i===t&&!a)o++;else if(i!==t&&a)o++;else break}return n.slice(0,e-o)}function Li(n,t){if(n.indexOf(t[1])===-1)return-1;let a=n.length,e=0,o=0;for(;o<a;o++)if(n[o]==="\\")o++;else if(n[o]===t[0])e++;else if(n[o]===t[1]){if(e--,e<0)return o}return-1}function Yi(n,t){if(!n||n.silent)return;if(t)console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async");if(n.sanitize||n.sanitizer)console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");if(n.highlight||n.langPrefix!=="language-")console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight.");if(n.mangle)console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`.");if(n.baseUrl)console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url.");if(n.smartypants)console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants.");if(n.xhtml)console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml.");if(n.headerIds||n.headerPrefix)console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`.")}function _e(n,t,a,e){let o=t.href,i=t.title?A(t.title):null,s=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){e.state.inLink=!0;let l={type:"link",raw:a,href:o,title:i,text:s,tokens:e.inlineTokens(s)};return e.state.inLink=!1,l}return{type:"image",raw:a,href:o,title:i,text:A(s)}}function Fi(n,t){let a=n.match(/^(\s+)(?:```)/);if(a===null)return t;let e=a[1];return t.split(`
...
`):a}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let a=t[0],e=Fi(a,t[3]||"");return{type:"code",raw:a,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:e}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let a=t[2].trim();if(/#$/.test(a)){let e=bt(a,"#");if(this.options.pedantic)a=e.trim();else if(!e||/ $/.test(e))a=e.trim()}return{type:"heading",raw:t[0],depth:t[1].length,text:a,tokens:this.lexer.inline(a)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){let t=this.rules.block.blockquote.exec(n);if(t){let a=t[0].replace(/^ *>[ \t]?/gm,""),e=this.lexer.state.top;this.lexer.state.top=!0;let o=this.lexer.blockTokens(a);return this.lexer.state.top=e,{type:"blockquote",raw:t[0],tokens:o,text:a}}}list(n){let t=this.rules.block.list.exec(n);if(t){let a,e,o,i,s,l,d,h,p,m,c,x,_=t[1].trim(),B=_.length>1,E={type:"list",raw:"",ordered:B,start:B?+_.slice(0,-1):"",loose:!1,items:[]};if(_=B?`\\d{1,9}\\${_.slice(-1)}`:`\\${_}`,this.options.pedantic)_=B?_:"[*+-]";let C=new RegExp(`^( {0,3}${_})((?:[	 ][^\\n]*)?(?:\\n|$))`);while(n){if(x=!1,!(t=C.exec(n)))break;if(this.rules.block.hr.test(n))break;if(a=t[0],n=n.substring(a.length),h=t[2].split(`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];Fn("demo-style",Ao);var rn="tosijs";setTimeout(()=>{let n=v.fromVar(r.brandColor),t=v.fromVar(r.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var jl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Sl=At.find((n)=>n.filename===jl)||At[0],{app:z,prefs:q}=Z({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,xinjsuiUrl:"https://ui.xinjs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:At,currentDoc:Sl},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});kt((n)=>{if(n.startsWith("prefs"))return!0;return!1});Q.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};Q.current={toDOM(n,t){let a=n.getAttribute("href")||"";n.classList.toggle("current",t===a.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:z,tosi:Z,img:Xt,bindings:Q,elements:g,vars:r,touch:mn,Color:v})},1000);var zo=document.querySelector("main"),{h2:El,div:Vo,span:zt,a:Vt,img:Xt,header:Tl,button:Xo,template:Il,input:Ml}=g;N(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});N(document.body,q.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});N(document.body,q.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);z.currentDoc=z.docs.find((t)=>t.filename===n)||z.docs[0]});var Pl=dt(()=>{console.time("filter");let n=qo.value.toLocaleLowerCase();z.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),mn(z.docs),console.timeEnd("filter")}),qo=Ml({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Pl});if(zo)zo.append(Tl(Vt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${pt}, tosijs-ui ${Ja}`},Xt({src:"favicon.svg",style:{height:40,marginRight:10}}),El({bindText:"app.title"})),zt({class:"elastic"}),Ya({minWidth:750},zt({style:{marginRight:r.spacing,display:"flex",alignItems:"center",gap:r.spacing50}},Vt({href:z.bundleUrl},Xt({alt:"bundlejs size badge",src:z.bundleBadgeUrl})),Vt({href:z.cdnUrl},Xt({alt:"jsdelivr",src:z.cdnBadgeUrl}))),zt({slot:"small"})),zt({style:{flex:"0 0 10px"}}),Xo({title:"theme",class:"iconic",onClick(n){G({target:n.target,menuItems:[{icon:"github",caption:"github",action:z.githubUrl},{icon:"npm",caption:"npm",action:z.npmUrl},{icon:"discord",caption:"discord",action:z.discordUrl},{icon:"xinjsUiColor",caption:"xinjs-ui",action:z.xinjsuiUrl},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return q.theme==="system"},action(){q.theme="system"}},{caption:"Dark",checked(){return q.theme==="dark"},action(){q.theme="dark"}},{caption:"Light",checked(){return q.theme==="light"},action(){q.theme="light"}},null,{caption:"High Contrast",checked(){return q.highContrast.valueOf()},action(){q.highContrast=!q.highContrast.valueOf()}},{caption:"Monochrome",checked(){return q.monochrome.valueOf()},action(){q.monochrome=!q.monochrome.valueOf()}}]}]})}},f.moreVertical())),Wa({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"}},qo,Vo({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:z.docs}},Il(Vt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let a=cn(n.target),e=n.target.closest("xin-sidenav");e.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),z.currentDoc=a,n.preventDefault()}}))),Vo({style:{position:"relative",overflowY:"scroll",height:"100%"}},Xo({title:"show navigation",class:"transparent close-nav show-within-compact",style:{marginTop:"2px",position:"fixed"},onClick(n){n.target.closest("xin-sidenav").contentVisible=!1}},f.chevronLeft()),Da({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){On.insertExamples(this,{tosijs:$n,tosijsui:Ra})}}))));

//# debugId=D3D842BDA770A17F64756E2164756E21
