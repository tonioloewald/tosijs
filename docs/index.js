var cs=Object.create;var{getPrototypeOf:hs,defineProperty:qe,getOwnPropertyNames:ps}=Object;var us=Object.prototype.hasOwnProperty;var ms=(n,e,t)=>{t=n!=null?cs(hs(n)):{};let a=e||!n||!n.__esModule?qe(t,"default",{value:n,enumerable:!0}):t;for(let o of ps(n))if(!us.call(a,o))qe(a,o,{get:()=>n[o],enumerable:!0});return a};var ma=(n,e)=>{for(var t in e)qe(n,t,{get:e[t],enumerable:!0,configurable:!0,set:(a)=>e[t]=()=>a})};var se=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Un={};ma(Un,{xinValue:()=>D,xinProxy:()=>Ya,xinPath:()=>Tn,xin:()=>E,version:()=>be,vars:()=>l,varDefault:()=>h,updates:()=>xs,unobserve:()=>he,touchElement:()=>tt,touch:()=>cn,tosi:()=>G,throttle:()=>Nn,svgElements:()=>me,settings:()=>le,on:()=>En,observe:()=>Yn,mathML:()=>Na,makeComponent:()=>dt,invertLuminance:()=>st,initVars:()=>Qs,hotReload:()=>rt,getListItem:()=>hn,getCssVar:()=>Ha,elements:()=>m,debounce:()=>ue,css:()=>qn,boxedProxy:()=>lt,boxed:()=>pe,blueprintLoader:()=>ii,blueprint:()=>si,bindings:()=>J,bind:()=>_,StyleSheet:()=>Fn,MoreMath:()=>Ws,Component:()=>b,Color:()=>y,BlueprintLoader:()=>ct,Blueprint:()=>ge});var le={debug:!1,perf:!1};function ln(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(ln);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=ln(a);else e[t]=a}return e}var Ta="-xin-data",Sn=`.${Ta}`,Ea="-xin-event",ba=`.${Ea}`,$="xinPath",Hn="xinValue",bs="xinSet",gs="xinObserve",fs="xinBind",ys="xinOn",Tn=(n)=>{return n&&n[$]||void 0};function D(n){return typeof n==="object"&&n!==null?n[Hn]||n:n}var Vn=new WeakMap,dn=new WeakMap,Xn=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=dn.get(n),a=Vn.get(n);if(t!=null)dn.set(e,ln(t));if(a!=null)Vn.set(e,ln(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(Xn(t));else e.appendChild(t.cloneNode());return e},re=new WeakMap,hn=(n)=>{let e=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==e){let t=re.get(n);if(t!=null)return t;n=n.parentElement}return!1},ga=Symbol("observer should be removed"),de=[],ce=[],Je=!1,Ge,Ke;class Ia{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw Error("expect callback to be a path or function");de.push(this)}}var xs=async()=>{if(Ge===void 0)return;await Ge},ws=()=>{if(le.perf)console.time("xin async update");let n=Array.from(ce);for(let e of n)de.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===ga)return he(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===ga)he(t)});if(ce.splice(0),Je=!1,typeof Ke==="function")Ke();if(le.perf)console.timeEnd("xin async update")},cn=(n)=>{let e=typeof n==="string"?n:Tn(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(Je===!1)Ge=new Promise((t)=>{Ke=t}),Je=setTimeout(ws);if(ce.find((t)=>e.startsWith(t))==null)ce.push(e)},Pa=(n,e)=>{return new Ia(n,e)},he=(n)=>{let e=de.indexOf(n);if(e>-1)de.splice(e,1);else throw Error("unobserve failed, listener not found")},vs=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},Ma=(...n)=>Error(n.map(vs).join(" ")),ks=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),js=0,Cs=()=>(parseInt("10000",36)+ ++js).toString(36).slice(-5),Ss=()=>ks()+Cs(),Ze=Symbol("delete"),Ba=Symbol("new-object"),Ye=Symbol("automatic-index");function La(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var U=new WeakMap;function Da(n,e){if(U.get(n)===void 0)U.set(n,{});if(U.get(n)[e]===void 0)U.get(n)[e]={};let t=U.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a[Ye]===void 0)a[Ye]=Ss();t[a[Ye]+""]=o});else n.forEach((a,o)=>{t[Rn(a,e)+""]=o});return t}function Ts(n,e){if(U.get(n)===void 0||U.get(n)[e]===void 0)return Da(n,e);else return U.get(n)[e]}function Es(n,e,t){t=t+"";let a=Ts(n,e)[t];if(a===void 0||Rn(n[a],e)+""!==t)a=Da(n,e)[t];return a}function Is(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function za(n,e,t,a){let o=e!==""?Es(n,e,t):t;if(a===Ze)return n.splice(o,1),U.delete(n),Symbol("deleted");else if(a===Ba){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&Rn(a,e)+""===t+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function fa(n){if(!Array.isArray(n))throw Ma("setByPath failed: expected array, found",n)}function ya(n){if(n==null||!(n instanceof Object))throw Ma("setByPath failed: expected Object, found",n)}function Rn(n,e){let t=La(e),a=n,o,s,i,r;for(o=0,s=t.length;a!==void 0&&o<s;o++){let d=t[o];if(Array.isArray(d))for(i=0,r=d.length;a!==void 0&&i<r;i++){let c=d[i];a=a[c]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[c,...p]=d.split("=");a=za(a,c,p.join("="))}else i=parseInt(d,10),a=a[i]}return a}function Ps(n,e,t){let a=n;if(e==="")throw Error("setByPath cannot be used to set the root object");let o=La(e);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)ya(a);else fa(a);let r=s.slice(0,i),d=s.slice(i+1);if(a=za(a,r,d,o.length>0?Ba:t),o.length===0)return!0}else{fa(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(t!==Ze){if(a[r]===t)return!1;a[r]=t}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){ya(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=Is(a,i,s.length>0?{}:[]);else{if(t!==Ze){if(a[i]===t)return!1;a[i]=t}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${e}`)}throw Error(`setByPath(${n}, ${e}, ${t}) failed`)}var Ms=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],et={},Bs=!0,Ls=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,Ds=(n)=>Ls.test(n),sn=(n="",e="")=>{if(n==="")return e;else if(e.match(/^\d+$/)!==null||e.includes("="))return`${n}[${e}]`;else return`${n}.${e}`},zs={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function Fe(n,e){let t=typeof n;if(n===void 0||t==="object"||t==="function")return n;else return new Proxy(zs[typeof n](n),Cn(e,!0))}var Cn=(n,e)=>({get(t,a){switch(a){case $:return n;case Hn:return t.valueOf?t.valueOf():t;case bs:return(i)=>E[n]=i;case gs:return(i)=>{let r=Pa(n,i);return()=>he(r)};case ys:return(i,r)=>En(i,r,D(t));case fs:return(i,r,d)=>{_(i,n,r,d)}}if(typeof a==="symbol")return t[a];let o=a,s=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(s!==null){let[,i,r]=s,d=sn(n,i),c=Rn(t,i);return c!==null&&typeof c==="object"?new Proxy(c,Cn(d,e))[r]:c}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(t)&&t[o]!==void 0||Array.isArray(t)&&o.includes("=")){let i;if(o.includes("=")){let[r,d]=o.split("=");i=t.find((c)=>`${Rn(c,r)}`===d)}else i=t[o];if(i instanceof Object){let r=sn(n,o);return new Proxy(i instanceof Function?i.bind(t):i,Cn(r,e))}else return e?Fe(i,sn(n,o)):i}else if(Array.isArray(t)){let i=t[o];return typeof i==="function"?(...r)=>{let d=i.apply(t,r);if(Ms.includes(o))cn(n);return d}:typeof i==="object"?new Proxy(i,Cn(sn(n,o),e)):e?Fe(i,sn(n,o)):i}else return e?Fe(t[o],sn(n,o)):t[o]},set(t,a,o){o=D(o);let s=a!==Hn?sn(n,a):n;if(Bs&&!Ds(s))throw Error(`setting invalid path ${s}`);if(D(E[s])!==o&&Ps(et,s,o))cn(s);return!0}}),Yn=(n,e)=>{let t=typeof e==="function"?e:E[e];if(typeof t!=="function")throw Error(`observe expects a function or path to a function, ${e} is neither`);return Pa(n,t)},E=new Proxy(et,Cn("",!1)),pe=new Proxy(et,Cn("",!0)),_a=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},Aa=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},_s=(n,e)=>{switch(Aa(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},As=(n)=>{switch(Aa(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:xa}=globalThis,Qe=xa!=null?new xa((n)=>{for(let e of n){let t=e.target;_a(t,"resize")}}):{observe(){},unobserve(){}},wa=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?Xn(a):a)});else if(e instanceof Node)n.append(t?Xn(e):e);else throw Error("expect text content or document node")},ue=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},Nn=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...s)=>{if(clearTimeout(t),t=setTimeout(()=>{n(...s),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},nt=Symbol("list-binding"),Os=16,Hs=100;function va(n,e){let t=Array.from(n.querySelectorAll(Sn));if(n.matches(Sn))t.unshift(n);for(let a of t){let o=dn.get(a);for(let s of o){if(s.path.startsWith("^"))s.path=`${e}${s.path.substring(1)}`;if(s.binding.toDOM!=null)s.binding.toDOM(a,E[s.path])}}}class Oa{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,e,t={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=Xn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=t,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),t.virtual!=null)Qe.observe(this.boundElement),this._update=Nn(()=>{this.update(this._array,!0)},Os),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:e,visibleProp:t}=this.options,a=this._array;if(e!==void 0)a=a.filter((d)=>d[e]!==!0);if(t!==void 0)a=a.filter((d)=>d[t]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,s=a.length-1,i=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,c=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(c/n.height)+(n.rowChunkSize||1),u=Math.ceil(a.length/n.visibleColumns),g=n.visibleColumns*p,x=Math.floor(this.boundElement.scrollTop/n.height);if(x>u-p+1)x=Math.max(0,u-p+1);if(n.rowChunkSize)x-=x%n.rowChunkSize;o=x*n.visibleColumns,s=o+g-1,i=x*n.height,r=Math.max((u-p)*n.height-i,0)}return{items:a,firstItem:o,lastItem:s,topBuffer:i,bottomBuffer:r}}needle;filter=Nn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},Hs);update(n,e){if(n==null)n=[];this._array=n;let{hiddenProp:t,visibleProp:a}=this.options,o=Tn(n),s=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",s.items.length===0);let i=this._previousSlice,{firstItem:r,lastItem:d,topBuffer:c,bottomBuffer:p}=s;if(t===void 0&&a===void 0&&e===!0&&i!=null&&r===i.firstItem&&d===i.lastItem)return;this._previousSlice=s;let u=0,g=0,x=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let j=re.get(T);if(j==null)T.remove();else{let C=s.items.indexOf(j);if(C<r||C>d)T.remove(),this.itemToElement.delete(j),re.delete(T),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(p)+"px";let w=[],{idPath:S}=this.options;for(let T=r;T<=d;T++){let j=s.items[T];if(j===void 0)continue;let C=this.itemToElement.get(D(j));if(C==null){if(x++,C=Xn(this.template),typeof j==="object")this.itemToElement.set(D(j),C),re.set(C,D(j));if(this.boundElement.insertBefore(C,this.listBottom),S!=null){let B=j[S],kn=`${o}[${S}=${B}]`;va(C,kn)}else{let B=`${o}[${T}]`;va(C,B)}}w.push(C)}let F=null;for(let T of w){if(T.previousElementSibling!==F)if(g++,F?.nextElementSibling!=null)this.boundElement.insertBefore(T,F.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);F=T}if(le.perf)console.log(o,"updated",{removed:u,created:x,moved:g})}}var Vs=(n,e,t)=>{let a=n[nt];if(a===void 0)a=new Oa(n,e,t),n[nt]=a;return a},{document:Wn,MutationObserver:ka}=globalThis,tt=(n,e)=>{let t=dn.get(n);if(t==null)return;for(let a of t){let{binding:o,options:s}=a,{path:i}=a,{toDOM:r}=o;if(r!=null){if(i.startsWith("^")){let d=hn(n);if(d!=null&&d[$]!=null)i=a.path=`${d[$]}${i.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${i}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${i}`)}if(e==null||i.startsWith(e))r(n,E[i],s)}}};if(ka!=null)new ka((n)=>{n.forEach((e)=>{Array.from(e.addedNodes).forEach((t)=>{if(t instanceof Element)Array.from(t.querySelectorAll(Sn)).forEach((a)=>tt(a))})})}).observe(Wn.body,{subtree:!0,childList:!0});Yn(()=>!0,(n)=>{let e=Array.from(Wn.querySelectorAll(Sn));for(let t of e)tt(t,n)});var ja=(n)=>{let e=n.target.closest(Sn);while(e!=null){let t=dn.get(e);for(let a of t){let{binding:o,path:s}=a,{fromDOM:i}=o;if(i!=null){let r;try{r=i(e,a.options)}catch(d){throw console.error("Cannot get value from",e,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let d=E[s];if(d==null)E[s]=r;else{let c=d[$]!=null?d[Hn]:d,p=r[$]!=null?r[Hn]:r;if(c!==p)E[s]=p}}}}e=e.parentElement.closest(Sn)}};if(globalThis.document!=null)Wn.body.addEventListener("change",ja,!0),Wn.body.addEventListener("input",ja,!0);function _(n,e,t,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof e==="object"&&e[$]===void 0&&a===void 0){let{value:r}=e;o=typeof r==="string"?r:r[$],a=e,delete a.value}else o=typeof e==="string"?e:e[$];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:s}=t;n.classList?.add(Ta);let i=dn.get(n);if(i==null)i=[],dn.set(n,i);if(i.push({path:o,binding:t,options:a}),s!=null&&!o.startsWith("^"))cn(o);if(a?.filter&&a?.needle)_(n,a.needle,{toDOM(r,d){console.log({needle:d}),r[nt]?.filter(d)}});return n}var Ca=new Set,Xs=(n)=>{let e=n?.target.closest(ba),t=!1,a=new Proxy(n,{get(s,i){if(i==="stopPropagation")return()=>{n.stopPropagation(),t=!0};else{let r=s[i];return typeof r==="function"?r.bind(s):r}}}),o=new Set;while(!t&&e!=null){let s=Vn.get(e)[n.type]||o;for(let i of s){if(typeof i==="function")i(a);else{let r=E[i];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${i}`)}if(t)continue}e=e.parentElement!=null?e.parentElement.closest(ba):null}};function En(n,e,t){let a=Vn.get(n);if(n.classList.add(Ea),a==null)a={},Vn.set(n,a);if(!a[e])a[e]=new Set;if(a[e].add(t),!Ca.has(e))Ca.add(e),Wn.body.addEventListener(e,Xs,!0);return()=>{a[e].delete(t)}}var J={value:{toDOM:_s,fromDOM(n){return As(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){Vs(n,e,t).update(e)}}},Rs=180/Math.PI,Ns=Math.PI/180;function N(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function Z(n,e,t,a=!0){if(a)t=N(0,t,1);return t*(e-n)+n}var Ws={RADIANS_TO_DEGREES:Rs,DEGREES_TO_RADIANS:Ns,clamp:N,lerp:Z};function Ha(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var qs=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},rn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class Va{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),s=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var jn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class y{r;g;b;a;static fromVar(n,e=document.body){return y.fromCss(Ha(n,e))}static fromCss(n){let e=n;if(jn instanceof HTMLSpanElement)jn.style.color="black",jn.style.color=n,document.body.appendChild(jn),e=getComputedStyle(jn).color,jn.remove();let[t,a,o,s]=e.match(/[\d.]+/g)||["0","0","0","0"],i=e.startsWith("color(srgb")?255:1;return new y(Number(t)*i,Number(a)*i,Number(o)*i,s==null?1:Number(s))}static fromHsl(n,e,t,a=1){let o,s,i;if(e===0)o=s=i=t;else{let d=(g,x,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(x-g)*6*w;if(w<0.5)return x;if(w<0.6666666666666666)return g+(x-g)*(0.6666666666666666-w)*6;return g},c=t<0.5?t*(1+e):t+e-t*e,p=2*t-c,u=(n%360+360)%360/360;o=d(p,c,u+0.3333333333333333),s=d(p,c,u),i=d(p,c,u-0.3333333333333333)}let r=new y(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:e,l:t},r}static black=new y(0,0,0);static white=new y(255,255,255);constructor(n,e,t,a=1){this.r=N(0,n,255),this.g=N(0,e,255),this.b=N(0,t,255),this.a=N(0,a,1)}get inverse(){return new y(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return y.fromHsl(n,e,1-t,this.a)}get opaque(){return this.a===1?this:new y(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?y.black:y.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new Va(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new y(n,n,n)}get brightness(){return qs(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+rn(this.r)+rn(this.g)+rn(this.b):"#"+rn(this.r)+rn(this.g)+rn(this.b)+rn(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=N(0,a+n*(1-a),1);return y.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=N(0,a*(1-n),1);return y.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=N(0,t+n*(1-t),1);return y.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=N(0,t*(1-n),1);return y.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return y.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return y.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new y(Z(this.r,n.r,e),Z(this.g,n.g,e),Z(this.b,n.b,e),Z(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return y.fromHsl(t.s===0?a.h:a.s===0?t.h:y.blendHue(t.h,a.h,e),Z(t.s,a.s,e),Z(t.l,a.l,e),Z(this.a,n.a,e))}colorMix(n,e){return y.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}}function Q(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function Ys(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var Fs="http://www.w3.org/1998/Math/MathML",Us="http://www.w3.org/2000/svg",ie={},Xa=(n,e,t)=>{let a=Wa(Q(e),t);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[e]=a.value},$s=(n)=>{return{toDOM(e,t){Xa(e,n,t)}}},Ra=(n,e,t)=>{if(e==="style")if(typeof t==="object")for(let a of Object.keys(t))if(Tn(t[a]))_(n,t[a],$s(a));else Xa(n,a,t[a]);else n.setAttribute("style",t);else if(n[e]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(e,t);else n[e]=t}else{let a=Q(e);if(a==="class")t.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=t;else if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t)}},Js=(n)=>{return{toDOM(e,t){Ra(e,n,t)}}},Gs=(n,e,t)=>{if(e==="apply")t(n);else if(e.match(/^on[A-Z]/)!=null){let a=e.substring(2).toLowerCase();En(n,a,t)}else if(e==="bind")if((typeof t.binding==="string"?J[t.binding]:t.binding)!==void 0&&t.value!==void 0)_(n,t.value,t.binding instanceof Function?{toDOM:t.binding}:t.binding);else throw Error("bad binding");else if(e.match(/^bind[A-Z]/)!=null){let a=e.substring(4,5).toLowerCase()+e.substring(5),o=J[a];if(o!==void 0)_(n,t,o);else throw Error(`${e} is not allowed, bindings.${a} is not defined`)}else if(Tn(t))_(n,t,Js(e));else Ra(n,e,t)},at=(n,...e)=>{if(ie[n]===void 0){let[o,s]=n.split("|");if(s===void 0)ie[n]=globalThis.document.createElement(o);else ie[n]=globalThis.document.createElementNS(s,o)}let t=ie[n].cloneNode(),a={};for(let o of e)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(t instanceof HTMLTemplateElement)t.content.append(o);else t.append(o);else if(Tn(o))t.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let s=a[o];Gs(t,o,s)}return t},ot=(...n)=>{let e=globalThis.document.createDocumentFragment();for(let t of n)e.append(t);return e},m=new Proxy({fragment:ot},{get(n,e){if(e=e.replace(/[A-Z]/g,(t)=>`-${t.toLocaleLowerCase()}`),n[e]===void 0)n[e]=(...t)=>at(e,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),me=new Proxy({fragment:ot},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>at(`${e}|${Us}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Na=new Proxy({fragment:ot},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>at(`${e}|${Fs}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}});function Fn(n,e){let t=m.style(qn(e));t.id=n,document.head.append(t)}var Ks=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Wa=(n,e)=>{if(typeof e==="number"&&!Ks.includes(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},Zs=(n,e,t)=>{if(t===void 0)return"";if(t instanceof y)t=t.html;let a=Wa(e,t);return`${n}  ${a.prop}: ${a.value};`},qa=(n,e,t="")=>{let a=Q(n);if(typeof e==="object"&&!(e instanceof y)){let o=Object.keys(e).map((s)=>qa(s,e[s],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
...
${c}`:c,o=o?`${o}
${p}`:p;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,s,!0),this.lexer.state.top=u,t.length===0)break;let g=s.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let x=g,w=x.raw+`
`+t.join(`
...
`+t.join(`
`),S=this.list(w);s[s.length-1]=S,a=a.substring(0,a.length-g.raw.length)+S.raw,o=o.substring(0,o.length-x.raw.length)+S.raw,t=w.substring(s.at(-1).raw.length).split(`
