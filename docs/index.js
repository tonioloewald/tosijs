var vi=Object.create;var{getPrototypeOf:xi,defineProperty:Ft,getOwnPropertyNames:ki}=Object;var ji=Object.prototype.hasOwnProperty;var Ci=(n,t,e)=>{e=n!=null?vi(xi(n)):{};let a=t||!n||!n.__esModule?Ft(e,"default",{value:n,enumerable:!0}):e;for(let o of ki(n))if(!ji.call(a,o))Ft(a,o,{get:()=>n[o],enumerable:!0});return a};var va=(n,t)=>{for(var e in t)Ft(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var lt=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Gn={};va(Gn,{xinValue:()=>L,xinProxy:()=>to,xinPath:()=>Mn,xin:()=>I,version:()=>ft,vars:()=>l,varDefault:()=>h,updates:()=>Si,unobserve:()=>Pn,touchElement:()=>he,touch:()=>mn,tosi:()=>q,throttle:()=>Yn,svgElements:()=>gt,settings:()=>ht,on:()=>tn,observe:()=>Jn,mathML:()=>no,makeComponent:()=>be,invertLuminance:()=>re,initVars:()=>$i,hotReload:()=>ue,getListItem:()=>bn,getListInstance:()=>se,getListBinding:()=>ie,getCssVar:()=>$a,elements:()=>m,deleteListItem:()=>Ri,debounce:()=>bt,css:()=>Fn,boxedProxy:()=>me,boxed:()=>mt,blueprintLoader:()=>ps,blueprint:()=>hs,bindings:()=>G,bind:()=>z,StyleSheet:()=>$n,MoreMath:()=>qi,Component:()=>b,Color:()=>y,BlueprintLoader:()=>ge,Blueprint:()=>yt});var ht={debug:!1,perf:!1};function pn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(pn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=pn(a);else t[e]=a}return t}var Oa="-xin-data",Bn=`.${Oa}`,Ha="-xin-event",xa=`.${Ha}`,W="xinPath",In="xinValue",ka="xinObserve",ja="xinBind",Ca="xinOn",Zt=Symbol("list-binding"),Qt=Symbol("list-instance"),Mn=(n)=>{return n&&n[W]||void 0};function L(n){return typeof n==="object"&&n!==null?n[In]||n:n}var Nn=new WeakMap,un=new WeakMap,Wn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=un.get(n),a=Nn.get(n);if(e!=null)un.set(t,pn(e));if(a!=null)Nn.set(t,pn(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(Wn(e));else t.appendChild(e.cloneNode());return t},Sa=Symbol("observer should be removed"),pt=[],ut=[],ne=!1,te,ee;class Va{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw Error("expect callback to be a path or function");pt.push(this)}}var Si=async()=>{if(te===void 0)return;await te},Ti=()=>{if(ht.perf)console.time("xin async update");let n=Array.from(ut);for(let t of n)pt.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Sa)return Pn(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Sa)Pn(e)});if(ut.splice(0),ne=!1,typeof ee==="function")ee();if(ht.perf)console.timeEnd("xin async update")},mn=(n)=>{let t=typeof n==="string"?n:Mn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(ne===!1)te=new Promise((e)=>{ee=e}),ne=setTimeout(Ti);if(ut.find((e)=>t.startsWith(e))==null)ut.push(t)},ct=(n,t)=>{return new Va(n,t)},Pn=(n)=>{let t=pt.indexOf(n);if(t>-1)pt.splice(t,1);else throw Error("unobserve failed, listener not found")},Ei=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},Ra=(...n)=>Error(n.map(Ei).join(" ")),Ii=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Pi=0,Bi=()=>(parseInt("10000",36)+ ++Pi).toString(36).slice(-5),Mi=()=>Ii()+Bi(),ae=Symbol("delete"),Xa=Symbol("new-object"),Ut=Symbol("automatic-index");function Na(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var J=new WeakMap;function Wa(n,t){if(J.get(n)===void 0)J.set(n,{});if(J.get(n)[t]===void 0)J.get(n)[t]={};let e=J.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[Ut]===void 0)a[Ut]=Mi();e[a[Ut]+""]=o});else n.forEach((a,o)=>{e[qn(a,t)+""]=o});return e}function Li(n,t){if(J.get(n)===void 0||J.get(n)[t]===void 0)return Wa(n,t);else return J.get(n)[t]}function Di(n,t,e){e=e+"";let a=Li(n,t)[e];if(a===void 0||qn(n[a],t)+""!==e)a=Wa(n,t)[e];return a}function zi(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function qa(n,t,e,a){let o=t!==""?Di(n,t,e):e;if(a===ae)return n.splice(o,1),J.delete(n),Symbol("deleted");else if(a===Xa){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&qn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function Ta(n){if(!Array.isArray(n))throw Ra("setByPath failed: expected array, found",n)}function Ea(n){if(n==null||!(n instanceof Object))throw Ra("setByPath failed: expected Object, found",n)}function qn(n,t){let e=Na(t),a=n,o,i,s,r;for(o=0,i=e.length;a!==void 0&&o<i;o++){let d=e[o];if(Array.isArray(d))for(s=0,r=d.length;a!==void 0&&s<r;s++){let c=d[s];a=a[c]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[c,...p]=d.split("=");a=qa(a,c,p.join("="))}else s=parseInt(d,10),a=a[s]}return a}function _i(n,t,e){let a=n;if(t==="")throw Error("setByPath cannot be used to set the root object");let o=Na(t);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)Ea(a);else Ta(a);let r=i.slice(0,s),d=i.slice(s+1);if(a=qa(a,r,d,o.length>0?Xa:e),o.length===0)return!0}else{Ta(a);let r=parseInt(i,10);if(o.length>0)a=a[r];else{if(e!==ae){if(a[r]===e)return!1;a[r]=e}else a.splice(r,1);return!0}}}else if(Array.isArray(i)&&i.length>0){Ea(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=zi(a,s,i.length>0?{}:[]);else{if(e!==ae){if(a[s]===e)return!1;a[s]=e}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw Error(`setByPath failed, bad path ${t}`)}throw Error(`setByPath(${n}, ${t}, ${e}) failed`)}var Ya=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},Fa=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Ai=(n,t)=>{switch(Fa(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},Oi=(n)=>{switch(Fa(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:Ia}=globalThis,oe=Ia!=null?new Ia((n)=>{for(let t of n){let e=t.target;Ya(e,"resize")}}):{observe(){},unobserve(){}},Pa=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?Wn(a):a)});else if(t instanceof Node)n.append(e?Wn(t):t);else throw Error("expect text content or document node")},bt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Yn=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(e),e=setTimeout(()=>{n(...i),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},Hi=16,Vi=100;function Ba(n,t){let e=Array.from(n.querySelectorAll(Bn));if(n.matches(Bn))e.unshift(n);for(let a of e){let o=un.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,I[i.path])}}}class Ua{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=Wn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)oe.observe(this.boundElement),this._update=Yn(()=>{this.update(this.array,!0)},Hi),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this.array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,c=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(c/n.height)+(n.rowChunkSize||1),u=Math.ceil(a.length/n.visibleColumns),g=n.visibleColumns*p,w=Math.floor(this.boundElement.scrollTop/n.height);if(w>u-p+1)w=Math.max(0,u-p+1);if(n.rowChunkSize)w-=w%n.rowChunkSize;o=w*n.visibleColumns,i=o+g-1,s=w*n.height,r=Math.max((u-p)*n.height-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:r}}needle;filter=Yn((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},Vi);update(n,t){if(n==null)n=[];this.array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Mn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:r,lastItem:d,topBuffer:c,bottomBuffer:p}=i;if(e===void 0&&a===void 0&&t===!0&&s!=null&&r===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let u=0,g=0,w=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let j=T[Qt];if(j==null)T.remove();else{let C=i.items.indexOf(j);if(C<r||C>d)T.remove(),this.itemToElement.delete(j),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(p)+"px";let v=[],{idPath:S}=this.options;for(let T=r;T<=d;T++){let j=i.items[T];if(j===void 0)continue;let C=this.itemToElement.get(L(j));if(C==null){if(w++,C=Wn(this.template),typeof j==="object")this.itemToElement.set(L(j),C),C[Qt]=L(j);if(this.boundElement.insertBefore(C,this.listBottom),S!=null){let M=j[S],Tn=`${o}[${S}=${M}]`;Ba(C,Tn)}else{let M=`${o}[${T}]`;Ba(C,M)}}v.push(C)}let $=null;for(let T of v){if(T.previousElementSibling!==$)if(g++,$?.nextElementSibling!=null)this.boundElement.insertBefore(T,$.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);$=T}if(ht.perf)console.log(o,"updated",{removed:u,created:w,moved:g})}}var ie=(n,t,e)=>{let a=n[Zt];if(t&&a===void 0)a=new Ua(n,t,e),n[Zt]=a;return a},se=(n)=>{let t;while(!(t=n[Qt])&&n&&n.parentElement)n=n.parentElement;return t?{element:n,item:t}:void 0},bn=(n)=>{let t=se(n);return t?t.item:void 0},Ri=(n)=>{let t=se(n);if(!t)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let e=ie(t.element.parentElement);if(!e.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,e),!1;let a=e.array.indexOf(t.item);if(a>-1)return e.array.splice(a,1),!0;return!1},G={value:{toDOM:Ai,fromDOM(n){return Oi(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){ie(n,t,e).update(t)}}};function en(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function Xi(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var Ni=180/Math.PI,Wi=Math.PI/180;function N(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function Z(n,t,e,a=!0){if(a)e=N(0,e,1);return e*(t-n)+n}var qi={RADIANS_TO_DEGREES:Ni,DEGREES_TO_RADIANS:Wi,clamp:N,lerp:Z};function $a(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var Yi=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},dn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class Ja{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),i=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var En=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class y{r;g;b;a;static fromVar(n,t=document.body){return y.fromCss($a(n,t))}static fromCss(n){let t=n;if(En instanceof HTMLSpanElement)En.style.color="black",En.style.color=n,document.body.appendChild(En),t=getComputedStyle(En).color,En.remove();let[e,a,o,i]=t.match(/[\d.]+/g)||["0","0","0","0"],s=t.startsWith("color(srgb")?255:1;return new y(Number(e)*s,Number(a)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,e,a=1){let o,i,s;if(t===0)o=i=s=e;else{let d=(g,w,v)=>{if(v<0)v+=1;if(v>1)v-=1;if(v<0.16666666666666666)return g+(w-g)*6*v;if(v<0.5)return w;if(v<0.6666666666666666)return g+(w-g)*(0.6666666666666666-v)*6;return g},c=e<0.5?e*(1+t):e+t-e*t,p=2*e-c,u=(n%360+360)%360/360;o=d(p,c,u+0.3333333333333333),i=d(p,c,u),s=d(p,c,u-0.3333333333333333)}let r=new y(o*255,i*255,s*255,a);return r.hslCached={h:(n%360+360)%360,s:t,l:e},r}static black=new y(0,0,0);static white=new y(255,255,255);constructor(n,t,e,a=1){this.r=N(0,n,255),this.g=N(0,t,255),this.b=N(0,e,255),this.a=N(0,a,1)}get inverse(){return new y(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return y.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new y(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?y.black:y.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new Ja(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new y(n,n,n)}get brightness(){return Yi(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+dn(this.r)+dn(this.g)+dn(this.b):"#"+dn(this.r)+dn(this.g)+dn(this.b)+dn(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,a+n*(1-a),1);return y.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,a*(1-n),1);return y.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,e+n*(1-e),1);return y.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,e*(1-n),1);return y.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return y.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return y.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new y(Z(this.r,n.r,t),Z(this.g,n.g,t),Z(this.b,n.b,t),Z(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return y.fromHsl(e.s===0?a.h:a.s===0?e.h:y.blendHue(e.h,a.h,t),Z(e.s,a.s,t),Z(e.l,a.l,t),Z(this.a,n.a,t))}colorMix(n,t){return y.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function $n(n,t){let e=m.style(Fn(t));e.id=n,document.head.append(e)}var Fi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Ga=(n,t)=>{if(typeof t==="number"&&!Fi.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Ui=(n,t,e)=>{if(e===void 0)return"";if(e instanceof y)e=e.html;let a=Ga(t,e);return`${n}  ${a.prop}: ${a.value};`},Ka=(n,t,e="")=>{let a=en(n);if(typeof t==="object"&&!(t instanceof y)){let o=Object.keys(t).map((i)=>Ka(i,t[i],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Ui(e,a,t)},Fn=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>Ka(i,a[i])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},$i=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=en(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},re=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof y)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=y.fromCss(a).inverseLuminance}return t},h=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+en(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),l=new Proxy({},{get(n,t){if(t==="default")return h;if(n[t]==null){t=en(t);let[,e,,a,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${e}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=y.fromVar(s);n[t]=r>0?d.brighten(r).rgba:d.darken(-r).rgba}break;case"s":{let d=y.fromVar(s);n[t]=r>0?d.saturate(r).rgba:d.desaturate(-r).rgba}break;case"h":{let d=y.fromVar(s);n[t]=d.rotate(r*100).rgba}break;case"o":{let d=y.fromVar(s);n[t]=d.opacity(r).rgba}break;case"":n[t]=`calc(var(${s}) * ${r})`;break;default:throw console.error(i),Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),Ji="http://www.w3.org/1998/Math/MathML",Gi="http://www.w3.org/2000/svg",dt={},Za=(n,t,e)=>{let a=Ga(en(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},Ki=(n)=>{return{toDOM(t,e){Za(t,n,e)}}},Qa=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Mn(e[a]))z(n,e[a],Ki(a));else Za(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=en(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},Zi=(n)=>{return{toDOM(t,e){Qa(t,n,e)}}},Qi=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();tn(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?G[e.binding]:e.binding)!==void 0&&e.value!==void 0)z(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=G[a];if(o!==void 0)z(n,e,o);else throw Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Mn(e))z(n,e,Zi(t));else Qa(n,t,e)},le=(n,...t)=>{if(dt[n]===void 0){let[o,i]=n.split("|");if(i===void 0)dt[n]=globalThis.document.createElement(o);else dt[n]=globalThis.document.createElementNS(i,o)}let e=dt[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(Mn(o))e.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];Qi(e,o,i)}return e},de=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},m=new Proxy({fragment:de},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>le(t,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),gt=new Proxy({fragment:de},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>le(`${t}|${Gi}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),no=new Proxy({fragment:de},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>le(`${t}|${Ji}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),ns=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],ce={},ts=!0,es=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,as=(n)=>es.test(n),cn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},os={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}},Q=Symbol("undefined");function $t(n,t){if(n===void 0||n===null)return new Proxy({[Q]:n===null?"null":"undefined"},nn(t,!0));let e=typeof n;if(e==="object"||e==="function")return n;else return new Proxy(os[typeof n](n),nn(t,!0))}var Jt=()=>new Proxy({},nn("^",!0)),Ma=!1;function hn(){if(!Ma)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),Ma=!0}var La=(n)=>{return n instanceof Number||n instanceof String||n instanceof Boolean||Q in n},nn=(n,t)=>({get(e,a){if(La(e))switch(a){case"path":return n;case"value":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case"observe":return(s)=>{let r=ct(n,s);return()=>Pn(r)};case"on":return(s,r)=>tn(s,r,L(e));case"bind":return(s,r,d)=>{z(s,n,r,d)};case"binding":return(s)=>({bind:{value:n,binding:s}});case"listBinding":return(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Jt()))];case In:case"tosiValue":return hn(),e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case W:case"tosiPath":return hn(),n;case ka:case"tosiObserve":return hn(),(s)=>{let r=ct(n,s);return()=>Pn(r)};case Ca:case"tosiOn":return hn(),(s,r)=>tn(s,r,L(e));case ja:case"tosiBind":return hn(),(s,r,d)=>{z(s,n,r,d)};case"tosiBinding":return hn(),(s)=>({bind:{value:n,binding:s}});case"tosiListBinding":return hn(),(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Jt()))]}switch(a){case W:case"tosiPath":return n;case In:case"tosiValue":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case ka:case"tosiObserve":return(s)=>{let r=ct(n,s);return()=>Pn(r)};case Ca:case"tosiOn":return(s,r)=>tn(s,r,L(e));case ja:case"tosiBind":return(s,r,d)=>{z(s,n,r,d)};case"tosiBinding":return(s)=>({bind:{value:n,binding:s}});case"tosiListBinding":return(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Jt()))]}if(typeof a==="symbol")return e[a];let o=a,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,r]=i,d=cn(n,s),c=qn(e,s);return c!==null&&typeof c==="object"?new Proxy(c,nn(d,t))[r]:c}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(e)&&e[o]!==void 0||Array.isArray(e)&&o.includes("=")){let s;if(o.includes("=")){let[r,d]=o.split("=");s=e.find((c)=>`${qn(c,r)}`===d)}else s=e[o];if(s instanceof Object){let r=cn(n,o);return new Proxy(s instanceof Function?s.bind(e):s,nn(r,t))}else return t?$t(s,cn(n,o)):s}else if(Array.isArray(e)){let s=e[o];return typeof s==="function"?(...r)=>{let d=s.apply(e,r);if(ns.includes(o))mn(n);return d}:typeof s==="object"?new Proxy(s,nn(cn(n,o),t)):t?$t(s,cn(n,o)):s}else return t?$t(e[o],cn(n,o)):e[o]},set(e,a,o){o=L(o);let i=a===In||a==="value"&&La(e)?n:cn(n,a);if(ts&&!as(i))throw Error(`setting invalid path ${i}`);if(L(I[i])!==o&&_i(ce,i,o))mn(i);return!0}}),Jn=(n,t)=>{let e=typeof t==="function"?t:I[t];if(typeof e!=="function")throw Error(`observe expects a function or path to a function, ${t} is neither`);return ct(n,e)},I=new Proxy(ce,nn("",!1)),mt=new Proxy(ce,nn("",!0)),{document:Un,MutationObserver:Da}=globalThis,he=(n,t)=>{let e=un.get(n);if(e==null)return;for(let a of e){let{binding:o,options:i}=a,{path:s}=a,{toDOM:r}=o;if(r!=null){if(s.startsWith("^")){let d=bn(n);if(d!=null&&d[W]!=null)s=a.path=`${d[W]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))r(n,I[s],i)}}};if(Da!=null)new Da((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Bn)).forEach((a)=>he(a))})})}).observe(Un.body,{subtree:!0,childList:!0});Jn(()=>!0,(n)=>{let t=Array.from(Un.querySelectorAll(Bn));for(let e of t)he(e,n)});var za=(n)=>{let t=n.target.closest(Bn);while(t!=null){let e=un.get(t);for(let a of e){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let r;try{r=s(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let d=I[i];if(d==null)I[i]=r;else{let c=d[W]!=null?d[In]:d,p=r[W]!=null?r[In]:r;if(c!==p)I[i]=p}}}}t=t.parentElement.closest(Bn)}};if(globalThis.document!=null)Un.body.addEventListener("change",za,!0),Un.body.addEventListener("input",za,!0);function z(n,t,e,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[W]===void 0&&a===void 0){let{value:r}=t;o=typeof r==="string"?r:r[W],a=t,delete a.value}else o=typeof t==="string"?t:t[W];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:i}=e;n.classList?.add(Oa);let s=un.get(n);if(s==null)s=[],un.set(n,s);if(s.push({path:o,binding:e,options:a}),i!=null&&!o.startsWith("^"))mn(o);if(a?.filter&&a?.needle)z(n,a.needle,{toDOM(r,d){console.log({needle:d}),r[Zt]?.filter(d)}});return n}var _a=new Set,is=(n)=>{let t=n?.target.closest(xa),e=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let r=i[s];return typeof r==="function"?r.bind(i):r}}}),o=new Set;while(!e&&t!=null){let i=Nn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let r=I[s];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${s}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(xa):null}};function tn(n,t,e){let a=Nn.get(n);if(n.classList.add(Ha),a==null)a={},Nn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!_a.has(t))_a.add(t),Un.body.addEventListener(t,is,!0);return()=>{a[t].delete(e)}}var ss=0;function Gt(){return`custom-elt${(ss++).toString(36)}`}var Aa=0,Xn={};function rs(n,t){let e=Xn[n],a=Fn(t).replace(/:host\b/g,n);Xn[n]=e?e+`
`+a:a}function ls(n){if(Xn[n])document.head.append(m.style({id:n+"-component"},Xn[n]));delete Xn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Fn(n))}static elementCreator(n={}){let t=this;if(t._elementCreator==null){let{tag:e,styleSpec:a}=n,o=n!=null?e:null;if(o==null)if(typeof t.name==="string"&&t.name!==""){if(o=en(t.name),o.startsWith("-"))o=o.slice(1)}else o=Gt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Gt();while(customElements.get(o)!==void 0)o=Gt();if(t._tagName=o,a!==void 0)rs(o,a);window.customElements.define(o,this,n),t._elementCreator=m[o]}return t._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(Xi(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=pn(this[a]);let o=en(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(i){if(typeof t[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),e[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):pn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Aa+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Aa}`,this._value=pn(this.defaultValue)}connectedCallback(){if(ls(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(oe.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){oe.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)Ya(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content(m):this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=m.style(Fn(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Pa(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);Pa(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(pe.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{s[r.name]=r}),o.forEach((r)=>{let d=s[""],c=r instanceof Element?s[r.slot]:d;(c!==void 0?c:d).append(r)})}}this._hydrated=!0}}render(){}}class pe extends b{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Rl=pe.elementCreator({tag:"xin-slot"}),ue=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(I[o]!==void 0)Object.assign(I[o],a[o]);else I[o]=a[o]}let e=bt(()=>{let a={},o=L(I);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);Jn(n,e)},ft="1.0.10";function q(n){return Object.assign(mt,n),mt}function me(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),q(n)}function to(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),me(n);return Object.keys(n).forEach((e)=>{I[e]=n[e]}),I}var ds={};async function be(n,t){let{type:e,styleSpec:a}=await t(n,{Color:y,Component:b,elements:m,svgElements:gt,mathML:no,varDefault:h,vars:l,xin:I,boxed:mt,xinProxy:to,boxedProxy:me,tosi:q,makeComponent:be,bind:z,on:tn,version:ft}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return ds[n]=o,o}var Kt={},cs=(n)=>import(n);class yt extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Kt[a]===void 0)Kt[a]=cs(t).then((o)=>{let i=o[e];return be(n,i)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await Kt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var hs=yt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ge extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(yt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var ps=ge.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var wa={};va(wa,{xrControllersText:()=>Ur,xrControllers:()=>Fr,xinTagList:()=>Bl,xinTag:()=>ui,xinSizer:()=>Tl,xinSelect:()=>Cn,xinSegmented:()=>Sl,xinRating:()=>ul,xinPasswordStrength:()=>pl,xinNotification:()=>ri,xinMenu:()=>br,xinLocalized:()=>Ht,xinForm:()=>qr,xinFloat:()=>Xe,xinField:()=>Wr,xinCarousel:()=>ar,version:()=>ya,updateLocalized:()=>Je,trackDrag:()=>sn,tosijs:()=>Gn,tosiMonth:()=>rl,tosiDialog:()=>zt,tabSelector:()=>ii,svgIcon:()=>Qs,svg2DataUrl:()=>At,styleSheet:()=>Vo,spacer:()=>On,sizeBreak:()=>ba,sideNav:()=>ua,setLocale:()=>lr,scriptTag:()=>kn,richTextWidgets:()=>pi,richText:()=>vl,removeLastMenu:()=>Sn,postNotification:()=>cl,positionFloat:()=>qo,popMenu:()=>U,popFloat:()=>Wo,menu:()=>Ko,markdownViewer:()=>sa,mapBox:()=>ol,makeSorter:()=>Yo,makeExamplesLive:()=>tl,localize:()=>P,localePicker:()=>hr,liveExample:()=>Rt,isBreached:()=>di,initLocalization:()=>cr,icons:()=>f,i18n:()=>E,gamepadText:()=>Yr,gamepadState:()=>oi,findHighestZ:()=>Ot,filterPart:()=>_t,filterBuilder:()=>Or,elastic:()=>fl,editableRect:()=>Lr,dragAndDrop:()=>Qo,digest:()=>li,defineIcons:()=>Zs,dataTable:()=>Cr,createSubMenu:()=>Jo,createMenuItem:()=>Go,createMenuAction:()=>$o,commandButton:()=>X,colorInput:()=>No,codeEditor:()=>Lt,bringToFront:()=>ot,bodymovinPlayer:()=>tr,blockStyle:()=>ca,b3d:()=>nr,availableFilters:()=>ta,abTest:()=>Ks,XinTagList:()=>fa,XinTag:()=>Xt,XinSizer:()=>ga,XinSelect:()=>st,XinSegmented:()=>pa,XinRating:()=>da,XinPasswordStrength:()=>la,XinNotification:()=>jn,XinMenu:()=>Ze,XinLocalized:()=>F,XinForm:()=>it,XinFloat:()=>rn,XinField:()=>Vt,XinCarousel:()=>$e,TosiMonth:()=>ra,TosiDialog:()=>na,TabSelector:()=>oa,SvgIcon:()=>Fe,SizeBreak:()=>ma,SideNav:()=>Vn,RichText:()=>ha,MarkdownViewer:()=>ia,MapBox:()=>xn,LocalePicker:()=>Ge,LiveExample:()=>Hn,FilterPart:()=>ea,FilterBuilder:()=>aa,EditableRect:()=>V,DataTable:()=>Qe,CodeEditor:()=>An,BodymovinPlayer:()=>_n,B3d:()=>Ue,AbTest:()=>zn});function ye(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var fn=ye();function lo(n){fn=n}var nt={exec:()=>null};function k(n,t=""){let e=typeof n=="string"?n:n.source,a={replace:(o,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(D.caret,"$1"),e=e.replace(o,s),a},getRegex:()=>new RegExp(e,t)};return a}var D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},us=/^(?:[ \t]*(?:\n|$))+/,ms=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,bs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,tt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,gs=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,we=/(?:[*+-]|\d{1,9}[.)])/,co=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ho=k(co).replace(/bull/g,we).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),fs=k(co).replace(/bull/g,we).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),ve=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ys=/^[^\n]+/,xe=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ws=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",xe).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),vs=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,we).getRegex(),jt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ke=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,xs=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",ke).replace("tag",jt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),po=k(ve).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),ks=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",po).getRegex(),je={blockquote:ks,code:ms,def:ws,fences:bs,heading:gs,hr:tt,html:xs,lheading:ho,list:vs,newline:us,paragraph:po,table:nt,text:ys},eo=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),js={...je,lheading:fs,table:eo,paragraph:k(ve).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",eo).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex()},Cs={...je,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ke).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:nt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(ve).replace("hr",tt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ho).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ss=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ts=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,uo=/^( {2,}|\\)\n(?!\s*$)/,Es=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ct=/[\p{P}\p{S}]/u,Ce=/[\s\p{P}\p{S}]/u,mo=/[^\s\p{P}\p{S}]/u,Is=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ce).getRegex(),bo=/(?!~)[\p{P}\p{S}]/u,Ps=/(?!~)[\s\p{P}\p{S}]/u,Bs=/(?:[^\s\p{P}\p{S}]|~)/u,Ms=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,go=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ls=k(go,"u").replace(/punct/g,Ct).getRegex(),Ds=k(go,"u").replace(/punct/g,bo).getRegex(),fo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",zs=k(fo,"gu").replace(/notPunctSpace/g,mo).replace(/punctSpace/g,Ce).replace(/punct/g,Ct).getRegex(),_s=k(fo,"gu").replace(/notPunctSpace/g,Bs).replace(/punctSpace/g,Ps).replace(/punct/g,bo).getRegex(),As=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,mo).replace(/punctSpace/g,Ce).replace(/punct/g,Ct).getRegex(),Os=k(/\\(punct)/,"gu").replace(/punct/g,Ct).getRegex(),Hs=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Vs=k(ke).replace("(?:-->|$)","-->").getRegex(),Rs=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Vs).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),vt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Xs=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",vt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),yo=k(/^!?\[(label)\]\[(ref)\]/).replace("label",vt).replace("ref",xe).getRegex(),wo=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",xe).getRegex(),Ns=k("reflink|nolink(?!\\()","g").replace("reflink",yo).replace("nolink",wo).getRegex(),ao=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Se={_backpedal:nt,anyPunctuation:Os,autolink:Hs,blockSkip:Ms,br:uo,code:Ts,del:nt,emStrongLDelim:Ls,emStrongRDelimAst:zs,emStrongRDelimUnd:As,escape:Ss,link:Xs,nolink:wo,punctuation:Is,reflink:yo,reflinkSearch:Ns,tag:Rs,text:Es,url:nt},Ws={...Se,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",vt).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",vt).getRegex()},fe={...Se,emStrongRDelimAst:_s,emStrongLDelim:Ds,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",ao).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",ao).getRegex()},qs={...fe,br:k(uo).replace("{2,}","*").getRegex(),text:k(fe.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},wt={normal:je,gfm:js,pedantic:Cs},Kn={normal:Se,gfm:fe,breaks:qs,pedantic:Ws},Ys={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},oo=(n)=>Ys[n];function Y(n,t){if(t){if(D.escapeTest.test(n))return n.replace(D.escapeReplace,oo)}else if(D.escapeTestNoEncode.test(n))return n.replace(D.escapeReplaceNoEncode,oo);return n}function io(n){try{n=encodeURI(n).replace(D.percentDecode,"%")}catch{return null}return n}function so(n,t){let e=n.replace(D.findPipe,(i,s,r)=>{let d=!1,c=s;for(;--c>=0&&r[c]==="\\";)d=!d;return d?"|":" |"}),a=e.split(D.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(D.slashPipe,"|");return a}function Zn(n,t,e){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let i=n.charAt(a-o-1);if(i===t&&!e)o++;else if(i!==t&&e)o++;else break}return n.slice(0,a-o)}function Fs(n,t){if(n.indexOf(t[1])===-1)return-1;let e=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===t[0])e++;else if(n[a]===t[1]&&(e--,e<0))return a;return e>0?-2:-1}function ro(n,t,e,a,o){let i=t.href,s=t.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let d={type:n[0].charAt(0)==="!"?"image":"link",raw:e,href:i,title:s,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,d}function Us(n,t,e){let a=n.match(e.other.indentCodeCompensation);if(a===null)return t;let o=a[1];return t.split(`
`).map((i)=>{let s=i.match(e.other.beginningSpace);if(s===null)return i;let[r]=s;return r.length>=o.length?i.slice(o.length):i}).join(`
`)}var xt=class{options;rules;lexer;constructor(n){this.options=n||fn}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:Zn(e,`
`)}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let e=t[0],a=Us(e,t[3]||"",this.rules);return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let a=Zn(e,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(e=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:Zn(t[0],`
`)}}blockquote(n){let t=this.rules.block.blockquote.exec(n);if(t){let e=Zn(t[0],`
`).split(`
`),a="",o="",i=[];for(;e.length>0;){let s=!1,r=[],d;for(d=0;d<e.length;d++)if(this.rules.other.blockquoteStart.test(e[d]))r.push(e[d]),s=!0;else if(!s)r.push(e[d]);else break;e=e.slice(d);let c=r.join(`
`),p=c.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");a=a?`${a}
${c}`:c,o=o?`${o}
${p}`:p;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,i,!0),this.lexer.state.top=u,e.length===0)break;let g=i.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let w=g,v=w.raw+`
`+e.join(`
`),S=this.blockquote(v);i[i.length-1]=S,a=a.substring(0,a.length-w.raw.length)+S.raw,o=o.substring(0,o.length-w.text.length)+S.text;break}else if(g?.type==="list"){let w=g,v=w.raw+`
`+e.join(`
`),S=this.list(v);i[i.length-1]=S,a=a.substring(0,a.length-g.raw.length)+S.raw,o=o.substring(0,o.length-w.raw.length)+S.raw,e=v.substring(i.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:a,tokens:i,text:o}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e=t[1].trim(),a=e.length>1,o={type:"list",raw:"",ordered:a,start:a?+e.slice(0,-1):"",loose:!1,items:[]};e=a?`\\d{1,9}\\${e.slice(-1)}`:`\\${e}`,this.options.pedantic&&(e=a?e:"[*+-]");let i=this.rules.other.listItemRegex(e),s=!1;for(;n;){let d=!1,c="",p="";if(!(t=i.exec(n))||this.rules.block.hr.test(n))break;c=t[0],n=n.substring(c.length);let u=t[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,(T)=>" ".repeat(3*T.length)),g=n.split(`
`,1)[0],w=!u.trim(),v=0;if(this.options.pedantic?(v=2,p=u.trimStart()):w?v=t[1].length+1:(v=t[2].search(this.rules.other.nonSpaceChar),v=v>4?1:v,p=u.slice(v),v+=t[1].length),w&&this.rules.other.blankLine.test(g)&&(c+=g+`
`,n=n.substring(g.length+1),d=!0),!d){let T=this.rules.other.nextBulletRegex(v),j=this.rules.other.hrRegex(v),C=this.rules.other.fencesBeginRegex(v),M=this.rules.other.headingBeginRegex(v),Tn=this.rules.other.htmlBeginRegex(v);for(;n;){let Yt=n.split(`
`,1)[0],Rn;if(g=Yt,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Rn=g):Rn=g.replace(this.rules.other.tabCharGlobal,"    "),C.test(g)||M.test(g)||Tn.test(g)||T.test(g)||j.test(g))break;if(Rn.search(this.rules.other.nonSpaceChar)>=v||!g.trim())p+=`
`+Rn.slice(v);else{if(w||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||C.test(u)||M.test(u)||j.test(u))break;p+=`
`+g}!w&&!g.trim()&&(w=!0),c+=Yt+`
`,n=n.substring(Yt.length+1),u=Rn.slice(v)}}o.loose||(s?o.loose=!0:this.rules.other.doubleBlankLine.test(c)&&(s=!0));let S=null,$;this.options.gfm&&(S=this.rules.other.listIsTask.exec(p),S&&($=S[0]!=="[ ] ",p=p.replace(this.rules.other.listReplaceTask,""))),o.items.push({type:"list_item",raw:c,task:!!S,checked:$,loose:!1,text:p,tokens:[]}),o.raw+=c}let r=o.items.at(-1);if(r)r.raw=r.raw.trimEnd(),r.text=r.text.trimEnd();else return;o.raw=o.raw.trimEnd();for(let d=0;d<o.items.length;d++)if(this.lexer.state.top=!1,o.items[d].tokens=this.lexer.blockTokens(o.items[d].text,[]),!o.loose){let c=o.items[d].tokens.filter((u)=>u.type==="space"),p=c.length>0&&c.some((u)=>this.rules.other.anyLine.test(u.raw));o.loose=p}if(o.loose)for(let d=0;d<o.items.length;d++)o.items[d].loose=!0;return o}}html(n){let t=this.rules.block.html.exec(n);if(t)return{type:"html",block:!0,raw:t[0],pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:t[0]}}def(n){let t=this.rules.block.def.exec(n);if(t){let e=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),a=t[2]?t[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",o=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:a,title:o}}}table(n){let t=this.rules.block.table.exec(n);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;let e=so(t[1]),a=t[2].replace(this.rules.other.tableAlignChars,"").split("|"),o=t[3]?.trim()?t[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],i={type:"table",raw:t[0],header:[],align:[],rows:[]};if(e.length===a.length){for(let s of a)this.rules.other.tableAlignRight.test(s)?i.align.push("right"):this.rules.other.tableAlignCenter.test(s)?i.align.push("center"):this.rules.other.tableAlignLeft.test(s)?i.align.push("left"):i.align.push(null);for(let s=0;s<e.length;s++)i.header.push({text:e[s],tokens:this.lexer.inline(e[s]),header:!0,align:i.align[s]});for(let s of o)i.rows.push(so(s,i.header.length).map((r,d)=>({text:r,tokens:this.lexer.inline(r),header:!1,align:i.align[d]})));return i}}lheading(n){let t=this.rules.block.lheading.exec(n);if(t)return{type:"heading",raw:t[0],depth:t[2].charAt(0)==="="?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(n){let t=this.rules.block.paragraph.exec(n);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(n){let t=this.rules.block.text.exec(n);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(n){let t=this.rules.inline.escape.exec(n);if(t)return{type:"escape",raw:t[0],text:t[1]}}tag(n){let t=this.rules.inline.tag.exec(n);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(n){let t=this.rules.inline.link.exec(n);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let i=Zn(e.slice(0,-1),"\\");if((e.length-i.length)%2===0)return}else{let i=Fs(t[2],"()");if(i===-2)return;if(i>-1){let s=(t[0].indexOf("!")===0?5:4)+t[1].length+i;t[2]=t[2].substring(0,i),t[0]=t[0].substring(0,s).trim(),t[3]=""}}let a=t[2],o="";if(this.options.pedantic){let i=this.rules.other.pedanticHrefTitle.exec(a);i&&(a=i[1],o=i[3])}else o=t[3]?t[3].slice(1,-1):"";return a=a.trim(),this.rules.other.startAngleBracket.test(a)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?a=a.slice(1):a=a.slice(1,-1)),ro(t,{href:a&&a.replace(this.rules.inline.anyPunctuation,"$1"),title:o&&o.replace(this.rules.inline.anyPunctuation,"$1")},t[0],this.lexer,this.rules)}}reflink(n,t){let e;if((e=this.rules.inline.reflink.exec(n))||(e=this.rules.inline.nolink.exec(n))){let a=(e[2]||e[1]).replace(this.rules.other.multipleSpaceGlobal," "),o=t[a.toLowerCase()];if(!o){let i=e[0].charAt(0);return{type:"text",raw:i,text:i}}return ro(e,o,e[0],this.lexer,this.rules)}}emStrong(n,t,e=""){let a=this.rules.inline.emStrongLDelim.exec(n);if(!a||a[3]&&e.match(this.rules.other.unicodeAlphaNumeric))return;if(!(a[1]||a[2])||!e||this.rules.inline.punctuation.exec(e)){let o=[...a[0]].length-1,i,s,r=o,d=0,c=a[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*n.length+o);(a=c.exec(t))!=null;){if(i=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!i)continue;if(s=[...i].length,a[3]||a[4]){r+=s;continue}else if((a[5]||a[6])&&o%3&&!((o+s)%3)){d+=s;continue}if(r-=s,r>0)continue;s=Math.min(s,s+r+d);let p=[...a[0]][0].length,u=n.slice(0,o+a.index+p+s);if(Math.min(o,s)%2){let w=u.slice(1,-1);return{type:"em",raw:u,text:w,tokens:this.lexer.inlineTokens(w)}}let g=u.slice(2,-2);return{type:"strong",raw:u,text:g,tokens:this.lexer.inlineTokens(g)}}}}codespan(n){let t=this.rules.inline.code.exec(n);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal," "),a=this.rules.other.nonSpaceChar.test(e),o=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return a&&o&&(e=e.substring(1,e.length-1)),{type:"codespan",raw:t[0],text:e}}}br(n){let t=this.rules.inline.br.exec(n);if(t)return{type:"br",raw:t[0]}}del(n){let t=this.rules.inline.del.exec(n);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(n){let t=this.rules.inline.autolink.exec(n);if(t){let e,a;return t[2]==="@"?(e=t[1],a="mailto:"+e):(e=t[1],a=e),{type:"link",raw:t[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}url(n){let t;if(t=this.rules.inline.url.exec(n)){let e,a;if(t[2]==="@")e=t[0],a="mailto:"+e;else{let o;do o=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??"";while(o!==t[0]);e=t[0],t[1]==="www."?a="http://"+t[0]:a=t[0]}return{type:"link",raw:t[0],text:e,href:a,tokens:[{type:"text",raw:e,text:e}]}}}inlineText(n){let t=this.rules.inline.text.exec(n);if(t){let e=this.lexer.state.inRawBlock;return{type:"text",raw:t[0],text:t[0],escaped:e}}}},A=class n{tokens;options;state;tokenizer;inlineQueue;constructor(t){this.tokens=[],this.tokens.links=Object.create(null),this.options=t||fn,this.options.tokenizer=this.options.tokenizer||new xt,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let e={other:D,block:wt.normal,inline:Kn.normal};this.options.pedantic?(e.block=wt.pedantic,e.inline=Kn.pedantic):this.options.gfm&&(e.block=wt.gfm,this.options.breaks?e.inline=Kn.breaks:e.inline=Kn.gfm),this.tokenizer.rules=e}static get rules(){return{block:wt,inline:Kn}}static lex(t,e){return new n(e).lex(t)}static lexInline(t,e){return new n(e).inlineTokens(t)}lex(t){t=t.replace(D.carriageReturn,`
`),this.blockTokens(t,this.tokens);for(let e=0;e<this.inlineQueue.length;e++){let a=this.inlineQueue[e];this.inlineTokens(a.src,a.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(t,e=[],a=!1){for(this.options.pedantic&&(t=t.replace(D.tabCharGlobal,"    ").replace(D.spaceLine,""));t;){let o;if(this.options.extensions?.block?.some((s)=>(o=s.call({lexer:this},t,e))?(t=t.substring(o.raw.length),e.push(o),!0):!1))continue;if(o=this.tokenizer.space(t)){t=t.substring(o.raw.length);let s=e.at(-1);o.raw.length===1&&s!==void 0?s.raw+=`
...
`)?"":`
`)+o.raw,s.text+=`
`+o.raw,this.inlineQueue.at(-1).src=s.text):this.tokens.links[o.tag]||(this.tokens.links[o.tag]={href:o.href,title:o.title},e.push(o));continue}if(o=this.tokenizer.table(t)){t=t.substring(o.raw.length),e.push(o);continue}if(o=this.tokenizer.lheading(t)){t=t.substring(o.raw.length),e.push(o);continue}let i=t;if(this.options.extensions?.startBlock){let s=1/0,r=t.slice(1),d;this.options.extensions.startBlock.forEach((c)=>{d=c.call({lexer:this},r),typeof d=="number"&&d>=0&&(s=Math.min(s,d))}),s<1/0&&s>=0&&(i=t.substring(0,s+1))}if(this.state.top&&(o=this.tokenizer.paragraph(i))){let s=e.at(-1);a&&s?.type==="paragraph"?(s.raw+=(s.raw.endsWith(`
`)?"":`
`)+o.raw,s.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=s.text):e.push(o),a=i.length!==t.length,t=t.substring(o.raw.length);continue}if(o=this.tokenizer.text(t)){t=t.substring(o.raw.length);let s=e.at(-1);s?.type==="text"?(s.raw+=(s.raw.endsWith(`
`)?"":`
`)+o.raw,s.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=s.text):e.push(o);continue}if(t){let s="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(s);break}else throw Error(s)}}return this.state.top=!0,e}inline(t,e=[]){return this.inlineQueue.push({src:t,tokens:e}),e}inlineTokens(t,e=[]){let a=t,o=null;if(this.tokens.links){let r=Object.keys(this.tokens.links);if(r.length>0)for(;(o=this.tokenizer.rules.inline.reflinkSearch.exec(a))!=null;)r.includes(o[0].slice(o[0].lastIndexOf("[")+1,-1))&&(a=a.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(o=this.tokenizer.rules.inline.anyPunctuation.exec(a))!=null;)a=a.slice(0,o.index)+"++"+a.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;(o=this.tokenizer.rules.inline.blockSkip.exec(a))!=null;)a=a.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);a=this.options.hooks?.emStrongMask?.call({lexer:this},a)??a;let i=!1,s="";for(;t;){i||(s=""),i=!1;let r;if(this.options.extensions?.inline?.some((c)=>(r=c.call({lexer:this},t,e))?(t=t.substring(r.raw.length),e.push(r),!0):!1))continue;if(r=this.tokenizer.escape(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.tag(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.link(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(r.raw.length);let c=e.at(-1);r.type==="text"&&c?.type==="text"?(c.raw+=r.raw,c.text+=r.text):e.push(r);continue}if(r=this.tokenizer.emStrong(t,a,s)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.codespan(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.br(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.del(t)){t=t.substring(r.raw.length),e.push(r);continue}if(r=this.tokenizer.autolink(t)){t=t.substring(r.raw.length),e.push(r);continue}if(!this.state.inLink&&(r=this.tokenizer.url(t))){t=t.substring(r.raw.length),e.push(r);continue}let d=t;if(this.options.extensions?.startInline){let c=1/0,p=t.slice(1),u;this.options.extensions.startInline.forEach((g)=>{u=g.call({lexer:this},p),typeof u=="number"&&u>=0&&(c=Math.min(c,u))}),c<1/0&&c>=0&&(d=t.substring(0,c+1))}if(r=this.tokenizer.inlineText(d)){t=t.substring(r.raw.length),r.raw.slice(-1)!=="_"&&(s=r.raw.slice(-1)),i=!0;let c=e.at(-1);c?.type==="text"?(c.raw+=r.raw,c.text+=r.text):e.push(r);continue}if(t){let c="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw Error(c)}}return e}},kt=class{options;parser;constructor(n){this.options=n||fn}space(n){return""}code({text:n,lang:t,escaped:e}){let a=(t||"").match(D.notSpaceStart)?.[0],o=n.replace(D.endingNewline,"")+`
`;return a?'<pre><code class="language-'+Y(a)+'">'+(e?o:Y(o,!0))+`</code></pre>
`:"<pre><code>"+(e?o:Y(o,!0))+`</code></pre>
`}blockquote({tokens:n}){return`<blockquote>
${this.parser.parse(n)}</blockquote>
`}html({text:n}){return n}def(n){return""}heading({tokens:n,depth:t}){return`<h${t}>${this.parser.parseInline(n)}</h${t}>
`}hr(n){return`<hr>
`}list(n){let{ordered:t,start:e}=n,a="";for(let s=0;s<n.items.length;s++){let r=n.items[s];a+=this.listitem(r)}let o=t?"ol":"ul",i=t&&e!==1?' start="'+e+'"':"";return"<"+o+i+`>
`+a+"</"+o+`>
`}listitem(n){let t="";if(n.task){let e=this.checkbox({checked:!!n.checked});n.loose?n.tokens[0]?.type==="paragraph"?(n.tokens[0].text=e+" "+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type==="text"&&(n.tokens[0].tokens[0].text=e+" "+Y(n.tokens[0].tokens[0].text),n.tokens[0].tokens[0].escaped=!0)):n.tokens.unshift({type:"text",raw:e+" ",text:e+" ",escaped:!0}):t+=e+" "}return t+=this.parser.parse(n.tokens,!!n.loose),`<li>${t}</li>
`}checkbox({checked:n}){return"<input "+(n?'checked="" ':"")+'disabled="" type="checkbox">'}paragraph({tokens:n}){return`<p>${this.parser.parseInline(n)}</p>
`}table(n){let t="",e="";for(let o=0;o<n.header.length;o++)e+=this.tablecell(n.header[o]);t+=this.tablerow({text:e});let a="";for(let o=0;o<n.rows.length;o++){let i=n.rows[o];e="";for(let s=0;s<i.length;s++)e+=this.tablecell(i[s]);a+=this.tablerow({text:e})}return a&&(a=`<tbody>${a}</tbody>`),`<table>
<thead>
`+t+`</thead>
`+a+`</table>
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];$n("demo-style",bi);var ln="tosijs";setTimeout(()=>{let n=y.fromVar(l.brandColor),t=y.fromVar(l.background);console.log(`welcome to %c${ln}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Ll=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Dl=Nt.find((n)=>n.filename===Ll)||Nt[0],{app:B,prefs:_}=q({app:{title:ln,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${ln}#readme`,npmUrl:`https://www.npmjs.com/package/${ln}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${ln}&badge=`,bundleUrl:`https://bundlejs.com/?q=${ln}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${ln}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${ln}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Nt,currentDoc:Dl,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});ue((n)=>{if(n.startsWith("prefs"))return!0;return!1});G.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};G.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:q,img:qt,bindings:G,elements:m,vars:l,touch:mn,Color:y})},1000);var gi=document.querySelector("main"),{h2:zl,div:fi,span:rt,a:Wt,img:qt,header:_l,button:yi,template:Al,input:Ol}=m;z(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});z(document.body,_.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});z(document.body,_.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((t)=>t.filename.xinValue===n)||B.docs[0]});var Hl=bt(()=>{console.time("filter");let n=wi.value.toLocaleLowerCase();B.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),mn(B.docs),console.timeEnd("filter")}),wi=Ol({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Hl});if(gi)gi.append(_l(yi({class:"iconic",style:{color:l.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,t){n.style.display=t?"":"none",n.nextSibling.style.display=t?"":"none"}}},onClick(){let n=document.querySelector(Vn.tagName);n.contentVisible=!n.contentVisible}},f.menu()),rt({style:{flex:"0 0 10px"}}),Wt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${ft}, tosijs-ui ${ya}`},qt({src:"favicon.svg",style:{height:40,marginRight:10}}),zl({bindText:"app.title"})),rt({class:"elastic"}),ba({minWidth:750},rt({style:{marginRight:l.spacing,display:"flex",alignItems:"center",gap:l.spacing50}},Wt({href:B.bundleUrl},qt({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),Wt({href:B.cdnUrl},qt({alt:"jsdelivr",src:B.cdnBadgeUrl}))),rt({slot:"small"})),rt({style:{flex:"0 0 10px"}}),yi({title:"theme",class:"iconic",onClick(n){U({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.xinValue},{icon:"npm",caption:"npm",action:B.npmUrl.xinValue},{icon:"discord",caption:"discord",action:B.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return _.theme.xinValue==="system"},action(){_.theme.xinValue="system"}},{caption:"Dark",checked(){return _.theme.xinValue==="dark"},action(){_.theme.xinValue="dark"}},{caption:"Light",checked(){return _.theme.xinValue==="light"},action(){_.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return _.highContrast.xinValue},action(){_.highContrast.xinValue=!_.highContrast.xinValue}},{caption:"Monochrome",checked(){return _.monochrome.xinValue},action(){_.monochrome.xinValue=!_.monochrome.xinValue}}]}]})}},f.moreVertical())),ua({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Vn.tagName);B.compact.xinValue=n.compact}},wi,fi({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},Al(Wt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=bn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),B.currentDoc=e,n.preventDefault()}}))),fi({style:{position:"relative",overflowY:"scroll",height:"100%"}},sa({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Gn,"tosijs-ui":wa})}}))));

//# debugId=351923B1342224BB64756E2164756E21
