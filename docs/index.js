var Ls=Object.defineProperty;var Ba=(n,e)=>{for(var t in e)Ls(n,t,{get:e[t],enumerable:!0,configurable:!0,set:(a)=>e[t]=()=>a})};var de=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Kn={};Ba(Kn,{xinValue:()=>yn,xinProxy:()=>bo,xinPath:()=>Vs,xin:()=>P,warnDeprecated:()=>Gn,version:()=>ke,vars:()=>d,varDefault:()=>h,validateAgainstConstraints:()=>mo,updates:()=>$s,unobserve:()=>pn,touchElement:()=>wt,touch:()=>en,tosiValue:()=>z,tosiSetValue:()=>zs,tosiPath:()=>K,tosi:()=>U,throttle:()=>Un,svgElements:()=>we,settings:()=>me,on:()=>Ln,observe:()=>xe,mathML:()=>po,makeComponent:()=>jt,invertLuminance:()=>bt,initVars:()=>ii,hotReload:()=>kt,getListItem:()=>fn,getListInstance:()=>vt,getListBinding:()=>ft,getCssVar:()=>oo,elements:()=>m,deprecated:()=>ut,deleteListItem:()=>fi,debounce:()=>ve,css:()=>Yn,boxedProxy:()=>Ct,boxed:()=>fe,blueprintLoader:()=>Ii,blueprint:()=>Ti,bindings:()=>Z,bind:()=>D,StyleSheet:()=>Jn,MoreMath:()=>ti,Component:()=>b,Color:()=>f,BlueprintLoader:()=>St,Blueprint:()=>Ce});function hn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(hn);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=hn(a);else e[t]=a}return e}var Ya="-xin-data",An=`.${Ya}`,$a="-xin-event",Ma=`.${$a}`,X=Symbol.for("xin-path"),un=Symbol.for("xin-value"),Pa="xinObserve",Aa="xinBind",La="xinOn",tt=Symbol("list-binding"),at=Symbol("list-instance"),ot=new Map;function Ds(n,e){let t=ot.get(n);if(t===void 0)t=new Set,ot.set(n,t);t.add(e)}function Os(n){return ot.get(n)}var Da=new Set;function Gn(n,e){if(!Da.has(n))console.warn(e),Da.add(n)}function ut(n,e){let t=!1;return(...a)=>{if(!t)console.warn(e),t=!0;return n(...a)}}var K=(n)=>{return n&&n[X]||void 0};function z(n){if(typeof n==="object"&&n!==null){let e=n[un];return e!==void 0?e:n}return n}function zs(n,e){if(K(n)===void 0)throw Error("tosiSetValue requires a xin or boxed proxy");n[un]=e}var Vs=ut(K,"xinPath is deprecated. Use tosiPath instead."),yn=ut(z,"xinValue is deprecated. Use tosiValue instead."),qn=new WeakMap,gn=new WeakMap,Xn=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=gn.get(n),a=qn.get(n);if(t!=null)gn.set(e,hn(t));if(a!=null)qn.set(e,hn(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(Xn(t));else e.appendChild(t.cloneNode());return e},me={debug:!1,perf:!1},_s=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},Ga=(...n)=>Error(n.map(_s).join(" ")),Rs=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Hs=0,Ns=()=>(parseInt("10000",36)+ ++Hs).toString(36).slice(-5),Ws=()=>Rs()+Ns(),st=Symbol("delete"),Ja=Symbol("new-object"),Ke=Symbol("automatic-index");function Ka(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var J=new WeakMap;function Za(n,e){if(J.get(n)===void 0)J.set(n,{});if(J.get(n)[e]===void 0)J.get(n)[e]={};let t=J.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a[Ke]===void 0)a[Ke]=Ws();t[a[Ke]+""]=o});else n.forEach((a,o)=>{t[mn(a,e)+""]=o});return t}function Fs(n,e){if(J.get(n)===void 0||J.get(n)[e]===void 0)return Za(n,e);else return J.get(n)[e]}function qs(n,e,t){t=t+"";let a=Fs(n,e)[t];if(a===void 0||mn(n[a],e)+""!==t)a=Za(n,e)[t];return a}function Xs(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function Qa(n,e,t,a){let o=e!==""?qs(n,e,t):t;if(a===st)return n.splice(o,1),J.delete(n),Symbol("deleted");else if(a===Ja){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&mn(a,e)+""===t+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function Oa(n){if(!Array.isArray(n))throw Ga("setByPath failed: expected array, found",n)}function za(n){if(n==null||!(n instanceof Object))throw Ga("setByPath failed: expected Object, found",n)}function mn(n,e){let t=Ka(e),a=n,o,s,i,r;for(o=0,s=t.length;a!==void 0&&o<s;o++){let l=t[o];if(Array.isArray(l))for(i=0,r=l.length;a!==void 0&&i<r;i++){let c=l[i];a=a[c]}else if(a.length===0){if(a=a[Number(l.slice(1))],l[0]!=="=")return}else if(l.includes("=")){let[c,...p]=l.split("=");a=Qa(a,c,p.join("="))}else i=parseInt(l,10),a=a[i]}return a}function Us(n,e,t){let a=n;if(e==="")throw Error("setByPath cannot be used to set the root object");let o=Ka(e);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)za(a);else Oa(a);let r=s.slice(0,i),l=s.slice(i+1);if(a=Qa(a,r,l,o.length>0?Ja:t),o.length===0)return!0}else{Oa(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(t!==st){if(a[r]===t)return!1;a[r]=t}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){za(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=Xs(a,i,s.length>0?{}:[]);else{if(t!==st){if(a[i]===t)return!1;a[i]=t}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${e}`)}throw Error(`setByPath(${n}, ${e}, ${t}) failed`)}var Va=Symbol("observer should be removed"),be=[],ge=[],it=!1,rt,lt;function Ys(n,e,t,a){let o=Os(n);if(o===void 0)return[];let s=[];for(let i of o){let r=mn(t,i);if(r!==void 0)s.push(`${n}[${i}=${r}]${a}`)}return s}class no{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw Error("expect callback to be a path or function");be.push(this)}}var $s=async()=>{if(rt===void 0)return;await rt},Gs=()=>{if(me.perf)console.time("xin async update");let n=Array.from(ge);for(let e of n)be.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===Va)return pn(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===Va)pn(t)});if(ge.splice(0),it=!1,typeof lt==="function")lt();if(me.perf)console.timeEnd("xin async update")},en=(n)=>{let e=typeof n==="string"?n:K(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(it===!1)rt=new Promise((t)=>{lt=t}),it=setTimeout(Gs);if(ge.find((t)=>e.startsWith(t))==null)ge.push(e)},Pn=(n,e)=>{return new no(n,e)},pn=(n)=>{let e=be.indexOf(n);if(e>-1)be.splice(e,1);else throw Error("unobserve failed, listener not found")},ye={},dt=null,Js=(n)=>{dt=n},mt=()=>{if(dt===null)throw Error("xin proxy not initialized");return dt},ct=null,pt=null,Ks=(n,e)=>{ct=n,pt=e},ce=()=>{if(ct===null)throw Error("bind not initialized");return ct},pe=()=>{if(pt===null)throw Error("on not initialized");return pt},eo=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},to=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Zs=(n,e)=>{switch(to(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},Qs=(n)=>{switch(to(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:_a}=globalThis,ht=_a!=null?new _a((n)=>{for(let e of n){let t=e.target;eo(t,"resize")}}):{observe(){},unobserve(){}},Ra=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?Xn(a):a)});else if(e instanceof Node)n.append(t?Xn(e):e);else throw Error("expect text content or document node")},ve=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},Un=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...s)=>{if(clearTimeout(t),t=setTimeout(()=>{n(...s),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},Z={value:{toDOM:Zs,fromDOM(n){return Qs(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){ft(n,e,t).update(e)}}};function q(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function ao(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var ni=180/Math.PI,ei=Math.PI/180;function F(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function nn(n,e,t,a=!0){if(a)t=F(0,t,1);return t*(e-n)+n}var ti={RADIANS_TO_DEGREES:ni,DEGREES_TO_RADIANS:ei,clamp:F,lerp:nn};function oo(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var ai=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},ln=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class so{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),s=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Mn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class f{r;g;b;a;static fromVar(n,e=document.body){return f.fromCss(oo(n,e))}static fromCss(n){let e=n;if(Mn instanceof HTMLSpanElement)Mn.style.color="black",Mn.style.color=n,document.body.appendChild(Mn),e=getComputedStyle(Mn).color,Mn.remove();let[t,a,o,s]=e.match(/[\d.]+/g)||["0","0","0","0"],i=e.startsWith("color(srgb")?255:1;return new f(Number(t)*i,Number(a)*i,Number(o)*i,s==null?1:Number(s))}static fromHsl(n,e,t,a=1){let o,s,i;if(e===0)o=s=i=t;else{let l=(g,v,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(v-g)*6*w;if(w<0.5)return v;if(w<0.6666666666666666)return g+(v-g)*(0.6666666666666666-w)*6;return g},c=t<0.5?t*(1+e):t+e-t*e,p=2*t-c,u=(n%360+360)%360/360;o=l(p,c,u+0.3333333333333333),s=l(p,c,u),i=l(p,c,u-0.3333333333333333)}let r=new f(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:e,l:t},r}static black=new f(0,0,0);static white=new f(255,255,255);constructor(n,e,t,a=1){this.r=F(0,n,255),this.g=F(0,e,255),this.b=F(0,t,255),this.a=F(0,a,1)}get inverse(){return new f(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return f.fromHsl(n,e,1-t,this.a)}get opaque(){return this.a===1?this:new f(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?f.black:f.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new so(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new f(n,n,n)}get brightness(){return ai(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+ln(this.r)+ln(this.g)+ln(this.b):"#"+ln(this.r)+ln(this.g)+ln(this.b)+ln(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=F(0,a+n*(1-a),1);return f.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=F(0,a*(1-n),1);return f.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=F(0,t+n*(1-t),1);return f.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=F(0,t*(1-n),1);return f.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return f.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return f.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new f(nn(this.r,n.r,e),nn(this.g,n.g,e),nn(this.b,n.b,e),nn(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return f.fromHsl(t.s===0?a.h:a.s===0?t.h:f.blendHue(t.h,a.h,e),nn(t.s,a.s,e),nn(t.l,a.l,e),nn(this.a,n.a,e))}colorMix(n,e){return f.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}}function Jn(n,e){let t=m.style(Yn(e));t.id=n,document.head.append(t)}var oi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],io=(n,e)=>{if(typeof e==="number"&&!oi.includes(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},si=(n,e,t)=>{if(t===void 0)return"";if(t instanceof f)t=t.html;let a=io(e,t);return`${n}  ${a.prop}: ${a.value};`},ro=(n,e,t="")=>{let a=q(n);if(typeof e==="object"&&!(e instanceof f)){let o=Object.keys(e).map((s)=>ro(s,e[s],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
...
`,n=n.substring(g.length+1),l=!0),!l){let T=this.rules.other.nextBulletRegex(w),j=this.rules.other.hrRegex(w),S=this.rules.other.fencesBeginRegex(w),M=this.rules.other.headingBeginRegex(w),Bn=this.rules.other.htmlBeginRegex(w);for(;n;){let Je=n.split(`
`,1)[0],Wn;if(g=Je,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Wn=g):Wn=g.replace(this.rules.other.tabCharGlobal,"    "),S.test(g)||M.test(g)||Bn.test(g)||T.test(g)||j.test(g))break;if(Wn.search(this.rules.other.nonSpaceChar)>=w||!g.trim())p+=`
`+Wn.slice(w);else{if(v||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||S.test(u)||M.test(u)||j.test(u))break;p+=`
`+g}!v&&!g.trim()&&(v=!0),c+=Je+`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];Jn("demo-style",Es);var rn="tosijs";setTimeout(()=>{let n=f.fromVar(d.brandColor),e=f.fromVar(d.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var Yl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",$l=Ye.find((n)=>n.filename===Yl)||Ye[0],{app:B,prefs:L}=U({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Ye,currentDoc:$l,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});kt((n)=>{if(n.startsWith("prefs"))return!0;return!1});Z.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};Z.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:U,img:Ge,bindings:Z,elements:m,vars:d,touch:en,Color:f})},1000);var Bs=document.querySelector("main"),{h2:Gl,div:Ms,span:le,a:$e,img:Ge,header:Jl,button:Ps,template:Kl,input:Zl}=m;D(document.body,"prefs.theme",{toDOM(n,e){if(e==="system")e=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",e==="dark")}});D(document.body,L.highContrast,{toDOM(n,e){n.classList.toggle("high-contrast",e.valueOf())}});D(document.body,L.monochrome,{toDOM(n,e){n.classList.toggle("monochrome",e.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((e)=>e.filename===n)||B.docs[0]});var Ql=ve(()=>{console.time("filter");let n=As.value.toLocaleLowerCase();B.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),en(B.docs),console.timeEnd("filter")}),As=Zl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Ql});if(Bs)Bs.append(Jl(Ps({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(Nn.tagName);n.contentVisible=!n.contentVisible}},y.menu()),le({style:{flex:"0 0 10px"}}),$e({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${ke}, tosijs-ui ${Ia}`},Ge({src:"favicon.svg",style:{height:40,marginRight:10}}),Gl({bindText:"app.title"})),le({class:"elastic"}),ja({minWidth:750},le({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},$e({href:B.bundleUrl},Ge({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),$e({href:B.cdnUrl},Ge({alt:"jsdelivr",src:B.cdnBadgeUrl}))),le({slot:"small"})),le({style:{flex:"0 0 10px"}}),Ps({title:"theme",class:"iconic",onClick(n){G({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.value},{icon:"npm",caption:"npm",action:B.npmUrl.value},{icon:"discord",caption:"discord",action:B.discordUrl.value},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.value},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return L.theme.value==="system"},action(){L.theme.value="system"}},{caption:"Dark",checked(){return L.theme.value==="dark"},action(){L.theme.value="dark"}},{caption:"Light",checked(){return L.theme.value==="light"},action(){L.theme.value="light"}},null,{caption:"High Contrast",checked(){return L.highContrast.value},action(){L.highContrast.value=!L.highContrast.value}},{caption:"Monochrome",checked(){return L.monochrome.value},action(){L.monochrome.value=!L.monochrome.value}}]}]})}},y.moreVertical())),ka({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Nn.tagName);B.compact.value=n.compact}},As,Ms({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},Kl($e({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=fn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),B.currentDoc=t,n.preventDefault()}}))),Ms({style:{position:"relative",overflowY:"scroll",height:"100%"}},ba({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Kn,"tosijs-ui":Ea})}}))));

//# debugId=7E45C1F211E176B964756E2164756E21
