var Ss=Object.defineProperty;var Ca=(n,t)=>{for(var e in t)Ss(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var rt=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Jn={};Ca(Jn,{xinValue:()=>M,xinProxy:()=>io,xinPath:()=>Mn,xin:()=>L,version:()=>vt,vars:()=>d,varDefault:()=>p,updates:()=>Ts,unobserve:()=>dn,touchElement:()=>be,touch:()=>un,tosi:()=>F,throttle:()=>Fn,svgElements:()=>ft,settings:()=>pt,on:()=>Ln,observe:()=>wt,mathML:()=>ao,makeComponent:()=>we,invertLuminance:()=>ce,initVars:()=>Gs,hotReload:()=>ye,getListItem:()=>mn,getListInstance:()=>me,getListBinding:()=>ue,getCssVar:()=>Ka,elements:()=>m,deleteListItem:()=>ii,debounce:()=>yt,css:()=>Un,boxedProxy:()=>fe,boxed:()=>gt,blueprintLoader:()=>mi,blueprint:()=>ui,bindings:()=>$,bind:()=>O,StyleSheet:()=>Gn,MoreMath:()=>qs,Component:()=>b,Color:()=>f,BlueprintLoader:()=>ve,Blueprint:()=>xt});function cn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(cn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=cn(a);else t[e]=a}return t}var Na="-xin-data",Pn=`.${Na}`,Wa="-xin-event",Sa=`.${Wa}`,q="xinPath",In="xinValue",Ta="xinObserve",Ea="xinBind",Ia="xinOn",Qt=Symbol("list-binding"),ne=Symbol("list-instance"),Mn=(n)=>{return n&&n[q]||void 0};function M(n){if(typeof n==="object"&&n!==null){let t=n[In];return t!==void 0?t:n}return n}var Xn=new WeakMap,pn=new WeakMap,qn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=pn.get(n),a=Xn.get(n);if(e!=null)pn.set(t,cn(e));if(a!=null)Xn.set(t,cn(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(qn(e));else t.appendChild(e.cloneNode());return t},pt={debug:!1,perf:!1},Ba=Symbol("observer should be removed"),ut=[],mt=[],te=!1,ee,ae;class Xa{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw Error("expect callback to be a path or function");ut.push(this)}}var Ts=async()=>{if(ee===void 0)return;await ee},Es=()=>{if(pt.perf)console.time("xin async update");let n=Array.from(mt);for(let t of n)ut.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Ba)return dn(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Ba)dn(e)});if(mt.splice(0),te=!1,typeof ae==="function")ae();if(pt.perf)console.timeEnd("xin async update")},un=(n)=>{let t=typeof n==="string"?n:Mn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(te===!1)ee=new Promise((e)=>{ae=e}),te=setTimeout(Es);if(mt.find((e)=>t.startsWith(e))==null)mt.push(t)},En=(n,t)=>{return new Xa(n,t)},dn=(n)=>{let t=ut.indexOf(n);if(t>-1)ut.splice(t,1);else throw Error("unobserve failed, listener not found")},bt={},oe=null,Is=(n)=>{oe=n},de=()=>{if(oe===null)throw Error("xin proxy not initialized");return oe},se=null,ie=null,Bs=(n,t)=>{se=n,ie=t},lt=()=>{if(se===null)throw Error("bind not initialized");return se},dt=()=>{if(ie===null)throw Error("on not initialized");return ie},qa=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},Fa=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Ps=(n,t)=>{switch(Fa(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},Ms=(n)=>{switch(Fa(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:Pa}=globalThis,re=Pa!=null?new Pa((n)=>{for(let t of n){let e=t.target;qa(e,"resize")}}):{observe(){},unobserve(){}},Ma=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?qn(a):a)});else if(t instanceof Node)n.append(e?qn(t):t);else throw Error("expect text content or document node")},yt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Fn=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...s)=>{if(clearTimeout(e),e=setTimeout(()=>{n(...s),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},Ls=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},Ua=(...n)=>Error(n.map(Ls).join(" ")),Ds=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),As=0,Os=()=>(parseInt("10000",36)+ ++As).toString(36).slice(-5),zs=()=>Ds()+Os(),le=Symbol("delete"),Ya=Symbol("new-object"),Jt=Symbol("automatic-index");function Ga(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var J=new WeakMap;function Ja(n,t){if(J.get(n)===void 0)J.set(n,{});if(J.get(n)[t]===void 0)J.get(n)[t]={};let e=J.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[Jt]===void 0)a[Jt]=zs();e[a[Jt]+""]=o});else n.forEach((a,o)=>{e[Bn(a,t)+""]=o});return e}function _s(n,t){if(J.get(n)===void 0||J.get(n)[t]===void 0)return Ja(n,t);else return J.get(n)[t]}function Rs(n,t,e){e=e+"";let a=_s(n,t)[e];if(a===void 0||Bn(n[a],t)+""!==e)a=Ja(n,t)[e];return a}function Hs(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function $a(n,t,e,a){let o=t!==""?Rs(n,t,e):e;if(a===le)return n.splice(o,1),J.delete(n),Symbol("deleted");else if(a===Ya){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Bn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function La(n){if(!Array.isArray(n))throw Ua("setByPath failed: expected array, found",n)}function Da(n){if(n==null||!(n instanceof Object))throw Ua("setByPath failed: expected Object, found",n)}function Bn(n,t){let e=Ga(t),a=n,o,s,i,r;for(o=0,s=e.length;a!==void 0&&o<s;o++){let l=e[o];if(Array.isArray(l))for(i=0,r=l.length;a!==void 0&&i<r;i++){let c=l[i];a=a[c]}else if(a.length===0){if(a=a[Number(l.slice(1))],l[0]!=="=")return}else if(l.includes("=")){let[c,...h]=l.split("=");a=$a(a,c,h.join("="))}else i=parseInt(l,10),a=a[i]}return a}function Vs(n,t,e){let a=n;if(t==="")throw Error("setByPath cannot be used to set the root object");let o=Ga(t);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)Da(a);else La(a);let r=s.slice(0,i),l=s.slice(i+1);if(a=$a(a,r,l,o.length>0?Ya:e),o.length===0)return!0}else{La(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(e!==le){if(a[r]===e)return!1;a[r]=e}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){Da(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=Hs(a,i,s.length>0?{}:[]);else{if(e!==le){if(a[i]===e)return!1;a[i]=e}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${t}`)}throw Error(`setByPath(${n}, ${t}, ${e}) failed`)}var $={value:{toDOM:Ps,fromDOM(n){return Ms(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){ue(n,t,e).update(t)}}};function Q(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function Ns(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var Ws=180/Math.PI,Xs=Math.PI/180;function X(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function Z(n,t,e,a=!0){if(a)e=X(0,e,1);return e*(t-n)+n}var qs={RADIANS_TO_DEGREES:Ws,DEGREES_TO_RADIANS:Xs,clamp:X,lerp:Z};function Ka(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var Fs=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},sn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class Za{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),s=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Tn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class f{r;g;b;a;static fromVar(n,t=document.body){return f.fromCss(Ka(n,t))}static fromCss(n){let t=n;if(Tn instanceof HTMLSpanElement)Tn.style.color="black",Tn.style.color=n,document.body.appendChild(Tn),t=getComputedStyle(Tn).color,Tn.remove();let[e,a,o,s]=t.match(/[\d.]+/g)||["0","0","0","0"],i=t.startsWith("color(srgb")?255:1;return new f(Number(e)*i,Number(a)*i,Number(o)*i,s==null?1:Number(s))}static fromHsl(n,t,e,a=1){let o,s,i;if(t===0)o=s=i=e;else{let l=(g,v,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(v-g)*6*w;if(w<0.5)return v;if(w<0.6666666666666666)return g+(v-g)*(0.6666666666666666-w)*6;return g},c=e<0.5?e*(1+t):e+t-e*t,h=2*e-c,u=(n%360+360)%360/360;o=l(h,c,u+0.3333333333333333),s=l(h,c,u),i=l(h,c,u-0.3333333333333333)}let r=new f(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:t,l:e},r}static black=new f(0,0,0);static white=new f(255,255,255);constructor(n,t,e,a=1){this.r=X(0,n,255),this.g=X(0,t,255),this.b=X(0,e,255),this.a=X(0,a,1)}get inverse(){return new f(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return f.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new f(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?f.black:f.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new Za(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new f(n,n,n)}get brightness(){return Fs(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+sn(this.r)+sn(this.g)+sn(this.b):"#"+sn(this.r)+sn(this.g)+sn(this.b)+sn(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a+n*(1-a),1);return f.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a*(1-n),1);return f.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e+n*(1-e),1);return f.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e*(1-n),1);return f.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return f.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return f.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new f(Z(this.r,n.r,t),Z(this.g,n.g,t),Z(this.b,n.b,t),Z(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return f.fromHsl(e.s===0?a.h:a.s===0?e.h:f.blendHue(e.h,a.h,t),Z(e.s,a.s,t),Z(e.l,a.l,t),Z(this.a,n.a,t))}colorMix(n,t){return f.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function Gn(n,t){let e=m.style(Un(t));e.id=n,document.head.append(e)}var Us=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Qa=(n,t)=>{if(typeof t==="number"&&!Us.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Ys=(n,t,e)=>{if(e===void 0)return"";if(e instanceof f)e=e.html;let a=Qa(t,e);return`${n}  ${a.prop}: ${a.value};`},no=(n,t,e="")=>{let a=Q(n);if(typeof t==="object"&&!(t instanceof f)){let o=Object.keys(t).map((s)=>no(s,t[s],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Ys(e,a,t)},Un=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((s)=>no(s,a[s])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},Gs=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=Q(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},ce=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof f)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=f.fromCss(a).inverseLuminance}return t},p=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+Q(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),d=new Proxy({},{get(n,t){if(t==="default")return p;if(n[t]==null){t=Q(t);let[,e,,a,o,s]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],i=`--${e}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(s){case"b":{let l=f.fromVar(i);n[t]=r>0?l.brighten(r).rgba:l.darken(-r).rgba}break;case"s":{let l=f.fromVar(i);n[t]=r>0?l.saturate(r).rgba:l.desaturate(-r).rgba}break;case"h":{let l=f.fromVar(i);n[t]=l.rotate(r*100).rgba}break;case"o":{let l=f.fromVar(i);n[t]=l.opacity(r).rgba}break;case"":n[t]=`calc(var(${i}) * ${r})`;break;default:throw console.error(s),Error(`Unrecognized method ${s} for css variable ${i}`)}}else n[t]=`var(${i})`}return n[t]}}),Js="http://www.w3.org/1998/Math/MathML",$s="http://www.w3.org/2000/svg",ct={},to=(n,t,e)=>{let a=Qa(Q(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},Ks=(n)=>{return{toDOM(t,e){to(t,n,e)}}},eo=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Mn(e[a]))O(n,e[a],Ks(a));else to(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=Q(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},Zs=(n)=>{return{toDOM(t,e){eo(t,n,e)}}},Qs=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();Ln(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?$[e.binding]:e.binding)!==void 0&&e.value!==void 0)O(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=$[a];if(o!==void 0)O(n,e,o);else throw Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Mn(e))O(n,e,Zs(t));else eo(n,t,e)},he=(n,...t)=>{if(ct[n]===void 0){let[o,s]=n.split("|");if(s===void 0)ct[n]=globalThis.document.createElement(o);else ct[n]=globalThis.document.createElementNS(s,o)}let e=ct[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(Mn(o))e.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let s=a[o];Qs(e,o,s)}return e},pe=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},m=new Proxy({fragment:pe},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>he(t,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),ft=new Proxy({fragment:pe},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>he(`${t}|${$s}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),ao=new Proxy({fragment:pe},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>he(`${t}|${Js}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),ni=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],ti=!0,ei=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ai=(n)=>ei.test(n),rn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},oo={};function $t(n,t){if(n!==null&&(typeof n==="object"||typeof n==="function"))return n;return new Proxy(oo,hn(t,!0))}var ht=()=>new Proxy({},hn("^",!0)),Aa=!1;function ln(){if(!Aa)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),Aa=!0}var Oa=(n)=>{return n===oo},hn=(n,t)=>({get(e,a){if(Oa(e)){let r=()=>Bn(bt,n);switch(a){case"path":return n;case"value":return r();case"valueOf":case"toJSON":return()=>r();case Symbol.toPrimitive:return(l)=>{let c=r();if(l==="number")return Number(c);if(l==="string")return String(c);return c};case"toString":return()=>String(r());case"observe":return(l)=>{let c=En(n,l);return()=>dn(c)};case"on":return(l,c)=>dt()(l,c,r());case"bind":return(l,c,h)=>{lt()(l,n,c,h)};case"binding":return(l)=>({bind:{value:n,binding:l}});case"listBinding":return(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,ht()))];case In:case"tosiValue":return ln(),r();case q:case"tosiPath":return ln(),n;case Ta:case"tosiObserve":return ln(),(l)=>{let c=En(n,l);return()=>dn(c)};case Ia:case"tosiOn":return ln(),(l,c)=>dt()(l,c,r());case Ea:case"tosiBind":return ln(),(l,c,h)=>{lt()(l,n,c,h)};case"tosiBinding":return ln(),(l)=>({bind:{value:n,binding:l}});case"tosiListBinding":return ln(),(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,ht()))]}if(typeof a==="string"&&/^\d+$/.test(a)){let l=r();if(typeof l==="string")return l[parseInt(a,10)]}if(a==="length"){let l=r();if(typeof l==="string")return l.length}return}if(t&&!(a in e))switch(a){case"path":return n;case"value":return e.valueOf?e.valueOf():e;case"valueOf":case"toJSON":return()=>e.valueOf?e.valueOf():e;case"observe":return(r)=>{let l=En(n,r);return()=>dn(l)};case"on":return(r,l)=>dt()(r,l,M(e));case"bind":return(r,l,c)=>{lt()(r,n,l,c)};case"binding":return(r)=>({bind:{value:n,binding:r}});case"listBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,ht()))]}switch(a){case q:case"tosiPath":return n;case In:case"tosiValue":return e.valueOf?e.valueOf():e;case Ta:case"tosiObserve":return(r)=>{let l=En(n,r);return()=>dn(l)};case Ia:case"tosiOn":return(r,l)=>dt()(r,l,M(e));case Ea:case"tosiBind":return(r,l,c)=>{lt()(r,n,l,c)};case"tosiBinding":return(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,ht()))]}if(typeof a==="symbol")return e[a];let o=Object.getOwnPropertyDescriptor(e,a);if(o&&!o.configurable&&!o.writable&&"value"in o)return o.value;let s=a,i=s.match(/^([^.[]+)\.(.+)$/)??s.match(/^([^\]]+)(\[.+)/)??s.match(/^(\[[^\]]+\])\.(.+)$/)??s.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,r,l]=i,c=rn(n,r),h=Bn(e,r);return h!==null&&typeof h==="object"?new Proxy(h,hn(c,t))[l]:h}if(s.startsWith("[")&&s.endsWith("]"))s=s.substring(1,s.length-1);if(!Array.isArray(e)&&e[s]!==void 0||Array.isArray(e)&&s.includes("=")){let r;if(s.includes("=")){let[l,c]=s.split("=");r=e.find((h)=>`${Bn(h,l)}`===c)}else r=e[s];if(r instanceof Object){let l=rn(n,s);return new Proxy(r instanceof Function?r.bind(e):r,hn(l,t))}else return t?$t(r,rn(n,s)):r}else if(Array.isArray(e)){let r=e[s];return typeof r==="function"?(...l)=>{let c=l.map((u)=>M(u)),h=r.apply(e,c);if(ni.includes(s))un(n);return h}:typeof r==="object"?new Proxy(r,hn(rn(n,s),t)):t?$t(r,rn(n,s)):r}else return t?$t(e[s],rn(n,s)):e[s]},set(e,a,o){o=M(o);let s=a===In||a==="value"&&(Oa(e)||t)?n:rn(n,a);if(ti&&!ai(s))throw Error(`setting invalid path ${s}`);if(M(L[s])!==o&&Vs(bt,s,o))un(s);return!0}}),wt=(n,t)=>{let e=typeof t==="function"?t:L[t];if(typeof e!=="function")throw Error(`observe expects a function or path to a function, ${t} is neither`);return En(n,e)},L=new Proxy(bt,hn("",!1));Is(L);var gt=new Proxy(bt,hn("",!0)),oi=16,si=100;function za(n,t){let e=Array.from(n.querySelectorAll(Pn));if(n.matches(Pn))e.unshift(n);for(let a of e){let o=pn.get(a);for(let s of o){if(s.path.startsWith("^"))s.path=`${t}${s.path.substring(1)}`;if(s.binding.toDOM!=null)s.binding.toDOM(a,L[s.path])}}}class so{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=qn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)if(re.observe(this.boundElement),this._update=Fn(()=>{this.update(this.array,!0)},oi),this.boundElement.addEventListener("resize",this._update),e.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this.array;if(t!==void 0)a=a.filter((l)=>l[t]!==!0);if(e!==void 0)a=a.filter((l)=>l[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,s=a.length-1,i=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let l=this.boundElement.offsetWidth,c=n.scrollContainer==="window",h,u;if(c){h=window.innerHeight;let z=this.boundElement.getBoundingClientRect();u=Math.max(0,-z.top)}else h=this.boundElement.offsetHeight,u=this.boundElement.scrollTop;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(l/n.width)):1;let g=Math.ceil(h/n.height)+(n.rowChunkSize||1),v=Math.ceil(a.length/n.visibleColumns),w=n.visibleColumns*g,j=Math.floor(u/n.height);if(j>v-g+1)j=Math.max(0,v-g+1);if(n.rowChunkSize)j-=j%n.rowChunkSize;o=j*n.visibleColumns,s=o+w-1,i=j*n.height,r=Math.max((v-g)*n.height-i,0)}return{items:a,firstItem:o,lastItem:s,topBuffer:i,bottomBuffer:r}}needle;filter=Fn((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},si);update(n,t){if(n==null)n=[];this.array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Mn(n),s=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",s.items.length===0);let i=this._previousSlice,{firstItem:r,lastItem:l,topBuffer:c,bottomBuffer:h}=s;if(e===void 0&&a===void 0&&t===!0&&i!=null&&r===i.firstItem&&l===i.lastItem)return;this._previousSlice=s;let u=0,g=0,v=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let C=T[ne];if(C==null)T.remove();else{let S=s.items.indexOf(C);if(S<r||S>l)T.remove(),this.itemToElement.delete(C),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(h)+"px";let w=[],{idPath:j}=this.options;for(let T=r;T<=l;T++){let C=s.items[T];if(C===void 0)continue;let S=this.itemToElement.get(M(C));if(S==null){if(v++,S=qn(this.template),typeof C==="object")this.itemToElement.set(M(C),S),S[ne]=M(C);if(this.boundElement.insertBefore(S,this.listBottom),j!=null){let P=C[j],Sn=`${o}[${j}=${P}]`;za(S,Sn)}else{let P=`${o}[${T}]`;za(S,P)}}w.push(S)}let z=null;for(let T of w){if(T.previousElementSibling!==z)if(g++,z?.nextElementSibling!=null)this.boundElement.insertBefore(T,z.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);z=T}if(pt.perf)console.log(o,"updated",{removed:u,created:v,moved:g})}}var ue=(n,t,e)=>{let a=n[Qt];if(t&&a===void 0)a=new so(n,t,e),n[Qt]=a;return a},me=(n)=>{let t;while(!(t=n[ne])&&n&&n.parentElement)n=n.parentElement;return t?{element:n,item:t}:void 0},mn=(n)=>{let t=me(n);return t?t.item:void 0},ii=(n)=>{let t=me(n);if(!t)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let e=ue(t.element.parentElement);if(!e.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,e),!1;let a=e.array.indexOf(t.item);if(a>-1)return e.array.splice(a,1),!0;return!1},{document:Yn,MutationObserver:_a}=globalThis,be=(n,t)=>{let e=pn.get(n);if(e==null)return;for(let a of e){let{binding:o,options:s}=a,{path:i}=a,{toDOM:r}=o;if(r!=null){if(i.startsWith("^")){let l=mn(n);if(l!=null&&l[q]!=null)i=a.path=`${l[q]}${i.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${i}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${i}`)}if(t==null||i.startsWith(t))r(n,de()[i],s)}}};if(_a!=null)new _a((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Pn)).forEach((a)=>be(a))})})}).observe(Yn.body,{subtree:!0,childList:!0});En(()=>!0,(n)=>{let t=Array.from(Yn.querySelectorAll(Pn));for(let e of t)be(e,n)});var Ra=(n)=>{let t=n.target?.closest(Pn);while(t!=null){let e=pn.get(t);for(let a of e){let{binding:o,path:s}=a,{fromDOM:i}=o;if(i!=null){let r;try{r=i(t,a.options)}catch(l){throw console.error("Cannot get value from",t,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let l=de(),c=l[s];if(c==null)l[s]=r;else{let h=c[q]!=null?c[In]:c,u=r[q]!=null?r[In]:r;if(h!==u)l[s]=u}}}}t=t.parentElement.closest(Pn)}};if(globalThis.document!=null)Yn.body.addEventListener("change",Ra,!0),Yn.body.addEventListener("input",Ra,!0);function O(n,t,e,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[q]===void 0&&a===void 0){let{value:r}=t;o=typeof r==="string"?r:r[q],a=t,delete a.value}else o=typeof t==="string"?t:t[q];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:s}=e;n.classList?.add(Na);let i=pn.get(n);if(i==null)i=[],pn.set(n,i);if(i.push({path:o,binding:e,options:a}),s!=null&&!o.startsWith("^"))un(o);if(a?.filter&&a?.needle)O(n,a.needle,{toDOM(r,l){console.log({needle:l}),r[Qt]?.filter(l)}});return n}var Ha=new Set,ri=(n)=>{let t=n?.target?.closest(Sa),e=!1,a=new Proxy(n,{get(s,i){if(i==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let r=s[i];return typeof r==="function"?r.bind(s):r}}}),o=new Set;while(!e&&t!=null){let s=Xn.get(t)[n.type]||o;for(let i of s){if(typeof i==="function")i(a);else{let r=de()[i];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${i}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(Sa):null}};function Ln(n,t,e){let a=Xn.get(n);if(n.classList.add(Wa),a==null)a={},Xn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!Ha.has(t))Ha.add(t),Yn.body.addEventListener(t,ri,!0);return()=>{a[t].delete(e)}}Bs(O,Ln);var li=0;function Kt(){return`custom-elt${(li++).toString(36)}`}var Va=0,Wn={};function di(n,t){let e=Wn[n],a=Un(t).replace(/:host\b/g,n);Wn[n]=e?e+`
`+a:a}function ci(n){if(Wn[n])document.head.append(m.style({id:n+"-component"},Wn[n]));delete Wn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Un(n))}static elementCreator(n={}){let t=this;if(t._elementCreator==null){let{tag:e,styleSpec:a}=n,o=n!=null?e:null;if(o==null)if(typeof t.name==="string"&&t.name!==""){if(o=Q(t.name),o.startsWith("-"))o=o.slice(1)}else o=Kt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Kt();while(customElements.get(o)!==void 0)o=Kt();if(t._tagName=o,a!==void 0)di(o,a);window.customElements.define(o,this,n),t._elementCreator=m[o]}return t._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((s)=>{o=!!(s.attributeName&&n.includes(Ns(s.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=cn(this[a]);let o=Q(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(s){if(typeof t[a]==="boolean"){if(s!==this[a]){if(s)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(s!==parseFloat(this[a]))this.setAttribute(o,s),this.queueRender()}else if(typeof s==="object"||`${s}`!==`${this[a]}`){if(s===null||s===void 0||typeof s==="object")this.removeAttribute(o);else this.setAttribute(o,s);this.queueRender(),e[a]=s}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):cn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Va+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Va}`,this._value=cn(this.defaultValue)}connectedCallback(){if(ci(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(re.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){re.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)qa(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content(m):this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=m.style(Un(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Ma(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);Ma(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let s=Array.from(this.querySelectorAll("slot"));if(s.length>0)s.forEach(ge.replaceSlot);if(o.length>0){let i={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{i[r.name]=r}),o.forEach((r)=>{let l=i[""],c=r instanceof Element?i[r.slot]:l;(c!==void 0?c:l).append(r)})}}this._hydrated=!0}}render(){}}class ge extends b{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Wl=ge.elementCreator({tag:"xin-slot"}),ye=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(L[o]!==void 0)Object.assign(L[o],a[o]);else L[o]=a[o]}let e=yt(()=>{let a={},o=M(L);for(let s of Object.keys(o).filter(n))a[s]=o[s];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);wt(n,e)},vt="1.1.2";function F(n){return Object.assign(gt,n),gt}function fe(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),F(n)}function io(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),fe(n);return Object.keys(n).forEach((e)=>{L[e]=n[e]}),L}var hi={};async function we(n,t){let{type:e,styleSpec:a}=await t(n,{Color:f,Component:b,elements:m,svgElements:ft,mathML:ao,varDefault:p,vars:d,xin:L,boxed:gt,xinProxy:io,boxedProxy:fe,tosi:F,makeComponent:we,bind:O,on:Ln,version:vt}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return hi[n]=o,o}var Zt={},pi=(n)=>import(n);class xt extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Zt[a]===void 0)Zt[a]=pi(t).then((o)=>{let s=o[e];return we(n,s)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await Zt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var ui=xt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ve extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(xt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var mi=ve.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var ja={};Ca(ja,{xrControllersText:()=>Jr,xrControllers:()=>Gr,xinTagList:()=>Ll,xinTag:()=>fs,xinSizer:()=>Il,xinSelect:()=>jn,xinSegmented:()=>El,xinRating:()=>bl,xinPasswordStrength:()=>ml,xinNotification:()=>ps,xinMenu:()=>yr,xinLocalized:()=>Nt,xinForm:()=>Ur,xinFloat:()=>Fe,xinField:()=>Fr,xinCarousel:()=>sr,version:()=>ka,updateLocalized:()=>Qe,trackDrag:()=>en,tosijs:()=>Jn,tosiMonth:()=>dl,tosiDialog:()=>_t,tabSelector:()=>cs,svgIcon:()=>tr,svg2DataUrl:()=>Ht,styleSheet:()=>qo,spacer:()=>Rn,sizeBreak:()=>wa,sideNav:()=>ya,setLocale:()=>cr,scriptTag:()=>xn,richTextWidgets:()=>ys,richText:()=>kl,removeLastMenu:()=>Cn,postNotification:()=>pl,positionFloat:()=>Jo,popMenu:()=>G,popFloat:()=>Go,menu:()=>es,markdownViewer:()=>ca,mapBox:()=>il,makeSorter:()=>$o,makeExamplesLive:()=>al,localize:()=>I,localePicker:()=>ur,liveExample:()=>Xt,isBreached:()=>ms,initLocalization:()=>pr,icons:()=>y,i18n:()=>E,gamepadText:()=>Yr,gamepadState:()=>ds,findHighestZ:()=>Vt,filterPart:()=>Rt,filterBuilder:()=>Hr,elastic:()=>wl,editableRect:()=>Ar,dragAndDrop:()=>os,digest:()=>us,defineIcons:()=>nr,dataTable:()=>Tr,createSubMenu:()=>ns,createMenuItem:()=>ts,createMenuAction:()=>Qo,commandButton:()=>W,colorInput:()=>Yo,codeEditor:()=>Ot,bringToFront:()=>at,bodymovinPlayer:()=>ar,blockStyle:()=>ma,b3d:()=>er,availableFilters:()=>sa,abTest:()=>Qi,XinTagList:()=>xa,XinTag:()=>qt,XinSizer:()=>va,XinSelect:()=>st,XinSegmented:()=>ga,XinRating:()=>ua,XinPasswordStrength:()=>pa,XinNotification:()=>kn,XinMenu:()=>ea,XinLocalized:()=>Y,XinForm:()=>ot,XinFloat:()=>an,XinField:()=>Wt,XinCarousel:()=>Ze,TosiMonth:()=>ha,TosiDialog:()=>oa,TabSelector:()=>la,SvgIcon:()=>$e,SizeBreak:()=>fa,SideNav:()=>Vn,RichText:()=>ba,MarkdownViewer:()=>da,MapBox:()=>vn,LocalePicker:()=>na,LiveExample:()=>Hn,FilterPart:()=>ia,FilterBuilder:()=>ra,EditableRect:()=>V,DataTable:()=>aa,CodeEditor:()=>_n,BodymovinPlayer:()=>zn,B3d:()=>Ke,AbTest:()=>On});function ke(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var gn=ke();function mo(n){gn=n}var Qn={exec:()=>null};function k(n,t=""){let e=typeof n=="string"?n:n.source,a={replace:(o,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(D.caret,"$1"),e=e.replace(o,i),a},getRegex:()=>new RegExp(e,t)};return a}var D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},bi=/^(?:[ \t]*(?:\n|$))+/,gi=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,yi=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,nt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,fi=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,je=/(?:[*+-]|\d{1,9}[.)])/,bo=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,go=k(bo).replace(/bull/g,je).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),wi=k(bo).replace(/bull/g,je).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ce=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,vi=/^[^\n]+/,Se=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,xi=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Se).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),ki=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,je).getRegex(),Tt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Te=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,ji=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Te).replace("tag",Tt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),yo=k(Ce).replace("hr",nt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Tt).getRegex(),Ci=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",yo).getRegex(),Ee={blockquote:Ci,code:gi,def:xi,fences:yi,heading:fi,hr:nt,html:ji,lheading:go,list:ki,newline:bi,paragraph:yo,table:Qn,text:vi},ro=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",nt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Tt).getRegex(),Si={...Ee,lheading:wi,table:ro,paragraph:k(Ce).replace("hr",nt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ro).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Tt).getRegex()},Ti={...Ee,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Te).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Qn,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Ce).replace("hr",nt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",go).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ei=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ii=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,fo=/^( {2,}|\\)\n(?!\s*$)/,Bi=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Et=/[\p{P}\p{S}]/u,Ie=/[\s\p{P}\p{S}]/u,wo=/[^\s\p{P}\p{S}]/u,Pi=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ie).getRegex(),vo=/(?!~)[\p{P}\p{S}]/u,Mi=/(?!~)[\s\p{P}\p{S}]/u,Li=/(?:[^\s\p{P}\p{S}]|~)/u,Di=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,xo=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Ai=k(xo,"u").replace(/punct/g,Et).getRegex(),Oi=k(xo,"u").replace(/punct/g,vo).getRegex(),ko="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",zi=k(ko,"gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Ie).replace(/punct/g,Et).getRegex(),_i=k(ko,"gu").replace(/notPunctSpace/g,Li).replace(/punctSpace/g,Mi).replace(/punct/g,vo).getRegex(),Ri=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Ie).replace(/punct/g,Et).getRegex(),Hi=k(/\\(punct)/,"gu").replace(/punct/g,Et).getRegex(),Vi=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ni=k(Te).replace("(?:-->|$)","-->").getRegex(),Wi=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ni).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),jt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Xi=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",jt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),jo=k(/^!?\[(label)\]\[(ref)\]/).replace("label",jt).replace("ref",Se).getRegex(),Co=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Se).getRegex(),qi=k("reflink|nolink(?!\\()","g").replace("reflink",jo).replace("nolink",Co).getRegex(),lo=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Be={_backpedal:Qn,anyPunctuation:Hi,autolink:Vi,blockSkip:Di,br:fo,code:Ii,del:Qn,emStrongLDelim:Ai,emStrongRDelimAst:zi,emStrongRDelimUnd:Ri,escape:Ei,link:Xi,nolink:Co,punctuation:Pi,reflink:jo,reflinkSearch:qi,tag:Wi,text:Bi,url:Qn},Fi={...Be,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",jt).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",jt).getRegex()},xe={...Be,emStrongRDelimAst:_i,emStrongLDelim:Oi,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",lo).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",lo).getRegex()},Ui={...xe,br:k(fo).replace("{2,}","*").getRegex(),text:k(xe.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},kt={normal:Ee,gfm:Si,pedantic:Ti},$n={normal:Be,gfm:xe,breaks:Ui,pedantic:Fi},Yi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},co=(n)=>Yi[n];function U(n,t){if(t){if(D.escapeTest.test(n))return n.replace(D.escapeReplace,co)}else if(D.escapeTestNoEncode.test(n))return n.replace(D.escapeReplaceNoEncode,co);return n}function ho(n){try{n=encodeURI(n).replace(D.percentDecode,"%")}catch{return null}return n}function po(n,t){let e=n.replace(D.findPipe,(s,i,r)=>{let l=!1,c=i;for(;--c>=0&&r[c]==="\\";)l=!l;return l?"|":" |"}),a=e.split(D.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(D.slashPipe,"|");return a}function Kn(n,t,e){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let s=n.charAt(a-o-1);if(s===t&&!e)o++;else if(s!==t&&e)o++;else break}return n.slice(0,a-o)}function Gi(n,t){if(n.indexOf(t[1])===-1)return-1;let e=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===t[0])e++;else if(n[a]===t[1]&&(e--,e<0))return a;return e>0?-2:-1}function uo(n,t,e,a,o){let s=t.href,i=t.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:i,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,l}function Ji(n,t,e){let a=n.match(e.other.indentCodeCompensation);if(a===null)return t;let o=a[1];return t.split(`
`).map((s)=>{let i=s.match(e.other.beginningSpace);if(i===null)return s;let[r]=i;return r.length>=o.length?s.slice(o.length):s}).join(`
`)}var Ct=class{options;rules;lexer;constructor(n){this.options=n||gn}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:Kn(e,`
`)}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let e=t[0],a=Ji(e,t[3]||"",this.rules);return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let a=Kn(e,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(e=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:Kn(t[0],`
...
`+a+"</"+o+`>
`}listitem(n){let t="";if(n.task){let e=this.checkbox({checked:!!n.checked});n.loose?n.tokens[0]?.type==="paragraph"?(n.tokens[0].text=e+" "+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type==="text"&&(n.tokens[0].tokens[0].text=e+" "+U(n.tokens[0].tokens[0].text),n.tokens[0].tokens[0].escaped=!0)):n.tokens.unshift({type:"text",raw:e+" ",text:e+" ",escaped:!0}):t+=e+" "}return t+=this.parser.parse(n.tokens,!!n.loose),`<li>${t}</li>
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];Gn("demo-style",vs);var on="tosijs";setTimeout(()=>{let n=f.fromVar(d.brandColor),t=f.fromVar(d.background);console.log(`welcome to %c${on}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Al=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Ol=Ft.find((n)=>n.filename===Al)||Ft[0],{app:B,prefs:A}=F({app:{title:on,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${on}#readme`,npmUrl:`https://www.npmjs.com/package/${on}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${on}&badge=`,bundleUrl:`https://bundlejs.com/?q=${on}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${on}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${on}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Ft,currentDoc:Ol,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});ye((n)=>{if(n.startsWith("prefs"))return!0;return!1});$.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};$.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:F,img:Yt,bindings:$,elements:m,vars:d,touch:un,Color:f})},1000);var xs=document.querySelector("main"),{h2:zl,div:ks,span:it,a:Ut,img:Yt,header:_l,button:js,template:Rl,input:Hl}=m;O(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});O(document.body,A.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});O(document.body,A.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((t)=>t.filename.xinValue===n)||B.docs[0]});var Vl=yt(()=>{console.time("filter");let n=Cs.value.toLocaleLowerCase();B.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),un(B.docs),console.timeEnd("filter")}),Cs=Hl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Vl});if(xs)xs.append(_l(js({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,t){n.style.display=t?"":"none",n.nextSibling.style.display=t?"":"none"}}},onClick(){let n=document.querySelector(Vn.tagName);n.contentVisible=!n.contentVisible}},y.menu()),it({style:{flex:"0 0 10px"}}),Ut({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${vt}, tosijs-ui ${ka}`},Yt({src:"favicon.svg",style:{height:40,marginRight:10}}),zl({bindText:"app.title"})),it({class:"elastic"}),wa({minWidth:750},it({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},Ut({href:B.bundleUrl},Yt({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),Ut({href:B.cdnUrl},Yt({alt:"jsdelivr",src:B.cdnBadgeUrl}))),it({slot:"small"})),it({style:{flex:"0 0 10px"}}),js({title:"theme",class:"iconic",onClick(n){G({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.xinValue},{icon:"npm",caption:"npm",action:B.npmUrl.xinValue},{icon:"discord",caption:"discord",action:B.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return A.theme.xinValue==="system"},action(){A.theme.xinValue="system"}},{caption:"Dark",checked(){return A.theme.xinValue==="dark"},action(){A.theme.xinValue="dark"}},{caption:"Light",checked(){return A.theme.xinValue==="light"},action(){A.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return A.highContrast.xinValue},action(){A.highContrast.xinValue=!A.highContrast.xinValue}},{caption:"Monochrome",checked(){return A.monochrome.xinValue},action(){A.monochrome.xinValue=!A.monochrome.xinValue}}]}]})}},y.moreVertical())),ya({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Vn.tagName);B.compact.xinValue=n.compact}},Cs,ks({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},Rl(Ut({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=mn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),B.currentDoc=e,n.preventDefault()}}))),ks({style:{position:"relative",overflowY:"scroll",height:"100%"}},ca({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Jn,"tosijs-ui":ja})}}))));

//# debugId=7BB3A85D9C488DA964756E2164756E21
