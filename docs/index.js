...
`,1)[0].replace(this.rules.other.listReplaceTabs,(S)=>" ".repeat(3*S.length)),y=n.split(`
...
`,n=n.substring(y.length+1),l=!0),!l){let S=this.rules.other.nextBulletRegex(g),j=this.rules.other.hrRegex(g),z=this.rules.other.fencesBeginRegex(g),I=this.rules.other.headingBeginRegex(g),tn=this.rules.other.htmlBeginRegex(g);for(;n;){let W=n.split(`
`,1)[0],on;if(y=W,this.options.pedantic?(y=y.replace(this.rules.other.listReplaceNesting,"  "),on=y):on=y.replace(this.rules.other.tabCharGlobal,"    "),z.test(y)||I.test(y)||tn.test(y)||S.test(y)||j.test(y))break;if(on.search(this.rules.other.nonSpaceChar)>=g||!y.trim())c+=`
`+on.slice(g);else{if(w||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||z.test(p)||I.test(p)||j.test(p))break;c+=`
`+y}!w&&!y.trim()&&(w=!0),h+=W+`
`,n=n.substring(W.length+1),p=on.slice(g)}}o.loose||(a?o.loose=!0:this.rules.other.doubleBlankLine.test(h)&&(a=!0));let k=null,B;this.options.gfm&&(k=this.rules.other.listIsTask.exec(c),k&&(B=k[0]!=="[ ] ",c=c.replace(this.rules.other.listReplaceTask,""))),o.items.push({type:"list_item",raw:h,task:!!k,checked:B,loose:!1,text:c,tokens:[]}),o.raw+=h}let r=o.items.at(-1);if(r)r.raw=r.raw.trimEnd(),r.text=r.text.trimEnd();else return;o.raw=o.raw.trimEnd();for(let l=0;l<o.items.length;l++)if(this.lexer.state.top=!1,o.items[l].tokens=this.lexer.blockTokens(o.items[l].text,[]),!o.loose){let h=o.items[l].tokens.filter((p)=>p.type==="space"),c=h.length>0&&h.some((p)=>this.rules.other.anyLine.test(p.raw));o.loose=c}if(o.loose)for(let l=0;l<o.items.length;l++)o.items[l].loose=!0;return o}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),i=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",o=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:i,title:o}}}table(n){let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=Xa(e[1]),i=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),o=e[3]?.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],s={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===i.length){for(let a of i)this.rules.other.tableAlignRight.test(a)?s.align.push("right"):this.rules.other.tableAlignCenter.test(a)?s.align.push("center"):this.rules.other.tableAlignLeft.test(a)?s.align.push("left"):s.align.push(null);for(let a=0;a<t.length;a++)s.header.push({text:t[a],tokens:this.lexer.inline(t[a]),header:!0,align:s.align[a]});for(let a of o)s.rows.push(Xa(a,s.header.length).map((r,l)=>({text:r,tokens:this.lexer.inline(r),header:!1,align:s.align[l]})));return s}}lheading(n){let e=this.rules.block.lheading.exec(n);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(n){let e=this.rules.block.paragraph.exec(n);if(e){let t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(n){let e=this.rules.block.text.exec(n);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(n){let e=this.rules.inline.escape.exec(n);if(e)return{type:"escape",raw:e[0],text:e[1]}}tag(n){let e=this.rules.inline.tag.exec(n);if(e)return!this.lexer.state.inLink&&this.rules.other.startATag.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(n){let e=this.rules.inline.link.exec(n);if(e){let t=e[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(t)){if(!this.rules.other.endAngleBracket.test(t))return;let s=$e(t.slice(0,-1),"\\");if((t.length-s.length)%2===0)return}else{let s=id(e[2],"()");if(s===-2)return;if(s>-1){let a=(e[0].indexOf("!")===0?5:4)+e[1].length+s;e[2]=e[2].substring(0,s),e[0]=e[0].substring(0,a).trim(),e[3]=""}}let i=e[2],o="";if(this.options.pedantic){let s=this.rules.other.pedanticHrefTitle.exec(i);s&&(i=s[1],o=s[3])}else o=e[3]?e[3].slice(1,-1):"";return i=i.trim(),this.rules.other.startAngleBracket.test(i)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(t)?i=i.slice(1):i=i.slice(1,-1)),Fa(e,{href:i&&i.replace(this.rules.inline.anyPunctuation,"$1"),title:o&&o.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer,this.rules)}}reflink(n,e){let t;if((t=this.rules.inline.reflink.exec(n))||(t=this.rules.inline.nolink.exec(n))){let i=(t[2]||t[1]).replace(this.rules.other.multipleSpaceGlobal," "),o=e[i.toLowerCase()];if(!o){let s=t[0].charAt(0);return{type:"text",raw:s,text:s}}return Fa(t,o,t[0],this.lexer,this.rules)}}emStrong(n,e,t=""){let i=this.rules.inline.emStrongLDelim.exec(n);if(!i||i[3]&&t.match(this.rules.other.unicodeAlphaNumeric))return;if(!(i[1]||i[2])||!t||this.rules.inline.punctuation.exec(t)){let o=[...i[0]].length-1,s,a,r=o,l=0,h=i[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(h.lastIndex=0,e=e.slice(-1*n.length+o);(i=h.exec(e))!=null;){if(s=i[1]||i[2]||i[3]||i[4]||i[5]||i[6],!s)continue;if(a=[...s].length,i[3]||i[4]){r+=a;continue}else if((i[5]||i[6])&&o%3&&!((o+a)%3)){l+=a;continue}if(r-=a,r>0)continue;a=Math.min(a,a+r+l);let c=[...i[0]][0].length,p=n.slice(0,o+i.index+c+a);if(Math.min(o,a)%2){let w=p.slice(1,-1);return{type:"em",raw:p,text:w,tokens:this.lexer.inlineTokens(w)}}let y=p.slice(2,-2);return{type:"strong",raw:p,text:y,tokens:this.lexer.inlineTokens(y)}}}}codespan(n){let e=this.rules.inline.code.exec(n);if(e){let t=e[2].replace(this.rules.other.newLineCharGlobal," "),i=this.rules.other.nonSpaceChar.test(t),o=this.rules.other.startingSpaceChar.test(t)&&this.rules.other.endingSpaceChar.test(t);return i&&o&&(t=t.substring(1,t.length-1)),{type:"codespan",raw:e[0],text:t}}}br(n){let e=this.rules.inline.br.exec(n);if(e)return{type:"br",raw:e[0]}}del(n){let e=this.rules.inline.del.exec(n);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(n){let e=this.rules.inline.autolink.exec(n);if(e){let t,i;return e[2]==="@"?(t=e[1],i="mailto:"+t):(t=e[1],i=t),{type:"link",raw:e[0],text:t,href:i,tokens:[{type:"text",raw:t,text:t}]}}}url(n){let e;if(e=this.rules.inline.url.exec(n)){let t,i;if(e[2]==="@")t=e[0],i="mailto:"+t;else{let o;do o=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])?.[0]??"";while(o!==e[0]);t=e[0],e[1]==="www."?i="http://"+e[0]:i=e[0]}return{type:"link",raw:e[0],text:t,href:i,tokens:[{type:"text",raw:t,text:t}]}}}inlineText(n){let e=this.rules.inline.text.exec(n);if(e){let t=this.lexer.state.inRawBlock;return{type:"text",raw:e[0],text:e[0],escaped:t}}}},yn=class n{tokens;options;state;tokenizer;inlineQueue;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||En,this.options.tokenizer=this.options.tokenizer||new Xt,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:M,block:Ut.normal,inline:Qe.normal};this.options.pedantic?(t.block=Ut.pedantic,t.inline=Qe.pedantic):this.options.gfm&&(t.block=Ut.gfm,this.options.breaks?t.inline=Qe.breaks:t.inline=Qe.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ut,inline:Qe}}static lex(e,t){return new n(t).lex(e)}static lexInline(e,t){return new n(t).inlineTokens(e)}lex(e){e=e.replace(M.carriageReturn,`
`),this.blockTokens(e,this.tokens);for(let t=0;t<this.inlineQueue.length;t++){let i=this.inlineQueue[t];this.inlineTokens(i.src,i.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(e,t=[],i=!1){for(this.options.pedantic&&(e=e.replace(M.tabCharGlobal,"    ").replace(M.spaceLine,""));e;){let o;if(this.options.extensions?.block?.some((a)=>(o=a.call({lexer:this},e,t))?(e=e.substring(o.raw.length),t.push(o),!0):!1))continue;if(o=this.tokenizer.space(e)){e=e.substring(o.raw.length);let a=t.at(-1);o.raw.length===1&&a!==void 0?a.raw+=`
...
`)?"":`
`)+o.raw,a.text+=`
`+o.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):t.push(o);continue}if(e){let a="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw Error(a)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){let i=e,o=null;if(this.tokens.links){let l=Object.keys(this.tokens.links);if(l.length>0)for(;(o=this.tokenizer.rules.inline.reflinkSearch.exec(i))!=null;)l.includes(o[0].slice(o[0].lastIndexOf("[")+1,-1))&&(i=i.slice(0,o.index)+"["+"a".repeat(o[0].length-2)+"]"+i.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(o=this.tokenizer.rules.inline.anyPunctuation.exec(i))!=null;)i=i.slice(0,o.index)+"++"+i.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let s;for(;(o=this.tokenizer.rules.inline.blockSkip.exec(i))!=null;)s=o[2]?o[2].length:0,i=i.slice(0,o.index+s)+"["+"a".repeat(o[0].length-s-2)+"]"+i.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);i=this.options.hooks?.emStrongMask?.call({lexer:this},i)??i;let a=!1,r="";for(;e;){a||(r=""),a=!1;let l;if(this.options.extensions?.inline?.some((c)=>(l=c.call({lexer:this},e,t))?(e=e.substring(l.raw.length),t.push(l),!0):!1))continue;if(l=this.tokenizer.escape(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.tag(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.link(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(l.raw.length);let c=t.at(-1);l.type==="text"&&c?.type==="text"?(c.raw+=l.raw,c.text+=l.text):t.push(l);continue}if(l=this.tokenizer.emStrong(e,i,r)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.codespan(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.br(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.del(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.autolink(e)){e=e.substring(l.raw.length),t.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(e))){e=e.substring(l.raw.length),t.push(l);continue}let h=e;if(this.options.extensions?.startInline){let c=1/0,p=e.slice(1),y;this.options.extensions.startInline.forEach((w)=>{y=w.call({lexer:this},p),typeof y=="number"&&y>=0&&(c=Math.min(c,y))}),c<1/0&&c>=0&&(h=e.substring(0,c+1))}if(l=this.tokenizer.inlineText(h)){e=e.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(r=l.raw.slice(-1)),a=!0;let c=t.at(-1);c?.type==="text"?(c.raw+=l.raw,c.text+=l.text):t.push(l);continue}if(e){let c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw Error(c)}}return t}},Ft=class{options;parser;constructor(n){this.options=n||En}space(n){return""}code({text:n,lang:e,escaped:t}){let i=(e||"").match(M.notSpaceStart)?.[0],o=n.replace(M.endingNewline,"")+`
`;return i?'<pre><code class="language-'+zn(i)+'">'+(t?o:zn(o,!0))+`</code></pre>
`:"<pre><code>"+(t?o:zn(o,!0))+`</code></pre>
...
`+i+"</"+o+`>
`}listitem(n){let e="";if(n.task){let t=this.checkbox({checked:!!n.checked});n.loose?n.tokens[0]?.type==="paragraph"?(n.tokens[0].text=t+" "+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type==="text"&&(n.tokens[0].tokens[0].text=t+" "+zn(n.tokens[0].tokens[0].text),n.tokens[0].tokens[0].escaped=!0)):n.tokens.unshift({type:"text",raw:t+" ",text:t+" ",escaped:!0}):e+=t+" "}return e+=this.parser.parse(n.tokens,!!n.loose),`<li>${e}</li>
...
`}strong({tokens:n}){return`<strong>${this.parser.parseInline(n)}</strong>`}em({tokens:n}){return`<em>${this.parser.parseInline(n)}</em>`}codespan({text:n}){return`<code>${zn(n,!0)}</code>`}br(n){return"<br>"}del({tokens:n}){return`<del>${this.parser.parseInline(n)}</del>`}link({href:n,title:e,tokens:t}){let i=this.parser.parseInline(t),o=Ra(n);if(o===null)return i;n=o;let s='<a href="'+n+'"';return e&&(s+=' title="'+zn(e)+'"'),s+=">"+i+"</a>",s}image({href:n,title:e,text:t,tokens:i}){i&&(t=this.parser.parseInline(i,this.parser.textRenderer));let o=Ra(n);if(o===null)return zn(t);n=o;let s=`<img src="${n}" alt="${t}"`;return e&&(s+=` title="${zn(e)}"`),s+=">",s}text(n){return"tokens"in n&&n.tokens?this.parser.parseInline(n.tokens):("escaped"in n)&&n.escaped?n.text:zn(n.text)}},To=class{strong({text:n}){return n}em({text:n}){return n}codespan({text:n}){return n}del({text:n}){return n}html({text:n}){return n}text({text:n}){return n}link({text:n}){return""+n}image({text:n}){return""+n}br(){return""}},mn=class n{options;renderer;textRenderer;constructor(e){this.options=e||En,this.options.renderer=this.options.renderer||new Ft,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new To}static parse(e,t){return new n(t).parse(e)}static parseInline(e,t){return new n(t).parseInline(e)}parse(e,t=!0){let i="";for(let o=0;o<e.length;o++){let s=e[o];if(this.options.extensions?.renderers?.[s.type]){let r=s,l=this.options.extensions.renderers[r.type].call({parser:this},r);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(r.type)){i+=l||"";continue}}let a=s;switch(a.type){case"space":{i+=this.renderer.space(a);continue}case"hr":{i+=this.renderer.hr(a);continue}case"heading":{i+=this.renderer.heading(a);continue}case"code":{i+=this.renderer.code(a);continue}case"table":{i+=this.renderer.table(a);continue}case"blockquote":{i+=this.renderer.blockquote(a);continue}case"list":{i+=this.renderer.list(a);continue}case"html":{i+=this.renderer.html(a);continue}case"def":{i+=this.renderer.def(a);continue}case"paragraph":{i+=this.renderer.paragraph(a);continue}case"text":{let r=a,l=this.renderer.text(r);for(;o+1<e.length&&e[o+1].type==="text";)r=e[++o],l+=`
`+this.renderer.text(r);t?i+=this.renderer.paragraph({type:"paragraph",raw:l,text:l,tokens:[{type:"text",raw:l,text:l,escaped:!0}]}):i+=l;continue}default:{let r='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(r),"";throw Error(r)}}}return i}parseInline(e,t=this.renderer){let i="";for(let o=0;o<e.length;o++){let s=e[o];if(this.options.extensions?.renderers?.[s.type]){let r=this.options.extensions.renderers[s.type].call({parser:this},s);if(r!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){i+=r||"";continue}}let a=s;switch(a.type){case"escape":{i+=t.text(a);break}case"html":{i+=t.html(a);break}case"link":{i+=t.link(a);break}case"image":{i+=t.image(a);break}case"strong":{i+=t.strong(a);break}case"em":{i+=t.em(a);break}case"codespan":{i+=t.codespan(a);break}case"br":{i+=t.br(a);break}case"del":{i+=t.del(a);break}case"text":{i+=t.text(a);break}default:{let r='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(r),"";throw Error(r)}}}return i}},He=class{options;block;constructor(n){this.options=n||En}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}emStrongMask(n){return n}provideLexer(){return this.block?yn.lex:yn.lexInline}provideParser(){return this.block?mn.parse:mn.parseInline}},sd=class{defaults=jo();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=mn;Renderer=Ft;TextRenderer=To;Lexer=yn;Tokenizer=Xt;Hooks=He;constructor(...n){this.use(...n)}walkTokens(n,e){let t=[];for(let i of n)switch(t=t.concat(e.call(this,i)),i.type){case"table":{let o=i;for(let s of o.header)t=t.concat(this.walkTokens(s.tokens,e));for(let s of o.rows)for(let a of s)t=t.concat(this.walkTokens(a.tokens,e));break}case"list":{let o=i;t=t.concat(this.walkTokens(o.items,e));break}default:{let o=i;this.defaults.extensions?.childTokens?.[o.type]?this.defaults.extensions.childTokens[o.type].forEach((s)=>{let a=o[s].flat(1/0);t=t.concat(this.walkTokens(a,e))}):o.tokens&&(t=t.concat(this.walkTokens(o.tokens,e)))}}return t}use(...n){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach((t)=>{let i={...t};if(i.async=this.defaults.async||i.async||!1,t.extensions&&(t.extensions.forEach((o)=>{if(!o.name)throw Error("extension name required");if("renderer"in o){let s=e.renderers[o.name];s?e.renderers[o.name]=function(...a){let r=o.renderer.apply(this,a);return r===!1&&(r=s.apply(this,a)),r}:e.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw Error("extension level must be 'block' or 'inline'");let s=e[o.level];s?s.unshift(o.tokenizer):e[o.level]=[o.tokenizer],o.start&&(o.level==="block"?e.startBlock?e.startBlock.push(o.start):e.startBlock=[o.start]:o.level==="inline"&&(e.startInline?e.startInline.push(o.start):e.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(e.childTokens[o.name]=o.childTokens)}),i.extensions=e),t.renderer){let o=this.defaults.renderer||new Ft(this.defaults);for(let s in t.renderer){if(!(s in o))throw Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let a=s,r=t.renderer[a],l=o[a];o[a]=(...h)=>{let c=r.apply(o,h);return c===!1&&(c=l.apply(o,h)),c||""}}i.renderer=o}if(t.tokenizer){let o=this.defaults.tokenizer||new Xt(this.defaults);for(let s in t.tokenizer){if(!(s in o))throw Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let a=s,r=t.tokenizer[a],l=o[a];o[a]=(...h)=>{let c=r.apply(o,h);return c===!1&&(c=l.apply(o,h)),c}}i.tokenizer=o}if(t.hooks){let o=this.defaults.hooks||new He;for(let s in t.hooks){if(!(s in o))throw Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let a=s,r=t.hooks[a],l=o[a];He.passThroughHooks.has(s)?o[a]=(h)=>{if(this.defaults.async&&He.passThroughHooksRespectAsync.has(s))return(async()=>{let p=await r.call(o,h);return l.call(o,p)})();let c=r.call(o,h);return l.call(o,c)}:o[a]=(...h)=>{if(this.defaults.async)return(async()=>{let p=await r.apply(o,h);return p===!1&&(p=await l.apply(o,h)),p})();let c=r.apply(o,h);return c===!1&&(c=l.apply(o,h)),c}}i.hooks=o}if(t.walkTokens){let o=this.defaults.walkTokens,s=t.walkTokens;i.walkTokens=function(a){let r=[];return r.push(s.call(this,a)),o&&(r=r.concat(o.call(this,a))),r}}this.defaults={...this.defaults,...i}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return yn.lex(n,e??this.defaults)}parser(n,e){return mn.parse(n,e??this.defaults)}parseMarkdown(n){return(e,t)=>{let i={...t},o={...this.defaults,...i},s=this.onError(!!o.silent,!!o.async);if(this.defaults.async===!0&&i.async===!1)return s(Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return s(Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return s(Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(o.hooks&&(o.hooks.options=o,o.hooks.block=n),o.async)return(async()=>{let a=o.hooks?await o.hooks.preprocess(e):e,r=await(o.hooks?await o.hooks.provideLexer():n?yn.lex:yn.lexInline)(a,o),l=o.hooks?await o.hooks.processAllTokens(r):r;o.walkTokens&&await Promise.all(this.walkTokens(l,o.walkTokens));let h=await(o.hooks?await o.hooks.provideParser():n?mn.parse:mn.parseInline)(l,o);return o.hooks?await o.hooks.postprocess(h):h})().catch(s);try{o.hooks&&(e=o.hooks.preprocess(e));let a=(o.hooks?o.hooks.provideLexer():n?yn.lex:yn.lexInline)(e,o);o.hooks&&(a=o.hooks.processAllTokens(a)),o.walkTokens&&this.walkTokens(a,o.walkTokens);let r=(o.hooks?o.hooks.provideParser():n?mn.parse:mn.parseInline)(a,o);return o.hooks&&(r=o.hooks.postprocess(r)),r}catch(a){return s(a)}}}onError(n,e){return(t)=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){let i="<p>An error occurred:</p><pre>"+zn(t.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(t);throw t}}},Ln=new sd;function P(n,e){return Ln.parse(n,e)}P.options=P.setOptions=function(n){return Ln.setOptions(n),P.defaults=Ln.defaults,Wa(P.defaults),P};P.getDefaults=jo;P.defaults=En;P.use=function(...n){return Ln.use(...n),P.defaults=Ln.defaults,Wa(P.defaults),P};P.walkTokens=function(n,e){return Ln.walkTokens(n,e)};P.parseInline=Ln.parseInline;P.Parser=mn;P.parser=mn.parse;P.Renderer=Ft;P.TextRenderer=To;P.Lexer=yn;P.lexer=yn.lex;P.Tokenizer=Xt;P.Hooks=He;P.parse=P;var{options:ap,setOptions:lp,use:rp,walkTokens:dp,parseInline:hp}=P;var cp=mn.parse,pp=yn.lex;function Ea(n,e){if(e==null)e="";else if(typeof e!=="string")e=String(e);return e.replace(/\{\{([^}]+)\}\}/g,(t,i)=>{let o=F[`${n}${i.startsWith("[")?i:"."+i}`];return o===void 0?t:Ea(n,String(o))})}class Gt extends f{static preferredTagName="tosi-md";static initAttributes={src:"",elements:!1};context={};value="";content=null;options={};connectedCallback(){if(super.connectedCallback(),this.src!=="")(async()=>{let n=await fetch(this.src);this.value=await n.text()})();else if(this.value==="")if(this.elements)this.value=this.innerHTML;else this.value=this.textContent!=null?this.textContent:""}didRender=()=>{};render(){super.render(),F[this.instanceId]=typeof this.context==="string"?JSON.parse(this.context):this.context;let n=Ea(this.instanceId,this.value);if(this.elements){let e=n.split(`
`).reduce((t,i)=>{if(i.startsWith("<")||t.length===0)t.push(i);else{let o=t[t.length-1];if(!o.startsWith("<")||!o.endsWith(">"))t[t.length-1]+=`
`+i;else t.push(i)}return t},[]);this.innerHTML=e.map((t)=>t.startsWith("<")&&t.endsWith(">")?t:P(t,this.options)).join("")}else this.innerHTML=P(n,this.options);this.didRender()}}var ad=Gt,fe=Gt.elementCreator(),Vo=fe,ld=fe;var{div:ne,slot:nl,span:rd,button:dd}=x;class Kt extends f{static preferredTagName="tosi-tabs";static initAttributes={localized:!1};value=0;makeTab(n,e,t){let i=e.getAttribute("name"),o=e.querySelector('template[role="tab"]')?.content.cloneNode(!0)||(this.localized?Sn(i):rd(i));return ne(o,{part:"tab",tabindex:0,role:"tab",ariaControls:t},e.hasAttribute("data-close")?dd({title:"close",class:"close"},m.x()):{})}static shadowStyleSpec={":host":{"--tosi-tabs-selected-color":"var(--xin-tabs-selected-color, var(--tosi-accent, currentColor))","--tosi-tabs-bar-color":"var(--xin-tabs-bar-color, #ccc)","--tosi-tabs-bar-height":"var(--xin-tabs-bar-height, 2px)",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden",boxShadow:"none !important"},slot:{position:"relative",display:"block",flex:"1",overflow:"hidden",overflowY:"auto"},'slot[name="after-tabs"]':{flex:"0 0 auto"},"::slotted([hidden])":{display:"none !important"},":host::part(tabpanel)":{display:"flex",flexDirection:"column",overflowX:"auto"},":host::part(tabrow)":{display:"flex"},":host .tabs":{display:"flex",userSelect:"none",whiteSpace:"nowrap"},":host .tabs > div":{padding:`${d.spacing50} ${d.spacing}`,cursor:"default",display:"flex",alignItems:"baseline"},':host .tabs > [aria-selected="true"]':{"--text-color":d.tosiTabsSelectedColor,color:d.textColor},":host .elastic":{flex:"1"},":host .border":{background:d.tosiTabsBarColor},":host .border > .selected":{content:" ",width:0,height:d.tosiTabsBarHeight,background:d.tosiTabsSelectedColor,transition:"ease-out 0.2s"},":host button.close":{border:0,background:"transparent",textAlign:"center",marginLeft:d.spacing50,padding:0},":host button.close > svg":{height:"12px"}};onCloseTab=null;content=[ne({role:"tabpanel",part:"tabpanel"},ne({part:"tabrow"},ne({class:"tabs",part:"tabs"}),ne({class:"elastic"}),nl({name:"after-tabs"})),ne({class:"border"},ne({class:"selected",part:"selected"}))),nl()];addTabBody(n,e=!1){if(!n.hasAttribute("name"))throw console.error("element has no name attribute",n),Error("element has no name attribute");if(this.append(n),this.setupTabs(),e)this.value=this.bodies.length-1;this.queueRender()}removeTabBody(n){n.remove(),this.setupTabs(),this.queueRender()}keyTab=(n)=>{let{tabs:e}=this.parts,t=[...e.children].indexOf(n.target);switch(n.key){case"ArrowLeft":this.value=(t+Number(e.children.length)-1)%e.children.length,e.children[this.value].focus(),n.preventDefault();break;case"ArrowRight":this.value=(t+1)%e.children.length,e.children[this.value].focus(),n.preventDefault();break;case" ":this.pickTab(n),n.preventDefault();break;default:}};get bodies(){return[...this.children].filter((n)=>n.hasAttribute("name"))}pickTab=(n)=>{let{tabs:e}=this.parts,t=n.target,i=t.closest("button.close")!==null,o=t.closest(".tabs > div"),s=[...e.children].indexOf(o);if(i){let a=this.bodies[s];if(!this.onCloseTab||this.onCloseTab(a)!==!1)this.removeTabBody(this.bodies[s])}else if(s>-1)this.value=s};setupTabs=()=>{let{tabs:n}=this.parts,e=[...this.children].filter((t)=>!t.hasAttribute("slot")&&t.hasAttribute("name"));if(n.textContent="",this.value>=e.length)this.value=e.length-1;for(let t in e){let i=e[t],o=`${this.instanceId}-${t}`;i.id=o;let s=this.makeTab(this,i,o);n.append(s)}};connectedCallback(){super.connectedCallback();let{tabs:n}=this.parts;n.addEventListener("click",this.pickTab),n.addEventListener("keydown",this.keyTab),this.setupTabs(),Bn.allInstances.add(this)}disconnectedCallback(){super.disconnectedCallback(),Bn.allInstances.delete(this)}localeChanged=()=>{this.queueRender()};onResize(){this.queueRender()}render(){let{tabs:n,selected:e}=this.parts,t=this.bodies;for(let i=0;i<t.length;i++){let o=t[i],s=n.children[i];if(this.value===Number(i))s.setAttribute("aria-selected","true"),e.style.marginLeft=`${s.offsetLeft-n.offsetLeft}px`,e.style.width=`${s.offsetWidth}px`,o.toggleAttribute("hidden",!1);else s.toggleAttribute("aria-selected",!1),o.toggleAttribute("hidden",!0)}}}var hd=Kt,Je=Kt.elementCreator(),cd=Je,pd=Je;var Le=(async()=>{}).constructor;function Fn(n,e){let t=n;for(let i of e)t=t.replace(new RegExp(`import \\{([^}]*)\\} from '${i}'`,"g"),(o,s)=>{return`const { ${s.replace(/\s+/g," ").trim()} } = ${i.replace(/-/g,"")}`});return t}async function el(n,e,t){let i=Fn(n,Object.keys(e)),o=t(i,{transforms:["typescript"]}).code,s=Object.keys(e).map((l)=>l.replace(/-/g,"")),a=Object.values(e);await new Le(...s,o)(...a)}var ud=(n,e)=>{if(e.transforms.includes("typescript"))throw Error('TypeScript examples require the "sucrase" package. Install it with: npm install sucrase');return{code:n}},yd="https://cdn.jsdelivr.net/npm/sucrase@3.35.0/+esm";async function Qt(){try{let{transform:n}=await import("sucrase");return n}catch{}try{let{transform:n}=await import(yd);return n}catch{return console.warn("sucrase not available — TypeScript examples will not work. "+"Install with: npm install sucrase"),ud}}var $t="live-example-payload";function tl(n,e,t){return t!==""?`${n}-${t}`:`${n}-${e}`}function qo(n,e){try{localStorage.setItem(n,JSON.stringify(e))}catch(t){console.warn("live-example: failed to write to localStorage",t)}}function md(n){if(n===null)return null;try{return JSON.parse(n)}catch{return null}}function il(n,e,t,i,o){let s=location.href.split("?")[0]+`?${n}=${e}`;qo(t,{remoteKey:i,sentAt:Date.now(),...o}),window.open(s)}var gd=typeof BroadcastChannel<"u";class Ee{storageKey;remoteKey;lastUpdate=0;interval;channel;listening=!1;onReceive;constructor(n,e,t){this.storageKey=n,this.remoteKey=e,this.onReceive=t}handlePayload=(n)=>{if(n.sentAt<=this.lastUpdate)return;if(n.remoteKey!==this.remoteKey)return;this.lastUpdate=n.sentAt,this.onReceive(n)};handleMessage=(n)=>{let e=n.data;if(e)this.handlePayload(e)};handlePoll=()=>{let n=null;try{n=localStorage.getItem(this.storageKey)}catch{return}let e=md(n);if(e)this.handlePayload(e)};startListening(){if(this.listening)return;if(this.listening=!0,gd)this.channel=new BroadcastChannel(this.storageKey),this.channel.onmessage=this.handleMessage;this.interval=setInterval(this.handlePoll,500)}stopListening(){if(!this.listening)return;if(this.listening=!1,this.channel)this.channel.close(),this.channel=void 0;if(this.interval)clearInterval(this.interval),this.interval=void 0}send(n){let e={remoteKey:this.remoteKey,sentAt:Date.now(),...n};if(qo(this.storageKey,e),this.channel)this.channel.postMessage(e)}sendClose(){let n={remoteKey:this.remoteKey,sentAt:Date.now(),css:"",html:"",js:"",close:!0};if(qo(this.storageKey,n),this.channel)this.channel.postMessage(n)}}var{div:ol}=x;function xd(n,e){let t=n.customElements;if(!t)return;let i=(s)=>{if(!s||t.get(s))return;let a=customElements.get(s);if(a)try{t.define(s,a)}catch{}};for(let s of Object.values(e))if(s&&typeof s==="object"){for(let a of Object.values(s))if(typeof a==="function"&&"tagName"in a)i(a.tagName)}let o=n.document;if(o){let s=o.querySelectorAll("*");for(let a of s){let r=a.tagName.toLowerCase();if(r.includes("-"))i(r)}}}async function Ht(n){let{html:e,css:t,js:i,context:o,transform:s,exampleElement:a,styleElement:r,widgetsElement:l,onError:h}=n,c=ol({class:"preview"});c.innerHTML=e,r.innerText=t;let p=a.querySelector(".preview");if(p)p.replaceWith(c);else a.insertBefore(c,l);let y={preview:c,...o};try{let w=Fn(i,Object.keys(o)),g=s(w,{transforms:["typescript"]}).code,k=Object.keys(y).map((j)=>j.replace(/-/g,"")),B=Object.values(y);await new Le(...k,g)(...B)}catch(w){if(console.error(w),c.append(ol({class:"preview-error"},String(w.message||w))),h)h(w);else window.alert(`Error: ${w}, the console may have more information…`)}return c}async function Zt(n){let{html:e,css:t,js:i,context:o,transform:s,exampleElement:a,widgetsElement:r,onError:l}=n,h=a.querySelector("iframe.preview-iframe");if(!h){h=document.createElement("iframe"),h.className="preview-iframe",h.style.cssText="width: 100%; height: 100%; border: none;";let g=a.querySelector(".preview");if(g)g.replaceWith(h);else a.insertBefore(h,r)}let c=h.contentDocument;if(!c)return console.error("Could not access iframe document"),null;let p=h.contentWindow;if(o.tosijs)p.tosijs=o.tosijs;if(o["tosijs-ui"])p.tosijsui=o["tosijs-ui"];c.open(),c.write(`<!DOCTYPE html>
<html>
<head>
  <style>
    body { margin: 0; }
...
</html>`),c.close(),xd(p,o);let y=c.querySelector(".preview");if(!y)return console.error("Could not find preview element in iframe"),null;let w={preview:y,...o};try{let g=Fn(i,Object.keys(o)),k=s(g,{transforms:["typescript"]}).code,B=p.eval("(async () => {}).constructor"),S=Object.keys(w).map((I)=>I.replace(/-/g,"")),j=Object.values(w);await new B(...S,k)(...j)}catch(g){console.error(g);let k=c.createElement("div");if(k.className="preview-error",k.textContent=String(g.message||g),y.append(k),l)l(g);else window.alert(`Error: ${g}, the console may have more information…`)}return y}function Mt(n,e,t,i){let o=[...n.querySelectorAll(".language-html,.language-js,.language-css,.language-test")].filter((s)=>!s.closest(i)).map((s)=>({block:s.parentElement,language:s.classList[0].split("-").pop(),code:s.innerText}));for(let s=0;s<o.length;s+=1){let a=[o[s]];while(s<o.length-1&&o[s].block.nextElementSibling===o[s+1].block)a.push(o[s+1]),s+=1;let r=t({context:e});a[0].block.parentElement.insertBefore(r,a[0].block),a.forEach((h)=>{switch(h.language){case"js":r.js=h.code;break;case"html":r.html=h.code;break;case"css":r.css=h.code;break;case"test":r.test=h.code;break}h.block.remove()}),r.showDefaultTab()}}var sl={":host":{"--tosi-example-height":"320px","--code-editors-bar-bg":"#777","--code-editors-bar-color":"#fff","--widget-bg":"#fff8","--widget-color":"#000",position:"relative",display:"flex",height:"var(--tosi-example-height)",background:"var(--background)",boxSizing:"border-box"},":host.-maximize":{position:"fixed",left:"0",top:"0",height:"100vh",width:"100vw",margin:"0 !important"},".-maximize":{zIndex:101},":host.-vertical":{flexDirection:"column"},":host .layout-indicator":{transition:"0.5s ease-out",transform:"rotateZ(270deg)"},":host.-vertical .layout-indicator":{transform:"rotateZ(180deg)"},":host.-maximize .hide-if-maximized, :host:not(.-maximize) .show-if-maximized":{display:"none"},':host [part="example"]':{flex:"1 1 50%",height:"100%",position:"relative",overflowX:"auto"},":host .preview":{height:"100%",position:"relative",overflow:"hidden",boxShadow:"inset 0 0 0 2px #8883"},":host .preview-error":{padding:"8px 12px",margin:"8px",background:"#fee",color:"#900",borderRadius:"4px",fontSize:"13px",fontFamily:"system-ui, sans-serif",whiteSpace:"pre-wrap"},':host [part="editors"]':{flex:"1 1 200px",height:"100%",position:"relative"},':host [part="exampleWidgets"]':{position:"absolute",left:"5px",bottom:"5px","--widget-color":"var(--brand-color)",borderRadius:"5px",width:"44px",height:"44px",lineHeight:"44px",zIndex:"100"},':host [part="exampleWidgets"] svg':{stroke:"var(--widget-color)"},":host .code-editors":{overflow:"hidden",background:"white",position:"relative",top:"0",right:"0",flex:"1 1 50%",height:"100%",flexDirection:"column",zIndex:"10"},":host .code-editors:not([hidden])":{display:"flex"},":host .code-editors > h4":{padding:"5px",margin:"0",textAlign:"center",background:"var(--code-editors-bar-bg)",color:"var(--code-editors-bar-color)",cursor:"move"},":host button.transparent, :host .sizer":{width:"32px",height:"32px",lineHeight:"32px",textAlign:"center",padding:"0",margin:"0"},":host .sizer":{cursor:"nwse-resize"},':host [part="testIndicator"]':{position:"absolute",top:"8px",right:"8px",width:"12px",height:"12px",borderRadius:"50%",background:"#888",zIndex:"100",display:"none"},':host.-has-tests [part="testIndicator"]':{display:"block",opacity:"var(--tests-enabled, 1)"},':host.-test-running [part="testIndicator"]':{background:"#fa0",animation:"test-pulse 0.5s ease-in-out infinite"},':host.-test-passed [part="testIndicator"]':{background:"#0a0",animation:"test-fade 2s ease-out forwards"},':host.-test-failed [part="testIndicator"]':{background:"#c00",animation:"test-pulse 1s ease-in-out infinite"},"@keyframes test-pulse":{"0%, 100%":{opacity:"1"},"50%":{opacity:"0.4"}},"@keyframes test-fade":{"0%":{opacity:"1"},"50%":{opacity:"1"},"100%":{opacity:"0"}},':host.-test-passed [part="exampleWidgets"]':{"--widget-color":"#0a0"},':host.-test-failed [part="exampleWidgets"]':{"--widget-color":"#f00"},':host [part="testResults"]':{position:"absolute",bottom:"54px",left:"5px",background:"var(--widget-bg)",borderRadius:"5px",padding:"8px",fontSize:"14px",margin:"0",maxWidth:"400px",maxHeight:"200px",overflow:"auto",zIndex:"100"},':host [part="testResults"][hidden]':{display:"none"},":host .test-pass":{color:"#0a0"},":host .test-fail":{color:"#f00"}};class _o extends Error{constructor(n){super(n);this.name="AssertionError"}}function al(n,e){if(n===e)return!0;if(typeof n!==typeof e)return!1;if(n===null||e===null)return n===e;if(typeof n!=="object")return!1;let t=n,i=e;if(Array.isArray(t)!==Array.isArray(i))return!1;let o=Object.keys(t),s=Object.keys(i);if(o.length!==s.length)return!1;return o.every((a)=>al(t[a],i[a]))}var bd=5000,fd={stringify(n){if(typeof n>"u")return"undefined";if(n===null)return"null";if(typeof Element<"u"&&n instanceof Element)return`<${n.tagName.toLowerCase()}>`;if(typeof Node<"u"&&n instanceof Node)return`[${n.nodeName}]`;try{return JSON.stringify(n)}catch{return String(n)}}},{stringify:An}=fd;function ll(n,e=!1){let t=(o,s)=>{if(!(e?!o:o))throw new _o(e?`not: ${s}`:s)};return{toBe(o){t(n===o,`Expected ${An(n)} to be ${An(o)}`)},toEqual(o){t(al(n,o),`Expected ${An(n)} to equal ${An(o)}`)},toBeTruthy(){t(!!n,`Expected ${An(n)} to be truthy`)},toBeFalsy(){t(!n,`Expected ${An(n)} to be falsy`)},toBeNull(){t(n===null,`Expected ${An(n)} to be null`)},toBeUndefined(){t(n===void 0,`Expected ${An(n)} to be undefined`)},toBeDefined(){t(n!==void 0,`Expected ${An(n)} to be defined`)},toContain(o){if(typeof n==="string")t(n.includes(o),`Expected "${n}" to contain "${o}"`);else if(Array.isArray(n))t(n.includes(o),`Expected array to contain ${An(o)}`);else throw new _o("toContain requires string or array")},toHaveLength(o){let s=n.length;t(s===o,`Expected length ${s} to be ${o}`)},toMatch(o){t(o.test(n),`Expected "${n}" to match ${o}`)},toBeGreaterThan(o){t(n>o,`Expected ${n} to be greater than ${o}`)},toBeLessThan(o){t(n<o,`Expected ${n} to be less than ${o}`)},toBeInstanceOf(o){t(n instanceof o,`Expected value to be instance of ${o.name}`)},get not(){return ll(n,!e)}}}function No(n){return ll(n)}function wd(n){return new Promise((e)=>setTimeout(e,n))}function vd(n,e,t=1000){return new Promise((i,o)=>{let s=Date.now(),a=()=>{let r=n.querySelector(e);if(r){i(r);return}if(Date.now()-s>=t){o(Error(`Timeout waiting for "${e}" after ${t}ms`));return}requestAnimationFrame(a)};a()})}function kd(n,e,t){return Promise.race([n,new Promise((i,o)=>setTimeout(()=>o(Error(`Test "${t}" timed out after ${e}ms`)),e))])}function Do(n,e=bd){let t="",i=[];return{pending:i,expect:No,test(o,s){let a=t?`${t} > ${o}`:o;try{let r=s();if(r instanceof Promise){let l=kd(r,e,a).then(()=>{n.push({name:a,passed:!0})}).catch((h)=>{n.push({name:a,passed:!1,error:h.message})});i.push(l)}else n.push({name:a,passed:!0})}catch(r){n.push({name:a,passed:!1,error:r.message})}},describe(o,s){let a=t;t=t?`${t} > ${o}`:o,s(),t=a}}}async function Jt(n,e,t,i){let o=[],s=Do(o),a={preview:e,...t,expect:s.expect,test:s.test,describe:s.describe,waitMs:wd,waitFor:(r,l)=>vd(e,r,l)};try{let r=Fn(n,Object.keys(t)),l=i(r,{transforms:["typescript"]}).code,h=Object.keys(a).map((y)=>y.replace(/-/g,"")),c=Object.values(a);await new Le(...h,l)(...c)}catch(r){o.push({name:"Test execution",passed:!1,error:r.message})}if(s.pending.length>0)await Promise.all(s.pending);return{passed:o.filter((r)=>r.passed).length,failed:o.filter((r)=>!r.passed).length,tests:o}}var{div:we,xinSlot:Cd,style:jd,button:ee,pre:rl,span:dl}=x,Uo="tosijs-ui-tests-enabled",Bd=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1");function Sd(){if(typeof localStorage>"u")return!1;let n=localStorage.getItem(Uo);if(n!==null)return n==="true";return Bd}var{testManager:cn}=G({testManager:{enabled:Sd()}});function Lt(){document.body.classList.toggle("tests-enabled",cn.enabled.value),document.body.style.setProperty("--tests-enabled",cn.enabled.value?"1":"0")}if(typeof document<"u")if(document.body)Lt();else document.addEventListener("DOMContentLoaded",Lt);function Ro(){localStorage.setItem(Uo,"true"),cn.enabled.value=!0,Lt(),document.querySelectorAll("tosi-example").forEach((n)=>{n.refresh()})}function Xo(){localStorage.setItem(Uo,"false"),cn.enabled.value=!1,Lt()}class On extends f{static preferredTagName="tosi-example";static lightStyleSpec=sl;static initAttributes={persistToDom:!1,iframe:!1};prefix="lx";storageKey=$t;context={};uuid=crypto.randomUUID();remoteId="";remoteSync;undoInterval;testResults;pendingValues={};pendingShowDefaultTab=!1;beforeUnloadHandler;static insertExamples(n,e={}){Mt(n,e,Et,On.tagName)}get activeTab(){let{editors:n}=this.parts;return[...n.children].find((e)=>e.getAttribute("hidden")===null)}get hydrated(){try{return this.parts.js!==void 0}catch{return!1}}getEditorValue(n){if(!this.hydrated)return this.pendingValues[n]??"";return this.parts[n].value}setEditorValue(n,e){if(!this.hydrated){this.pendingValues[n]=e;return}let t=this.parts[n];t.value=e}flushPendingValues(){for(let[n,e]of Object.entries(this.pendingValues)){let t=this.parts[n];if(t)t.value=e}if(this.pendingValues={},this.pendingShowDefaultTab)this.pendingShowDefaultTab=!1,this.showDefaultTab()}get css(){return this.getEditorValue("css")}set css(n){this.setEditorValue("css",n)}get html(){return this.getEditorValue("html")}set html(n){this.setEditorValue("html",n)}get js(){return this.getEditorValue("js")}set js(n){this.setEditorValue("js",n)}get test(){return this.getEditorValue("test")}set test(n){this.setEditorValue("test",n)}get remoteKey(){return tl(this.prefix,this.uuid,this.remoteId)}updateUndo=()=>{let{activeTab:n}=this,{undo:e,redo:t}=this.parts;if(n instanceof Mn&&n.editor!==void 0){let i=n.editor.session.getUndoManager();e.disabled=!i.hasUndo(),t.disabled=!i.hasRedo()}else e.disabled=!0,t.disabled=!0;this.updateTestResultsVisibility()};updateTestResultsVisibility(){let{testResults:n}=this.parts,e=this.testResults,t=this.activeTab?.getAttribute("name")==="test",i=e&&e.failed>0;n.hidden=!e||e.tests.length===0||!t&&!i}undo=()=>{let{activeTab:n}=this;if(n instanceof Mn)n.editor.undo()};redo=()=>{let{activeTab:n}=this;if(n instanceof Mn)n.editor.redo()};get isMaximized(){return this.classList.contains("-maximize")}flipLayout=()=>{this.classList.toggle("-vertical")};exampleMenu=()=>{let n=cn.enabled.value;_({target:this.parts.exampleWidgets,width:"auto",menuItems:[{icon:"edit2",caption:"view/edit code",action:this.showCode},{icon:"edit",caption:"view/edit code in a new window",action:this.openEditorWindow},null,{icon:this.isMaximized?"minimize":"maximize",caption:this.isMaximized?"restore preview":"maximize preview",action:this.toggleMaximize},null,{icon:n?"check":"",caption:"Run tests",action:()=>{if(n)Xo();else Ro()}}]})};handleShortcuts=(n)=>{if(n.metaKey||n.ctrlKey){let e=!1;switch(n.key){case"s":case"r":this.refresh(),e=!0;break;case"/":this.flipLayout();break;case"c":if(n.shiftKey)this.copy(),e=!0;break}if(e)n.preventDefault(),n.stopPropagation()}};content=()=>[we({part:"example"},jd({part:"style"}),we({part:"testIndicator",title:"test status"}),rl({part:"testResults",hidden:!0}),ee({title:"example menu",part:"exampleWidgets",onClick:this.exampleMenu},m.code())),we({class:"code-editors",part:"codeEditors",onKeydown:this.handleShortcuts,hidden:!0},Je({part:"editors",onChange:this.updateUndo},pe({name:"js",mode:"javascript",part:"js"}),pe({name:"html",mode:"html",part:"html"}),pe({name:"css",mode:"css",part:"css"}),pe({name:"test",mode:"javascript",part:"test"}),we({slot:"after-tabs",class:"row"},ee({title:"undo",part:"undo",class:"transparent",onClick:this.undo},m.cornerUpLeft()),ee({title:"redo",part:"redo",class:"transparent",onClick:this.redo},m.cornerUpRight()),ee({title:"flip direction (⌘/ | ^/)",class:"transparent",onClick:this.flipLayout},m.columns({class:"layout-indicator"})),ee({title:"copy as markdown (⌘⇧C | ^⇧C)",class:"transparent",onClick:this.copy},m.copy()),ee({title:"reload (⌘R | ^R)",class:"transparent",onClick:this.refreshRemote},m.refreshCw()),ee({title:"close code",class:"transparent",onClick:this.closeCode},m.x())))),Cd({part:"sources",hidden:!0})];connectedCallback(){super.connectedCallback(),this.flushPendingValues();let{sources:n}=this.parts;this.initFromElements([...n.children]),this.remoteSync=new Ee(this.storageKey,this.remoteKey,(t)=>{if(t.close){if(this.remoteId!=="")window.close();else this.classList.remove("-maximize"),this.parts.codeEditors.hidden=!0;return}if(this.css=t.css,this.html=t.html,this.js=t.js,t.test)this.test=t.test;this.refresh()}),this.remoteSync.startListening();let e=Math.random()*100;this.undoInterval=setInterval(()=>{if(!document.hidden)this.updateUndo()},250+e),this.beforeUnloadHandler=()=>this.remoteSync?.sendClose(),addEventListener("beforeunload",this.beforeUnloadHandler)}disconnectedCallback(){if(super.disconnectedCallback(),this.remoteSync?.sendClose(),this.remoteSync?.stopListening(),this.undoInterval)clearInterval(this.undoInterval),this.undoInterval=void 0;if(this.beforeUnloadHandler)removeEventListener("beforeunload",this.beforeUnloadHandler),this.beforeUnloadHandler=void 0}copy=()=>{let n=this.js!==""?"```js\n"+this.js.trim()+"\n```\n":"",e=this.html!==""?"```html\n"+this.html.trim()+"\n```\n":"",t=this.css!==""?"```css\n"+this.css.trim()+"\n```\n":"",i=this.test!==""?"```test\n"+this.test.trim()+"\n```\n":"";navigator.clipboard.writeText(n+e+t+i)};toggleMaximize=()=>{this.classList.toggle("-maximize")};showCode=()=>{this.classList.add("-maximize"),this.classList.toggle("-vertical",this.offsetHeight>this.offsetWidth),this.parts.codeEditors.hidden=!1};closeCode=()=>{if(this.remoteId!=="")this.remoteSync?.sendClose(),window.close();else this.remoteSync?.sendClose(),this.classList.remove("-maximize"),this.parts.codeEditors.hidden=!0};openEditorWindow=()=>{let{css:n,html:e,js:t,test:i}=this;il(this.prefix,this.uuid,this.storageKey,this.remoteKey,{css:n,html:e,js:t,test:i}),this.classList.add("-maximize")};refreshRemote=()=>{this.remoteSync?.send({css:this.css,html:this.html,js:this.js,test:this.test})};updateSources=()=>{if(this.persistToDom){let{sources:n}=this.parts;n.innerText="";for(let e of["js","css","html","test"])if(this[e])n.append(rl({class:`language-${e}`,innerHTML:this[e]}))}};refresh=async()=>{if(this.remoteId!=="")return;let n=await Qt(),{example:e,style:t,exampleWidgets:i}=this.parts,o,s,a=(r)=>{s=r};if(this.iframe)o=await Zt({html:this.html,css:this.css,js:this.js,context:this.context,transform:n,exampleElement:e,widgetsElement:i,onError:a});else o=await Ht({html:this.html,css:this.css,js:this.js,context:this.context,transform:n,exampleElement:e,styleElement:t,widgetsElement:i,onError:a});if(this.persistToDom)this.updateSources();if((this.test||s)&&o&&cn.enabled.value){if(this.classList.add("-has-tests","-test-running"),this.classList.remove("-test-passed","-test-failed"),this.testResults=this.test?await Jt(this.test,o,this.context,n):{passed:0,failed:0,tests:[]},s)this.testResults.failed+=1,this.testResults.tests.unshift({name:"example loads without error",passed:!1,error:String(s)});this.classList.remove("-test-running"),this.displayTestResults()}else this.classList.remove("-has-tests","-test-running","-test-passed","-test-failed")};displayTestResults(){let{testResults:n,testIndicator:e}=this.parts,t=this.testResults;if(!t||t.tests.length===0){n.hidden=!0,this.classList.remove("-test-passed","-test-failed"),e.title="no tests";return}n.innerHTML="";let i=we({style:{marginBottom:"8px",fontWeight:"bold"}},`${t.passed}/${t.tests.length} tests passed`);n.append(i);for(let o of t.tests){let s=o.passed?"✓":"✗",a=o.passed?"test-pass":"test-fail",r=we({class:a},dl(s+" "),o.name,o.error?dl({style:{opacity:"0.7"}},` - ${o.error}`):"");n.append(r)}this.classList.toggle("-test-passed",t.failed===0),this.classList.toggle("-test-failed",t.failed>0),e.title=t.failed===0?`${t.passed} tests passed`:`${t.failed}/${t.tests.length} tests failed`,this.updateTestResultsVisibility(),this.dispatchEvent(new CustomEvent("testcomplete",{bubbles:!0,detail:{results:t,element:this}}))}initFromElements(n){for(let e of n){e.hidden=!0;let[t,...i]=e.innerHTML.split(`
...
`);this.setEditorValue(t,s)}else{let o=["js","html","css","test"].find((s)=>e.matches(`.language-${s}`));if(o)this.setEditorValue(o,o==="html"?e.innerHTML:e.innerText)}}}showDefaultTab(){if(!this.hydrated){this.pendingShowDefaultTab=!0;return}let{editors:n}=this.parts;if(this.js!=="")n.value=0;else if(this.html!=="")n.value=1;else if(this.css!=="")n.value=2;else if(this.test!=="")n.value=3}render(){if(super.render(),this.remoteId!==""){let n=localStorage.getItem(this.storageKey);if(n!==null){let e=JSON.parse(n);if(this.remoteKey!==e.remoteKey)return;if(this.css=e.css,this.html=e.html,this.js=e.js,e.test)this.test=e.test;this.parts.example.hidden=!0,this.parts.codeEditors.hidden=!1,this.classList.add("-maximize"),this.updateUndo()}}else this.refresh()}}var Et=On.elementCreator(),zd=new URL(window.location.href).searchParams,hl=zd.get("lx");if(hl)document.title+=" [code editor]",document.body.textContent="",document.body.append(Et({remoteId:hl}));var{slot:cl}=x;class te extends f{static preferredTagName="tosi-sidenav";static initAttributes={minSize:800,navSize:200,compact:!1,contentVisible:!1};value="normal";content=[cl({name:"nav",part:"nav"}),cl({part:"content"})];static shadowStyleSpec={":host":{display:"grid",gridTemplateColumns:`${u.navWidth("50%")} ${u.contentWidth("50%")}`,gridTemplateRows:"100%",position:"relative",margin:u.margin("0 0 0 -100%"),transition:u.sideNavTransition("0.25s ease-out")},":host slot":{position:"relative"},":host slot:not([name])":{display:"block"},':host slot[name="nav"]':{display:"block"}};onResize=()=>{let{content:n}=this.parts,e=this.offsetParent;if(e===null)return;let t=this.value;if(this.compact=e.offsetWidth<this.minSize,[...this.childNodes].find((o)=>o instanceof Element?o.getAttribute("slot")!=="nav":!0)===void 0)t="compact/nav",this.style.setProperty("--nav-width","100%"),this.style.setProperty("--content-width","0%");else if(!this.compact)t="normal",n.classList.add("-tosi-sidenav-visible"),this.style.setProperty("--nav-width",`${this.navSize}px`),this.style.setProperty("--content-width",`calc(100% - ${this.navSize}px)`),this.style.setProperty("--margin","0");else if(n.classList.remove("-tosi-sidenav-visible"),this.style.setProperty("--nav-width","50%"),this.style.setProperty("--content-width","50%"),this.contentVisible)t="compact/content",this.style.setProperty("--margin","0 0 0 -100%");else t="compact/nav",this.style.setProperty("--margin","0 -100% 0 0");if(this.value!==t)this.value=t};observer;connectedCallback(){super.connectedCallback(),this.contentVisible=this.parts.content.childNodes.length===0,globalThis.addEventListener("resize",this.onResize),this.observer=new MutationObserver(this.onResize),this.observer.observe(this,{childList:!0}),this.style.setProperty("--side-nav-transition","0s"),setTimeout(()=>{this.style.removeProperty("--side-nav-transition")},250)}disconnectedCallback(){super.disconnectedCallback(),this.observer.disconnect()}render(){super.render(),this.onResize()}}var ni=te,nt=te.elementCreator(),Fo=nt,Ad=nt;var{div:Wo,span:et,a:Wn,header:Od,button:pl,template:Pd,input:Id,h2:Td}=x,ve={pass:u.testColorPass("#0a0"),fail:u.testColorFail("#c00"),running:u.testColorRunning("#fa0")},Vd={"@keyframes test-pulse":{"0%, 100%":{opacity:"1"},"50%":{opacity:"0.7"}},"@keyframes test-appear":{from:{opacity:"0",transform:"scale(0.8)"},to:{opacity:"1",transform:"scale(1)"}},"@keyframes test-fade":{"0%, 20%":{opacity:"1",transform:"scale(1)"},"70%":{opacity:"1",transform:"scale(1.1)"},"100%":{opacity:"0",transform:"scale(0.9)",pointerEvents:"none"}},"body:not(.tests-enabled) .doc-link::after, body:not(.tests-enabled) .test-widget":{display:"none !important"},".doc-link.-test-passed::after, .doc-link.-test-failed::after":{content:"''",width:d.fontSize50,height:d.fontSize50,borderRadius:"50%",marginLeft:d.spacing50,display:"inline-block",verticalAlign:"middle"},".doc-link.-test-passed::after":{background:ve.pass},".doc-link.-test-failed::after":{background:ve.fail,animation:"test-pulse 2s ease-in-out infinite"},".test-widget":{_testBg:ve.running,position:"fixed",bottom:d.spacing,right:d.spacing,zIndex:"1000",background:d.testBg,color:"white",gap:d.spacing50},".test-widget[hidden]":{display:"none"},".test-widget.-running":{_testBg:ve.running,animation:"test-appear 0.3s ease-out, test-pulse 2s ease-in-out 0.3s infinite"},".test-widget.-passed":{_testBg:ve.pass,animation:"test-fade 3s ease-out forwards"},".test-widget.-failed":{_testBg:ve.fail,animation:"test-pulse 2s ease-in-out infinite"},".test-widget .count":{background:"white",color:d.testBg,borderRadius:"50%",width:d.lineHeight,height:d.lineHeight,display:"flex",alignItems:"center",justifyContent:"center",fontWeight:"bold"}};function qd(n){let{docs:e,context:t={},projectName:i="",projectLinks:o={},navSize:s=200,minSize:a=600}=n;for(let b of e)b.testStatus=void 0;let r=document.location.search!==""?document.location.search.substring(1).split("&")[0]:e[0]?.filename||"README.md",l=e.find((b)=>b.filename===r)||e[0],{app:h}=G({app:{docs:e,currentDoc:l,compact:!1}}),c={},p,y=!1,w=0,g=0;window.__docTestResults=new Promise((b)=>{p=b});let k=(b)=>{let C=c[b],A=h.docs.find((V)=>V.filename===b);if(A)A.testStatus=C?C.passed?"passed":"failed":void 0},B=()=>{if(g>=w&&p){let b={passed:0,failed:0,pages:c};for(let C of Object.values(c))b.passed+=C.totalPassed,b.failed+=C.totalFailed;if(p(b),p=void 0,S)fetch("/report",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(b)}).catch(()=>{})}},S=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",j=(b)=>{let{results:C}=b.detail,A=String(h.currentDoc.filename);c[A]={passed:C.failed===0,tests:[...C.tests],totalPassed:C.passed,totalFailed:C.failed},k(A)},z=(b)=>{g++,B(),yi()};nn.docLink={toDOM(b,C){b.setAttribute("href",`?${C}`)}},nn.current={toDOM(b,C){let A=b.getAttribute("href")||"";b.classList.toggle("current",C===A.substring(1))}},nn.testStatus={toDOM(b,C){if(b.classList.remove("-test-passed","-test-failed"),C==="passed")b.classList.add("-test-passed");else if(C==="failed")b.classList.add("-test-failed")}};let I=Zn(()=>{let b=tn.value.toLocaleLowerCase();h.docs.forEach((C)=>{C.hidden=!C.title.toLocaleLowerCase().includes(b)&&!C.text.toLocaleLowerCase().includes(b)}),Z(h.docs)}),tn=Id({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:I});window.addEventListener("popstate",()=>{let b=window.location.search.substring(1);h.currentDoc=h.docs.find((C)=>C.filename===b)||h.docs[0]});let W=[pl({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:h.compact,binding:{toDOM(b,C){b.style.display=C?"":"none",b.nextSibling.style.display=C?"":"none"}}},onClick(){let b=document.querySelector(te.tagName);b.contentVisible=!b.contentVisible}},m.menu()),et({style:{flex:"0 0 10px"}})];if(i)W.push(Wn({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"}},o.tosijs?m.tosiUi({style:{_xinIconSize:40,marginRight:10}}):et(),Td(i)));if(W.push(et({class:"elastic"})),o.tosijs)W.push(Wn({class:"iconic",title:"tosijs",target:"_blank"},m.tosi(),{href:o.tosijs}));if(o.discord)W.push(Wn({class:"iconic",title:"discord",target:"_blank"},m.discord(),{href:o.discord}));if(o.blog)W.push(Wn({class:"iconic",title:"blog",target:"_blank"},m.blog(),{href:o.blog}));if(o.github)W.push(Wn({class:"iconic",title:"github",target:"_blank"},m.github(),{href:o.github}));if(o.npm)W.push(Wn({class:"iconic",title:"npmjs",target:"_blank"},m.npm(),{href:o.npm}));let on=Wo({style:{display:"flex",flexDirection:"column",maxWidth:"100vw",height:"100vh",overflow:"hidden"}},Od(...W),nt({name:"Documentation",navSize:s,minSize:a,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let b=document.querySelector(te.tagName);h.compact=b.compact}},tn,Wo({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"calc(100% - 44px)",overflowY:"scroll"},bindList:{idPath:"filename",hiddenProp:"hidden",value:h.docs}},Pd(Wn({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindTestStatus:"^.testStatus",onClick(b){let C=b.target,A=un(b.target),V=b.target.closest("tosi-sidenav");V.contentVisible=!0;let{href:R}=C;window.history.pushState({href:R},"",R),h.currentDoc=A,b.preventDefault();let fn=String(A.filename),sn=c[fn];if(sn&&!sn.passed)setTimeout(()=>{let X=document.querySelector("tosi-example.-test-failed");if(X)X.scrollIntoView({behavior:"smooth",block:"center"})},100)}},Sn({bindText:"^.title"})))),Wo({style:{position:"relative",overflowY:"scroll",height:"100%"}},Wn({class:"view-source",target:"_blank",style:{display:o.github?"flex":"none",alignItems:"center",gap:"6px",position:"fixed",top:"calc(var(--xin-header-height, 60px) + 5px)",right:"5px",fontSize:"0.875em",color:"var(--brand-color, inherit)",opacity:"0.7",borderBottom:"none",transition:"opacity 0.2s ease"},onMouseenter(b){b.target.style.opacity="0.9"},onMouseleave(b){b.target.style.opacity="0.7"},bind:{value:h.currentDoc,binding(b,C){if(o.github&&C.path&&C.path!=="README.md")b.href=`${o.github}/blob/main/${C.path}`,b.style.display="flex";else b.style.display="none"}}},m.github({style:{_xinIconSize:16}}),"View source on GitHub"),fe({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){On.insertExamples(this,t)}}))));Cn("test-indicators",Vd);let J=pl({class:"test-widget",hidden:!0,onClick:Hl},et({part:"label"},"Tests"),et({class:"count",part:"count"},"0"));on.appendChild(J);let rt=!1;function ys(){rt=!0,J.hidden=!1,J.classList.remove("-passed","-failed"),J.classList.add("-running"),ms()}function ms(){let b=J.querySelector('[part="label"]'),C=J.querySelector('[part="count"]'),A=Object.values(c).reduce((R,fn)=>R+fn.totalPassed,0),V=Object.values(c).reduce((R,fn)=>R+fn.totalFailed,0);if(b)if(rt)b.textContent="Running";else if(V>0)b.textContent="Failed";else if(A>0)b.textContent="Passed";else b.textContent="Tests";if(C)C.textContent=V>0?String(V):String(A)}function yi(){let b=Object.values(c).reduce((C,A)=>C+A.totalFailed,0);if(rt&&g>=w)if(rt=!1,J.classList.remove("-running"),b>0)J.classList.add("-failed"),J.classList.remove("-passed"),J.hidden=!1;else J.classList.add("-passed"),J.classList.remove("-failed"),J.hidden=!1;ms()}function Hl(){let b=Object.entries(c).filter(([,A])=>!A.passed),C=[];for(let[A,V]of b){let R=e.find((sn)=>sn.filename===A),fn=V.tests.filter((sn)=>!sn.passed);for(let sn of fn)C.push({caption:`${R?.title||A}: ${sn.name}`,action:()=>{let X=h.docs.find((pn)=>String(pn.filename)===A);if(X)window.history.pushState({href:`?${A}`},"",`?${A}`),h.currentDoc=X,setTimeout(()=>{let pn=document.querySelector("tosi-example.-test-failed");if(pn)pn.scrollIntoView({behavior:"smooth",block:"center"})},100)}})}if(C.length>0)C.push(null);C.push({icon:"copy",caption:"Copy test results to clipboard",action:()=>{let A=Zl();navigator.clipboard.writeText(A)}}),_({target:J,menuItems:C})}function Zl(){let b=["# Test Results",""],C=0,A=0;for(let[V,R]of Object.entries(c)){let sn=e.find((X)=>X.filename===V)?.title||V;if(C+=R.totalPassed,A+=R.totalFailed,R.tests.length>0){b.push(`## ${sn}`),b.push("");for(let X of R.tests){let pn=X.passed?"✓":"✗",Be=X.error?`- ${pn} ${X.name}: ${X.error}`:`- ${pn} ${X.name}`;b.push(Be)}b.push("")}}return b.unshift(`**Summary: ${C} passed, ${A} failed**`,""),b.join(`
`)}on.addEventListener("testcomplete",(b)=>{j(b),yi()});let Ml=async()=>{if(y)return;if(!cn.enabled.value)return;y=!0;let b=e.filter((V)=>V.text.includes("```test"));if(w=b.length,w>0)ys();if(w===0){if(p)p({passed:0,failed:0,pages:{}}),p=void 0;return}let C=document.createElement("iframe");C.style.cssText="position: fixed; left: -9999px; width: 800px; height: 600px; visibility: hidden;",document.body.appendChild(C);let A=String(h.currentDoc.filename);for(let V of b){if(V.filename===A)continue;c[V.filename]={passed:!0,tests:[],totalPassed:0,totalFailed:0};let R=document.createElement("div"),fn=fe({value:V.text,didRender(){On.insertExamples(this,t)}});R.appendChild(fn);let sn=(pn)=>{let{results:Be}=pn.detail,Se=c[V.filename];Se.tests.push(...Be.tests),Se.totalPassed+=Be.passed,Se.totalFailed+=Be.failed,Se.passed=Se.totalFailed===0,k(V.filename),yi()};R.addEventListener("testcomplete",sn);let X=C.contentDocument;if(X)X.body.innerHTML="",X.body.appendChild(R),await new Promise((pn)=>setTimeout(pn,500));z(V.filename)}if(C.remove(),b.some((V)=>V.filename===A))setTimeout(()=>{z(A)},1000)},gs=()=>{if(!cn.enabled.value)return;if(S)setTimeout(Ml,1000);else if(l.text.includes("```test"))w=1,ys(),setTimeout(()=>z(l.filename),2000);else if(p)p({passed:0,failed:0,pages:{}}),p=void 0};return gs(),cn.enabled.observe(gs),on}var{div:gn,slot:_d}=x;class xn extends f{static preferredTagName="tosi-editable";static initAttributes={rotationSnap:0,positionSnap:0};static angleSize=15;static gridSize=8;static snapAngle=!1;static snapToGrid=!1;static shadowStyleSpec={":host":{"--handle-bg":"#fff4","--handle-color":"#2228","--handle-hover-bg":"#8ff8","--handle-hover-color":"#222","--handle-size":"20px","--handle-padding":"2px"},":host ::slotted(*)":{position:"absolute"},":host > :not(style,slot)":{boxSizing:"border-box",content:'" "',position:"absolute",display:"flex",height:d.handleSize,width:d.handleSize,padding:d.handlePadding,"--text-color":d.handleColor,background:d.handleBg},":host > .drag-size":{top:0,bottom:0,left:0,right:0,height:"auto",width:"auto",background:"transparent",cursor:"ew-resize"},':host > [part="rotate"]':{transform:`translateY(${d.handleSize_50})`},":host > [locked] > svg:first-child, :host > :not([locked]) > svg+svg":{display:"none"},":host .icon-unlock":{opacity:0.5},":host svg":{pointerEvents:"none"},":host > *:hover":{"--text-color":d.handleHoverColor,background:d.handleHoverBg}};static snappedCoords(n,e){let{gridSize:t}=xn;return xn.snapToGrid||n.shiftKey?e.map((i)=>Math.round(i/t)*t):e}static snappedAngle(n,e){let{angleSize:t}=xn;return xn.snapAngle||n.shiftKey?Math.round(e/t)*t:e}get locked(){let n=this.parentElement;if(n.style.inset)return{left:!0,top:!0,bottom:!0,right:!0};let e=n.style.right.match(/\d/)!==null,t=!e||n.style.left.match(/\d/)!==null,i=n.style.bottom.match(/\d/)!==null,o=!i||n.style.top.match(/\d/)!==null;return{left:t,top:o,bottom:i,right:e}}set locked(n){let{bottom:e,right:t}=n,{left:i,top:o}=n,s=this.parentElement,a=s.offsetLeft,r=s.offsetTop,l=s.offsetWidth,h=s.offsetHeight,c=s.offsetParent.offsetWidth-a-l,p=s.offsetParent.offsetHeight-r-h;if(Object.assign(s.style,{left:"",right:"",top:"",bottom:"",width:"",height:""}),!t)i=!0;if(!e)o=!0;if(i)s.style.left=a+"px";if(t)s.style.right=c+"px";if(i&&t)s.style.width="auto";else s.style.width=l+"px";if(o)s.style.top=r+"px";if(e)s.style.bottom=p+"px";if(o&&e)s.style.height="auto";else s.style.height=h+"px";this.queueRender()}get coords(){let{top:n,left:e,right:t,bottom:i}=this.parentElement.style;return{top:parseFloat(n),left:parseFloat(e),right:parseFloat(t),bottom:parseFloat(i)}}get left(){return this.parentElement.offsetLeft}get width(){return this.parentElement.offsetWidth}get right(){return this.parentElement.offsetParent.offsetWidth-(this.left+this.width)}get top(){return this.parentElement.offsetTop}get height(){return this.parentElement.offsetHeight}get bottom(){return this.parentElement.offsetParent.offsetHeight-(this.top+this.height)}triggerChange=()=>{this.parentElement.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))};adjustPosition=(n)=>{let{locked:e}=this;this.locked=e;let t=this.parentElement,{top:i,left:o,bottom:s,right:a}=this.coords;en(n,(r,l,h)=>{if([r,l]=xn.snappedCoords(h,[r,l]),!isNaN(i))t.style.top=i+l+"px";if(!isNaN(s))t.style.bottom=s-l+"px";if(!isNaN(o))t.style.left=o+r+"px";if(!isNaN(a))t.style.right=a-r+"px";if(h.type==="mouseup")return this.triggerChange(),!0})};resize=(n)=>{let e=this.parentElement,{locked:t}=this;this.locked=Object.assign({left:!0,top:!0,right:!0,bottom:!0});let[i,o]=[this.right,this.bottom];en(n,(s,a,r)=>{let l=i-s,h=o-a;if([l,h]=xn.snappedCoords(r,[l,h]),e.style.right=l+"px",e.style.bottom=h+"px",r.type==="mouseup")return this.locked=t,this.triggerChange(),!0})};adjustSize=(n)=>{let e=this.parentElement,{locked:t}=this,i=n.target.getAttribute("part");this.locked=Object.assign({left:!0,right:!0,top:!0,bottom:!0});let o=this[i];en(n,(s,a,r)=>{let[l]=xn.snappedCoords(r,[o+(["left","right"].includes(i)?s:a)*(["right","bottom"].includes(i)?-1:1)]);if(e.style[i]=l+"px",r.type==="mouseup")return this.locked=t,this.triggerChange(),!0})};get rect(){return this.parentElement.getBoundingClientRect()}get center(){let n=this.parentElement.getBoundingClientRect();return{x:n.x+n.width*0.5,y:n.y+n.height*0.5}}get element(){return this.parentElement}adjustRotation=(n)=>{let{center:e}=this,{transformOrigin:t}=this.element.style;if(!t)this.element.style.transformOrigin="50% 50%";en(n,(i,o,s)=>{let{clientX:a,clientY:r}=s,l=a-e.x,h=r-e.y,c=h>0?90:-90;if(l!==0)c=Math.atan2(h,l)*180/Math.PI;if(c=xn.snappedAngle(s,c),c===0)this.element.style.transformOrigin="",this.element.style.transform="";else this.element.style.transform=`rotate(${c}deg)`;return this.triggerChange(),s.type==="mouseup"})};toggleLock=(n)=>{let{locked:e}=this,t=n.target.title.split(" ")[1];e[t]=!e[t],this.locked=e,this.queueRender(),n.stopPropagation(),n.preventDefault()};content=()=>[gn({part:"move",style:{top:"50%",left:"50%",transform:"translate(-50%,-50%)"}},m.move()),gn({part:"left",title:"resize left",class:"drag-size",style:{left:"-6px",width:"8px"}}),gn({part:"right",title:"resize right",class:"drag-size",style:{left:"calc(100% - 2px)",width:"8px"}}),gn({part:"top",title:"resize top",class:"drag-size",style:{top:"-6px",height:"8px",cursor:"ns-resize"}}),gn({part:"bottom",title:"resize bottom",class:"drag-size",style:{top:"calc(100% - 2px)",height:"8px",cursor:"ns-resize"}}),gn({part:"resize",style:{top:"100%",left:"100%"}},m.resize()),gn({part:"rotate",style:{top:"50%",right:"0"}},m.refreshCw()),gn({part:"lockLeft",title:"lock left",style:{top:"50%",left:0,transform:"translate(-100%, -50%)"}},m.unlock(),m.lock()),gn({part:"lockRight",title:"lock right",style:{top:"50%",left:"100%",transform:"translate(0%, -50%)"}},m.unlock(),m.lock()),gn({part:"lockTop",title:"lock top",style:{top:0,left:"50%",transform:"translate(-50%, -100%)"}},m.unlock(),m.lock()),gn({part:"lockBottom",title:"lock bottom",style:{top:"100%",left:"50%",transform:"translate(-50%, 0%)"}},m.unlock(),m.lock()),_d()];connectedCallback(){super.connectedCallback();let{left:n,right:e,top:t,bottom:i,lockLeft:o,lockRight:s,lockTop:a,lockBottom:r,move:l,resize:h,rotate:c}=this.parts,p={passive:!0};[n,e,t,i].forEach((y)=>{y.addEventListener("mousedown",this.adjustSize,p),y.addEventListener("touchstart",this.adjustSize,p)}),[o,s,a,r].forEach((y)=>{y.addEventListener("click",this.toggleLock)}),h.addEventListener("mousedown",this.resize,p),l.addEventListener("mousedown",this.adjustPosition,p),c.addEventListener("mousedown",this.adjustRotation,p),h.addEventListener("touchstart",this.resize,p),l.addEventListener("touchstart",this.adjustPosition,p),c.addEventListener("touchstart",this.adjustRotation,p)}render(){if(super.render(),!this.parentElement)return;let{lockLeft:n,lockRight:e,lockTop:t,lockBottom:i}=this.parts,{left:o,right:s,top:a,bottom:r}=this.locked;n.toggleAttribute("locked",o),e.toggleAttribute("locked",s),t.toggleAttribute("locked",a),i.toggleAttribute("locked",r)}}var Nd=xn.elementCreator();var{div:Dd,input:Ud,button:Yo,span:Rd}=x,ul=(n)=>n,yl="null filter, everything matches",Go={contains:{caption:"contains",negative:"does not contain",makeTest:(n)=>{return n=n.toLocaleLowerCase(),(e)=>String(e).toLocaleLowerCase().includes(n)}},hasTags:{caption:"has tags",makeTest:(n)=>{let e=n.split(/[\s,]/).map((t)=>t.trim().toLocaleLowerCase()).filter((t)=>t!=="");return(t)=>Array.isArray(t)&&e.find((i)=>!t.includes(i))===void 0}},doesNotHaveTags:{caption:"does not have tags",makeTest:(n)=>{let e=n.split(/[\s,]/).map((t)=>t.trim().toLocaleLowerCase()).filter((t)=>t!=="");return(t)=>Array.isArray(t)&&e.find((i)=>t.includes(i))===void 0}},equals:{caption:"=",negative:"≠",makeTest:(n)=>{if(isNaN(Number(n)))return n=String(n).toLocaleLowerCase(),(t)=>String(t).toLocaleLowerCase()===n;let e=Number(n);return(t)=>Number(t)===e}},after:{caption:"is after",negative:"is before",makeTest:(n)=>{let e=new Date(n);return(t)=>new Date(t)>e}},greaterThan:{caption:">",negative:"≤",makeTest:(n)=>{if(!isNaN(Number(n))){let e=Number(n);return(t)=>Number(t)>e}return n=n.toLocaleLowerCase(),(e)=>String(e).toLocaleLowerCase()>n}},truthy:{caption:"is true/non-empty/non-zero",negative:"is false/empty/zero",needsValue:!1,makeTest:()=>(n)=>!!n},isTrue:{caption:"= true",needsValue:!1,makeTest:()=>(n)=>n===!0},isFalse:{caption:"= false",needsValue:!1,makeTest:()=>(n)=>n===!1}},Xd={description:"anything",test:()=>!0};function ml(n){return n.options[n.selectedIndex]?.caption||""}class Ko extends f{static preferredTagName="tosi-filter-part";static lightStyleSpec={":host":{display:"flex"},":host .tosi-icon:":{verticalAlign:"middle",pointerEvents:"none"},':host [part="haystack"], :host [part="condition"]':{flex:"1"},':host [part="needle"]':{flex:2},':host [hidden]+[part="padding"]':{display:"block",content:" ",flex:"1 1 auto"}};static initAttributes={haystack:"*",condition:"contains",needle:""};fields=[];filters=Go;content=()=>[dn({part:"haystack"}),dn({part:"condition"}),Ud({part:"needle",type:"search"}),Rd({part:"padding"}),Yo({part:"remove",title:"delete"},m.trash())];filter=Xd;get state(){let{haystack:n,needle:e,condition:t}=this.parts;return{haystack:n.value,needle:e.value,condition:t.value}}set state(n){Object.assign(this,n)}buildFilter=()=>{let{haystack:n,condition:e,needle:t}=this.parts,i=e.value.startsWith("~"),o=i?e.value.slice(1):e.value,s=this.filters[o];t.hidden=s.needsValue===!1;let a=s.needsValue===!1?s.makeTest(void 0):s.makeTest(t.value),r=n.value,l;if(r!=="*")l=i?(p)=>!a(p[r]):(p)=>a(p[r]);else l=i?(p)=>Object.values(p).find((y)=>!a(y))!==void 0:(p)=>Object.values(p).find((y)=>a(y))!==void 0;let h=s.needsValue!==!1?` "${t.value}"`:"",c=`${ml(n)} ${ml(e)}${h}`;this.filter={description:c,test:l},this.parentElement?.dispatchEvent(new Event("change"))};connectedCallback(){super.connectedCallback();let{haystack:n,condition:e,needle:t,remove:i}=this.parts;n.addEventListener("change",this.buildFilter),e.addEventListener("change",this.buildFilter),t.addEventListener("input",this.buildFilter),n.value=this.haystack,e.value=this.condition,t.value=this.needle,i.addEventListener("click",()=>{let{parentElement:o}=this;this.remove(),o?.dispatchEvent(new Event("change"))})}render(){super.render();let{haystack:n,condition:e,needle:t}=this.parts;if(n.options=[{caption:"any field",value:"*"},...this.fields.map((i)=>i.prop)],e.options=Object.keys(this.filters).map((i)=>{let o=this.filters[i];return o.negative!==void 0?[{caption:o.caption,value:i},{caption:o.negative,value:"~"+i}]:{caption:o.caption,value:i}}).flat(),this.haystack!=="")n.value=this.haystack;if(this.condition!=="")e.value=this.condition;if(this.needle!=="")t.value=this.needle;this.buildFilter()}}var ei=Ko.elementCreator();class Qo extends f{static preferredTagName="tosi-filter";static lightStyleSpec={":host":{height:"auto",display:"grid",gridTemplateColumns:"32px calc(100% - 64px) 32px",alignItems:"center"},':host [part="filterContainer"]':{display:"flex",flexDirection:"column",alignItems:"stretch",flex:"1 1 auto"},':host [part="haystack"]':{_fieldWidth:"100px"},':host [part="condition"]':{_fieldWidth:"60px"},':host [part="needle"]':{_fieldWidth:"80px"},':host [part="add"], :host [part="reset"]':{"--button-size":"var(--touch-size, 32px)",borderRadius:"999px",height:"var(--button-size)",lineHeight:"var(--button-size)",margin:"0",padding:"0",textAlign:"center",width:"var(--button-size)",flex:"0 0 var(--button-size)"}};_fields=[];get fields(){return this._fields}set fields(n){this._fields=n,this.queueRender()}get state(){let{filterContainer:n}=this.parts;return[...n.children].map((e)=>e.state)}set state(n){let{fields:e,filters:t}=this,{filterContainer:i}=this.parts;i.textContent="";for(let o of n)i.append(ei({fields:e,filters:t,...o}))}filter=ul;description=yl;addFilter=()=>{let{fields:n,filters:e}=this,{filterContainer:t}=this.parts;t.append(ei({fields:n,filters:e}))};content=()=>[Yo({part:"add",title:"add filter condition",onClick:this.addFilter,class:"round"},m.plus()),Dd({part:"filterContainer"}),Yo({part:"reset",title:"reset filter",onClick:this.reset},m.x())];filters=Go;reset=()=>{let{fields:n,filters:e}=this,{filterContainer:t}=this.parts;this.description=yl,this.filter=ul,t.textContent="",t.append(ei({fields:n,filters:e})),this.dispatchEvent(new Event("change"))};buildFilter=()=>{let{filterContainer:n}=this.parts;if(n.children.length===0){this.reset();return}let e=[...n.children].map((i)=>i.filter),t=e.map((i)=>i.test);this.description=e.map((i)=>i.description).join(", "),this.filter=(i)=>i.filter((o)=>t.find((s)=>s(o)===!1)===void 0),this.dispatchEvent(new Event("change"))};connectedCallback(){super.connectedCallback();let{filterContainer:n}=this.parts;n.addEventListener("change",this.buildFilter),this.reset()}render(){super.render()}}var Fd=Qo.elementCreator();var{form:Wd,slot:$o,xinSlot:gl,label:Yd,input:Gd,span:Kd}=x;function Yn(n,e,t){if(t!==""&&t!==!1)n.setAttribute(e,t);else n.removeAttribute(e)}function Qd(n){switch(n.type){case"checkbox":return n.checked;case"radio":{let e=n.parentElement?.querySelector(`input[type="radio"][name="${n.name}"]:checked`);return e?e.value:null}case"range":case"number":return Number(n.value);default:return Array.isArray(n.value)&&n.value.length===0?null:n.value}}function xl(n,e){if(!(n instanceof HTMLElement));else if(n instanceof HTMLInputElement)switch(n.type){case"checkbox":n.checked=e;break;case"radio":n.checked=e===n.value;break;default:n.value=String(e||"")}else if(e!=null||n.value!=null)n.value=String(e||"")}class ti extends f{static preferredTagName="tosi-field";static lightStyleSpec={':host [part="field"]':{position:"relative",display:"flex",alignItems:"center",gap:u.prefixSuffixGap("8px")},':host [part="field"][prefix]::before':{content:"attr(prefix)"},':host [part="field"][suffix]::after':{content:"attr(suffix)"},':host [part="field"] > *, :host [part="input"] > *':{width:"100%"},":host textarea":{resize:"none"},':host input[type="checkbox"]':{width:"fit-content"},":host .hidden":{position:"absolute",pointerEvents:"none",opacity:0}};static initAttributes={caption:"",key:"",type:"",optional:!1,pattern:"",placeholder:"",min:"",max:"",step:"",fixedPrecision:-1,prefix:"",suffix:""};value=null;content=Yd(gl({part:"caption"}),Kd({part:"field"},gl({part:"input",name:"input"}),Gd({part:"valueHolder"})));valueChanged=!1;handleChange=()=>{let{input:n,valueHolder:e}=this.parts,t=n.children[0]||e;if(t!==e)e.value=t.value;this.value=Qd(t),this.valueChanged=!0;let i=this.closest("tosi-form");if(i&&this.key!=="")switch(this.type){case"checkbox":i.fields[this.key]=t.checked;break;case"number":case"range":if(this.fixedPrecision>-1)t.value=Number(t.value).toFixed(this.fixedPrecision),i.fields[this.key]=Number(t.value);else i.fields[this.key]=Number(t.value);break;default:i.fields[this.key]=t.value}};connectedCallback(){super.connectedCallback();let{input:n,valueHolder:e}=this.parts;e.addEventListener("change",this.handleChange),n.addEventListener("change",this.handleChange,!0)}render(){if(this.valueChanged){this.valueChanged=!1;return}let{input:n,caption:e,valueHolder:t,field:i}=this.parts;if(e.textContent?.trim()==="")e.append(this.caption!==""?this.caption:this.key);if(this.type==="text"){n.textContent="";let o=x.textarea({value:this.value});if(this.placeholder)o.setAttribute("placeholder",this.placeholder);n.append(o)}else if(this.type==="color")n.textContent="",n.append(so({value:this.value}));else if(n.children.length===0){if(Yn(t,"placeholder",this.placeholder),Yn(t,"type",this.type),Yn(t,"pattern",this.pattern),Yn(t,"min",this.min),Yn(t,"max",this.max),this.step)Yn(t,"step",this.step);else if(this.fixedPrecision>0&&this.type==="number")Yn(t,"step",Math.pow(10,-this.fixedPrecision))}if(xl(t,this.value),xl(n.children[0],this.value),this.prefix?i.setAttribute("prefix",this.prefix):i.removeAttribute("prefix"),this.suffix?i.setAttribute("suffix",this.suffix):i.removeAttribute("suffix"),t.classList.toggle("hidden",n.children.length>0),n.children.length>0)t.setAttribute("tabindex","-1");else t.removeAttribute("tabindex");n.style.display=n.children.length===0?"none":"",Yn(t,"required",!this.optional)}}class ii extends f{static preferredTagName="tosi-form";context={};value={};get isValid(){return[...this.querySelectorAll("*")].filter((e)=>e.required!==void 0).find((e)=>!e.reportValidity())===void 0}static shadowStyleSpec={":host":{display:"flex",flexDirection:"column"},":host::part(header), :host::part(footer)":{display:"flex"},":host::part(content)":{display:"flex",flexDirection:"column",overflow:"hidden auto",height:"100%",width:"100%",position:"relative",boxSizing:"border-box"},":host form":{display:"flex",flex:"1 1 auto",position:"relative",overflow:"hidden"}};content=[$o({part:"header",name:"header"}),Wd({part:"form"},$o({part:"content"})),$o({part:"footer",name:"footer"})];getField=(n)=>{return this.querySelector(`tosi-field[key="${n}"]`)};get fields(){if(typeof this.value==="string")try{this.value=JSON.parse(this.value)}catch(t){console.log("<tosi-form> could not use its value, expects valid JSON"),this.value={}}let{getField:n}=this,e=this.dispatchEvent.bind(this);return new Proxy(this.value,{get(t,i){return t[i]},set(t,i,o){if(t[i]!==o){t[i]=o;let s=n(i);if(s)s.value=o;e(new Event("change"))}return!0}})}set fields(n){let e=[...this.querySelectorAll("tosi-field")];for(let t of e)t.value=n[t.key]}submit=()=>{this.parts.form.dispatchEvent(new Event("submit"))};handleSubmit=(n)=>{n.preventDefault(),n.stopPropagation();let e=this.fields;this.submitCallback(e,this.isValid)};submitCallback=(n,e)=>{console.log("override submitCallback to handle this data",{value:n,isValid:e})};connectedCallback(){super.connectedCallback();let{form:n}=this.parts;n.addEventListener("submit",this.handleSubmit),this.addEventListener("change",this.handleElementChange,!0),this.initializeNamedElements()}handleElementChange=(n)=>{let e=n.target,t=e.getAttribute("name");if(t&&"value"in e)this.fields[t]=e.value};initializeNamedElements(){let n=this.fields,e=this.querySelectorAll("[name], [key]");for(let t of e){let i=t.getAttribute("name")||t.getAttribute("key");if(i&&n[i]!==void 0)t.value=n[i]}}}var $d=ti,Hd=ii,bl=ti.elementCreator(),fl=ii.elementCreator(),Zd=bl,Md=fl;function wl(){return navigator.getGamepads().filter((e)=>e!==null).map((e)=>{let{id:t,axes:i,buttons:o}=e;return{id:t,axes:i,buttons:o.map((s,a)=>{let{pressed:r,value:l}=s;return{index:a,pressed:r,value:l}}).filter((s)=>s.pressed||s.value!==0).reduce((s,a)=>{return s[a.index]=a.value,s},{})}})}function Jd(){let n=wl();return n.length===0?"no active gamepads":n.map(({id:e,axes:t,buttons:i})=>{let o=t.map((a)=>a.toFixed(2)).join(" "),s=Object.keys(i).map((a)=>`[${a}](${i[Number(a)].toFixed(2)})`).join(" ");return`${e}
${o}
${s}`}).join(`
...
\`transport.disconnect()\`.`,title:"A.5 sync",filename:"sync.ts",path:"src/sync.ts"},{text:'# Migrating from `xinjs` to `tosijs`\n\n<!--{ "pin": "bottom" }-->\n\nIn a nutshell:\n\n1. Update to `xinjs` (and `xinjs-ui`) 1.0.6\n2. Fix any issues\n3. Replace all references to "xinjs" with "tosijs"\n\n`xinjs` and `tosijs` 1.0.6 should be identical (likewise `xinjs-ui` and `tosijs-ui`), so the only thing you need to change\nshould be the module names.\n\n> Please [let me know](https://discord.gg/ramJ9rgky5) if there are any issues.\n',title:"Migrating from xinjs to tosijs",filename:"Migration.md",path:"Migration.md",pin:"bottom"}];Wl();var Kn="tosijs";setTimeout(()=>{let n=v.fromVar(d.brandColor),e=v.fromVar(d.background);console.log(`welcome to %c${Kn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var Hh=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Zh=ci.find((n)=>n.filename===Hh)||ci[0],Yl=at(),{app:U,prefs:$}=G({app:{title:Kn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${Kn}#readme`,npmUrl:`https://www.npmjs.com/package/${Kn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${Kn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${Kn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${Kn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${Kn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:ci,currentDoc:Zh,compact:!1},prefs:{colorScheme:Yl.colorScheme,highContrast:Yl.highContrast,locale:""}});Zi((n)=>{if(n.startsWith("prefs"))return!0;return!1});nn.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};nn.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:U,tosi:G,img:ui,bindings:nn,elements:x,vars:d,touch:Z,Color:v})},1000);var Gl=document.querySelector("main"),{h2:Mh,div:Kl,span:lt,a:pi,img:ui,header:Jh,button:Ql,template:Lh,input:Eh}=x;$.colorScheme.observe(()=>{us({colorScheme:$.colorScheme.value})});$.highContrast.observe(()=>{us({highContrast:$.highContrast.value})});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);U.currentDoc=U.docs.find((e)=>e.filename===n)||U.docs[0]});var nc=Zn(()=>{console.time("filter");let n=$l.value.toLocaleLowerCase();U.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),Z(U.docs),console.timeEnd("filter")}),$l=Eh({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:nc});if(Gl)Gl.append(Jh(Ql({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:U.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(ni.tagName);n.contentVisible=!n.contentVisible}},m.menu()),lt({style:{flex:"0 0 10px"}}),pi({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${wt}, tosijs-ui ${di}`},ui({src:"favicon.svg",style:{height:40,marginRight:10}}),Mh({bindText:"app.title"})),lt({class:"elastic"}),os({minWidth:750},lt({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},pi({href:U.bundleUrl},ui({alt:"bundlejs size badge",src:U.bundleBadgeUrl})),pi({href:U.cdnUrl},ui({alt:"jsdelivr",src:U.cdnBadgeUrl}))),lt({slot:"small"})),lt({style:{flex:"0 0 10px"}}),Ql({title:"theme",class:"iconic",onClick(n){_({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:U.githubUrl.value},{icon:"npm",caption:"npm",action:U.npmUrl.value},{icon:"discord",caption:"discord",action:U.discordUrl.value},{icon:"tosiUi",caption:"tosijs-ui",action:U.tosijsuiUrl.value},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return $.colorScheme.value==="system"},action(){$.colorScheme.value="system"}},{caption:"Dark",checked(){return $.colorScheme.value==="dark"},action(){$.colorScheme.value="dark"}},{caption:"Light",checked(){return $.colorScheme.value==="light"},action(){$.colorScheme.value="light"}},null,{caption:"High Contrast (System)",checked(){return $.highContrast.value==="system"},action(){$.highContrast.value="system"}},{caption:"High Contrast On",checked(){return $.highContrast.value===!0},action(){$.highContrast.value=!0}},{caption:"High Contrast Off",checked(){return $.highContrast.value===!1},action(){$.highContrast.value=!1}}]}]})}},m.moreVertical())),Fo({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(ni.tagName);U.compact.value=n.compact}},$l,Kl({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:U.docs}},Lh(pi({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=un(n.target),i=n.target.closest("xin-sidenav");i.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),U.currentDoc=t,n.preventDefault()}}))),Kl({style:{position:"relative",overflowY:"scroll",height:"100%"}},Vo({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){On.insertExamples(this,{tosijs:Re,"tosijs-ui":rs})}}))));

//# debugId=30F440D31935461264756E2164756E21
