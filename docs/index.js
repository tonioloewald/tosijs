var No=Object.defineProperty;var Ka=(n,t)=>{for(var a in t)No(n,a,{get:t[a],enumerable:!0,configurable:!0,set:(e)=>t[a]=()=>e})};var $n={};Ka($n,{xinValue:()=>X,xinProxy:()=>Ie,xinPath:()=>Wn,xin:()=>M,version:()=>pt,vars:()=>r,varDefault:()=>u,updates:()=>$o,unobserve:()=>lt,touchElement:()=>Ut,touch:()=>mn,tosi:()=>Z,throttle:()=>qn,svgElements:()=>ut,settings:()=>ot,on:()=>ht,observe:()=>Yn,mathML:()=>Se,makeComponent:()=>aa,invertLuminance:()=>Zt,initVars:()=>Ti,hotReload:()=>na,getListItem:()=>cn,getCssVar:()=>ve,elements:()=>g,debounce:()=>dt,css:()=>Ln,boxedProxy:()=>ta,boxed:()=>rt,blueprintLoader:()=>Oi,blueprint:()=>Bi,bindings:()=>Q,bind:()=>q,StyleSheet:()=>Fn,MoreMath:()=>bi,Component:()=>y,Color:()=>v,BlueprintLoader:()=>ea,Blueprint:()=>mt});var ot={debug:!1,perf:!1};function un(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(un);let t={};for(let a in n){let e=n[a];if(n!=null&&typeof n==="object")t[a]=un(e);else t[a]=e}return t}var re="-xin-data",Tn=`.${re}`,de="-xin-event",Qa=`.${de}`,K="xinPath",zn="xinValue",Lo="xinSet",Wo="xinObserve",Yo="xinBind",Fo="xinOn",Wn=(n)=>{return n&&n[K]||void 0};function X(n){return typeof n==="object"&&n!==null?n[zn]||n:n}var Vn=new WeakMap,pn=new WeakMap,Xn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let a=pn.get(n),e=Vn.get(n);if(a!=null)pn.set(t,un(a));if(e!=null)Vn.set(t,un(e))}for(let a of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(a instanceof Element||a instanceof DocumentFragment)t.appendChild(Xn(a));else t.appendChild(a.cloneNode());return t},et=new WeakMap,cn=(n)=>{let t=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==t){let a=et.get(n);if(a!=null)return a;n=n.parentElement}return!1},Za=Symbol("observer should be removed"),it=[],st=[],Wt=!1,Yt,Ft;class he{description;test;callback;constructor(n,t){let a=typeof t==="string"?`"${t}"`:`function ${t.name}`,e;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),e=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),e=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,e=`test = function ${n.name}`;else throw new Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${e}, ${a}`,typeof t==="function")this.callback=t;else throw new Error("expect callback to be a path or function");it.push(this)}}var $o=async()=>{if(Yt===void 0)return;await Yt},Jo=()=>{if(ot.perf)console.time("xin async update");let n=Array.from(st);for(let t of n)it.filter((a)=>{let e;try{e=a.test(t)}catch(o){throw new Error(`Listener ${a.description} threw "${o}" at "${t}"`)}if(e===Za)return lt(a),!1;return e}).forEach((a)=>{let e;try{e=a.callback(t)}catch(o){console.error(`Listener ${a.description} threw "${o}" handling "${t}"`)}if(e===Za)lt(a)});if(st.splice(0),Wt=!1,typeof Ft==="function")Ft();if(ot.perf)console.timeEnd("xin async update")},mn=(n)=>{let t=typeof n==="string"?n:Wn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),new Error("touch was called on an invalid target");if(Wt===!1)Yt=new Promise((a)=>{Ft=a}),Wt=setTimeout(Jo);if(st.find((a)=>t.startsWith(a))==null)st.push(t)},ue=(n,t)=>{return new he(n,t)},lt=(n)=>{let t=it.indexOf(n);if(t>-1)it.splice(t,1);else throw new Error("unobserve failed, listener not found")},Ro=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},pe=(...n)=>new Error(n.map(Ro).join(" ")),Go=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Uo=0,Ko=()=>(parseInt("10000",36)+ ++Uo).toString(36).slice(-5),Qo=()=>Go()+Ko(),$t=Symbol("delete"),me=Symbol("new-object"),Ht=Symbol("automatic-index");function ce(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let a=n.search(/\[[^\]]+\]/);if(a===-1){t.push(n.split("."));break}else{let e=n.slice(0,a);if(n=n.slice(a),e!=="")t.push(e.split("."));if(a=n.indexOf("]")+1,t.push(n.slice(1,a-1)),n.slice(a,a+1)===".")a+=1;n=n.slice(a)}}return t}}var U=new WeakMap;function be(n,t){if(U.get(n)===void 0)U.set(n,{});if(U.get(n)[t]===void 0)U.get(n)[t]={};let a=U.get(n)[t];if(t==="_auto_")n.forEach((e,o)=>{if(e[Ht]===void 0)e[Ht]=Qo();a[e[Ht]+""]=o});else n.forEach((e,o)=>{a[Hn(e,t)+""]=o});return a}function Zo(n,t){if(U.get(n)===void 0||U.get(n)[t]===void 0)return be(n,t);else return U.get(n)[t]}function ko(n,t,a){a=a+"";let e=Zo(n,t)[a];if(e===void 0||Hn(n[e],t)+""!==a)e=be(n,t)[a];return e}function ni(n,t,a){if(n[t]===void 0&&a!==void 0)n[t]=a;return n[t]}function ge(n,t,a,e){let o=t!==""?ko(n,t,a):a;if(e===$t)return n.splice(o,1),U.delete(n),Symbol("deleted");else if(e===me){if(t===""&&n[o]===void 0)n[o]={}}else if(e!==void 0)if(o!==void 0)n[o]=e;else if(t!==""&&Hn(e,t)+""===a+"")n.push(e),o=n.length-1;else throw new Error(`byIdPath insert failed at [${t}=${a}]`);return n[o]}function ka(n){if(!Array.isArray(n))throw pe("setByPath failed: expected array, found",n)}function ne(n){if(n==null||!(n instanceof Object))throw pe("setByPath failed: expected Object, found",n)}function Hn(n,t){let a=ce(t),e=n,o,i,s,l;for(o=0,i=a.length;e!==void 0&&o<i;o++){let d=a[o];if(Array.isArray(d))for(s=0,l=d.length;e!==void 0&&s<l;s++){let h=d[s];e=e[h]}else if(e.length===0){if(e=e[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[h,...p]=d.split("=");e=ge(e,h,p.join("="))}else s=parseInt(d,10),e=e[s]}return e}function ti(n,t,a){let e=n;if(t==="")throw new Error("setByPath cannot be used to set the root object");let o=ce(t);while(e!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)ne(e);else ka(e);let l=i.slice(0,s),d=i.slice(s+1);if(e=ge(e,l,d,o.length>0?me:a),o.length===0)return!0}else{ka(e);let l=parseInt(i,10);if(o.length>0)e=e[l];else{if(a!==$t){if(e[l]===a)return!1;e[l]=a}else e.splice(l,1);return!0}}}else if(Array.isArray(i)&&i.length>0){ne(e);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)e=ni(e,s,i.length>0?{}:[]);else{if(a!==$t){if(e[s]===a)return!1;e[s]=a}else{if(!Object.prototype.hasOwnProperty.call(e,s))return!1;delete e[s]}return!0}}}else throw new Error(`setByPath failed, bad path ${t}`)}throw new Error(`setByPath(${n}, ${t}, ${a}) failed`)}var ai=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Gt={},ei=!0,oi=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ii=(n)=>oi.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},si={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function qt(n,t){let a=typeof n;if(n===void 0||a==="object"||a==="function")return n;else return new Proxy(si[typeof n](n),Sn(t,!0))}var Sn=(n,t)=>({get(a,e){switch(e){case K:return n;case zn:return a.valueOf?a.valueOf():a;case Lo:return(s)=>M[n]=s;case Wo:return(s)=>{let l=ue(n,s);return()=>lt(l)};case Fo:return(s,l)=>ht(s,l,X(a));case Yo:return(s,l,d)=>{q(s,n,l,d)}}if(typeof e==="symbol")return a[e];let o=e,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,l]=i,d=dn(n,s),h=Hn(a,s);return h!==null&&typeof h==="object"?new Proxy(h,Sn(d,t))[l]:h}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(a)&&a[o]!==void 0||Array.isArray(a)&&o.includes("=")){let s;if(o.includes("=")){let[l,d]=o.split("=");s=a.find((h)=>`${Hn(h,l)}`===d)}else s=a[o];if(s instanceof Object){let l=dn(n,o);return new Proxy(s instanceof Function?s.bind(a):s,Sn(l,t))}else return t?qt(s,dn(n,o)):s}else if(Array.isArray(a)){let s=a[o];return typeof s==="function"?(...l)=>{let d=s.apply(a,l);if(ai.includes(o))mn(n);return d}:typeof s==="object"?new Proxy(s,Sn(dn(n,o),t)):t?qt(s,dn(n,o)):s}else return t?qt(a[o],dn(n,o)):a[o]},set(a,e,o){o=X(o);let i=e!==zn?dn(n,e):n;if(ei&&!ii(i))throw new Error(`setting invalid path ${i}`);if(X(M[i])!==o&&ti(Gt,i,o))mn(i);return!0}}),Yn=(n,t)=>{let a=typeof t==="function"?t:M[t];if(typeof a!=="function")throw new Error(`observe expects a function or path to a function, ${t} is neither`);return ue(n,a)},M=new Proxy(Gt,Sn("",!1)),rt=new Proxy(Gt,Sn("",!0)),ye=(n,t)=>{let a=new Event(t);n.dispatchEvent(a)},fe=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},li=(n,t)=>{switch(fe(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let a of Array.from(n.querySelectorAll("option")))a.selected=t[a.value];break;default:n.value=t}},ri=(n)=>{switch(fe(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,a)=>{return t[a.value]=a.selected,t},{});default:return n.value}},{ResizeObserver:te}=globalThis,Jt=te!=null?new te((n)=>{for(let t of n){let a=t.target;ye(a,"resize")}}):{observe(){},unobserve(){}},ae=(n,t,a=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((e)=>{n.append(e instanceof Node&&a?Xn(e):e)});else if(t instanceof Node)n.append(a?Xn(t):t);else throw new Error("expect text content or document node")},dt=(n,t=250)=>{let a;return(...e)=>{if(a!==void 0)clearTimeout(a);a=setTimeout(()=>{n(...e)},t)}},qn=(n,t=250)=>{let a,e=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(a),a=setTimeout(async()=>{n(...i),e=Date.now()},t),!o&&Date.now()-e>=t){o=!0;try{n(...i),e=Date.now()}finally{o=!1}}}},Rt=Symbol("list-binding"),di=16,hi=100;function ee(n,t){let a=Array.from(n.querySelectorAll(Tn));if(n.matches(Tn))a.unshift(n);for(let e of a){let o=pn.get(e);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(e,M[i.path])}}}class we{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,a={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw new Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let e=n.children[0];if(e.content.children.length!==1)throw new Error("ListBinding expects a template with exactly one child element");this.template=Xn(e.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=a,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),a.virtual!=null)Jt.observe(this.boundElement),this._update=qn(()=>{this.update(this._array,!0)},di),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:a}=this.options,e=this._array;if(t!==void 0)e=e.filter((d)=>d[t]!==!0);if(a!==void 0)e=e.filter((d)=>d[a]===!0);if(this.options.filter&&this.needle!==void 0)e=this.options.filter(e,this.needle);let o=0,i=e.length-1,s=0,l=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,h=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(h/n.height)+(n.rowChunkSize||1),m=Math.ceil(e.length/n.visibleColumns),c=n.visibleColumns*p,x=Math.floor(this.boundElement.scrollTop/n.height);if(x>m-p+1)x=Math.max(0,m-p+1);if(n.rowChunkSize)x-=x%n.rowChunkSize;o=x*n.visibleColumns,i=o+c-1,s=x*n.height,l=Math.max((m-p)*n.height-s,0)}return{items:e,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:l}}needle;filter=qn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},hi);update(n,t){if(n==null)n=[];this._array=n;let{hiddenProp:a,visibleProp:e}=this.options,o=Wn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:l,lastItem:d,topBuffer:h,bottomBuffer:p}=i;if(a===void 0&&e===void 0&&t===!0&&s!=null&&l===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let m=0,c=0,x=0;for(let C of Array.from(this.boundElement.children)){if(C===this.listTop||C===this.listBottom)continue;let E=et.get(C);if(E==null)C.remove();else{let j=i.items.indexOf(E);if(j<l||j>d)C.remove(),this.itemToElement.delete(E),et.delete(C),m++}}this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(p)+"px";let B=[],{idPath:O}=this.options;for(let C=l;C<=d;C++){let E=i.items[C];if(E===void 0)continue;let j=this.itemToElement.get(X(E));if(j==null){if(x++,j=Xn(this.template),typeof E==="object")this.itemToElement.set(X(E),j),et.set(j,X(E));if(this.boundElement.insertBefore(j,this.listBottom),O!=null){let P=E[O],V=`${o}[${O}=${P}]`;ee(j,V)}else{let P=`${o}[${C}]`;ee(j,P)}}B.push(j)}let T=null;for(let C of B){if(C.previousElementSibling!==T)if(c++,T?.nextElementSibling!=null)this.boundElement.insertBefore(C,T.nextElementSibling);else this.boundElement.insertBefore(C,this.listBottom);T=C}if(ot.perf)console.log(o,"updated",{removed:m,created:x,moved:c})}}var ui=(n,t,a)=>{let e=n[Rt];if(e===void 0)e=new we(n,t,a),n[Rt]=e;return e},{document:Nn,MutationObserver:oe}=globalThis,Ut=(n,t)=>{let a=pn.get(n);if(a==null)return;for(let e of a){let{binding:o,options:i}=e,{path:s}=e,{toDOM:l}=o;if(l!=null){if(s.startsWith("^")){let d=cn(n);if(d!=null&&d[K]!=null)s=e.path=`${d[K]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),new Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))l(n,M[s],i)}}};if(oe!=null)new oe((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((a)=>{if(a instanceof Element)Array.from(a.querySelectorAll(Tn)).forEach((e)=>Ut(e))})})}).observe(Nn.body,{subtree:!0,childList:!0});Yn(()=>!0,(n)=>{let t=Array.from(Nn.querySelectorAll(Tn));for(let a of t)Ut(a,n)});var ie=(n)=>{let t=n.target.closest(Tn);while(t!=null){let a=pn.get(t);for(let e of a){let{binding:o,path:i}=e,{fromDOM:s}=o;if(s!=null){let l;try{l=s(t,e.options)}catch(d){throw console.error("Cannot get value from",t,"via",e),new Error("Cannot obtain value fromDOM")}if(l!=null){let d=M[i];if(d==null)M[i]=l;else{let h=d[K]!=null?d[zn]:d,p=l[K]!=null?l[zn]:l;if(h!==p)M[i]=p}}}}t=t.parentElement.closest(Tn)}};if(globalThis.document!=null)Nn.body.addEventListener("change",ie,!0),Nn.body.addEventListener("input",ie,!0);function q(n,t,a,e){if(n instanceof DocumentFragment)throw new Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[K]===void 0&&e===void 0){let{value:l}=t;o=typeof l==="string"?l:l[K],e=t,delete e.value}else o=typeof t==="string"?t:t[K];if(o==null)throw new Error("bind requires a path or object with xin Proxy");let{toDOM:i}=a;n.classList?.add(re);let s=pn.get(n);if(s==null)s=[],pn.set(n,s);if(s.push({path:o,binding:a,options:e}),i!=null&&!o.startsWith("^"))mn(o);if(e?.filter&&e?.needle)q(n,e.needle,{toDOM(l,d){console.log({needle:d}),l[Rt]?.filter(d)}});return n}var se=new Set,pi=(n)=>{let t=n?.target.closest(Qa),a=!1,e=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),a=!0};else{let l=i[s];return typeof l==="function"?l.bind(i):l}}}),o=new Set;while(!a&&t!=null){let i=Vn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(e);else{let l=M[s];if(typeof l==="function")l(e);else throw new Error(`no event handler found at path ${s}`)}if(a)continue}t=t.parentElement!=null?t.parentElement.closest(Qa):null}};function ht(n,t,a){let e=Vn.get(n);if(n.classList.add(de),e==null)e={},Vn.set(n,e);if(!e[t])e[t]=new Set;if(e[t].add(a),!se.has(t))se.add(t),Nn.body.addEventListener(t,pi,!0);return()=>{e[t].delete(a)}}var Q={value:{toDOM:li,fromDOM(n){return ri(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,a){ui(n,t,a).update(t)}}},mi=180/Math.PI,ci=Math.PI/180;function F(n,t,a){return a<n?NaN:t<n?n:t>a?a:t}function k(n,t,a,e=!0){if(e)a=F(0,a,1);return a*(t-n)+n}var bi={RADIANS_TO_DEGREES:mi,DEGREES_TO_RADIANS:ci,clamp:F,lerp:k};function ve(n,t=document.body){let a=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return a.getPropertyValue(n).trim()}var gi=(n,t,a)=>{return(0.299*n+0.587*t+0.114*a)/255},hn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class xe{h;s;l;constructor(n,t,a){n/=255,t/=255,a/=255;let e=Math.max(n,t,a),o=e-Math.min(n,t,a),i=o!==0?e===n?(t-a)/o:e===t?2+(a-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?e<=0.5?o/(2*e-o):o/(2-(2*e-o)):0,this.l=(2*e-o)/2}}var jn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class v{r;g;b;a;static fromVar(n,t=document.body){return v.fromCss(ve(n,t))}static fromCss(n){let t=n;if(jn instanceof HTMLSpanElement)jn.style.color="black",jn.style.color=n,document.body.appendChild(jn),t=getComputedStyle(jn).color,jn.remove();let[a,e,o,i]=t.match(/[\d.]+/g),s=t.startsWith("color(srgb")?255:1;return new v(Number(a)*s,Number(e)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,a,e=1){return v.fromCss(`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}% / ${(e*100).toFixed(0)}%)`)}static black=new v(0,0,0);static white=new v(255,255,255);constructor(n,t,a,e=1){this.r=F(0,n,255),this.g=F(0,t,255),this.b=F(0,a,255),this.a=e!==void 0?F(0,e,1):e=1}get inverse(){return new v(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:a}=this._hsl;return v.fromHsl(n,t,1-a,this.a)}contrasting(n=1){let{h:t,s:a,l:e}=this._hsl;return this.blend(this.brightness>0.5?v.black:v.white,n)}get rgb(){let{r:n,g:t,b:a}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${a.toFixed(0)})`}get rgba(){let{r:n,g:t,b:a,a:e}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${a.toFixed(0)},${e.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new xe(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:a}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:a}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(a*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new v(n,n,n)}get brightness(){return gi(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+hn(this.r)+hn(this.g)+hn(this.b):"#"+hn(this.r)+hn(this.g)+hn(this.b)+hn(Math.floor(255*this.a))}brighten(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,e+n*(1-e),1);return v.fromHsl(t,a,o,this.a)}darken(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,e*(1-n),1);return v.fromHsl(t,a,o,this.a)}saturate(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,a+n*(1-a),1);return v.fromHsl(t,o,e,this.a)}desaturate(n){let{h:t,s:a,l:e}=this._hsl,o=F(0,a*(1-n),1);return v.fromHsl(t,o,e,this.a)}rotate(n){let{h:t,s:a,l:e}=this._hsl,o=(t+360+n)%360;return v.fromHsl(o,a,e,this.a)}opacity(n){let{h:t,s:a,l:e}=this._hsl;return v.fromHsl(t,a,e,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new v(k(this.r,n.r,t),k(this.g,n.g,t),k(this.b,n.b,t),k(this.a,n.a,t))}static blendHue(n,t,a){let e=(t-n+720)%360;if(e<180)return n+a*e;else return n-(360-e)*a}mix(n,t){let a=this._hsl,e=n._hsl;return v.fromHsl(a.s===0?e.h:e.s===0?a.h:v.blendHue(a.h,e.h,t),k(a.s,e.s,t),k(a.l,e.l,t),k(this.a,n.a,t))}colorMix(n,t){return v.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function nn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function yi(n){return n.replace(/-([a-z])/g,(t,a)=>{return a.toLocaleUpperCase()})}var fi="http://www.w3.org/1998/Math/MathML",wi="http://www.w3.org/2000/svg",at={},Ce=(n,t,a)=>{let e=Te(nn(t),a);if(e.prop.startsWith("--"))n.style.setProperty(e.prop,e.value);else n.style[t]=e.value},vi=(n)=>{return{toDOM(t,a){Ce(t,n,a)}}},je=(n,t,a)=>{if(t==="style")if(typeof a==="object")for(let e of Object.keys(a))if(Wn(a[e]))q(n,a[e],vi(e));else Ce(n,e,a[e]);else n.setAttribute("style",a);else if(n[t]!==void 0){let{MathMLElement:e}=globalThis;if(n instanceof SVGElement||e!==void 0&&n instanceof e)n.setAttribute(t,a);else n[t]=a}else{let e=nn(t);if(e==="class")a.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[e]!==void 0)n[e]=a;else if(typeof a==="boolean")a?n.setAttribute(e,""):n.removeAttribute(e);else n.setAttribute(e,a)}},xi=(n)=>{return{toDOM(t,a){je(t,n,a)}}},Ci=(n,t,a)=>{if(t==="apply")a(n);else if(t.match(/^on[A-Z]/)!=null){let e=t.substring(2).toLowerCase();ht(n,e,a)}else if(t==="bind")if((typeof a.binding==="string"?Q[a.binding]:a.binding)!==void 0&&a.value!==void 0)q(n,a.value,a.binding instanceof Function?{toDOM:a.binding}:a.binding);else throw new Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let e=t.substring(4,5).toLowerCase()+t.substring(5),o=Q[e];if(o!==void 0)q(n,a,o);else throw new Error(`${t} is not allowed, bindings.${e} is not defined`)}else if(Wn(a))q(n,a,xi(t));else je(n,t,a)},Kt=(n,...t)=>{if(at[n]===void 0){let[o,i]=n.split("|");if(i===void 0)at[n]=globalThis.document.createElement(o);else at[n]=globalThis.document.createElementNS(i,o)}let a=at[n].cloneNode(),e={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(a instanceof HTMLTemplateElement)a.content.append(o);else a.append(o);else if(o.xinPath)a.append(g.span({bindText:o}));else Object.assign(e,o);for(let o of Object.keys(e)){let i=e[o];Ci(a,o,i)}return a},Qt=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let a of n)t.append(a);return t},g=new Proxy({fragment:Qt},{get(n,t){if(t=t.replace(/[A-Z]/g,(a)=>`-${a.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...a)=>Kt(t,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),ut=new Proxy({fragment:Qt},{get(n,t){if(n[t]===void 0)n[t]=(...a)=>Kt(`${t}|${wi}`,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),Se=new Proxy({fragment:Qt},{get(n,t){if(n[t]===void 0)n[t]=(...a)=>Kt(`${t}|${fi}`,...a);return n[t]},set(){throw new Error("You may not add new properties to elements")}});function Fn(n,t){let a=g.style(Ln(t));a.id=n,document.head.append(a)}var ji=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Te=(n,t)=>{if(typeof t==="number"&&!ji.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Si=(n,t,a)=>{if(a===void 0)return"";if(a instanceof v)a=a.html;let e=Te(t,a);return`${n}  ${e.prop}: ${e.value};`},Ee=(n,t,a="")=>{let e=nn(n);if(typeof t==="object"&&!(t instanceof v)){let o=Object.keys(t).map((i)=>Ee(i,t[i],`${a}  `)).join(`
`);return`${a}  ${n} {
${o}
${a}  }`}else return Si(a,e,t)},Ln=(n,t="")=>{return Object.keys(n).map((a)=>{let e=n[a];if(typeof e==="string"){if(a==="@import")return`@import url('${e}');`;throw new Error("top-level string value only allowed for `@import`")}let o=Object.keys(e).map((i)=>Ee(i,e[i])).join(`
`);return`${t}${a} {
${o}
}`}).join(`

`)},Ti=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let a of Object.keys(n)){let e=n[a],o=nn(a);t[`--${o}`]=typeof e==="number"&&e!==0?String(e)+"px":e}return t},Zt=(n)=>{let t={};for(let a of Object.keys(n)){let e=n[a];if(e instanceof v)t[a]=e.inverseLuminance;else if(typeof e==="string"&&e.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[a]=v.fromCss(e).inverseLuminance}return t},u=new Proxy({},{get(n,t){if(n[t]===void 0){let a="--"+nn(t);n[t]=(e)=>`var(${a}, ${e})`}return n[t]}}),r=new Proxy({},{get(n,t){if(t==="default")return u;if(n[t]==null){t=nn(t);let[,a,,e,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${a}`;if(o!=null){let l=e==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=v.fromVar(s);n[t]=l>0?d.brighten(l).rgba:d.darken(-l).rgba}break;case"s":{let d=v.fromVar(s);n[t]=l>0?d.saturate(l).rgba:d.desaturate(-l).rgba}break;case"h":{let d=v.fromVar(s);n[t]=d.rotate(l*100).rgba}break;case"o":{let d=v.fromVar(s);n[t]=d.opacity(l).rgba}break;case"":n[t]=`calc(var(${s}) * ${l})`;break;default:throw console.error(i),new Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),Ei=0;function Nt(){return`custom-elt${(Ei++).toString(36)}`}var le=0,An={};function Ii(n,t){let a=An[n],e=Ln(t).replace(/:host\b/g,n);An[n]=a?a+`
`+e:e}function Pi(n){if(An[n])document.head.append(g.style({id:n+"-component"},An[n]));delete An[n]}class y extends HTMLElement{static elements=g;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=g.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),g.style(Ln(n))}static elementCreator(n={}){if(this._elementCreator==null){let{tag:t,styleSpec:a}=n,e=n!=null?t:null;if(e==null)if(typeof this.name==="string"&&this.name!==""){if(e=nn(this.name),e.startsWith("-"))e=e.slice(1)}else e=Nt();if(customElements.get(e)!=null)console.warn(`${e} is already defined`);if(e.match(/\w+(-\w+)+/)==null)console.warn(`${e} is not a legal tag for a custom-element`),e=Nt();while(customElements.get(e)!==void 0)e=Nt();if(this._tagName=e,a!==void 0)Ii(e,a);window.customElements.define(e,this,n),this._elementCreator=g[e]}return this._elementCreator}initAttributes(...n){let t={},a={};new MutationObserver((e)=>{let o=!1;if(e.forEach((i)=>{o=!!(i.attributeName&&n.includes(yi(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((e)=>{t[e]=un(this[e]);let o=nn(e);Object.defineProperty(this,e,{enumerable:!1,get(){if(typeof t[e]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[e]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(a[e]!==void 0)return a[e];else return t[e]},set(i){if(typeof t[e]==="boolean"){if(i!==this[e]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[e]==="number"){if(i!==parseFloat(this[e]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[e]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),a[e]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):un(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(a){if(t!==a)t=a,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,a){if(t[a]===void 0){let e=n.querySelector(`[part="${a}"]`);if(e==null)e=n.querySelector(a);if(e==null)throw new Error(`elementRef "${a}" does not exist!`);e.removeAttribute("data-ref"),t[a]=e}return t[a]}});return this._parts}constructor(){super();le+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${le}`,this._value=un(this.defaultValue)}connectedCallback(){if(Pi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(Jt.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){Jt.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)ye(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content():this.content,{styleSpec:a}=this.constructor,{styleNode:e}=this.constructor;if(a)e=this.constructor.styleNode=g.style(Ln(a)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),e=this.styleNode;if(e){let o=this.attachShadow({mode:"open"});o.appendChild(e.cloneNode(!0)),ae(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);ae(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(kt.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((l)=>{s[l.name]=l}),o.forEach((l)=>{let d=s[""],h=l instanceof Element?s[l.slot]:d;(h!==void 0?h:d).append(l)})}}this._hydrated=!0}}render(){}}class kt extends y{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Dl=kt.elementCreator({tag:"xin-slot"}),na=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let e=JSON.parse(t);for(let o of Object.keys(e).filter(n))if(M[o]!==void 0)Object.assign(M[o],e[o]);else M[o]=e[o]}let a=dt(()=>{let e={},o=X(M);for(let i of Object.keys(o).filter(n))e[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(e)),console.log("xin state saved to localStorage")},500);Yn(n,a)},pt="1.0.3";function Z(n){return Object.assign(rt,n),rt}function ta(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),Z(n)}function Ie(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),ta(n);return Object.keys(n).forEach((a)=>{M[a]=n[a]}),M}var Mi={};async function aa(n,t){let{type:a,styleSpec:e}=await t(n,{Color:v,Component:y,elements:g,svgElements:ut,mathML:Se,varDefault:u,vars:r,xin:M,boxed:rt,xinProxy:Ie,boxedProxy:ta,makeComponent:aa,bind:q,on:ht,version:pt}),o={type:a,creator:a.elementCreator({tag:n,styleSpec:e})};return Mi[n]=o,o}var Lt={},_i=(n)=>import(n);class mt extends y{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:a}=this,e=`${n}.${a}:${t}`;if(!this.loaded){if(Lt[e]===void 0)Lt[e]=_i(t).then((o)=>{let i=o[a];return aa(n,i)});else console.log(`using cached ${n}`);this.loaded=await Lt[e],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var Bi=mt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ea extends y{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(mt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Oi=ea.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Ga={};Ka(Ga,{xrControllersText:()=>Ns,xrControllers:()=>qs,xinTagList:()=>jl,xinTag:()=>Do,xinSizer:()=>wl,xinSelect:()=>kn,xinSegmented:()=>fl,xinRating:()=>sl,xinPasswordStrength:()=>il,xinNotification:()=>Io,xinMenu:()=>cs,xinLocalized:()=>_t,xinForm:()=>Xs,xinFloat:()=>ba,xinField:()=>Vs,xinCarousel:()=>as,version:()=>Ra,updateLocalized:()=>Sa,trackDrag:()=>on,tosijs:()=>$n,tosiMonth:()=>nl,tabSelector:()=>To,svgIcon:()=>Zi,svg2DataUrl:()=>Mt,styleSheet:()=>oo,spacer:()=>Bn,sizeBreak:()=>Fa,sideNav:()=>Wa,setLocale:()=>ls,scriptTag:()=>vn,richTextWidgets:()=>Oo,richText:()=>ml,removeLastMenu:()=>Cn,postNotification:()=>el,positionFloat:()=>ho,popMenu:()=>G,popFloat:()=>ro,menu:()=>yo,markdownViewer:()=>Aa,mapBox:()=>Qs,makeSorter:()=>uo,makeExamplesLive:()=>Gs,localize:()=>D,localePicker:()=>hs,liveExample:()=>Ot,isBreached:()=>Mo,initLocalization:()=>ds,icons:()=>f,i18n:()=>_,gamepadText:()=>Hs,gamepadState:()=>So,findHighestZ:()=>ja,filterPart:()=>Pt,filterBuilder:()=>_s,elastic:()=>hl,editableRect:()=>Ts,dragAndDrop:()=>wo,digest:()=>Po,defineIcons:()=>Qi,dataTable:()=>js,createSubMenu:()=>bo,createMenuItem:()=>go,createMenuAction:()=>co,commandButton:()=>Y,colorInput:()=>lo,codeEditor:()=>Et,bringToFront:()=>Zn,bodymovinPlayer:()=>ns,blockStyle:()=>Ha,b3d:()=>ki,availableFilters:()=>Ma,abTest:()=>Ki,XinTagList:()=>Ja,XinTag:()=>Dt,XinSizer:()=>$a,XinSelect:()=>tt,XinSegmented:()=>Na,XinRating:()=>Xa,XinPasswordStrength:()=>Va,XinNotification:()=>xn,XinMenu:()=>Ia,XinLocalized:()=>R,XinForm:()=>nt,XinFloat:()=>sn,XinField:()=>Bt,XinCarousel:()=>Ca,TosiMonth:()=>za,TabSelector:()=>Oa,SvgIcon:()=>va,SizeBreak:()=>Ya,SideNav:()=>La,RichText:()=>qa,MarkdownViewer:()=>Da,MapBox:()=>wn,LocalePicker:()=>Ta,LiveExample:()=>On,FilterPart:()=>_a,FilterBuilder:()=>Ba,EditableRect:()=>L,DataTable:()=>Pa,CodeEditor:()=>_n,BodymovinPlayer:()=>Mn,B3d:()=>xa,AbTest:()=>Pn});function oa(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}var tn=oa();function De(n){tn=n}var Ae=/[&<>"']/,Di=new RegExp(Ae.source,"g"),ze=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Ai=new RegExp(ze.source,"g"),zi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Pe=(n)=>zi[n];function A(n,t){if(t){if(Ae.test(n))return n.replace(Di,Pe)}else if(ze.test(n))return n.replace(Ai,Pe);return n}var Vi=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Ve(n){return n.replace(Vi,(t,a)=>{if(a=a.toLowerCase(),a==="colon")return":";if(a.charAt(0)==="#")return a.charAt(1)==="x"?String.fromCharCode(parseInt(a.substring(2),16)):String.fromCharCode(+a.substring(1));return""})}var Xi=/(^|[^\[])\^/g;function I(n,t){n=typeof n==="string"?n:n.source,t=t||"";let a={replace:(e,o)=>{return o=o.source||o,o=o.replace(Xi,"$1"),n=n.replace(e,o),a},getRegex:()=>{return new RegExp(n,t)}};return a}var Hi=/[^\w:]/g,qi=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Me(n,t,a){if(n){let e;try{e=decodeURIComponent(Ve(a)).replace(Hi,"").toLowerCase()}catch(o){return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}if(t&&!qi.test(a))a=Yi(t,a);try{a=encodeURI(a).replace(/%25/g,"%")}catch(e){return null}return a}var ct={},Ni=/^[^:]+:\/*[^/]*$/,Li=/^([^:]+:)[\s\S]*$/,Wi=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Yi(n,t){if(!ct[" "+n])if(Ni.test(n))ct[" "+n]=n+"/";else ct[" "+n]=bt(n,"/",!0);n=ct[" "+n];let a=n.indexOf(":")===-1;if(t.substring(0,2)==="//"){if(a)return t;return n.replace(Li,"$1")+t}else if(t.charAt(0)==="/"){if(a)return t;return n.replace(Wi,"$1")+t}else return n+t}var gt={exec:function n(){}};function _e(n,t){let a=n.replace(/\|/g,(i,s,l)=>{let d=!1,h=s;while(--h>=0&&l[h]==="\\")d=!d;if(d)return"|";else return" |"}),e=a.split(/ \|/),o=0;if(!e[0].trim())e.shift();if(e.length>0&&!e[e.length-1].trim())e.pop();if(e.length>t)e.splice(t);else while(e.length<t)e.push("");for(;o<e.length;o++)e[o]=e[o].trim().replace(/\\\|/g,"|");return e}function bt(n,t,a){let e=n.length;if(e===0)return"";let o=0;while(o<e){let i=n.charAt(e-o-1);if(i===t&&!a)o++;else if(i!==t&&a)o++;else break}return n.slice(0,e-o)}function Fi(n,t){if(n.indexOf(t[1])===-1)return-1;let a=n.length,e=0,o=0;for(;o<a;o++)if(n[o]==="\\")o++;else if(n[o]===t[0])e++;else if(n[o]===t[1]){if(e--,e<0)return o}return-1}function $i(n,t){if(!n||n.silent)return;if(t)console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async");if(n.sanitize||n.sanitizer)console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");if(n.highlight||n.langPrefix!=="language-")console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight.");if(n.mangle)console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`.");if(n.baseUrl)console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url.");if(n.smartypants)console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants.");if(n.xhtml)console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml.");if(n.headerIds||n.headerPrefix)console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`.")}function Be(n,t,a,e){let o=t.href,i=t.title?A(t.title):null,s=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){e.state.inLink=!0;let l={type:"link",raw:a,href:o,title:i,text:s,tokens:e.inlineTokens(s)};return e.state.inLink=!1,l}return{type:"image",raw:a,href:o,title:i,text:A(s)}}function Ji(n,t){let a=n.match(/^(\s+)(?:```)/);if(a===null)return t;let e=a[1];return t.split(`
`).map((o)=>{let i=o.match(/^\s+/);if(i===null)return o;let[s]=i;if(s.length>=e.length)return o.slice(e.length);return o}).join(`
`)}class Rn{constructor(n){this.options=n||tn}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let a=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:!this.options.pedantic?bt(a,`
`):a}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let a=t[0],e=Ji(a,t[3]||"");return{type:"code",raw:a,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:e}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let a=t[2].trim();if(/#$/.test(a)){let e=bt(a,"#");if(this.options.pedantic)a=e.trim();else if(!e||/ $/.test(e))a=e.trim()}return{type:"heading",raw:t[0],depth:t[1].length,text:a,tokens:this.lexer.inline(a)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){let t=this.rules.block.blockquote.exec(n);if(t){let a=t[0].replace(/^ *>[ \t]?/gm,""),e=this.lexer.state.top;this.lexer.state.top=!0;let o=this.lexer.blockTokens(a);return this.lexer.state.top=e,{type:"blockquote",raw:t[0],tokens:o,text:a}}}list(n){let t=this.rules.block.list.exec(n);if(t){let a,e,o,i,s,l,d,h,p,m,c,x,B=t[1].trim(),O=B.length>1,T={type:"list",raw:"",ordered:O,start:O?+B.slice(0,-1):"",loose:!1,items:[]};if(B=O?`\\d{1,9}\\${B.slice(-1)}`:`\\${B}`,this.options.pedantic)B=O?B:"[*+-]";let C=new RegExp(`^( {0,3}${B})((?:[	 ][^\\n]*)?(?:\\n|$))`);while(n){if(x=!1,!(t=C.exec(n)))break;if(this.rules.block.hr.test(n))break;if(a=t[0],n=n.substring(a.length),h=t[2].split(`
`,1)[0].replace(/^\t+/,(j)=>" ".repeat(3*j.length)),p=n.split(`
`,1)[0],this.options.pedantic)i=2,c=h.trimLeft();else i=t[2].search(/[^ ]/),i=i>4?1:i,c=h.slice(i),i+=t[1].length;if(l=!1,!h&&/^ *$/.test(p))a+=p+`
