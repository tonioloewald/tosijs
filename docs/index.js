...
`,1)[0],Wn;if(g=$e,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Wn=g):Wn=g.replace(this.rules.other.tabCharGlobal,"    "),S.test(g)||M.test(g)||En.test(g)||T.test(g)||j.test(g))break;if(Wn.search(this.rules.other.nonSpaceChar)>=v||!g.trim())p+=`
