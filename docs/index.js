...
`,1)[0].replace(this.rules.other.listReplaceTabs,(T)=>" ".repeat(3*T.length)),m=n.split(`
...
`}strong({tokens:n}){return`<strong>${this.parser.parseInline(n)}</strong>`}em({tokens:n}){return`<em>${this.parser.parseInline(n)}</em>`}codespan({text:n}){return`<code>${Bn(n,!0)}</code>`}br(n){return"<br>"}del({tokens:n}){return`<del>${this.parser.parseInline(n)}</del>`}link({href:n,title:e,tokens:t}){let o=this.parser.parseInline(t),i=_a(n);if(i===null)return o;n=i;let s='<a href="'+n+'"';return e&&(s+=' title="'+Bn(e)+'"'),s+=">"+o+"</a>",s}image({href:n,title:e,text:t,tokens:o}){o&&(t=this.parser.parseInline(o,this.parser.textRenderer));let i=_a(n);if(i===null)return Bn(t);n=i;let s=`<img src="${n}" alt="${t}"`;return e&&(s+=` title="${Bn(e)}"`),s+=">",s}text(n){return"tokens"in n&&n.tokens?this.parser.parseInline(n.tokens):("escaped"in n)&&n.escaped?n.text:Bn(n.text)}},Pi=class{strong({text:n}){return n}em({text:n}){return n}codespan({text:n}){return n}del({text:n}){return n}html({text:n}){return n}text({text:n}){return n}link({text:n}){return""+n}image({text:n}){return""+n}br(){return""}},yn=class n{options;renderer;textRenderer;constructor(e){this.options=e||En,this.options.renderer=this.options.renderer||new Ut,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new Pi}static parse(e,t){return new n(t).parse(e)}static parseInline(e,t){return new n(t).parseInline(e)}parse(e,t=!0){let o="";for(let i=0;i<e.length;i++){let s=e[i];if(this.options.extensions?.renderers?.[s.type]){let r=s,l=this.options.extensions.renderers[r.type].call({parser:this},r);if(l!==!1||!["space","hr","heading","code","table","blockquote","list","html","def","paragraph","text"].includes(r.type)){o+=l||"";continue}}let a=s;switch(a.type){case"space":{o+=this.renderer.space(a);continue}case"hr":{o+=this.renderer.hr(a);continue}case"heading":{o+=this.renderer.heading(a);continue}case"code":{o+=this.renderer.code(a);continue}case"table":{o+=this.renderer.table(a);continue}case"blockquote":{o+=this.renderer.blockquote(a);continue}case"list":{o+=this.renderer.list(a);continue}case"html":{o+=this.renderer.html(a);continue}case"def":{o+=this.renderer.def(a);continue}case"paragraph":{o+=this.renderer.paragraph(a);continue}case"text":{let r=a,l=this.renderer.text(r);for(;i+1<e.length&&e[i+1].type==="text";)r=e[++i],l+=`
`+this.renderer.text(r);t?o+=this.renderer.paragraph({type:"paragraph",raw:l,text:l,tokens:[{type:"text",raw:l,text:l,escaped:!0}]}):o+=l;continue}default:{let r='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(r),"";throw Error(r)}}}return o}parseInline(e,t=this.renderer){let o="";for(let i=0;i<e.length;i++){let s=e[i];if(this.options.extensions?.renderers?.[s.type]){let r=this.options.extensions.renderers[s.type].call({parser:this},s);if(r!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){o+=r||"";continue}}let a=s;switch(a.type){case"escape":{o+=t.text(a);break}case"html":{o+=t.html(a);break}case"link":{o+=t.link(a);break}case"image":{o+=t.image(a);break}case"strong":{o+=t.strong(a);break}case"em":{o+=t.em(a);break}case"codespan":{o+=t.codespan(a);break}case"br":{o+=t.br(a);break}case"del":{o+=t.del(a);break}case"text":{o+=t.text(a);break}default:{let r='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(r),"";throw Error(r)}}}return o}},$e=class{options;block;constructor(n){this.options=n||En}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens","emStrongMask"]);static passThroughHooksRespectAsync=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(n){return n}postprocess(n){return n}processAllTokens(n){return n}emStrongMask(n){return n}provideLexer(){return this.block?mn.lex:mn.lexInline}provideParser(){return this.block?yn.parse:yn.parseInline}},oh=class{defaults=ki();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=yn;Renderer=Ut;TextRenderer=Pi;Lexer=mn;Tokenizer=Rt;Hooks=$e;constructor(...n){this.use(...n)}walkTokens(n,e){let t=[];for(let o of n)switch(t=t.concat(e.call(this,o)),o.type){case"table":{let i=o;for(let s of i.header)t=t.concat(this.walkTokens(s.tokens,e));for(let s of i.rows)for(let a of s)t=t.concat(this.walkTokens(a.tokens,e));break}case"list":{let i=o;t=t.concat(this.walkTokens(i.items,e));break}default:{let i=o;this.defaults.extensions?.childTokens?.[i.type]?this.defaults.extensions.childTokens[i.type].forEach((s)=>{let a=i[s].flat(1/0);t=t.concat(this.walkTokens(a,e))}):i.tokens&&(t=t.concat(this.walkTokens(i.tokens,e)))}}return t}use(...n){let e=this.defaults.extensions||{renderers:{},childTokens:{}};return n.forEach((t)=>{let o={...t};if(o.async=this.defaults.async||o.async||!1,t.extensions&&(t.extensions.forEach((i)=>{if(!i.name)throw Error("extension name required");if("renderer"in i){let s=e.renderers[i.name];s?e.renderers[i.name]=function(...a){let r=i.renderer.apply(this,a);return r===!1&&(r=s.apply(this,a)),r}:e.renderers[i.name]=i.renderer}if("tokenizer"in i){if(!i.level||i.level!=="block"&&i.level!=="inline")throw Error("extension level must be 'block' or 'inline'");let s=e[i.level];s?s.unshift(i.tokenizer):e[i.level]=[i.tokenizer],i.start&&(i.level==="block"?e.startBlock?e.startBlock.push(i.start):e.startBlock=[i.start]:i.level==="inline"&&(e.startInline?e.startInline.push(i.start):e.startInline=[i.start]))}"childTokens"in i&&i.childTokens&&(e.childTokens[i.name]=i.childTokens)}),o.extensions=e),t.renderer){let i=this.defaults.renderer||new Ut(this.defaults);for(let s in t.renderer){if(!(s in i))throw Error(`renderer '${s}' does not exist`);if(["options","parser"].includes(s))continue;let a=s,r=t.renderer[a],l=i[a];i[a]=(...c)=>{let h=r.apply(i,c);return h===!1&&(h=l.apply(i,c)),h||""}}o.renderer=i}if(t.tokenizer){let i=this.defaults.tokenizer||new Rt(this.defaults);for(let s in t.tokenizer){if(!(s in i))throw Error(`tokenizer '${s}' does not exist`);if(["options","rules","lexer"].includes(s))continue;let a=s,r=t.tokenizer[a],l=i[a];i[a]=(...c)=>{let h=r.apply(i,c);return h===!1&&(h=l.apply(i,c)),h}}o.tokenizer=i}if(t.hooks){let i=this.defaults.hooks||new $e;for(let s in t.hooks){if(!(s in i))throw Error(`hook '${s}' does not exist`);if(["options","block"].includes(s))continue;let a=s,r=t.hooks[a],l=i[a];$e.passThroughHooks.has(s)?i[a]=(c)=>{if(this.defaults.async&&$e.passThroughHooksRespectAsync.has(s))return(async()=>{let p=await r.call(i,c);return l.call(i,p)})();let h=r.call(i,c);return l.call(i,h)}:i[a]=(...c)=>{if(this.defaults.async)return(async()=>{let p=await r.apply(i,c);return p===!1&&(p=await l.apply(i,c)),p})();let h=r.apply(i,c);return h===!1&&(h=l.apply(i,c)),h}}o.hooks=i}if(t.walkTokens){let i=this.defaults.walkTokens,s=t.walkTokens;o.walkTokens=function(a){let r=[];return r.push(s.call(this,a)),i&&(r=r.concat(i.call(this,a))),r}}this.defaults={...this.defaults,...o}}),this}setOptions(n){return this.defaults={...this.defaults,...n},this}lexer(n,e){return mn.lex(n,e??this.defaults)}parser(n,e){return yn.parse(n,e??this.defaults)}parseMarkdown(n){return(e,t)=>{let o={...t},i={...this.defaults,...o},s=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&o.async===!1)return s(Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if(typeof e>"u"||e===null)return s(Error("marked(): input parameter is undefined or null"));if(typeof e!="string")return s(Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected"));if(i.hooks&&(i.hooks.options=i,i.hooks.block=n),i.async)return(async()=>{let a=i.hooks?await i.hooks.preprocess(e):e,r=await(i.hooks?await i.hooks.provideLexer():n?mn.lex:mn.lexInline)(a,i),l=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(l,i.walkTokens));let c=await(i.hooks?await i.hooks.provideParser():n?yn.parse:yn.parseInline)(l,i);return i.hooks?await i.hooks.postprocess(c):c})().catch(s);try{i.hooks&&(e=i.hooks.preprocess(e));let a=(i.hooks?i.hooks.provideLexer():n?mn.lex:mn.lexInline)(e,i);i.hooks&&(a=i.hooks.processAllTokens(a)),i.walkTokens&&this.walkTokens(a,i.walkTokens);let r=(i.hooks?i.hooks.provideParser():n?yn.parse:yn.parseInline)(a,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(a){return s(a)}}}onError(n,e){return(t)=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,n){let o="<p>An error occurred:</p><pre>"+Bn(t.message+"",!0)+"</pre>";return e?Promise.resolve(o):o}if(e)return Promise.reject(t);throw t}}},Jn=new oh;function P(n,e){return Jn.parse(n,e)}P.options=P.setOptions=function(n){return Jn.setOptions(n),P.defaults=Jn.defaults,Wa(P.defaults),P};P.getDefaults=ki;P.defaults=En;P.use=function(...n){return Jn.use(...n),P.defaults=Jn.defaults,Wa(P.defaults),P};P.walkTokens=function(n,e){return Jn.walkTokens(n,e)};P.parseInline=Jn.parseInline;P.Parser=yn;P.parser=yn.parse;P.Renderer=Ut;P.TextRenderer=Pi;P.Lexer=mn;P.lexer=mn.lex;P.Tokenizer=Rt;P.Hooks=$e;P.parse=P;var{options:i2,setOptions:s2,use:a2,walkTokens:l2,parseInline:r2}=P;var d2=yn.parse,c2=mn.lex;function Ja(n,e){if(e==null)e="";else if(typeof e!=="string")e=String(e);return e.replace(/\{\{([^}]+)\}\}/g,(t,o)=>{let i=W[`${n}${o.startsWith("[")?o:"."+o}`];return i===void 0?t:Ja(n,String(i))})}class Xt extends x{static preferredTagName="tosi-md";static initAttributes={src:"",elements:!1};context={};value="";content=null;options={};connectedCallback(){if(super.connectedCallback(),this.src!=="")(async()=>{let n=await fetch(this.src);this.value=await n.text()})();else if(this.value==="")if(this.elements)this.value=this.innerHTML;else this.value=this.textContent!=null?this.textContent:""}didRender=()=>{};render(){super.render(),W[this.instanceId]=typeof this.context==="string"?JSON.parse(this.context):this.context;let n=Ja(this.instanceId,this.value);if(this.elements){let e=n.split(`
`).reduce((t,o)=>{if(o.startsWith("<")||t.length===0)t.push(o);else{let i=t[t.length-1];if(!i.startsWith("<")||!i.endsWith(">"))t[t.length-1]+=`
`+o;else t.push(o)}return t},[]);this.innerHTML=e.map((t)=>t.startsWith("<")&&t.endsWith(">")?t:P(t,this.options)).join("")}else this.innerHTML=P(n,this.options);this.didRender()}}var ih=Xt,xe=Xt.elementCreator(),Oi=xe,sh=xe;var{div:ne,slot:Ea,span:ah,button:lh}=b;class Yt extends x{static preferredTagName="tosi-tabs";static initAttributes={localized:!1};value=0;makeTab(n,e,t){let o=e.getAttribute("name"),i=e.querySelector('template[role="tab"]')?.content.cloneNode(!0)||(this.localized?Sn(o):ah(o));return ne(i,{part:"tab",tabindex:0,role:"tab",ariaControls:t},e.hasAttribute("data-close")?lh({title:"close",class:"close"},y.x()):{})}static shadowStyleSpec={":host":{"--tosi-tabs-selected-color":"var(--xin-tabs-selected-color, var(--tosi-accent, currentColor))","--tosi-tabs-bar-color":"var(--xin-tabs-bar-color, #ccc)","--tosi-tabs-bar-height":"var(--xin-tabs-bar-height, 2px)",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden",boxShadow:"none !important"},slot:{position:"relative",display:"block",flex:"1",overflow:"hidden",overflowY:"auto"},'slot[name="after-tabs"]':{flex:"0 0 auto"},"::slotted([hidden])":{display:"none !important"},":host::part(tabpanel)":{display:"flex",flexDirection:"column",overflowX:"auto"},":host::part(tabrow)":{display:"flex"},":host .tabs":{display:"flex",userSelect:"none",whiteSpace:"nowrap"},":host .tabs > div":{padding:`${d.spacing50} ${d.spacing}`,cursor:"default",display:"flex",alignItems:"baseline"},':host .tabs > [aria-selected="true"]':{"--text-color":d.tosiTabsSelectedColor,color:d.textColor},":host .elastic":{flex:"1"},":host .border":{background:d.tosiTabsBarColor},":host .border > .selected":{content:" ",width:0,height:d.tosiTabsBarHeight,background:d.tosiTabsSelectedColor,transition:"ease-out 0.2s"},":host button.close":{border:0,background:"transparent",textAlign:"center",marginLeft:d.spacing50,padding:0},":host button.close > svg":{height:"12px"}};onCloseTab=null;content=[ne({role:"tabpanel",part:"tabpanel"},ne({part:"tabrow"},ne({class:"tabs",part:"tabs"}),ne({class:"elastic"}),Ea({name:"after-tabs"})),ne({class:"border"},ne({class:"selected",part:"selected"}))),Ea()];addTabBody(n,e=!1){if(!n.hasAttribute("name"))throw console.error("element has no name attribute",n),Error("element has no name attribute");if(this.append(n),this.setupTabs(),e)this.value=this.bodies.length-1;this.queueRender()}removeTabBody(n){n.remove(),this.setupTabs(),this.queueRender()}keyTab=(n)=>{let{tabs:e}=this.parts,t=[...e.children].indexOf(n.target);switch(n.key){case"ArrowLeft":this.value=(t+Number(e.children.length)-1)%e.children.length,e.children[this.value].focus(),n.preventDefault();break;case"ArrowRight":this.value=(t+1)%e.children.length,e.children[this.value].focus(),n.preventDefault();break;case" ":this.pickTab(n),n.preventDefault();break;default:}};get bodies(){return[...this.children].filter((n)=>n.hasAttribute("name"))}pickTab=(n)=>{let{tabs:e}=this.parts,t=n.target,o=t.closest("button.close")!==null,i=t.closest(".tabs > div"),s=[...e.children].indexOf(i);if(o){let a=this.bodies[s];if(!this.onCloseTab||this.onCloseTab(a)!==!1)this.removeTabBody(this.bodies[s])}else if(s>-1)this.value=s};setupTabs=()=>{let{tabs:n}=this.parts,e=[...this.children].filter((t)=>!t.hasAttribute("slot")&&t.hasAttribute("name"));if(n.textContent="",this.value>=e.length)this.value=e.length-1;for(let t in e){let o=e[t],i=`${this.instanceId}-${t}`;o.id=i;let s=this.makeTab(this,o,i);n.append(s)}};connectedCallback(){super.connectedCallback();let{tabs:n}=this.parts;n.addEventListener("click",this.pickTab),n.addEventListener("keydown",this.keyTab),this.setupTabs(),jn.allInstances.add(this)}disconnectedCallback(){super.disconnectedCallback(),jn.allInstances.delete(this)}localeChanged=()=>{this.queueRender()};onResize(){this.queueRender()}render(){let{tabs:n,selected:e}=this.parts,t=this.bodies;for(let o=0;o<t.length;o++){let i=t[o],s=n.children[o];if(this.value===Number(o))s.setAttribute("aria-selected","true"),e.style.marginLeft=`${s.offsetLeft-n.offsetLeft}px`,e.style.width=`${s.offsetWidth}px`,i.toggleAttribute("hidden",!1);else s.toggleAttribute("aria-selected",!1),i.toggleAttribute("hidden",!0)}}}var rh=Yt,Ze=Yt.elementCreator(),dh=Ze,ch=Ze;var Je=(async()=>{}).constructor;function Un(n,e){let t=n;for(let o of e)t=t.replace(new RegExp(`import \\{([^}]*)\\} from '${o}'`,"g"),(i,s)=>{return`const { ${s.replace(/\s+/g," ").trim()} } = ${o.replace(/-/g,"")}`});return t}async function nl(n,e,t){let o=Un(n,Object.keys(e)),i=t(o,{transforms:["typescript"]}).code,s=Object.keys(e).map((l)=>l.replace(/-/g,"")),a=Object.values(e);await new Je(...s,i)(...a)}var hh=(n,e)=>{if(e.transforms.includes("typescript"))throw Error('TypeScript examples require the "sucrase" package. Install it with: npm install sucrase');return{code:n}},ph="https://cdn.jsdelivr.net/npm/sucrase@3.35.0/+esm";async function Ht(){try{let{transform:n}=await import("sucrase");return n}catch{}try{let{transform:n}=await import(ph);return n}catch{return console.warn("sucrase not available — TypeScript examples will not work. "+"Install with: npm install sucrase"),hh}}var Lt="live-example-payload";function el(n,e,t){return t!==""?`${n}-${t}`:`${n}-${e}`}function zi(n,e){try{localStorage.setItem(n,JSON.stringify(e))}catch(t){console.warn("live-example: failed to write to localStorage",t)}}function uh(n){if(n===null)return null;try{return JSON.parse(n)}catch{return null}}function tl(n,e,t,o,i){let s=location.href.split("?")[0]+`?${n}=${e}`;zi(t,{remoteKey:o,sentAt:Date.now(),...i}),window.open(s)}var mh=typeof BroadcastChannel<"u";class Ee{storageKey;remoteKey;lastUpdate=0;interval;channel;listening=!1;onReceive;constructor(n,e,t){this.storageKey=n,this.remoteKey=e,this.onReceive=t}handlePayload=(n)=>{if(n.sentAt<=this.lastUpdate)return;if(n.remoteKey!==this.remoteKey)return;this.lastUpdate=n.sentAt,this.onReceive(n)};handleMessage=(n)=>{let e=n.data;if(e)this.handlePayload(e)};handlePoll=()=>{let n=null;try{n=localStorage.getItem(this.storageKey)}catch{return}let e=uh(n);if(e)this.handlePayload(e)};startListening(){if(this.listening)return;if(this.listening=!0,mh)this.channel=new BroadcastChannel(this.storageKey),this.channel.onmessage=this.handleMessage;this.interval=setInterval(this.handlePoll,500)}stopListening(){if(!this.listening)return;if(this.listening=!1,this.channel)this.channel.close(),this.channel=void 0;if(this.interval)clearInterval(this.interval),this.interval=void 0}send(n){let e={remoteKey:this.remoteKey,sentAt:Date.now(),...n};if(zi(this.storageKey,e),this.channel)this.channel.postMessage(e)}sendClose(){let n={remoteKey:this.remoteKey,sentAt:Date.now(),css:"",html:"",js:"",close:!0};if(zi(this.storageKey,n),this.channel)this.channel.postMessage(n)}}var{div:ol}=b;function yh(n,e){let t=n.customElements;if(!t)return;let o=(s)=>{if(!s||t.get(s))return;let a=customElements.get(s);if(a)try{t.define(s,a)}catch{}};for(let s of Object.values(e))if(s&&typeof s==="object"){for(let a of Object.values(s))if(typeof a==="function"&&"tagName"in a)o(a.tagName)}let i=n.document;if(i){let s=i.querySelectorAll("*");for(let a of s){let r=a.tagName.toLowerCase();if(r.includes("-"))o(r)}}}async function Kt(n){let{html:e,css:t,js:o,context:i,transform:s,exampleElement:a,styleElement:r,widgetsElement:l,onError:c}=n,h=ol({class:"preview"});h.innerHTML=e,r.innerText=t;let p=a.querySelector(".preview");if(p)p.replaceWith(h);else a.insertBefore(h,l);let m={preview:h,...i};try{let v=Un(o,Object.keys(i)),g=s(v,{transforms:["typescript"]}).code,k=Object.keys(m).map((j)=>j.replace(/-/g,"")),B=Object.values(m);await new Je(...k,g)(...B)}catch(v){if(console.error(v),h.append(ol({class:"preview-error"},String(v.message||v))),c)c(v);else window.alert(`Error: ${v}, the console may have more information…`)}return h}async function $t(n){let{html:e,css:t,js:o,context:i,transform:s,exampleElement:a,widgetsElement:r,onError:l}=n,c=a.querySelector("iframe.preview-iframe");if(!c){c=document.createElement("iframe"),c.className="preview-iframe",c.style.cssText="width: 100%; height: 100%; border: none;";let g=a.querySelector(".preview");if(g)g.replaceWith(c);else a.insertBefore(c,r)}let h=c.contentDocument;if(!h)return console.error("Could not access iframe document"),null;let p=c.contentWindow;if(i.tosijs)p.tosijs=i.tosijs;if(i["tosijs-ui"])p.tosijsui=i["tosijs-ui"];h.open(),h.write(`<!DOCTYPE html>
<html>
<head>
  <style>
    body { margin: 0; }
...
</html>`),h.close(),yh(p,i);let m=h.querySelector(".preview");if(!m)return console.error("Could not find preview element in iframe"),null;let v={preview:m,...i};try{let g=Un(o,Object.keys(i)),k=s(g,{transforms:["typescript"]}).code,B=p.eval("(async () => {}).constructor"),T=Object.keys(v).map((O)=>O.replace(/-/g,"")),j=Object.values(v);await new B(...T,k)(...j)}catch(g){console.error(g);let k=h.createElement("div");if(k.className="preview-error",k.textContent=String(g.message||g),m.append(k),l)l(g);else window.alert(`Error: ${g}, the console may have more information…`)}return m}function Qt(n,e,t,o){let i=[...n.querySelectorAll(".language-html,.language-js,.language-css,.language-test")].filter((s)=>!s.closest(o)).map((s)=>({block:s.parentElement,language:s.classList[0].split("-").pop(),code:s.innerText}));for(let s=0;s<i.length;s+=1){let a=[i[s]];while(s<i.length-1&&i[s].block.nextElementSibling===i[s+1].block)a.push(i[s+1]),s+=1;let r=t({context:e});a[0].block.parentElement.insertBefore(r,a[0].block),a.forEach((c)=>{switch(c.language){case"js":r.js=c.code;break;case"html":r.html=c.code;break;case"css":r.css=c.code;break;case"test":r.test=c.code;break}c.block.remove()}),r.showDefaultTab()}}var il={":host":{"--tosi-example-height":"320px","--code-editors-bar-bg":"#777","--code-editors-bar-color":"#fff","--widget-bg":"#fff8","--widget-color":"#000",position:"relative",display:"flex",height:"var(--tosi-example-height)",background:"var(--background)",boxSizing:"border-box"},":host.-maximize":{position:"fixed",left:"0",top:"0",height:"100vh",width:"100vw",margin:"0 !important"},".-maximize":{zIndex:101},":host.-vertical":{flexDirection:"column"},":host .layout-indicator":{transition:"0.5s ease-out",transform:"rotateZ(270deg)"},":host.-vertical .layout-indicator":{transform:"rotateZ(180deg)"},":host.-maximize .hide-if-maximized, :host:not(.-maximize) .show-if-maximized":{display:"none"},':host [part="example"]':{flex:"1 1 50%",height:"100%",position:"relative",overflowX:"auto"},":host .preview":{height:"100%",position:"relative",overflow:"hidden",boxShadow:"inset 0 0 0 2px #8883"},":host .preview-error":{padding:"8px 12px",margin:"8px",background:"#fee",color:"#900",borderRadius:"4px",fontSize:"13px",fontFamily:"system-ui, sans-serif",whiteSpace:"pre-wrap"},':host [part="editors"]':{flex:"1 1 200px",height:"100%",position:"relative"},':host [part="exampleWidgets"]':{position:"absolute",left:"5px",bottom:"5px","--widget-color":"var(--brand-color)",borderRadius:"5px",width:"44px",height:"44px",lineHeight:"44px",zIndex:"100"},':host [part="exampleWidgets"] svg':{stroke:"var(--widget-color)"},":host .code-editors":{overflow:"hidden",background:"white",position:"relative",top:"0",right:"0",flex:"1 1 50%",height:"100%",flexDirection:"column",zIndex:"10"},":host .code-editors:not([hidden])":{display:"flex"},":host .code-editors > h4":{padding:"5px",margin:"0",textAlign:"center",background:"var(--code-editors-bar-bg)",color:"var(--code-editors-bar-color)",cursor:"move"},":host button.transparent, :host .sizer":{width:"32px",height:"32px",lineHeight:"32px",textAlign:"center",padding:"0",margin:"0"},":host .sizer":{cursor:"nwse-resize"},':host [part="testIndicator"]':{position:"absolute",top:"8px",right:"8px",width:"12px",height:"12px",borderRadius:"50%",background:"#888",zIndex:"100",display:"none"},':host.-has-tests [part="testIndicator"]':{display:"block",opacity:"var(--tests-enabled, 1)"},':host.-test-running [part="testIndicator"]':{background:"#fa0",animation:"test-pulse 0.5s ease-in-out infinite"},':host.-test-passed [part="testIndicator"]':{background:"#0a0",animation:"test-fade 2s ease-out forwards"},':host.-test-failed [part="testIndicator"]':{background:"#c00",animation:"test-pulse 1s ease-in-out infinite"},"@keyframes test-pulse":{"0%, 100%":{opacity:"1"},"50%":{opacity:"0.4"}},"@keyframes test-fade":{"0%":{opacity:"1"},"50%":{opacity:"1"},"100%":{opacity:"0"}},':host.-test-passed [part="exampleWidgets"]':{"--widget-color":"#0a0"},':host.-test-failed [part="exampleWidgets"]':{"--widget-color":"#f00"},':host [part="testResults"]':{position:"absolute",bottom:"54px",left:"5px",background:"var(--widget-bg)",borderRadius:"5px",padding:"8px",fontSize:"14px",margin:"0",maxWidth:"400px",maxHeight:"200px",overflow:"auto",zIndex:"100"},':host [part="testResults"][hidden]':{display:"none"},":host .test-pass":{color:"#0a0"},":host .test-fail":{color:"#f00"}};class Vi extends Error{constructor(n){super(n);this.name="AssertionError"}}function sl(n,e){if(n===e)return!0;if(typeof n!==typeof e)return!1;if(n===null||e===null)return n===e;if(typeof n!=="object")return!1;let t=n,o=e;if(Array.isArray(t)!==Array.isArray(o))return!1;let i=Object.keys(t),s=Object.keys(o);if(i.length!==s.length)return!1;return i.every((a)=>sl(t[a],o[a]))}var gh=5000,bh={stringify(n){if(typeof n>"u")return"undefined";if(n===null)return"null";if(typeof Element<"u"&&n instanceof Element)return`<${n.tagName.toLowerCase()}>`;if(typeof Node<"u"&&n instanceof Node)return`[${n.nodeName}]`;try{return JSON.stringify(n)}catch{return String(n)}}},{stringify:Tn}=bh;function al(n,e=!1){let t=(i,s)=>{if(!(e?!i:i))throw new Vi(e?`not: ${s}`:s)};return{toBe(i){t(n===i,`Expected ${Tn(n)} to be ${Tn(i)}`)},toEqual(i){t(sl(n,i),`Expected ${Tn(n)} to equal ${Tn(i)}`)},toBeTruthy(){t(!!n,`Expected ${Tn(n)} to be truthy`)},toBeFalsy(){t(!n,`Expected ${Tn(n)} to be falsy`)},toBeNull(){t(n===null,`Expected ${Tn(n)} to be null`)},toBeUndefined(){t(n===void 0,`Expected ${Tn(n)} to be undefined`)},toBeDefined(){t(n!==void 0,`Expected ${Tn(n)} to be defined`)},toContain(i){if(typeof n==="string")t(n.includes(i),`Expected "${n}" to contain "${i}"`);else if(Array.isArray(n))t(n.includes(i),`Expected array to contain ${Tn(i)}`);else throw new Vi("toContain requires string or array")},toHaveLength(i){let s=n.length;t(s===i,`Expected length ${s} to be ${i}`)},toMatch(i){t(i.test(n),`Expected "${n}" to match ${i}`)},toBeGreaterThan(i){t(n>i,`Expected ${n} to be greater than ${i}`)},toBeLessThan(i){t(n<i,`Expected ${n} to be less than ${i}`)},toBeInstanceOf(i){t(n instanceof i,`Expected value to be instance of ${i.name}`)},get not(){return al(n,!e)}}}function Di(n){return al(n)}function fh(n){return new Promise((e)=>setTimeout(e,n))}function xh(n,e,t=1000){return new Promise((o,i)=>{let s=Date.now(),a=()=>{let r=n.querySelector(e);if(r){o(r);return}if(Date.now()-s>=t){i(Error(`Timeout waiting for "${e}" after ${t}ms`));return}requestAnimationFrame(a)};a()})}function vh(n,e,t){return Promise.race([n,new Promise((o,i)=>setTimeout(()=>i(Error(`Test "${t}" timed out after ${e}ms`)),e))])}function qi(n,e=gh){let t="",o=[];return{pending:o,expect:Di,test(i,s){let a=t?`${t} > ${i}`:i;try{let r=s();if(r instanceof Promise){let l=vh(r,e,a).then(()=>{n.push({name:a,passed:!0})}).catch((c)=>{n.push({name:a,passed:!1,error:c.message})});o.push(l)}else n.push({name:a,passed:!0})}catch(r){n.push({name:a,passed:!1,error:r.message})}},describe(i,s){let a=t;t=t?`${t} > ${i}`:i,s(),t=a}}}async function Gt(n,e,t,o){let i=[],s=qi(i),a={preview:e,...t,expect:s.expect,test:s.test,describe:s.describe,waitMs:fh,waitFor:(r,l)=>xh(e,r,l)};try{let r=Un(n,Object.keys(t)),l=o(r,{transforms:["typescript"]}).code,c=Object.keys(a).map((m)=>m.replace(/-/g,"")),h=Object.values(a);await new Je(...c,l)(...h)}catch(r){i.push({name:"Test execution",passed:!1,error:r.message})}if(s.pending.length>0)await Promise.all(s.pending);return{passed:i.filter((r)=>r.passed).length,failed:i.filter((r)=>!r.passed).length,tests:i}}var{div:ve,xinSlot:wh,style:kh,button:ee,pre:ll,span:rl}=b,Fi="tosijs-ui-tests-enabled",Ch=typeof window<"u"&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1");function jh(){if(typeof localStorage>"u")return!1;let n=localStorage.getItem(Fi);if(n!==null)return n==="true";return Ch}var{testManager:hn}=Y({testManager:{enabled:jh()}});function Zt(){document.body.classList.toggle("tests-enabled",hn.enabled.value),document.body.style.setProperty("--tests-enabled",hn.enabled.value?"1":"0")}if(typeof document<"u")if(document.body)Zt();else document.addEventListener("DOMContentLoaded",Zt);function Ni(){localStorage.setItem(Fi,"true"),hn.enabled.value=!0,Zt(),document.querySelectorAll("tosi-example").forEach((n)=>{n.refresh()})}function _i(){localStorage.setItem(Fi,"false"),hn.enabled.value=!1,Zt()}class In extends x{static preferredTagName="tosi-example";static lightStyleSpec=il;static initAttributes={persistToDom:!1,iframe:!1};prefix="lx";storageKey=Lt;context={};uuid=crypto.randomUUID();remoteId="";remoteSync;undoInterval;testResults;pendingValues={};pendingShowDefaultTab=!1;beforeUnloadHandler;static insertExamples(n,e={}){Qt(n,e,Jt,In.tagName)}get activeTab(){let{editors:n}=this.parts;return[...n.children].find((e)=>e.getAttribute("hidden")===null)}get hydrated(){try{return this.parts.js!==void 0}catch{return!1}}getEditorValue(n){if(!this.hydrated)return this.pendingValues[n]??"";return this.parts[n].value}setEditorValue(n,e){if(!this.hydrated){this.pendingValues[n]=e;return}let t=this.parts[n];t.value=e}flushPendingValues(){for(let[n,e]of Object.entries(this.pendingValues)){let t=this.parts[n];if(t)t.value=e}if(this.pendingValues={},this.pendingShowDefaultTab)this.pendingShowDefaultTab=!1,this.showDefaultTab()}get css(){return this.getEditorValue("css")}set css(n){this.setEditorValue("css",n)}get html(){return this.getEditorValue("html")}set html(n){this.setEditorValue("html",n)}get js(){return this.getEditorValue("js")}set js(n){this.setEditorValue("js",n)}get test(){return this.getEditorValue("test")}set test(n){this.setEditorValue("test",n)}get remoteKey(){return el(this.prefix,this.uuid,this.remoteId)}updateUndo=()=>{let{activeTab:n}=this,{undo:e,redo:t}=this.parts;if(n instanceof Gn&&n.editor!==void 0){let o=n.editor.session.getUndoManager();e.disabled=!o.hasUndo(),t.disabled=!o.hasRedo()}else e.disabled=!0,t.disabled=!0;this.updateTestResultsVisibility()};updateTestResultsVisibility(){let{testResults:n}=this.parts,e=this.testResults,t=this.activeTab?.getAttribute("name")==="test",o=e&&e.failed>0;n.hidden=!e||e.tests.length===0||!t&&!o}undo=()=>{let{activeTab:n}=this;if(n instanceof Gn)n.editor.undo()};redo=()=>{let{activeTab:n}=this;if(n instanceof Gn)n.editor.redo()};get isMaximized(){return this.classList.contains("-maximize")}flipLayout=()=>{this.classList.toggle("-vertical")};exampleMenu=()=>{let n=hn.enabled.value;q({target:this.parts.exampleWidgets,width:"auto",menuItems:[{icon:"edit2",caption:"view/edit code",action:this.showCode},{icon:"edit",caption:"view/edit code in a new window",action:this.openEditorWindow},null,{icon:this.isMaximized?"minimize":"maximize",caption:this.isMaximized?"restore preview":"maximize preview",action:this.toggleMaximize},null,{icon:n?"check":"",caption:"Run tests",action:()=>{if(n)_i();else Ni()}}]})};handleShortcuts=(n)=>{if(n.metaKey||n.ctrlKey){let e=!1;switch(n.key){case"s":case"r":this.refresh(),e=!0;break;case"/":this.flipLayout();break;case"c":if(n.shiftKey)this.copy(),e=!0;break}if(e)n.preventDefault(),n.stopPropagation()}};content=()=>[ve({part:"example"},kh({part:"style"}),ve({part:"testIndicator",title:"test status"}),ll({part:"testResults",hidden:!0}),ee({title:"example menu",part:"exampleWidgets",onClick:this.exampleMenu},y.code())),ve({class:"code-editors",part:"codeEditors",onKeydown:this.handleShortcuts,hidden:!0},Ze({part:"editors",onChange:this.updateUndo},pe({name:"js",mode:"javascript",part:"js"}),pe({name:"html",mode:"html",part:"html"}),pe({name:"css",mode:"css",part:"css"}),pe({name:"test",mode:"javascript",part:"test"}),ve({slot:"after-tabs",class:"row"},ee({title:"undo",part:"undo",class:"transparent",onClick:this.undo},y.cornerUpLeft()),ee({title:"redo",part:"redo",class:"transparent",onClick:this.redo},y.cornerUpRight()),ee({title:"flip direction (⌘/ | ^/)",class:"transparent",onClick:this.flipLayout},y.columns({class:"layout-indicator"})),ee({title:"copy as markdown (⌘⇧C | ^⇧C)",class:"transparent",onClick:this.copy},y.copy()),ee({title:"reload (⌘R | ^R)",class:"transparent",onClick:this.refreshRemote},y.refreshCw()),ee({title:"close code",class:"transparent",onClick:this.closeCode},y.x())))),wh({part:"sources",hidden:!0})];connectedCallback(){super.connectedCallback(),this.flushPendingValues();let{sources:n}=this.parts;this.initFromElements([...n.children]),this.remoteSync=new Ee(this.storageKey,this.remoteKey,(t)=>{if(t.close){if(this.remoteId!=="")window.close();else this.classList.remove("-maximize"),this.parts.codeEditors.hidden=!0;return}if(this.css=t.css,this.html=t.html,this.js=t.js,t.test)this.test=t.test;this.refresh()}),this.remoteSync.startListening();let e=Math.random()*100;this.undoInterval=setInterval(()=>{if(!document.hidden)this.updateUndo()},250+e),this.beforeUnloadHandler=()=>this.remoteSync?.sendClose(),addEventListener("beforeunload",this.beforeUnloadHandler)}disconnectedCallback(){if(super.disconnectedCallback(),this.remoteSync?.sendClose(),this.remoteSync?.stopListening(),this.undoInterval)clearInterval(this.undoInterval),this.undoInterval=void 0;if(this.beforeUnloadHandler)removeEventListener("beforeunload",this.beforeUnloadHandler),this.beforeUnloadHandler=void 0}copy=()=>{let n=this.js!==""?"```js\n"+this.js.trim()+"\n```\n":"",e=this.html!==""?"```html\n"+this.html.trim()+"\n```\n":"",t=this.css!==""?"```css\n"+this.css.trim()+"\n```\n":"",o=this.test!==""?"```test\n"+this.test.trim()+"\n```\n":"";navigator.clipboard.writeText(n+e+t+o)};toggleMaximize=()=>{this.classList.toggle("-maximize")};showCode=()=>{this.classList.add("-maximize"),this.classList.toggle("-vertical",this.offsetHeight>this.offsetWidth),this.parts.codeEditors.hidden=!1};closeCode=()=>{if(this.remoteId!=="")this.remoteSync?.sendClose(),window.close();else this.remoteSync?.sendClose(),this.classList.remove("-maximize"),this.parts.codeEditors.hidden=!0};openEditorWindow=()=>{let{css:n,html:e,js:t,test:o}=this;tl(this.prefix,this.uuid,this.storageKey,this.remoteKey,{css:n,html:e,js:t,test:o}),this.classList.add("-maximize")};refreshRemote=()=>{this.remoteSync?.send({css:this.css,html:this.html,js:this.js,test:this.test})};updateSources=()=>{if(this.persistToDom){let{sources:n}=this.parts;n.innerText="";for(let e of["js","css","html","test"])if(this[e])n.append(ll({class:`language-${e}`,innerHTML:this[e]}))}};refresh=async()=>{if(this.remoteId!=="")return;let n=await Ht(),{example:e,style:t,exampleWidgets:o}=this.parts,i,s,a=(r)=>{s=r};if(this.iframe)i=await $t({html:this.html,css:this.css,js:this.js,context:this.context,transform:n,exampleElement:e,widgetsElement:o,onError:a});else i=await Kt({html:this.html,css:this.css,js:this.js,context:this.context,transform:n,exampleElement:e,styleElement:t,widgetsElement:o,onError:a});if(this.persistToDom)this.updateSources();if((this.test||s)&&i&&hn.enabled.value){if(this.classList.add("-has-tests","-test-running"),this.classList.remove("-test-passed","-test-failed"),this.testResults=this.test?await Gt(this.test,i,this.context,n):{passed:0,failed:0,tests:[]},s)this.testResults.failed+=1,this.testResults.tests.unshift({name:"example loads without error",passed:!1,error:String(s)});this.classList.remove("-test-running"),this.displayTestResults()}else this.classList.remove("-has-tests","-test-running","-test-passed","-test-failed")};displayTestResults(){let{testResults:n,testIndicator:e}=this.parts,t=this.testResults;if(!t||t.tests.length===0){n.hidden=!0,this.classList.remove("-test-passed","-test-failed"),e.title="no tests";return}n.innerHTML="";let o=ve({style:{marginBottom:"8px",fontWeight:"bold"}},`${t.passed}/${t.tests.length} tests passed`);n.append(o);for(let i of t.tests){let s=i.passed?"✓":"✗",a=i.passed?"test-pass":"test-fail",r=ve({class:a},rl(s+" "),i.name,i.error?rl({style:{opacity:"0.7"}},` - ${i.error}`):"");n.append(r)}this.classList.toggle("-test-passed",t.failed===0),this.classList.toggle("-test-failed",t.failed>0),e.title=t.failed===0?`${t.passed} tests passed`:`${t.failed}/${t.tests.length} tests failed`,this.updateTestResultsVisibility(),this.dispatchEvent(new CustomEvent("testcomplete",{bubbles:!0,detail:{results:t,element:this}}))}initFromElements(n){for(let e of n){e.hidden=!0;let[t,...o]=e.innerHTML.split(`
...
The returned \`disconnect()\` removes all observers and calls
\`transport.disconnect()\`.`,title:"A.5 sync",filename:"sync.ts",path:"src/sync.ts"},{text:'# Migrating from `xinjs` to `tosijs`\n\n<!--{ "pin": "bottom" }-->\n\nIn a nutshell:\n\n1. Update to `xinjs` (and `xinjs-ui`) 1.0.6\n2. Fix any issues\n3. Replace all references to "xinjs" with "tosijs"\n\n`xinjs` and `tosijs` 1.0.6 should be identical (likewise `xinjs-ui` and `tosijs-ui`), so the only thing you need to change\nshould be the module names.\n\n> Please [let me know](https://discord.gg/ramJ9rgky5) if there are any issues.\n',title:"Migrating from xinjs to tosijs",filename:"Migration.md",path:"Migration.md",pin:"bottom"}];Wl();var Yn="tosijs";setTimeout(()=>{let n=w.fromVar(d.brandColor),e=w.fromVar(d.background);console.log(`welcome to %c${Yn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var L1=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",K1=ho.find((n)=>n.filename===L1)||ho[0],Ml=at(),{app:_,prefs:K}=Y({app:{title:Yn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${Yn}#readme`,npmUrl:`https://www.npmjs.com/package/${Yn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${Yn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${Yn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${Yn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${Yn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:ho,currentDoc:K1,compact:!1},prefs:{colorScheme:Ml.colorScheme,highContrast:Ml.highContrast,locale:""}});$o((n)=>{if(n.startsWith("prefs"))return!0;return!1});nn.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};nn.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:_,tosi:Y,img:uo,bindings:nn,elements:b,vars:d,touch:Z,Color:w})},1000);var Xl=document.querySelector("main"),{h2:$1,div:Yl,span:lt,a:po,img:uo,header:Q1,button:Hl,template:G1,input:Z1}=b;K.colorScheme.observe(()=>{hs({colorScheme:K.colorScheme.value})});K.highContrast.observe(()=>{hs({highContrast:K.highContrast.value})});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);_.currentDoc=_.docs.find((e)=>e.filename===n)||_.docs[0]});var J1=Qn(()=>{console.time("filter");let n=Ll.value.toLocaleLowerCase();_.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),Z(_.docs),console.timeEnd("filter")}),Ll=Z1({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:J1});if(Xl)Xl.append(Q1(Hl({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:_.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(Et.tagName);n.contentVisible=!n.contentVisible}},y.menu()),lt({style:{flex:"0 0 10px"}}),po({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${xt}, tosijs-ui ${ro}`},uo({src:"favicon.svg",style:{height:40,marginRight:10}}),$1({bindText:"app.title"})),lt({class:"elastic"}),ts({minWidth:750},lt({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},po({href:_.bundleUrl},uo({alt:"bundlejs size badge",src:_.bundleBadgeUrl})),po({href:_.cdnUrl},uo({alt:"jsdelivr",src:_.cdnBadgeUrl}))),lt({slot:"small"})),lt({style:{flex:"0 0 10px"}}),Hl({title:"theme",class:"iconic",onClick(n){q({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:_.githubUrl.value},{icon:"npm",caption:"npm",action:_.npmUrl.value},{icon:"discord",caption:"discord",action:_.discordUrl.value},{icon:"tosiUi",caption:"tosijs-ui",action:_.tosijsuiUrl.value},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return K.colorScheme.value==="system"},action(){K.colorScheme.value="system"}},{caption:"Dark",checked(){return K.colorScheme.value==="dark"},action(){K.colorScheme.value="dark"}},{caption:"Light",checked(){return K.colorScheme.value==="light"},action(){K.colorScheme.value="light"}},null,{caption:"High Contrast (System)",checked(){return K.highContrast.value==="system"},action(){K.highContrast.value="system"}},{caption:"High Contrast On",checked(){return K.highContrast.value===!0},action(){K.highContrast.value=!0}},{caption:"High Contrast Off",checked(){return K.highContrast.value===!1},action(){K.highContrast.value=!1}}]}]})}},y.moreVertical())),Ri({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Et.tagName);_.compact.value=n.compact}},Ll,Yl({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:_.docs}},G1(po({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=un(n.target),o=n.target.closest("xin-sidenav");o.contentVisible=!0;let{href:i}=e;window.history.pushState({href:i},"",i),_.currentDoc=t,n.preventDefault()}}))),Yl({style:{position:"relative",overflowY:"scroll",height:"100%"}},Oi({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){In.insertExamples(this,{tosijs:Re,"tosijs-ui":as})}}))));

//# debugId=D0E36CD4B75BBBE364756E2164756E21
