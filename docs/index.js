var Si=Object.defineProperty;var Sa=(n,t)=>{for(var e in t)Si(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var lt=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Jn={};Sa(Jn,{xinValue:()=>P,xinProxy:()=>so,xinPath:()=>Pn,xin:()=>L,version:()=>yt,vars:()=>l,varDefault:()=>h,updates:()=>Ti,unobserve:()=>En,touchElement:()=>ge,touch:()=>un,tosi:()=>U,throttle:()=>Un,svgElements:()=>bt,settings:()=>ct,on:()=>Mn,observe:()=>gt,mathML:()=>oo,makeComponent:()=>ve,invertLuminance:()=>he,initVars:()=>Gi,hotReload:()=>fe,getListItem:()=>mn,getListInstance:()=>be,getListBinding:()=>me,getCssVar:()=>Za,elements:()=>m,deleteListItem:()=>rs,debounce:()=>mt,css:()=>Yn,boxedProxy:()=>we,boxed:()=>ut,blueprintLoader:()=>bs,blueprint:()=>ms,bindings:()=>J,bind:()=>O,StyleSheet:()=>$n,MoreMath:()=>qi,Component:()=>b,Color:()=>f,BlueprintLoader:()=>xe,Blueprint:()=>ft});function hn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(hn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=hn(a);else t[e]=a}return t}var Wa="-xin-data",Bn=`.${Wa}`,Xa="-xin-event",Ta=`.${Xa}`,q="xinPath",In="xinValue",Ia="xinObserve",Ea="xinBind",Ba="xinOn",Qt=Symbol("list-binding"),ne=Symbol("list-instance"),Pn=(n)=>{return n&&n[q]||void 0};function P(n){if(typeof n==="object"&&n!==null){let t=n[In];return t!==void 0?t:n}return n}var Xn=new WeakMap,pn=new WeakMap,qn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=pn.get(n),a=Xn.get(n);if(e!=null)pn.set(t,hn(e));if(a!=null)Xn.set(t,hn(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(qn(e));else t.appendChild(e.cloneNode());return t},ct={debug:!1,perf:!1},Pa=Symbol("observer should be removed"),ht=[],pt=[],te=!1,ee,ae;class qa{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw Error("expect callback to be a path or function");ht.push(this)}}var Ti=async()=>{if(ee===void 0)return;await ee},Ii=()=>{if(ct.perf)console.time("xin async update");let n=Array.from(pt);for(let t of n)ht.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Pa)return En(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Pa)En(e)});if(pt.splice(0),te=!1,typeof ae==="function")ae();if(ct.perf)console.timeEnd("xin async update")},un=(n)=>{let t=typeof n==="string"?n:Pn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(te===!1)ee=new Promise((e)=>{ae=e}),te=setTimeout(Ii);if(pt.find((e)=>t.startsWith(e))==null)pt.push(t)},Nn=(n,t)=>{return new qa(n,t)},En=(n)=>{let t=ht.indexOf(n);if(t>-1)ht.splice(t,1);else throw Error("unobserve failed, listener not found")},de={},oe=null,Ei=(n)=>{oe=n},ce=()=>{if(oe===null)throw Error("xin proxy not initialized");return oe},ie=null,se=null,Bi=(n,t)=>{ie=n,se=t},Ft=()=>{if(ie===null)throw Error("bind not initialized");return ie},Yt=()=>{if(se===null)throw Error("on not initialized");return se},Ua=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},Fa=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Pi=(n,t)=>{switch(Fa(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},Mi=(n)=>{switch(Fa(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:Ma}=globalThis,re=Ma!=null?new Ma((n)=>{for(let t of n){let e=t.target;Ua(e,"resize")}}):{observe(){},unobserve(){}},La=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?qn(a):a)});else if(t instanceof Node)n.append(e?qn(t):t);else throw Error("expect text content or document node")},mt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Un=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(e),e=setTimeout(()=>{n(...i),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},Li=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},Ya=(...n)=>Error(n.map(Li).join(" ")),Di=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Ai=0,Oi=()=>(parseInt("10000",36)+ ++Ai).toString(36).slice(-5),zi=()=>Di()+Oi(),le=Symbol("delete"),Ga=Symbol("new-object"),Gt=Symbol("automatic-index");function $a(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var $=new WeakMap;function Ja(n,t){if($.get(n)===void 0)$.set(n,{});if($.get(n)[t]===void 0)$.get(n)[t]={};let e=$.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[Gt]===void 0)a[Gt]=zi();e[a[Gt]+""]=o});else n.forEach((a,o)=>{e[Fn(a,t)+""]=o});return e}function _i(n,t){if($.get(n)===void 0||$.get(n)[t]===void 0)return Ja(n,t);else return $.get(n)[t]}function Hi(n,t,e){e=e+"";let a=_i(n,t)[e];if(a===void 0||Fn(n[a],t)+""!==e)a=Ja(n,t)[e];return a}function Ri(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function Ka(n,t,e,a){let o=t!==""?Hi(n,t,e):e;if(a===le)return n.splice(o,1),$.delete(n),Symbol("deleted");else if(a===Ga){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Fn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function Da(n){if(!Array.isArray(n))throw Ya("setByPath failed: expected array, found",n)}function Aa(n){if(n==null||!(n instanceof Object))throw Ya("setByPath failed: expected Object, found",n)}function Fn(n,t){let e=$a(t),a=n,o,i,s,r;for(o=0,i=e.length;a!==void 0&&o<i;o++){let d=e[o];if(Array.isArray(d))for(s=0,r=d.length;a!==void 0&&s<r;s++){let c=d[s];a=a[c]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[c,...p]=d.split("=");a=Ka(a,c,p.join("="))}else s=parseInt(d,10),a=a[s]}return a}function Vi(n,t,e){let a=n;if(t==="")throw Error("setByPath cannot be used to set the root object");let o=$a(t);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)Aa(a);else Da(a);let r=i.slice(0,s),d=i.slice(s+1);if(a=Ka(a,r,d,o.length>0?Ga:e),o.length===0)return!0}else{Da(a);let r=parseInt(i,10);if(o.length>0)a=a[r];else{if(e!==le){if(a[r]===e)return!1;a[r]=e}else a.splice(r,1);return!0}}}else if(Array.isArray(i)&&i.length>0){Aa(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=Ri(a,s,i.length>0?{}:[]);else{if(e!==le){if(a[s]===e)return!1;a[s]=e}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw Error(`setByPath failed, bad path ${t}`)}throw Error(`setByPath(${n}, ${t}, ${e}) failed`)}var J={value:{toDOM:Pi,fromDOM(n){return Mi(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){me(n,t,e).update(t)}}};function tn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function Ni(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var Wi=180/Math.PI,Xi=Math.PI/180;function X(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function Z(n,t,e,a=!0){if(a)e=X(0,e,1);return e*(t-n)+n}var qi={RADIANS_TO_DEGREES:Wi,DEGREES_TO_RADIANS:Xi,clamp:X,lerp:Z};function Za(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var Ui=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},ln=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class Qa{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),i=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Tn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class f{r;g;b;a;static fromVar(n,t=document.body){return f.fromCss(Za(n,t))}static fromCss(n){let t=n;if(Tn instanceof HTMLSpanElement)Tn.style.color="black",Tn.style.color=n,document.body.appendChild(Tn),t=getComputedStyle(Tn).color,Tn.remove();let[e,a,o,i]=t.match(/[\d.]+/g)||["0","0","0","0"],s=t.startsWith("color(srgb")?255:1;return new f(Number(e)*s,Number(a)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,e,a=1){let o,i,s;if(t===0)o=i=s=e;else{let d=(g,v,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(v-g)*6*w;if(w<0.5)return v;if(w<0.6666666666666666)return g+(v-g)*(0.6666666666666666-w)*6;return g},c=e<0.5?e*(1+t):e+t-e*t,p=2*e-c,u=(n%360+360)%360/360;o=d(p,c,u+0.3333333333333333),i=d(p,c,u),s=d(p,c,u-0.3333333333333333)}let r=new f(o*255,i*255,s*255,a);return r.hslCached={h:(n%360+360)%360,s:t,l:e},r}static black=new f(0,0,0);static white=new f(255,255,255);constructor(n,t,e,a=1){this.r=X(0,n,255),this.g=X(0,t,255),this.b=X(0,e,255),this.a=X(0,a,1)}get inverse(){return new f(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return f.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new f(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?f.black:f.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new Qa(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new f(n,n,n)}get brightness(){return Ui(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+ln(this.r)+ln(this.g)+ln(this.b):"#"+ln(this.r)+ln(this.g)+ln(this.b)+ln(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a+n*(1-a),1);return f.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a*(1-n),1);return f.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e+n*(1-e),1);return f.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e*(1-n),1);return f.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return f.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return f.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new f(Z(this.r,n.r,t),Z(this.g,n.g,t),Z(this.b,n.b,t),Z(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return f.fromHsl(e.s===0?a.h:a.s===0?e.h:f.blendHue(e.h,a.h,t),Z(e.s,a.s,t),Z(e.l,a.l,t),Z(this.a,n.a,t))}colorMix(n,t){return f.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function $n(n,t){let e=m.style(Yn(t));e.id=n,document.head.append(e)}var Fi=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],no=(n,t)=>{if(typeof t==="number"&&!Fi.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Yi=(n,t,e)=>{if(e===void 0)return"";if(e instanceof f)e=e.html;let a=no(t,e);return`${n}  ${a.prop}: ${a.value};`},to=(n,t,e="")=>{let a=tn(n);if(typeof t==="object"&&!(t instanceof f)){let o=Object.keys(t).map((i)=>to(i,t[i],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Yi(e,a,t)},Yn=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>to(i,a[i])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},Gi=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=tn(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},he=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof f)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=f.fromCss(a).inverseLuminance}return t},h=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+tn(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),l=new Proxy({},{get(n,t){if(t==="default")return h;if(n[t]==null){t=tn(t);let[,e,,a,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${e}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=f.fromVar(s);n[t]=r>0?d.brighten(r).rgba:d.darken(-r).rgba}break;case"s":{let d=f.fromVar(s);n[t]=r>0?d.saturate(r).rgba:d.desaturate(-r).rgba}break;case"h":{let d=f.fromVar(s);n[t]=d.rotate(r*100).rgba}break;case"o":{let d=f.fromVar(s);n[t]=d.opacity(r).rgba}break;case"":n[t]=`calc(var(${s}) * ${r})`;break;default:throw console.error(i),Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),$i="http://www.w3.org/1998/Math/MathML",Ji="http://www.w3.org/2000/svg",dt={},eo=(n,t,e)=>{let a=no(tn(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},Ki=(n)=>{return{toDOM(t,e){eo(t,n,e)}}},ao=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Pn(e[a]))O(n,e[a],Ki(a));else eo(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=tn(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},Zi=(n)=>{return{toDOM(t,e){ao(t,n,e)}}},Qi=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();Mn(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?J[e.binding]:e.binding)!==void 0&&e.value!==void 0)O(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=J[a];if(o!==void 0)O(n,e,o);else throw Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Pn(e))O(n,e,Zi(t));else ao(n,t,e)},pe=(n,...t)=>{if(dt[n]===void 0){let[o,i]=n.split("|");if(i===void 0)dt[n]=globalThis.document.createElement(o);else dt[n]=globalThis.document.createElementNS(i,o)}let e=dt[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(Pn(o))e.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];Qi(e,o,i)}return e},ue=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},m=new Proxy({fragment:ue},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>pe(t,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),bt=new Proxy({fragment:ue},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>pe(`${t}|${Ji}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),oo=new Proxy({fragment:ue},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>pe(`${t}|${$i}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),ns=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],ts=!0,es=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,as=(n)=>es.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},os={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}},Q=Symbol("undefined");function $t(n,t){if(n===void 0||n===null)return new Proxy({[Q]:n===null?"null":"undefined"},nn(t,!0));let e=typeof n;if(e==="object"||e==="function")return n;else return new Proxy(os[typeof n](n),nn(t,!0))}var Jt=()=>new Proxy({},nn("^",!0)),Oa=!1;function cn(){if(!Oa)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),Oa=!0}var za=(n)=>{return n instanceof Number||n instanceof String||n instanceof Boolean||Q in n},nn=(n,t)=>({get(e,a){if(za(e))switch(a){case"path":return n;case"value":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case"observe":return(r)=>{let d=Nn(n,r);return()=>En(d)};case"on":return(r,d)=>Yt()(r,d,P(e));case"bind":return(r,d,c)=>{Ft()(r,n,d,c)};case"binding":return(r)=>({bind:{value:n,binding:r}});case"listBinding":return(r=({span:c})=>c({bindText:"^"}),d={})=>[{bindList:{value:n,...d}},m.template(r(m,Jt()))];case In:case"tosiValue":return cn(),e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case q:case"tosiPath":return cn(),n;case Ia:case"tosiObserve":return cn(),(r)=>{let d=Nn(n,r);return()=>En(d)};case Ba:case"tosiOn":return cn(),(r,d)=>Yt()(r,d,P(e));case Ea:case"tosiBind":return cn(),(r,d,c)=>{Ft()(r,n,d,c)};case"tosiBinding":return cn(),(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return cn(),(r=({span:c})=>c({bindText:"^"}),d={})=>[{bindList:{value:n,...d}},m.template(r(m,Jt()))]}switch(a){case q:case"tosiPath":return n;case In:case"tosiValue":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case Ia:case"tosiObserve":return(r)=>{let d=Nn(n,r);return()=>En(d)};case Ba:case"tosiOn":return(r,d)=>Yt()(r,d,P(e));case Ea:case"tosiBind":return(r,d,c)=>{Ft()(r,n,d,c)};case"tosiBinding":return(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return(r=({span:c})=>c({bindText:"^"}),d={})=>[{bindList:{value:n,...d}},m.template(r(m,Jt()))]}if(typeof a==="symbol")return e[a];let o=Object.getOwnPropertyDescriptor(e,a);if(o&&!o.configurable&&!o.writable&&"value"in o)return o.value;let i=a,s=i.match(/^([^.[]+)\.(.+)$/)??i.match(/^([^\]]+)(\[.+)/)??i.match(/^(\[[^\]]+\])\.(.+)$/)??i.match(/^(\[[^\]]+\])\[(.+)$/);if(s!==null){let[,r,d]=s,c=dn(n,r),p=Fn(e,r);return p!==null&&typeof p==="object"?new Proxy(p,nn(c,t))[d]:p}if(i.startsWith("[")&&i.endsWith("]"))i=i.substring(1,i.length-1);if(!Array.isArray(e)&&e[i]!==void 0||Array.isArray(e)&&i.includes("=")){let r;if(i.includes("=")){let[d,c]=i.split("=");r=e.find((p)=>`${Fn(p,d)}`===c)}else r=e[i];if(r instanceof Object){let d=dn(n,i);return new Proxy(r instanceof Function?r.bind(e):r,nn(d,t))}else return t?$t(r,dn(n,i)):r}else if(Array.isArray(e)){let r=e[i];return typeof r==="function"?(...d)=>{let c=d.map((u)=>P(u)),p=r.apply(e,c);if(ns.includes(i))un(n);return p}:typeof r==="object"?new Proxy(r,nn(dn(n,i),t)):t?$t(r,dn(n,i)):r}else return t?$t(e[i],dn(n,i)):e[i]},set(e,a,o){o=P(o);let i=a===In||a==="value"&&za(e)?n:dn(n,a);if(ts&&!as(i))throw Error(`setting invalid path ${i}`);if(P(L[i])!==o&&Vi(de,i,o))un(i);return!0}}),gt=(n,t)=>{let e=typeof t==="function"?t:L[t];if(typeof e!=="function")throw Error(`observe expects a function or path to a function, ${t} is neither`);return Nn(n,e)},L=new Proxy(de,nn("",!1));Ei(L);var ut=new Proxy(de,nn("",!0)),is=16,ss=100;function _a(n,t){let e=Array.from(n.querySelectorAll(Bn));if(n.matches(Bn))e.unshift(n);for(let a of e){let o=pn.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,L[i.path])}}}class io{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=qn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)if(re.observe(this.boundElement),this._update=Un(()=>{this.update(this.array,!0)},is),this.boundElement.addEventListener("resize",this._update),e.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this.array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,c=n.scrollContainer==="window",p,u;if(c){p=window.innerHeight;let z=this.boundElement.getBoundingClientRect();u=Math.max(0,-z.top)}else p=this.boundElement.offsetHeight,u=this.boundElement.scrollTop;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let g=Math.ceil(p/n.height)+(n.rowChunkSize||1),v=Math.ceil(a.length/n.visibleColumns),w=n.visibleColumns*g,j=Math.floor(u/n.height);if(j>v-g+1)j=Math.max(0,v-g+1);if(n.rowChunkSize)j-=j%n.rowChunkSize;o=j*n.visibleColumns,i=o+w-1,s=j*n.height,r=Math.max((v-g)*n.height-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:r}}needle;filter=Un((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},ss);update(n,t){if(n==null)n=[];this.array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Pn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:r,lastItem:d,topBuffer:c,bottomBuffer:p}=i;if(e===void 0&&a===void 0&&t===!0&&s!=null&&r===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let u=0,g=0,v=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let C=T[ne];if(C==null)T.remove();else{let S=i.items.indexOf(C);if(S<r||S>d)T.remove(),this.itemToElement.delete(C),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(p)+"px";let w=[],{idPath:j}=this.options;for(let T=r;T<=d;T++){let C=i.items[T];if(C===void 0)continue;let S=this.itemToElement.get(P(C));if(S==null){if(v++,S=qn(this.template),typeof C==="object")this.itemToElement.set(P(C),S),S[ne]=P(C);if(this.boundElement.insertBefore(S,this.listBottom),j!=null){let M=C[j],Sn=`${o}[${j}=${M}]`;_a(S,Sn)}else{let M=`${o}[${T}]`;_a(S,M)}}w.push(S)}let z=null;for(let T of w){if(T.previousElementSibling!==z)if(g++,z?.nextElementSibling!=null)this.boundElement.insertBefore(T,z.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);z=T}if(ct.perf)console.log(o,"updated",{removed:u,created:v,moved:g})}}var me=(n,t,e)=>{let a=n[Qt];if(t&&a===void 0)a=new io(n,t,e),n[Qt]=a;return a},be=(n)=>{let t;while(!(t=n[ne])&&n&&n.parentElement)n=n.parentElement;return t?{element:n,item:t}:void 0},mn=(n)=>{let t=be(n);return t?t.item:void 0},rs=(n)=>{let t=be(n);if(!t)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let e=me(t.element.parentElement);if(!e.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,e),!1;let a=e.array.indexOf(t.item);if(a>-1)return e.array.splice(a,1),!0;return!1},{document:Gn,MutationObserver:Ha}=globalThis,ge=(n,t)=>{let e=pn.get(n);if(e==null)return;for(let a of e){let{binding:o,options:i}=a,{path:s}=a,{toDOM:r}=o;if(r!=null){if(s.startsWith("^")){let d=mn(n);if(d!=null&&d[q]!=null)s=a.path=`${d[q]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))r(n,ce()[s],i)}}};if(Ha!=null)new Ha((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Bn)).forEach((a)=>ge(a))})})}).observe(Gn.body,{subtree:!0,childList:!0});Nn(()=>!0,(n)=>{let t=Array.from(Gn.querySelectorAll(Bn));for(let e of t)ge(e,n)});var Ra=(n)=>{let t=n.target?.closest(Bn);while(t!=null){let e=pn.get(t);for(let a of e){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let r;try{r=s(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let d=ce(),c=d[i];if(c==null)d[i]=r;else{let p=c[q]!=null?c[In]:c,u=r[q]!=null?r[In]:r;if(p!==u)d[i]=u}}}}t=t.parentElement.closest(Bn)}};if(globalThis.document!=null)Gn.body.addEventListener("change",Ra,!0),Gn.body.addEventListener("input",Ra,!0);function O(n,t,e,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[q]===void 0&&a===void 0){let{value:r}=t;o=typeof r==="string"?r:r[q],a=t,delete a.value}else o=typeof t==="string"?t:t[q];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:i}=e;n.classList?.add(Wa);let s=pn.get(n);if(s==null)s=[],pn.set(n,s);if(s.push({path:o,binding:e,options:a}),i!=null&&!o.startsWith("^"))un(o);if(a?.filter&&a?.needle)O(n,a.needle,{toDOM(r,d){console.log({needle:d}),r[Qt]?.filter(d)}});return n}var Va=new Set,ls=(n)=>{let t=n?.target?.closest(Ta),e=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let r=i[s];return typeof r==="function"?r.bind(i):r}}}),o=new Set;while(!e&&t!=null){let i=Xn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let r=ce()[s];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${s}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(Ta):null}};function Mn(n,t,e){let a=Xn.get(n);if(n.classList.add(Xa),a==null)a={},Xn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!Va.has(t))Va.add(t),Gn.body.addEventListener(t,ls,!0);return()=>{a[t].delete(e)}}Bi(O,Mn);var ds=0;function Kt(){return`custom-elt${(ds++).toString(36)}`}var Na=0,Wn={};function cs(n,t){let e=Wn[n],a=Yn(t).replace(/:host\b/g,n);Wn[n]=e?e+`
`+a:a}function hs(n){if(Wn[n])document.head.append(m.style({id:n+"-component"},Wn[n]));delete Wn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Yn(n))}static elementCreator(n={}){let t=this;if(t._elementCreator==null){let{tag:e,styleSpec:a}=n,o=n!=null?e:null;if(o==null)if(typeof t.name==="string"&&t.name!==""){if(o=tn(t.name),o.startsWith("-"))o=o.slice(1)}else o=Kt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Kt();while(customElements.get(o)!==void 0)o=Kt();if(t._tagName=o,a!==void 0)cs(o,a);window.customElements.define(o,this,n),t._elementCreator=m[o]}return t._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(Ni(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=hn(this[a]);let o=tn(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(i){if(typeof t[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),e[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):hn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Na+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Na}`,this._value=hn(this.defaultValue)}connectedCallback(){if(hs(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(re.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){re.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)Ua(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content(m):this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=m.style(Yn(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),La(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);La(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(ye.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{s[r.name]=r}),o.forEach((r)=>{let d=s[""],c=r instanceof Element?s[r.slot]:d;(c!==void 0?c:d).append(r)})}}this._hydrated=!0}}render(){}}class ye extends b{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Xl=ye.elementCreator({tag:"xin-slot"}),fe=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(L[o]!==void 0)Object.assign(L[o],a[o]);else L[o]=a[o]}let e=mt(()=>{let a={},o=P(L);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);gt(n,e)},yt="1.0.11";function U(n){return Object.assign(ut,n),ut}function we(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),U(n)}function so(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),we(n);return Object.keys(n).forEach((e)=>{L[e]=n[e]}),L}var ps={};async function ve(n,t){let{type:e,styleSpec:a}=await t(n,{Color:f,Component:b,elements:m,svgElements:bt,mathML:oo,varDefault:h,vars:l,xin:L,boxed:ut,xinProxy:so,boxedProxy:we,tosi:U,makeComponent:ve,bind:O,on:Mn,version:yt}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return ps[n]=o,o}var Zt={},us=(n)=>import(n);class ft extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Zt[a]===void 0)Zt[a]=us(t).then((o)=>{let i=o[e];return ve(n,i)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await Zt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var ms=ft.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class xe extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(ft.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var bs=xe.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Ca={};Sa(Ca,{xrControllersText:()=>Jr,xrControllers:()=>$r,xinTagList:()=>Dl,xinTag:()=>fi,xinSizer:()=>Bl,xinSelect:()=>jn,xinSegmented:()=>El,xinRating:()=>gl,xinPasswordStrength:()=>bl,xinNotification:()=>pi,xinMenu:()=>fr,xinLocalized:()=>Ht,xinForm:()=>Yr,xinFloat:()=>Fe,xinField:()=>Fr,xinCarousel:()=>sr,version:()=>ja,updateLocalized:()=>na,trackDrag:()=>on,tosijs:()=>Jn,tosiMonth:()=>cl,tosiDialog:()=>At,tabSelector:()=>ci,svgIcon:()=>er,svg2DataUrl:()=>zt,styleSheet:()=>qo,spacer:()=>_n,sizeBreak:()=>va,sideNav:()=>fa,setLocale:()=>hr,scriptTag:()=>xn,richTextWidgets:()=>yi,richText:()=>jl,removeLastMenu:()=>Cn,postNotification:()=>ul,positionFloat:()=>$o,popMenu:()=>G,popFloat:()=>Go,menu:()=>ei,markdownViewer:()=>ha,mapBox:()=>rl,makeSorter:()=>Jo,makeExamplesLive:()=>ol,localize:()=>E,localePicker:()=>mr,liveExample:()=>Vt,isBreached:()=>mi,initLocalization:()=>ur,icons:()=>y,i18n:()=>I,gamepadText:()=>Gr,gamepadState:()=>di,findHighestZ:()=>_t,filterPart:()=>Ot,filterBuilder:()=>Vr,elastic:()=>vl,editableRect:()=>Or,dragAndDrop:()=>oi,digest:()=>ui,defineIcons:()=>tr,dataTable:()=>Ir,createSubMenu:()=>ni,createMenuItem:()=>ti,createMenuAction:()=>Qo,commandButton:()=>W,colorInput:()=>Yo,codeEditor:()=>Lt,bringToFront:()=>ot,bodymovinPlayer:()=>or,blockStyle:()=>ba,b3d:()=>ar,availableFilters:()=>sa,abTest:()=>nr,XinTagList:()=>ka,XinTag:()=>Nt,XinSizer:()=>xa,XinSelect:()=>st,XinSegmented:()=>ya,XinRating:()=>ma,XinPasswordStrength:()=>ua,XinNotification:()=>kn,XinMenu:()=>aa,XinLocalized:()=>Y,XinForm:()=>it,XinFloat:()=>sn,XinField:()=>Rt,XinCarousel:()=>Qe,TosiMonth:()=>pa,TosiDialog:()=>ia,TabSelector:()=>da,SvgIcon:()=>Ke,SizeBreak:()=>wa,SideNav:()=>Rn,RichText:()=>ga,MarkdownViewer:()=>ca,MapBox:()=>vn,LocalePicker:()=>ta,LiveExample:()=>Hn,FilterPart:()=>ra,FilterBuilder:()=>la,EditableRect:()=>V,DataTable:()=>oa,CodeEditor:()=>zn,BodymovinPlayer:()=>On,B3d:()=>Ze,AbTest:()=>An});function je(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var gn=je();function mo(n){gn=n}var nt={exec:()=>null};function k(n,t=""){let e=typeof n=="string"?n:n.source,a={replace:(o,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(D.caret,"$1"),e=e.replace(o,s),a},getRegex:()=>new RegExp(e,t)};return a}var D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},gs=/^(?:[ \t]*(?:\n|$))+/,ys=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,fs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,tt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,ws=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ce=/(?:[*+-]|\d{1,9}[.)])/,bo=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,go=k(bo).replace(/bull/g,Ce).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),vs=k(bo).replace(/bull/g,Ce).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Se=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,xs=/^[^\n]+/,Te=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,ks=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Te).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),js=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ce).getRegex(),jt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ie=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Cs=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Ie).replace("tag",jt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),yo=k(Se).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Ss=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",yo).getRegex(),Ee={blockquote:Ss,code:ys,def:ks,fences:fs,heading:ws,hr:tt,html:Cs,lheading:go,list:js,newline:gs,paragraph:yo,table:nt,text:xs},ro=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Ts={...Ee,lheading:vs,table:ro,paragraph:k(Se).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ro).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex()},Is={...Ee,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ie).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:nt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Se).replace("hr",tt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",go).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Es=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Bs=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,fo=/^( {2,}|\\)\n(?!\s*$)/,Ps=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ct=/[\p{P}\p{S}]/u,Be=/[\s\p{P}\p{S}]/u,wo=/[^\s\p{P}\p{S}]/u,Ms=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Be).getRegex(),vo=/(?!~)[\p{P}\p{S}]/u,Ls=/(?!~)[\s\p{P}\p{S}]/u,Ds=/(?:[^\s\p{P}\p{S}]|~)/u,As=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,xo=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Os=k(xo,"u").replace(/punct/g,Ct).getRegex(),zs=k(xo,"u").replace(/punct/g,vo).getRegex(),ko="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",_s=k(ko,"gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Be).replace(/punct/g,Ct).getRegex(),Hs=k(ko,"gu").replace(/notPunctSpace/g,Ds).replace(/punctSpace/g,Ls).replace(/punct/g,vo).getRegex(),Rs=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Be).replace(/punct/g,Ct).getRegex(),Vs=k(/\\(punct)/,"gu").replace(/punct/g,Ct).getRegex(),Ns=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ws=k(Ie).replace("(?:-->|$)","-->").getRegex(),Xs=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ws).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),vt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,qs=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",vt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),jo=k(/^!?\[(label)\]\[(ref)\]/).replace("label",vt).replace("ref",Te).getRegex(),Co=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Te).getRegex(),Us=k("reflink|nolink(?!\\()","g").replace("reflink",jo).replace("nolink",Co).getRegex(),lo=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Pe={_backpedal:nt,anyPunctuation:Vs,autolink:Ns,blockSkip:As,br:fo,code:Bs,del:nt,emStrongLDelim:Os,emStrongRDelimAst:_s,emStrongRDelimUnd:Rs,escape:Es,link:qs,nolink:Co,punctuation:Ms,reflink:jo,reflinkSearch:Us,tag:Xs,text:Ps,url:nt},Fs={...Pe,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",vt).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",vt).getRegex()},ke={...Pe,emStrongRDelimAst:Hs,emStrongLDelim:zs,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",lo).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",lo).getRegex()},Ys={...ke,br:k(fo).replace("{2,}","*").getRegex(),text:k(ke.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},wt={normal:Ee,gfm:Ts,pedantic:Is},Kn={normal:Pe,gfm:ke,breaks:Ys,pedantic:Fs},Gs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},co=(n)=>Gs[n];function F(n,t){if(t){if(D.escapeTest.test(n))return n.replace(D.escapeReplace,co)}else if(D.escapeTestNoEncode.test(n))return n.replace(D.escapeReplaceNoEncode,co);return n}function ho(n){try{n=encodeURI(n).replace(D.percentDecode,"%")}catch{return null}return n}function po(n,t){let e=n.replace(D.findPipe,(i,s,r)=>{let d=!1,c=s;for(;--c>=0&&r[c]==="\\";)d=!d;return d?"|":" |"}),a=e.split(D.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(D.slashPipe,"|");return a}function Zn(n,t,e){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let i=n.charAt(a-o-1);if(i===t&&!e)o++;else if(i!==t&&e)o++;else break}return n.slice(0,a-o)}function $s(n,t){if(n.indexOf(t[1])===-1)return-1;let e=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===t[0])e++;else if(n[a]===t[1]&&(e--,e<0))return a;return e>0?-2:-1}function uo(n,t,e,a,o){let i=t.href,s=t.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let d={type:n[0].charAt(0)==="!"?"image":"link",raw:e,href:i,title:s,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,d}function Js(n,t,e){let a=n.match(e.other.indentCodeCompensation);if(a===null)return t;let o=a[1];return t.split(`
...
`)}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let e=t[0],a=Js(e,t[3]||"",this.rules);return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let a=Zn(e,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(e=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:Zn(t[0],`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];$n("demo-style",vi);var rn="tosijs";setTimeout(()=>{let n=f.fromVar(l.brandColor),t=f.fromVar(l.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Ol=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",zl=Wt.find((n)=>n.filename===Ol)||Wt[0],{app:B,prefs:A}=U({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Wt,currentDoc:zl,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});fe((n)=>{if(n.startsWith("prefs"))return!0;return!1});J.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};J.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:U,img:qt,bindings:J,elements:m,vars:l,touch:un,Color:f})},1000);var xi=document.querySelector("main"),{h2:_l,div:ki,span:rt,a:Xt,img:qt,header:Hl,button:ji,template:Rl,input:Vl}=m;O(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});O(document.body,A.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});O(document.body,A.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((t)=>t.filename.xinValue===n)||B.docs[0]});var Nl=mt(()=>{console.time("filter");let n=Ci.value.toLocaleLowerCase();B.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),un(B.docs),console.timeEnd("filter")}),Ci=Vl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Nl});if(xi)xi.append(Hl(ji({class:"iconic",style:{color:l.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,t){n.style.display=t?"":"none",n.nextSibling.style.display=t?"":"none"}}},onClick(){let n=document.querySelector(Rn.tagName);n.contentVisible=!n.contentVisible}},y.menu()),rt({style:{flex:"0 0 10px"}}),Xt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${yt}, tosijs-ui ${ja}`},qt({src:"favicon.svg",style:{height:40,marginRight:10}}),_l({bindText:"app.title"})),rt({class:"elastic"}),va({minWidth:750},rt({style:{marginRight:l.spacing,display:"flex",alignItems:"center",gap:l.spacing50}},Xt({href:B.bundleUrl},qt({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),Xt({href:B.cdnUrl},qt({alt:"jsdelivr",src:B.cdnBadgeUrl}))),rt({slot:"small"})),rt({style:{flex:"0 0 10px"}}),ji({title:"theme",class:"iconic",onClick(n){G({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.xinValue},{icon:"npm",caption:"npm",action:B.npmUrl.xinValue},{icon:"discord",caption:"discord",action:B.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return A.theme.xinValue==="system"},action(){A.theme.xinValue="system"}},{caption:"Dark",checked(){return A.theme.xinValue==="dark"},action(){A.theme.xinValue="dark"}},{caption:"Light",checked(){return A.theme.xinValue==="light"},action(){A.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return A.highContrast.xinValue},action(){A.highContrast.xinValue=!A.highContrast.xinValue}},{caption:"Monochrome",checked(){return A.monochrome.xinValue},action(){A.monochrome.xinValue=!A.monochrome.xinValue}}]}]})}},y.moreVertical())),fa({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Rn.tagName);B.compact.xinValue=n.compact}},Ci,ki({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},Rl(Xt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=mn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),B.currentDoc=e,n.preventDefault()}}))),ki({style:{position:"relative",overflowY:"scroll",height:"100%"}},ha({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Jn,"tosijs-ui":Ca})}}))));

//# debugId=4CE4665BA1464BED64756E2164756E21
