var us=Object.defineProperty;var ms=(n)=>n;function bs(n,e){this[n]=ms.bind(null,e)}var La=(n,e)=>{for(var t in e)us(n,t,{get:e[t],enumerable:!0,configurable:!0,set:bs.bind(e,t)})};var ke=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var le={};La(le,{xinValue:()=>Tn,xinProxy:()=>Ko,xinPath:()=>ws,xin:()=>V,warnDeprecated:()=>Sn,version:()=>Ve,vars:()=>d,varDefault:()=>p,validateAgainstConstraints:()=>_o,updates:()=>Io,unobserve:()=>fn,touchElement:()=>Ut,touch:()=>q,tosiValue:()=>R,tosiSetValue:()=>vs,tosiPath:()=>_,tosiLoader:()=>Cr,tosiBlueprint:()=>jr,tosi:()=>W,throttle:()=>ae,svgElements:()=>Oe,share:()=>xr,settings:()=>De,scrollListItemIntoView:()=>ar,onThemePreferencesChange:()=>Vt,onStylesheetChange:()=>qs,on:()=>Gn,observe:()=>re,mathML:()=>Uo,makeComponent:()=>Ft,invertLuminance:()=>At,initVars:()=>Ks,hotReload:()=>qt,getThemePreferences:()=>se,getListItem:()=>In,getListInstance:()=>zt,getListBinding:()=>Ae,getCssVar:()=>Oo,elements:()=>m,deprecated:()=>Bt,deleteListItem:()=>er,debounce:()=>ie,css:()=>_n,boxedProxy:()=>_t,boxed:()=>X,blueprintLoader:()=>Tr,blueprint:()=>Sr,bindings:()=>tn,bind:()=>cn,StyleSheet:()=>Fn,MoreMath:()=>zs,Component:()=>g,Color:()=>y,BlueprintLoader:()=>Gt,Blueprint:()=>Re});function kn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(kn);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=kn(a);else e[t]=a}return e}var wo="-xin-data",qn=`.${wo}`,xo="-xin-event",Ma=`.${xo}`,H=Symbol.for("xin-path"),jn=Symbol.for("xin-value"),Ea="xinObserve",no="xinBind",eo="xinOn",Ie=Symbol("list-binding"),ne=Symbol("list-instance"),yt=new Map;function gs(n,e){let t=yt.get(n);if(t===void 0)t=new Set,yt.set(n,t);t.add(e)}function ys(n){return yt.get(n)}var to=new Set;function Sn(n,e){if(!to.has(n))console.warn(e),to.add(n)}function Bt(n,e){let t=!1;return(...a)=>{if(!t)console.warn(e),t=!0;return n(...a)}}var _=(n)=>{return n&&n[H]||void 0};function R(n){if(typeof n==="object"&&n!==null){let e=n[jn];return e!==void 0?e:n}return n}function vs(n,e){if(_(n)===void 0)throw Error("tosiSetValue requires a xin or boxed proxy");n[jn]=e}var ws=Bt(_,"xinPath is deprecated. Use tosiPath instead."),Tn=Bt(R,"xinValue is deprecated. Use tosiValue instead."),ee=new WeakMap,Cn=new WeakMap,te=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=Cn.get(n),a=ee.get(n);if(t!=null)Cn.set(e,kn(t));if(a!=null)ee.set(e,kn(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(te(t));else e.appendChild(t.cloneNode());return e},De={debug:!1,perf:!1},xs=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},fo=(...n)=>Error(n.map(xs).join(" ")),fs=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),ks=0,js=()=>(parseInt("10000",36)+ ++ks).toString(36).slice(-5),Cs=()=>fs()+js(),vt=Symbol("delete"),ko=Symbol("new-object"),lt=Symbol("automatic-index");function jo(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var en=new WeakMap;function Co(n,e){if(en.get(n)===void 0)en.set(n,{});if(en.get(n)[e]===void 0)en.get(n)[e]={};let t=en.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a[lt]===void 0)a[lt]=Cs();t[a[lt]+""]=o});else n.forEach((a,o)=>{t[z(a,e)+""]=o});return t}function Ss(n,e){if(en.get(n)===void 0||en.get(n)[e]===void 0)return Co(n,e);else return en.get(n)[e]}function Ts(n,e,t){t=t+"";let a=Ss(n,e)[t];if(a===void 0||z(n[a],e)+""!==t)a=Co(n,e)[t];return a}function Is(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function So(n,e,t,a){let o=e!==""?Ts(n,e,t):t;if(a===vt)return n.splice(o,1),en.delete(n),Symbol("deleted");else if(a===ko){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&z(a,e)+""===t+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function ao(n){if(!Array.isArray(n))throw fo("setByPath failed: expected array, found",n)}function oo(n){if(n==null||!(n instanceof Object))throw fo("setByPath failed: expected Object, found",n)}function z(n,e){let t=jo(e),a=n,o,i,s,r;for(o=0,i=t.length;a!==void 0&&o<i;o++){let l=t[o];if(Array.isArray(l))for(s=0,r=l.length;a!==void 0&&s<r;s++){let c=l[s];a=a[c]}else if(a.length===0){if(a=a[Number(l.slice(1))],l[0]!=="=")return}else if(l.includes("=")){let[c,...h]=l.split("=");a=So(a,c,h.join("="))}else s=parseInt(l,10),a=a[s]}return a}function Pt(n,e,t){let a=n;if(e==="")throw Error("setByPath cannot be used to set the root object");let o=jo(e);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)oo(a);else ao(a);let r=i.slice(0,s),l=i.slice(s+1);if(a=So(a,r,l,o.length>0?ko:t),o.length===0)return!0}else{ao(a);let r=parseInt(i,10);if(o.length>0)a=a[r];else{if(t!==vt){if(a[r]===t)return!1;a[r]=t}else a.splice(r,1);return!0}}}else if(Array.isArray(i)&&i.length>0){oo(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=Is(a,s,i.length>0?{}:[]);else{if(t!==vt){if(a[s]===t)return!1;a[s]=t}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw Error(`setByPath failed, bad path ${e}`)}throw Error(`setByPath(${n}, ${e}, ${t}) failed`)}var L={},wt=null,Ds=(n)=>{wt=n},Ot=()=>{if(wt===null)throw Error("xin proxy not initialized");return wt},xt=null,ft=null,Bs=(n,e)=>{xt=n,ft=e},je=()=>{if(xt===null)throw Error("bind not initialized");return xt},Ce=()=>{if(ft===null)throw Error("on not initialized");return ft},io=Symbol("observer should be removed"),Be=[],Wn=[],kt=!1,jt,Ct;function Ps(n,e,t,a){let o=ys(n);if(o===void 0)return[];let i=[];for(let s of o){let r=z(t,s);if(r!==void 0)i.push(`${n}[${s}=${r}]${a}`)}return i}class To{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw Error("expect callback to be a path or function");Be.push(this)}}var Io=async()=>{if(jt===void 0)return;await jt},Os=()=>{if(De.perf)console.time("xin async update");let n=Array.from(Wn);Wn.length=0,kt=!1;for(let e of n)Be.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===io)return fn(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===io)fn(t)});if(typeof Ct==="function")Ct();if(De.perf)console.timeEnd("xin async update")},q=(n)=>{let e=typeof n==="string"?n:_(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(kt===!1)jt=new Promise((a)=>{Ct=a}),kt=setTimeout(Os);if(Wn.find((a)=>e.startsWith(a))==null)Wn.push(e);let t=e.match(/^(.+)\[(\d+)\](.*)$/);if(t!==null){let[,a,o,i]=t,s=parseInt(o,10),r=z(L,`${a}[${s}]`);if(r!=null){let l=Ps(a,s,r,i);for(let c of l)if(Wn.find((h)=>c.startsWith(h))==null)Wn.push(c)}}},xn=(n,e)=>{return new To(n,e)},fn=(n)=>{let e=Be.indexOf(n);if(e>-1)Be.splice(e,1);else throw Error("unobserve failed, listener not found")},Do=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},Bo=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},As=(n,e)=>{switch(Bo(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},Vs=(n)=>{switch(Bo(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:so}=globalThis,St=so!=null?new so((n)=>{for(let e of n){let t=e.target;Do(t,"resize")}}):{observe(){},unobserve(){}},ro=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?te(a):a)});else if(e instanceof Node)n.append(t?te(e):e);else throw Error("expect text content or document node")},ie=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},ae=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...i)=>{if(clearTimeout(t),t=setTimeout(()=>{n(...i),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},tn={value:{toDOM:As,fromDOM(n){return Vs(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){Ae(n,e,t).update(e)}}};function J(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function Po(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var Ns=180/Math.PI,Rs=Math.PI/180;function Y(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function rn(n,e,t,a=!0){if(a)t=Y(0,t,1);return t*(e-n)+n}var zs={RADIANS_TO_DEGREES:Ns,DEGREES_TO_RADIANS:Rs,clamp:Y,lerp:rn};function Oo(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var Us=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},yn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class Ao{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),i=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var ln=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;if(ln)ln.style.display="none";class y{r;g;b;a;static fromVar(n,e=document.body){return y.fromCss(Oo(n,e))}static fromCss(n){let e=n.match(/^#([0-9a-fA-F]+)$/);if(e){let l=e[1];if(l.length===3)return new y(parseInt(l[0]+l[0],16),parseInt(l[1]+l[1],16),parseInt(l[2]+l[2],16));if(l.length===4)return new y(parseInt(l[0]+l[0],16),parseInt(l[1]+l[1],16),parseInt(l[2]+l[2],16),parseInt(l[3]+l[3],16)/255);if(l.length===6)return new y(parseInt(l.slice(0,2),16),parseInt(l.slice(2,4),16),parseInt(l.slice(4,6),16));if(l.length===8)return new y(parseInt(l.slice(0,2),16),parseInt(l.slice(2,4),16),parseInt(l.slice(4,6),16),parseInt(l.slice(6,8),16)/255)}let t=n;if(ln instanceof HTMLSpanElement)ln.style.color="black",ln.style.color=n,document.body.appendChild(ln),t=getComputedStyle(ln).color,ln.remove();let[a,o,i,s]=t.match(/[\d.]+/g)||["0","0","0","0"],r=t.startsWith("color(srgb")?255:1;return new y(Number(a)*r,Number(o)*r,Number(i)*r,s==null?1:Number(s))}static fromHsl(n,e,t,a=1){let o,i,s;if(e===0)o=i=s=t;else{let l=(b,x,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return b+(x-b)*6*w;if(w<0.5)return x;if(w<0.6666666666666666)return b+(x-b)*(0.6666666666666666-w)*6;return b},c=t<0.5?t*(1+e):t+e-t*e,h=2*t-c,u=(n%360+360)%360/360;o=l(h,c,u+0.3333333333333333),i=l(h,c,u),s=l(h,c,u-0.3333333333333333)}let r=new y(o*255,i*255,s*255,a);return r.hslCached={h:(n%360+360)%360,s:e,l:t},r}static black=new y(0,0,0);static white=new y(255,255,255);constructor(n,e,t,a=1){this.r=Y(0,n,255),this.g=Y(0,e,255),this.b=Y(0,t,255),this.a=Y(0,a,1)}get inverse(){return new y(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return y.fromHsl(n,e,1-t,this.a)}get opaque(){return this.a===1?this:new y(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?y.black:y.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new Ao(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new y(n,n,n)}get brightness(){return Us(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+yn(this.r)+yn(this.g)+yn(this.b):"#"+yn(this.r)+yn(this.g)+yn(this.b)+yn(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=Y(0,a+n*(1-a),1);return y.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=Y(0,a*(1-n),1);return y.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=Y(0,t+n*(1-t),1);return y.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=Y(0,t*(1-n),1);return y.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return y.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return y.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new y(rn(this.r,n.r,e),rn(this.g,n.g,e),rn(this.b,n.b,e),rn(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return y.fromHsl(t.s===0?a.h:a.s===0?t.h:y.blendHue(t.h,a.h,e),rn(t.s,a.s,e),rn(t.l,a.l,e),rn(this.a,n.a,e))}colorMix(n,e){return y.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}static computedColorStylesheet=null;static computedColors=new Map;static recomputeQueued=!1;static registerComputedColor(n,e,t,a){if(!y.computedColors.has(n))y.computedColors.set(n,{varName:e,scale:t,method:a}),y.queueRecompute()}static queueRecompute(){if(y.recomputeQueued)return;y.recomputeQueued=!0,queueMicrotask(()=>{y.recomputeQueued=!1,y.recomputeColors()})}static recomputeColors(){if(y.computedColors.size===0)return;let n=[];for(let[t,{varName:a,scale:o,method:i}]of y.computedColors)try{let s=y.fromVar(a),r;switch(i){case"b":r=o>0?s.brighten(o):s.darken(-o);break;case"s":r=o>0?s.saturate(o):s.desaturate(-o);break;case"h":r=s.rotate(o*100);break;case"o":r=s.opacity(o);break;default:continue}n.push(`  ${t}: ${r.rgba};`)}catch(s){}if(n.length===0)return;let e=`:root {
${n.join(`
`)}
}`;if(y.computedColorStylesheet===null)y.computedColorStylesheet=document.createElement("style"),y.computedColorStylesheet.id="tosijs-computed-colors",document.head.append(y.computedColorStylesheet);y.computedColorStylesheet.textContent=e}}var Pe=new Set,lo=!1;function Ws(){if(!lo)lo=!0,Pe.add(()=>y.queueRecompute())}function qs(n){return Pe.add(n),()=>Pe.delete(n)}function _s(){Ws();for(let n of Pe)n()}function Fn(n,e){let t=R(e),a=m.style(_n(t));a.id=n,document.head.append(a);let o=_(e);if(o!==void 0)re(o,()=>{a.textContent=_n(R(e)),_s()})}var Fs=/^(animation-iteration-count|column-count|flex(-grow|-shrink)?|font-weight|line-height|opacity|order|orphans|scale|tab-size|widows|z-index|zoom)$/,Vo=(n,e)=>{if(typeof e==="number"&&!Fs.test(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},Gs=(n,e,t)=>{if(t===void 0)return"";if(t instanceof y)t=t.html;let a=Vo(e,t);return`${n}  ${a.prop}: ${a.value};`},No=(n,e,t="")=>{let a=J(n);if(typeof e==="object"&&!(e instanceof y)){let o=Object.keys(e).map((i)=>No(i,e[i],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
${t}  }`}else return Gs(t,a,e)},_n=(n,e="")=>{return Object.keys(n).map((t)=>{let a=n[t];if(typeof a==="string"){if(t==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>No(i,a[i])).join(`
`);return`${e}${t} {
${o}
}`}).join(`

`)},Ks=(n)=>{Sn("initVars","initVars is deprecated. Just use _ and __ prefixes instead.");let e={};for(let t of Object.keys(n)){let a=n[t],o=J(t);e[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return e},At=(n)=>{let e={};for(let t of Object.keys(n)){let a=n[t];if(a instanceof y)e[t]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))e[t]=y.fromCss(a).inverseLuminance}return e},p=new Proxy({},{get(n,e){if(n[e]===void 0){let t="--"+J(e);n[e]=(a)=>`var(${t}, ${a})`}return n[e]}}),d=new Proxy({},{get(n,e){if(e==="default")return p;if(n[e]==null){e=J(e);let[,t,,a,o,i]=e.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",e],s=`--${t}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":case"s":case"h":case"o":{let l=`--${e}`;y.registerComputedColor(l,s,r,i),n[e]=`var(${l})`}break;case"":n[e]=`calc(var(${s}) * ${r})`;break;default:throw console.error(i),Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[e]=`var(${s})`}return n[e]}});function se(){let n=(e)=>typeof matchMedia<"u"&&matchMedia(e).matches;return{colorScheme:n("(prefers-color-scheme: dark)")?"dark":"light",contrast:n("(prefers-contrast: more)")?"more":n("(prefers-contrast: less)")?"less":n("(prefers-contrast: custom)")?"custom":"no-preference",reducedMotion:n("(prefers-reduced-motion: reduce)"),reducedTransparency:n("(prefers-reduced-transparency: reduce)"),forcedColors:n("(forced-colors: active)")}}function Vt(n){if(typeof matchMedia>"u")return()=>{};let e=["(prefers-color-scheme: dark)","(prefers-contrast: more)","(prefers-contrast: less)","(prefers-contrast: custom)","(prefers-reduced-motion: reduce)","(prefers-reduced-transparency: reduce)","(forced-colors: active)"],t=()=>n(se()),a=e.map((o)=>matchMedia(o));for(let o of a)o.addEventListener("change",t);return()=>{for(let o of a)o.removeEventListener("change",t)}}var Qs="http://www.w3.org/1998/Math/MathML",$s="http://www.w3.org/2000/svg",Se={},Ro=(n,e,t)=>{let a=Vo(J(e),t);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[e]=a.value},Zs=(n)=>{return{toDOM(e,t){Ro(e,n,t)}}},zo=(n,e,t)=>{if(e==="style")if(typeof t==="object")for(let a of Object.keys(t))if(_(t[a]))cn(n,t[a],Zs(a));else Ro(n,a,t[a]);else n.setAttribute("style",t);else{let a=J(e),o=n.constructor.observedAttributes;if(o?.includes(e)||o?.includes(a))if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t);else if(n[e]!==void 0){let{MathMLElement:i}=globalThis;if(n instanceof SVGElement||i!==void 0&&n instanceof i)n.setAttribute(e,t);else n[e]=t}else if(a==="class")t.split(" ").forEach((i)=>{n.classList.add(i)});else if(n[a]!==void 0)n[a]=t;else if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t)}},dt={},Ys=(n)=>{if(!dt[n])dt[n]={toDOM(e,t){zo(e,n,t)}};return dt[n]},Xs=(n,e,t)=>{if(e==="apply")t(n);else if(e.match(/^on[A-Z]/)!=null){let a=e.substring(2).toLowerCase();Gn(n,a,t)}else if(e==="bind")if((typeof t.binding==="string"?tn[t.binding]:t.binding)!==void 0&&t.value!==void 0)cn(n,t.value,t.binding instanceof Function?{toDOM:t.binding}:t.binding);else throw Error("bad binding");else if(e.match(/^bind[A-Z]/)!=null){let a=e.substring(4,5).toLowerCase()+e.substring(5),o=tn[a];if(o!==void 0)cn(n,t,o);else throw Error(`${e} is not allowed, bindings.${a} is not defined`)}else if(_(t))cn(n,t,Ys(e));else zo(n,e,t)},Nt=(n,...e)=>{if(Se[n]===void 0){let[o,i]=n.split("|");if(i===void 0)Se[n]=globalThis.document.createElement(o);else Se[n]=globalThis.document.createElementNS(i,o)}let t=Se[n].cloneNode(),a={};for(let o of e)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(t instanceof HTMLTemplateElement)t.content.append(o);else t.append(o);else if(_(o))t.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];Xs(t,o,i)}return t},Rt=(...n)=>{let e=globalThis.document.createDocumentFragment();for(let t of n)e.append(t);return e},m=new Proxy({fragment:Rt},{get(n,e){if(e=e.replace(/[A-Z]/g,(t)=>`-${t.toLocaleLowerCase()}`),n[e]===void 0)n[e]=(...t)=>Nt(e,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Oe=new Proxy({fragment:Rt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>Nt(`${e}|${$s}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Uo=new Proxy({fragment:Rt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>Nt(`${e}|${Qs}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Js=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Hs=!0,Ls=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,Ms=(n)=>Ls.test(n),sn=(n="",e="")=>{if(n==="")return e;else if(e.match(/^\d+$/)!==null||e.includes("="))return`${n}[${e}]`;else return`${n}.${e}`},Wo={};function ct(n,e){if(n!==null&&(typeof n==="object"||typeof n==="function"))return n;return new Proxy(Wo,dn(e,!0))}var Ln=()=>new Proxy({},dn("^",!0)),ht=(n)=>{let e=n(Ln())?.path;if(!e?.startsWith("^."))throw Error("selector must return a property of the item");return e.substring(2)},pt=(n,e,t)=>{for(let a=0;a<n.length;a++)if(`${z(n[a],e)}`===`${t}`)return a;return-1},co=(n,e)=>({listFind(t,a){if(t instanceof Element){let s=t;while(s&&!s[ne]&&s.parentElement)s=s.parentElement;let r=s?.[ne];if(r==null)return;let l=e.indexOf(r);return l!==-1?X[n][l]:void 0}let o=ht(t),i=pt(e,o,a);return i!==-1?X[n][i]:void 0},listUpdate(t,a){let o=ht(t),i=z(a,o),s=pt(e,o,i);if(s!==-1){let r=X[n][s];for(let l of Object.keys(a))r[l]=a[l];return r}return X[n].push(a),X[n][e.length-1]},listRemove(t,a){let o=ht(t),i=pt(e,o,a);if(i===-1)return!1;return X[n].splice(i,1),!0}}),ho=!1;function vn(){if(!ho)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),ho=!0}var po=(n)=>{return n===Wo},dn=(n,e)=>({get(t,a){if(po(t)){let r=()=>z(L,n);switch(a){case"path":return n;case"value":return r();case"valueOf":case"toJSON":return()=>r();case Symbol.toPrimitive:return(l)=>{let c=r();if(l==="number")return Number(c);if(l==="string")return String(c);return c};case"toString":return()=>String(r());case"touch":return()=>q(n);case"observe":return(l)=>{let c=xn(n,l);return()=>fn(c)};case"on":return(l,c)=>Ce()(l,c,r());case"bind":return(l,c,h)=>{je()(l,n,c,h)};case"binding":return(l)=>({bind:{value:n,binding:l}});case"listBinding":return(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,Ln()))];case"listFind":case"listUpdate":case"listRemove":return co(n,t)[a];case jn:case"xinValue":case"tosiValue":return vn(),r();case H:case"xinPath":case"tosiPath":return vn(),n;case Ea:case"tosiObserve":return vn(),(l)=>{let c=xn(n,l);return()=>fn(c)};case eo:case"tosiOn":return vn(),(l,c)=>Ce()(l,c,r());case no:case"tosiBind":return vn(),(l,c,h)=>{je()(l,n,c,h)};case"tosiBinding":return vn(),(l)=>({bind:{value:n,binding:l}});case"tosiListBinding":return vn(),(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,Ln()))]}if(typeof a==="string"&&/^\d+$/.test(a)){let l=r();if(typeof l==="string")return l[parseInt(a,10)]}if(a==="length"){let l=r();if(typeof l==="string")return l.length}return}if(e&&!(a in t))switch(a){case"path":return n;case"value":return t.valueOf?t.valueOf():t;case"valueOf":case"toJSON":return()=>t.valueOf?t.valueOf():t;case"touch":return()=>q(n);case"observe":return(r)=>{let l=xn(n,r);return()=>fn(l)};case"on":return(r,l)=>Ce()(r,l,R(t));case"bind":return(r,l,c)=>{je()(r,n,l,c)};case"binding":return(r)=>({bind:{value:n,binding:r}});case"listBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,Ln()))];case"listFind":case"listUpdate":case"listRemove":return co(n,t)[a]}switch(a){case H:case"xinPath":case"tosiPath":return n;case jn:case"xinValue":case"tosiValue":return t.valueOf?t.valueOf():t;case Ea:case"xinObserve":case"tosiObserve":return(r)=>{let l=xn(n,r);return()=>fn(l)};case eo:case"xinOn":case"tosiOn":return(r,l)=>Ce()(r,l,R(t));case no:case"xinBind":case"tosiBind":return(r,l,c)=>{je()(r,n,l,c)};case"tosiBinding":return(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,Ln()))]}if(typeof a==="symbol")return t[a];let o=Object.getOwnPropertyDescriptor(t,a);if(o&&!o.configurable&&!o.writable&&"value"in o)return o.value;let i=a,s=i.match(/^([^.[]+)\.(.+)$/)??i.match(/^([^\]]+)(\[.+)/)??i.match(/^(\[[^\]]+\])\.(.+)$/)??i.match(/^(\[[^\]]+\])\[(.+)$/);if(s!==null){let[,r,l]=s,c=sn(n,r),h=z(t,r);return h!==null&&typeof h==="object"?new Proxy(h,dn(c,e))[l]:h}if(i.startsWith("[")&&i.endsWith("]"))i=i.substring(1,i.length-1);if(!Array.isArray(t)&&t[i]!==void 0||Array.isArray(t)&&i.includes("=")){let r;if(i.includes("=")){let[l,c]=i.split("=");r=t.find((h)=>`${z(h,l)}`===c)}else r=t[i];if(r instanceof Object){let l=sn(n,i);return new Proxy(r instanceof Function?r.bind(t):r,dn(l,e))}else return e?ct(r,sn(n,i)):r}else if(Array.isArray(t)){let r=t[i];return typeof r==="function"?(...l)=>{let c=l.map((u)=>R(u)),h=r.apply(t,c);if(Js.includes(i))q(n);if(h!=null&&typeof h==="object"){if(i==="find"||i==="findLast"||i==="at"){let u=t.indexOf(h);if(u!==-1)return new Proxy(h,dn(sn(n,String(u)),e))}}return h}:typeof r==="object"?new Proxy(r,dn(sn(n,i),e)):e?ct(r,sn(n,i)):r}else return e?ct(t[i],sn(n,i)):t[i]},set(t,a,o){o=R(o);let i=a===jn||a==="xinValue"||a==="tosiValue"||a==="value"&&(po(t)||e)?n:sn(n,a);if(Hs&&!Ms(i))throw Error(`setting invalid path ${i}`);if(R(V[i])!==o&&Pt(L,i,o))q(i);return!0}}),re=(n,e)=>{let t=typeof e==="function"?e:V[e];if(typeof t!=="function")throw Error(`observe expects a function or path to a function, ${e} is neither`);return xn(n,t)},V=new Proxy(L,dn("",!1));Ds(V);var X=new Proxy(L,dn("",!0)),Es=16,nr=100;function uo(n,e){let t=Array.from(n.querySelectorAll(qn));if(n.matches(qn))t.unshift(n);for(let a of t){let o=Cn.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${e}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,V[i.path])}}}class qo{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_filteredCache;_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,e,t={}){if(this.boundElement=n,this.itemToElement=new WeakMap,t.idPath!=null){let a=_(e);if(a!=null)gs(a,t.idPath)}if(n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=te(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=t,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),this.boundElement[Ie]=this,t.virtual!=null)if(St.observe(this.boundElement),this._update=ae(()=>{this.update(this.array,!0)},Es),this.boundElement.addEventListener("resize",this._update),t.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}filteredArray(){if(this._filteredCache!=null)return this._filteredCache;let{hiddenProp:n,visibleProp:e}=this.options,t=this.array;if(n!==void 0)t=t.filter((a)=>a[n]!==!0);if(e!==void 0)t=t.filter((a)=>a[e]===!0);if(this.options.filter&&this.needle!==void 0)t=this.options.filter(t,this.needle);return this._filteredCache=t,t}visibleSlice(){let{virtual:n}=this.options,e=this.filteredArray(),t=0,a=e.length-1,o=0,i=0;if(n!=null&&this.boundElement instanceof HTMLElement){let s=this.boundElement.offsetWidth,r=n.scrollContainer==="window",l,c;if(r){l=window.innerHeight;let b=this.boundElement.getBoundingClientRect();c=Math.max(0,-b.top)}else l=this.boundElement.offsetHeight,c=this.boundElement.scrollTop;let h=n.width!=null?Math.max(1,Math.floor(s/n.width)):n.visibleColumns??1,u=Math.ceil(e.length/h);if(n.minHeight!=null){let b=n.minHeight,x=Math.ceil(l/b)+(n.rowChunkSize||1),w=h*x,k=u*b,I=Math.max(0,k-l),B=I>0?Math.min(1,Math.max(0,c/I)):0,f=Math.max(0,u-x+1),j=B*f,C=Math.floor(j);if(n.rowChunkSize)C-=C%n.rowChunkSize;return t=C*h,a=t+w-1,o=c,i=Math.max(0,k-c-l),{items:e,firstItem:t,lastItem:a,topBuffer:o,bottomBuffer:i,interpolation:{t:B,position:j,scrollTop:c,viewportHeight:l,totalScrollHeight:k,rowHeight:n.height}}}else{let b=Math.ceil(l/n.height)+(n.rowChunkSize||1),x=h*b,w=Math.floor(c/n.height);if(w>u-b+1)w=Math.max(0,u-b+1);if(n.rowChunkSize)w-=w%n.rowChunkSize;t=w*h,a=t+x-1,o=w*n.height,i=Math.max((u-b)*n.height-o,0)}}return{items:e,firstItem:t,lastItem:a,topBuffer:o,bottomBuffer:i}}needle;filter=ae((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},nr);update(n,e){if(n==null)n=[];if(this.array=n,!e)this._filteredCache=void 0;let{hiddenProp:t,visibleProp:a}=this.options,o=_(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:r,lastItem:l,topBuffer:c,bottomBuffer:h}=i,u=t===void 0&&a===void 0&&e===!0&&s!=null&&r===s.firstItem&&l===s.lastItem;if(u&&i.interpolation==null&&c===s.topBuffer&&h===s.bottomBuffer)return;if(u&&i.interpolation!=null){this._updateInterpolatedBuffers(i);return}this._previousSlice=i;let b=0,x=0,w=0;for(let f of Array.from(this.boundElement.children)){if(f===this.listTop||f===this.listBottom)continue;let j=f[ne];if(j==null)f.remove();else{let C=i.items.indexOf(j);if(C<r||C>l)f.remove(),this.itemToElement.delete(j),b++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(h)+"px";let k=[],{idPath:I}=this.options;for(let f=r;f<=l;f++){let j=i.items[f];if(j===void 0)continue;let C=this.itemToElement.get(R(j));if(C==null){if(w++,C=te(this.template),typeof j==="object")this.itemToElement.set(R(j),C),C[ne]=R(j);if(this.boundElement.insertBefore(C,this.listBottom),I!=null){let U=j[I],gn=`${o}[${I}=${U}]`;uo(C,gn)}else{let U=`${o}[${f}]`;uo(C,U)}}k.push(C)}let B=null;for(let f of k){if(f.previousElementSibling!==B)if(x++,B?.nextElementSibling!=null)this.boundElement.insertBefore(f,B.nextElementSibling);else this.boundElement.insertBefore(f,this.listBottom);B=f}if(i.interpolation!=null)this._updateInterpolatedBuffers(i);if(De.perf)console.log(o,"updated",{removed:b,created:w,moved:x})}_updateInterpolatedBuffers(n){let{t:e,position:t,scrollTop:a,viewportHeight:o,totalScrollHeight:i,rowHeight:s}=n.interpolation,r=0;for(let u of Array.from(this.boundElement.children)){if(u===this.listTop||u===this.listBottom)continue;r+=u.offsetHeight||s}let l=a,c=a+o-r,h=Math.max(0,e*c+(1-e)*l-t%1*s);this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(Math.max(0,i-h-r))+"px"}}var Ae=(n,e,t)=>{let a=n[Ie];if(e&&a===void 0)a=new qo(n,e,t),n[Ie]=a;return a},zt=(n)=>{let e;while(!(e=n[ne])&&n&&n.parentElement)n=n.parentElement;return e?{element:n,item:e}:void 0},In=(n)=>{let e=zt(n);return e?e.item:void 0},er=(n)=>{let e=zt(n);if(!e)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let t=Ae(e.element.parentElement);if(!t.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,t),!1;let a=t.array.indexOf(e.item);if(a>-1)return t.array.splice(a,1),!0;return!1},tr={start:"start",middle:"center",end:"end",nearest:"nearest"},ar=(n,e,t={})=>{let a=Ae(n);if(a==null)return console.error("scrollListItemIntoView failed, element has no list binding",n),!1;let{position:o="middle"}=t,i=a.filteredArray(),s=R(e)??e,r=i.indexOf(s);if(r===-1)return console.error("scrollListItemIntoView failed, item not found in list",e),!1;let{virtual:l}=a.options;if(l!=null&&n instanceof HTMLElement){let c=l.width!=null?Math.max(1,Math.floor(n.offsetWidth/l.width)):l.visibleColumns??1,h=Math.floor(r/c),u=l.minHeight??l.height,b=Math.ceil(i.length/c),x=l.scrollContainer==="window",w=x?window.innerHeight:n.offsetHeight,k;if(l.minHeight!=null){let I=Math.ceil(w/u)+(l.rowChunkSize||1),B=b*u,f=Math.max(0,B-w),j=Math.max(1,b-I+1),C=h/j;switch(o){case"start":k=C*f;break;case"end":k=Math.max(0,(h-I+1)/j*f);break;case"nearest":{let U=x?Math.max(0,-n.getBoundingClientRect().top):n.scrollTop,gn=f>0?U/f:0,on=Math.floor(gn*j);if(h<on)k=C*f;else if(h>=on+I)k=Math.max(0,(h-I+1)/j*f);else return!0;break}default:{let U=h-Math.floor(I/2);k=Math.max(0,U)/j*f}}}else{let I=h*l.height;switch(o){case"start":k=I;break;case"end":k=I-w+l.height;break;case"nearest":{let B=x?Math.max(0,-n.getBoundingClientRect().top):n.scrollTop;if(I<B)k=I;else if(I+l.height>B+w)k=I-w+l.height;else return!0;break}default:k=I-(w-l.height)/2}}if(k=Math.max(0,k),x){let I=n.getBoundingClientRect().top+window.scrollY;window.scrollTo({top:I+k,behavior:"smooth"})}else n.scrollTo({top:k,behavior:"smooth"})}else{let c=a.itemToElement.get(s);if(c==null)return console.error("scrollListItemIntoView failed, no DOM element found for item",e),!1;c.scrollIntoView({block:tr[o]??"center",behavior:"smooth"})}return!0},{document:oe,MutationObserver:mo}=globalThis,Ut=(n,e)=>{let t=Cn.get(n);if(t==null)return;for(let a of t){let{binding:o,options:i}=a,{path:s}=a,{toDOM:r}=o;if(r!=null){if(s.startsWith("^")){let l=In(n);if(l!=null&&l[H]!=null)s=a.path=`${l[H]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${s}`)}if(e==null||s.startsWith(e))r(n,Ot()[s],i)}}};if(mo!=null)new mo((n)=>{n.forEach((e)=>{Array.from(e.addedNodes).forEach((t)=>{if(t instanceof Element)Array.from(t.querySelectorAll(qn)).forEach((a)=>Ut(a))})})}).observe(oe.body,{subtree:!0,childList:!0});xn(()=>!0,(n)=>{let e=Array.from(oe.querySelectorAll(qn));for(let t of e)Ut(t,n)});var bo=(n)=>{let e=n.target?.closest(qn);while(e!=null){let t=Cn.get(e);for(let a of t){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let r;try{r=s(e,a.options)}catch(l){throw console.error("Cannot get value from",e,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let l=Ot(),c=l[i];if(c==null)l[i]=r;else{let h=c[H]!=null?c[jn]:c,u=r[H]!=null?r[jn]:r;if(h!==u)l[i]=u}}}}e=e.parentElement.closest(qn)}};if(globalThis.document!=null)oe.body.addEventListener("change",bo,!0),oe.body.addEventListener("input",bo,!0);function cn(n,e,t,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof e==="object"&&e[H]===void 0&&a===void 0){let{value:r}=e;o=typeof r==="string"?r:r[H],a=e,delete a.value}else o=typeof e==="string"?e:e[H];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:i}=t;n.classList?.add(wo);let s=Cn.get(n);if(s==null)s=[],Cn.set(n,s);if(s.push({path:o,binding:t,options:a}),i!=null&&!o.startsWith("^"))q(o);if(a?.filter&&a?.needle)cn(n,a.needle,{toDOM(r,l){console.log({needle:l}),r[Ie]?.filter(l)}});return n}var go=new Set,or=(n)=>{let e=n?.target?.closest(Ma),t=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),t=!0};else{let r=i[s];return typeof r==="function"?r.bind(i):r}}}),o=new Set;while(!t&&e!=null){let i=ee.get(e)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let r=Ot()[s];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${s}`)}if(t)continue}e=e.parentElement!=null?e.parentElement.closest(Ma):null}};function Gn(n,e,t){let a=ee.get(n);if(n.classList.add(xo),a==null)a={},ee.set(n,a);if(!a[e])a[e]=new Set;if(a[e].add(t),!go.has(e))go.add(e),oe.body.addEventListener(e,or,!0);return()=>{a[e].delete(t)}}Bs(cn,Gn);function _o(n,e){if(!n.internals)return;let t={},a="";if(n.hasAttribute("required")&&e==="")t.valueMissing=!0,a="Please fill out this field.";let o=n.getAttribute("minlength");if(o&&e.length<parseInt(o,10))t.tooShort=!0,a=`Please use at least ${o} characters.`;let i=n.getAttribute("maxlength");if(i&&e.length>parseInt(i,10))t.tooLong=!0,a=`Please use no more than ${i} characters.`;let s=n.getAttribute("pattern");if(s&&e!=="")try{if(!new RegExp(`^(?:${s})$`).test(e))t.patternMismatch=!0,a="Please match the requested format."}catch{}if(Object.keys(t).length>0)n.internals.setValidity(t,a,n);else n.internals.setValidity({})}var ir=0;function ut(){return`custom-elt${(ir++).toString(36)}`}var yo=0,mt=null;function sr(){if(mt===null)mt=new MutationObserver((n)=>{let e=new Set;for(let t of n)if(t.type==="attributes"&&t.target instanceof g){let a=t.target,o=Po(t.attributeName);if(a._legacyTrackedAttrs?.has(o))e.add(a)}for(let t of e)t.queueRender(!1)});return mt}var En={};function rr(n,e){let t=En[n],a=_n(e).replace(/:host\(([^)]+)\)/g,`${n}$1`).replace(/:host\b/g,n);En[n]=t?t+`
`+a:a}function lr(n){if(En[n])document.head.append(m.style({id:n+"-component"},En[n]));delete En[n]}class g extends HTMLElement{static elements=m;static _elementCreator;static initAttributes;static formAssociated;internals;get validity(){return this.internals?.validity}get validationMessage(){return this.internals?.validationMessage??""}get willValidate(){return this.internals?.willValidate??!1}checkValidity(){return this.internals?.checkValidity()??!0}reportValidity(){return this.internals?.reportValidity()??!0}setCustomValidity(n){if(this.internals)if(n)this.internals.setValidity({customError:!0},n);else this.internals.setValidity({})}setValidity(n,e,t){this.internals?.setValidity(n,e,t)}setFormValue(n,e){this.internals?.setFormValue(n,e)}static get observedAttributes(){let n=this.initAttributes;if(n)return["hidden",...Object.keys(n).map(J)];return["hidden"]}instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}_legacyTrackedAttrs;_attrValues;_valueChanged=!1;static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(_n(n))}static elementCreator(n={}){let e=this;if(!Object.prototype.hasOwnProperty.call(e,"_elementCreator")){let{tag:t,styleSpec:a}=n,o=n!=null?t:null;if(o==null)if(typeof e.name==="string"&&e.name!==""){if(o=J(e.name),o.startsWith("-"))o=o.slice(1)}else o=ut();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=ut();while(customElements.get(o)!==void 0)o=ut();if(e._tagName=o,a!==void 0)rr(o,a);window.customElements.define(o,this,n),e._elementCreator=m[o]}return e._elementCreator}initAttributes(...n){if(Sn("initAttributes","initAttributes() is deprecated. Use static initAttributes = { ... } instead."),!this._legacyTrackedAttrs)this._legacyTrackedAttrs=new Set;for(let a of n)this._legacyTrackedAttrs.add(a);sr().observe(this,{attributes:!0});let e={},t={};n.forEach((a)=>{e[a]=kn(this[a]);let o=J(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof e[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof e[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(t[a]!==void 0)return t[a];else return e[a]},set(i){if(typeof e[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof e[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),t[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let e=this.hasAttribute("value")?this.getAttribute("value"):kn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return e},set(t){if(e!==t)e=t,this._valueChanged=!0,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(e,t){if(e[t]===void 0){let a=n.querySelector(`[part="${t}"]`);if(a==null)a=n.querySelector(t);if(a==null)throw Error(`elementRef "${t}" does not exist!`);a.removeAttribute("data-ref"),e[t]=a}return e[t]}});return this._parts}attributeChangedCallback(n,e,t){let a=Po(n);if(!this._legacyTrackedAttrs?.has(a))this.queueRender(!1)}constructor(){super();if(yo+=1,this.constructor.formAssociated&&typeof this.attachInternals==="function"&&!this.internals)this.internals=this.attachInternals();let n=this.constructor.initAttributes;if(n)this._setupAttributeAccessors(n);this.instanceId=`${this.tagName.toLocaleLowerCase()}-${yo}`,this._value=kn(this.defaultValue)}_setupAttributeAccessors(n){if(!this._attrValues)this._attrValues=new Map;for(let e of Object.keys(n)){let t=J(e),a=n[e];if(e==="value"){console.warn(`${this.tagName}: 'value' cannot be an attribute. Use the Component value property instead.`);continue}if(typeof a==="object"&&a!==null){console.warn(`${this.tagName}: initAttributes.${e} is an object. Use a regular property instead.`);continue}let o=this,i=!1;while(o){let s=Object.getOwnPropertyDescriptor(o,e);if(s){if(!s.configurable||s.get||s.set){i=!0;break}break}o=Object.getPrototypeOf(o)}if(i)continue;Object.defineProperty(this,e,{enumerable:!1,get:()=>{if(typeof a==="boolean")return this.hasAttribute(t);else if(this.hasAttribute(t))return typeof a==="number"?parseFloat(this.getAttribute(t)):this.getAttribute(t);else if(this._attrValues.has(e))return this._attrValues.get(e);else return a},set:(s)=>{if(typeof a==="boolean"){if(s!==this[e]){if(s)this.setAttribute(t,"");else this.removeAttribute(t);this.queueRender()}}else if(typeof a==="number"){if(s!==parseFloat(this[e]))this.setAttribute(t,s),this.queueRender()}else if(typeof s==="object"||`${s}`!==`${this[e]}`){if(s===null||s===void 0||typeof s==="object")this.removeAttribute(t);else this.setAttribute(t,s);this.queueRender(),this._attrValues.set(e,s)}}})}}connectedCallback(){if(lr(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.constructor.formAssociated&&!this.hasAttribute("tabindex"))this.setAttribute("tabindex","0");if(this.onResize!==void 0){if(St.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");if(this.internals&&this.value!==void 0)this.internals.setFormValue(this.value),this.validateValue();this.queueRender()}disconnectedCallback(){St.unobserve(this)}formResetCallback(){if(this.value!==void 0)this.value=this.defaultValue??""}formDisabledCallback(n){if(n)this.setAttribute("disabled","");else this.removeAttribute("disabled")}formStateRestoreCallback(n){if(this.value!==void 0&&typeof n==="string")this.value=n}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued){if(Do(this,"change"),this.internals&&this.value!==void 0)this.internals.setFormValue(this.value)}this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",e=typeof this.content==="function"?this.content(m):this.content,{styleSpec:t}=this.constructor,{styleNode:a}=this.constructor;if(t)a=this.constructor.styleNode=m.style(_n(t)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),ro(o,e,n)}else if(e!==null){let o=Array.from(this.childNodes);ro(this,e,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(Wt.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{s[r.name]=r}),o.forEach((r)=>{let l=s[""],c=r instanceof Element?s[r.slot]:l;(c!==void 0?c:l).append(r)})}}this._hydrated=!0}}render(){if(this._valueChanged&&this.internals&&this.value!==void 0)this.internals.setFormValue(this.value),this.validateValue();this._valueChanged=!1}validateValue(){if(!this.internals||this.value===void 0)return;let n=typeof this.value==="string"?this.value:String(this.value);_o(this,n)}}class Wt extends g{static initAttributes={name:""};content=null;static replaceSlot(n){let e=document.createElement("xin-slot");if(n.name!=="")e.setAttribute("name",n.name);n.replaceWith(e)}}var ac=Wt.elementCreator({tag:"xin-slot"}),qt=(n=()=>!0)=>{let e=localStorage.getItem("xin-state");if(e!=null){let a=JSON.parse(e);for(let o of Object.keys(a).filter(n))if(V[o]!==void 0)Object.assign(V[o],a[o]);else V[o]=a[o]}let t=ie(()=>{let a={},o=R(V);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);re(n,t)},dr="tosijs-share",cr="tosijs-share",Mn="shared",hr=1,Tt=new Set,It=new Set,bt=new Map,wn=null,Dt="",Te=null,pr=null;function vo(){if(Te!=null)return Promise.resolve(Te);return new Promise((n,e)=>{let t=indexedDB.open(cr,hr);t.onupgradeneeded=()=>{t.result.createObjectStore(Mn)},t.onsuccess=()=>{Te=t.result,n(Te)},t.onerror=()=>e(t.error)})}var ur={async get(n){let e=await vo();return new Promise((t,a)=>{let o=e.transaction(Mn,"readonly").objectStore(Mn).get(n);o.onsuccess=()=>t(o.result),o.onerror=()=>a(o.error)})},async set(n,e){let t=await vo();return new Promise((a,o)=>{let i=t.transaction(Mn,"readwrite");i.objectStore(Mn).put(e,n),i.oncomplete=()=>a(),i.onerror=()=>o(i.error)})}};function Fo(){return pr??ur}function mr(n){return n!=null&&n.type==="tosijs-share"&&typeof n.path==="string"}function Go(n){for(let e of Tt)if(n===e||n.startsWith(e+"."))return e;return}function br(n){for(let e of It)if(n===e||n.startsWith(e+"."))return!0;return!1}function gr(n,e){It.add(n),Pt(L,n,e),q(n),Io().then(()=>{It.delete(n)})}function yr(){if(wn!=null)return wn;return Dt=crypto.randomUUID(),wn=new BroadcastChannel(dr),wn.onmessage=(n)=>{let e=n.data;if(!mr(e))return;if(e.origin===Dt)return;if(Go(e.path)===void 0)return;gr(e.path,e.value)},wn}function vr(n,e){if(wn==null)return;let t={type:"tosijs-share",path:n,value:e,origin:Dt};wn.postMessage(t)}function wr(n){if(!bt.has(n))bt.set(n,ie(()=>{let e=z(L,n);Fo().set(n,e)},500));bt.get(n)()}async function xr(...n){if(typeof BroadcastChannel>"u")return{restored:[]};yr();let e=[],t=Fo();for(let a of n){let o=typeof a==="string"?a:_(a);if(o===void 0)throw Error("share() requires boxed proxies or string paths. Got a non-proxy value.");if(Tt.has(o))continue;Tt.add(o);let i=await t.get(o);if(i!==void 0)Pt(L,o,i),q(o),e.push(a);else{let s=z(L,o);await t.set(o,s)}xn((s)=>s===o||s.startsWith(o+"."),(s)=>{if(br(s))return;let r=Go(s);if(r===void 0)return;let l=z(L,s);vr(s,l),wr(r)})}return{restored:e}}var Ve="1.4.1";function W(n){return Object.assign(X,n),X}function _t(n){return Sn("boxedProxy","boxedProxy is deprecated, please use tosi() instead"),W(n)}function Ko(n,e=!1){if(e)return Sn("xinProxy-boxed","xinProxy(..., true) is deprecated; use tosi(...) instead"),_t(n);return Object.keys(n).forEach((t)=>{V[t]=n[t]}),V}var fr={};async function Ft(n,e){let{type:t,styleSpec:a}=await e(n,{Color:y,Component:g,elements:m,svgElements:Oe,mathML:Uo,varDefault:p,vars:d,xin:V,boxed:X,xinProxy:Ko,boxedProxy:_t,tosi:W,makeComponent:Ft,bind:cn,on:Gn,version:Ve}),o={type:t,creator:t.elementCreator({tag:n,styleSpec:a})};return fr[n]=o,o}var Ne={":host":{display:"none"}},gt={},kr=(n)=>import(n);class Re extends g{static initAttributes={tag:"anon-elt",src:"",property:"default"};loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:e,property:t}=this,a=`${n}.${t}:${e}`;if(!this.loaded){if(gt[a]===void 0)gt[a]=kr(e).then((o)=>{let i=o[t];return Ft(n,i)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await gt[a],this.blueprintLoaded(this.loaded)}return this.loaded}}var jr=Re.elementCreator({tag:"tosi-blueprint",styleSpec:Ne});class Gt extends g{allLoaded=()=>{};async load(){let n=Array.from(this.querySelectorAll("tosi-blueprint, xin-blueprint")).filter((e)=>e.src).map((e)=>e.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Cr=Gt.elementCreator({tag:"tosi-loader",styleSpec:Ne});class Qo extends Re{constructor(){super();Sn("xin-blueprint","<xin-blueprint> is deprecated. Use <tosi-blueprint> instead.")}}var Sr=Qo.elementCreator({tag:"xin-blueprint",styleSpec:Ne});class $o extends g{allLoaded=()=>{};constructor(){super();Sn("xin-loader","<xin-loader> is deprecated. Use <tosi-loader> instead.")}async load(){let n=Array.from(this.querySelectorAll("xin-blueprint")).filter((e)=>e.src).map((e)=>e.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Tr=$o.elementCreator({tag:"xin-loader",styleSpec:Ne});var $a={};La($a,{xrControllersText:()=>rd,xrControllers:()=>sd,xinTagList:()=>Qd,xinTag:()=>ts,xinSizer:()=>_d,xinSelect:()=>zn,xinSegmented:()=>qd,xinRating:()=>Id,xinPasswordStrength:()=>Td,xinNotification:()=>Hi,xinMenu:()=>Bl,xinLocalized:()=>et,xinForm:()=>od,xinFloat:()=>ua,xinField:()=>ad,xinCarousel:()=>yl,version:()=>Qa,updateLocalized:()=>fa,trackDrag:()=>un,tosijs:()=>le,tosiMonth:()=>fd,tosiDialog:()=>Le,tabSelector:()=>Xi,svgIcon:()=>ul,svg2DataUrl:()=>Ee,styleSheet:()=>Di,spacer:()=>Xn,sizeBreak:()=>Fa,sideNav:()=>qa,setLocale:()=>kl,scriptTag:()=>Nn,richTextWidgets:()=>es,richText:()=>Nd,removeLastMenu:()=>Un,postNotification:()=>Cd,positionFloat:()=>Vi,popMenu:()=>nn,popFloat:()=>Ai,menu:()=>_i,markdownViewer:()=>Aa,mapBox:()=>vd,makeSorter:()=>Ni,makeExamplesLive:()=>bd,localize:()=>P,localePicker:()=>Sl,liveExample:()=>at,isBreached:()=>Mi,initLocalization:()=>Cl,icons:()=>v,i18n:()=>D,gamepadText:()=>id,gamepadState:()=>Yi,findHighestZ:()=>nt,filterPart:()=>Me,filterBuilder:()=>Ll,elastic:()=>Od,editableRect:()=>Zl,dragAndDrop:()=>Gi,digest:()=>Li,defineIcons:()=>pl,dataTable:()=>Wl,createSubMenu:()=>Wi,createMenuItem:()=>qi,createMenuAction:()=>Ui,commandButton:()=>Z,colorInput:()=>Oi,codeEditor:()=>Je,bringToFront:()=>ge,bodymovinPlayer:()=>bl,blockStyle:()=>za,b3d:()=>ml,availableFilters:()=>Ia,abTest:()=>hl,XinTagList:()=>Ka,XinTag:()=>ot,XinSizer:()=>Ga,XinSelect:()=>ve,XinSegmented:()=>Wa,XinRating:()=>Ra,XinPasswordStrength:()=>Na,XinNotification:()=>Rn,XinMenu:()=>Ca,XinLocalized:()=>E,XinForm:()=>ye,XinFloat:()=>mn,XinField:()=>tt,XinCarousel:()=>xa,TosiMonth:()=>Va,TosiDialog:()=>Ta,TabSelector:()=>Pa,SvgIcon:()=>va,SizeBreak:()=>_a,SideNav:()=>Hn,RichText:()=>Ua,MarkdownViewer:()=>Oa,MapBox:()=>Vn,LocalePicker:()=>ka,LiveExample:()=>Jn,FilterPart:()=>Da,FilterBuilder:()=>Ba,EditableRect:()=>Q,DataTable:()=>Sa,CodeEditor:()=>Yn,BodymovinPlayer:()=>Zn,B3d:()=>wa,AbTest:()=>$n});function Qt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Bn=Qt();function Mo(n){Bn=n}var pe={exec:()=>null};function T(n,e=""){let t=typeof n=="string"?n:n.source,a={replace:(o,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(N.caret,"$1"),t=t.replace(o,s),a},getRegex:()=>new RegExp(t,e)};return a}var N={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},Ir=/^(?:[ \t]*(?:\n|$))+/,Dr=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Br=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ue=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Pr=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,$t=/(?:[*+-]|\d{1,9}[.)])/,Eo=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,ni=T(Eo).replace(/bull/g,$t).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Or=T(Eo).replace(/bull/g,$t).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Zt=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ar=/^[^\n]+/,Yt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Vr=T(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Yt).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Nr=T(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,$t).getRegex(),_e="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Xt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Rr=T("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Xt).replace("tag",_e).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ei=T(Zt).replace("hr",ue).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_e).getRegex(),zr=T(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ei).getRegex(),Jt={blockquote:zr,code:Dr,def:Vr,fences:Br,heading:Pr,hr:ue,html:Rr,lheading:ni,list:Nr,newline:Ir,paragraph:ei,table:pe,text:Ar},Zo=T("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ue).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_e).getRegex(),Ur={...Jt,lheading:Or,table:Zo,paragraph:T(Zt).replace("hr",ue).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Zo).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",_e).getRegex()},Wr={...Jt,html:T(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Xt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:pe,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:T(Zt).replace("hr",ue).replace("heading",` *#{1,6} *[^
]`).replace("lheading",ni).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},qr=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,_r=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,ti=/^( {2,}|\\)\n(?!\s*$)/,Fr=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Fe=/[\p{P}\p{S}]/u,Ht=/[\s\p{P}\p{S}]/u,ai=/[^\s\p{P}\p{S}]/u,Gr=T(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Ht).getRegex(),oi=/(?!~)[\p{P}\p{S}]/u,Kr=/(?!~)[\s\p{P}\p{S}]/u,Qr=/(?:[^\s\p{P}\p{S}]|~)/u,$r=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,ii=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Zr=T(ii,"u").replace(/punct/g,Fe).getRegex(),Yr=T(ii,"u").replace(/punct/g,oi).getRegex(),si="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Xr=T(si,"gu").replace(/notPunctSpace/g,ai).replace(/punctSpace/g,Ht).replace(/punct/g,Fe).getRegex(),Jr=T(si,"gu").replace(/notPunctSpace/g,Qr).replace(/punctSpace/g,Kr).replace(/punct/g,oi).getRegex(),Hr=T("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,ai).replace(/punctSpace/g,Ht).replace(/punct/g,Fe).getRegex(),Lr=T(/\\(punct)/,"gu").replace(/punct/g,Fe).getRegex(),Mr=T(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Er=T(Xt).replace("(?:-->|$)","-->").getRegex(),nl=T("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Er).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ue=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,el=T(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Ue).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ri=T(/^!?\[(label)\]\[(ref)\]/).replace("label",Ue).replace("ref",Yt).getRegex(),li=T(/^!?\[(ref)\](?:\[\])?/).replace("ref",Yt).getRegex(),tl=T("reflink|nolink(?!\\()","g").replace("reflink",ri).replace("nolink",li).getRegex(),Yo=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Lt={_backpedal:pe,anyPunctuation:Lr,autolink:Mr,blockSkip:$r,br:ti,code:_r,del:pe,emStrongLDelim:Zr,emStrongRDelimAst:Xr,emStrongRDelimUnd:Hr,escape:qr,link:el,nolink:li,punctuation:Gr,reflink:ri,reflinkSearch:tl,tag:nl,text:Fr,url:pe},al={...Lt,link:T(/^!?\[(label)\]\((.*?)\)/).replace("label",Ue).getRegex(),reflink:T(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ue).getRegex()},Kt={...Lt,emStrongRDelimAst:Jr,emStrongLDelim:Yr,url:T(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Yo).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:T(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Yo).getRegex()},ol={...Kt,br:T(ti).replace("{2,}","*").getRegex(),text:T(Kt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},ze={normal:Jt,gfm:Ur,pedantic:Wr},de={normal:Lt,gfm:Kt,breaks:ol,pedantic:al},il={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Xo=(n)=>il[n];function M(n,e){if(e){if(N.escapeTest.test(n))return n.replace(N.escapeReplace,Xo)}else if(N.escapeTestNoEncode.test(n))return n.replace(N.escapeReplaceNoEncode,Xo);return n}function Jo(n){try{n=encodeURI(n).replace(N.percentDecode,"%")}catch{return null}return n}function Ho(n,e){let t=n.replace(N.findPipe,(i,s,r)=>{let l=!1,c=s;for(;--c>=0&&r[c]==="\\";)l=!l;return l?"|":" |"}),a=t.split(N.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(N.slashPipe,"|");return a}function ce(n,e,t){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let i=n.charAt(a-o-1);if(i===e&&!t)o++;else if(i!==e&&t)o++;else break}return n.slice(0,a-o)}function sl(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===e[0])t++;else if(n[a]===e[1]&&(t--,t<0))return a;return t>0?-2:-1}function Lo(n,e,t,a,o){let i=e.href,s=e.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:i,title:s,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,l}function rl(n,e,t){let a=n.match(t.other.indentCodeCompensation);if(a===null)return e;let o=a[1];return e.split(`
`).map((i)=>{let s=i.match(t.other.beginningSpace);if(s===null)return i;let[r]=s;return r.length>=o.length?i.slice(o.length):i}).join(`
`)}var We=class{options;rules;lexer;constructor(n){this.options=n||Bn}space(n){let e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){let e=this.rules.block.code.exec(n);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:ce(t,`
...
${c}`:c,o=o?`${o}
${h}`:h;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(h,i,!0),this.lexer.state.top=u,t.length===0)break;let b=i.at(-1);if(b?.type==="code")break;if(b?.type==="blockquote"){let x=b,w=x.raw+`
`+t.join(`
`),k=this.blockquote(w);i[i.length-1]=k,a=a.substring(0,a.length-x.raw.length)+k.raw,o=o.substring(0,o.length-x.text.length)+k.text;break}else if(b?.type==="list"){let x=b,w=x.raw+`
`+t.join(`
`),k=this.list(w);i[i.length-1]=k,a=a.substring(0,a.length-b.raw.length)+k.raw,o=o.substring(0,o.length-x.raw.length)+k.raw,t=w.substring(i.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:a,tokens:i,text:o}}}list(n){let e=this.rules.block.list.exec(n);if(e){let t=e[1].trim(),a=t.length>1,o={type:"list",raw:"",ordered:a,start:a?+t.slice(0,-1):"",loose:!1,items:[]};t=a?`\\d{1,9}\\${t.slice(-1)}`:`\\${t}`,this.options.pedantic&&(t=a?t:"[*+-]");let i=this.rules.other.listItemRegex(t),s=!1;for(;n;){let l=!1,c="",h="";if(!(e=i.exec(n))||this.rules.block.hr.test(n))break;c=e[0],n=n.substring(c.length);let u=e[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,(B)=>" ".repeat(3*B.length)),b=n.split(`
`,1)[0],x=!u.trim(),w=0;if(this.options.pedantic?(w=2,h=u.trimStart()):x?w=e[1].length+1:(w=e[2].search(this.rules.other.nonSpaceChar),w=w>4?1:w,h=u.slice(w),w+=e[1].length),x&&this.rules.other.blankLine.test(b)&&(c+=b+`
`,n=n.substring(b.length+1),l=!0),!l){let B=this.rules.other.nextBulletRegex(w),f=this.rules.other.hrRegex(w),j=this.rules.other.fencesBeginRegex(w),C=this.rules.other.headingBeginRegex(w),U=this.rules.other.htmlBeginRegex(w);for(;n;){let gn=n.split(`
`,1)[0],on;if(b=gn,this.options.pedantic?(b=b.replace(this.rules.other.listReplaceNesting,"  "),on=b):on=b.replace(this.rules.other.tabCharGlobal,"    "),j.test(b)||C.test(b)||U.test(b)||B.test(b)||f.test(b))break;if(on.search(this.rules.other.nonSpaceChar)>=w||!b.trim())h+=`
`+on.slice(w);else{if(x||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||j.test(u)||C.test(u)||f.test(u))break;h+=`
`+b}!x&&!b.trim()&&(x=!0),c+=gn+`
`,n=n.substring(gn.length+1),u=on.slice(w)}}o.loose||(s?o.loose=!0:this.rules.other.doubleBlankLine.test(c)&&(s=!0));let k=null,I;this.options.gfm&&(k=this.rules.other.listIsTask.exec(h),k&&(I=k[0]!=="[ ] ",h=h.replace(this.rules.other.listReplaceTask,""))),o.items.push({type:"list_item",raw:c,task:!!k,checked:I,loose:!1,text:h,tokens:[]}),o.raw+=c}let r=o.items.at(-1);if(r)r.raw=r.raw.trimEnd(),r.text=r.text.trimEnd();else return;o.raw=o.raw.trimEnd();for(let l=0;l<o.items.length;l++)if(this.lexer.state.top=!1,o.items[l].tokens=this.lexer.blockTokens(o.items[l].text,[]),!o.loose){let c=o.items[l].tokens.filter((u)=>u.type==="space"),h=c.length>0&&c.some((u)=>this.rules.other.anyLine.test(u.raw));o.loose=h}if(o.loose)for(let l=0;l<o.items.length;l++)o.items[l].loose=!0;return o}}html(n){let e=this.rules.block.html.exec(n);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(n){let e=this.rules.block.def.exec(n);if(e){let t=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),a=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",o=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:t,raw:e[0],href:a,title:o}}}table(n){let e=this.rules.block.table.exec(n);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;let t=Ho(e[1]),a=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),o=e[3]?.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
`):[],i={type:"table",raw:e[0],header:[],align:[],rows:[]};if(t.length===a.length){for(let s of a)this.rules.other.tableAlignRight.test(s)?i.align.push("right"):this.rules.other.tableAlignCenter.test(s)?i.align.push("center"):this.rules.other.tableAlignLeft.test(s)?i.align.push("left"):i.align.push(null);for(let s=0;s<t.length;s++)i.header.push({text:t[s],tokens:this.lexer.inline(t[s]),header:!0,align:i.align[s]});for(let s of o)i.rows.push(Ho(s,i.header.length).map((r,l)=>({text:r,tokens:this.lexer.inline(r),header:!1,align:i.align[l]})));return i}}lheading(n){let e=this.rules.block.lheading.exec(n);if(e)return{type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(n){let e=this.rules.block.paragraph.exec(n);if(e){let t=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return{type:"paragraph",raw:e[0],text:t,tokens:this.lexer.inline(t)}}}text(n){let e=this.rules.block.text.exec(n);if(e)return{type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(n){let e=this.rules.inline.escape.exec(n);if(e)return{type:"escape",raw:e[0],text:e[1]}}tag(n){let e=this.rules.inline.tag.exec(n);if(e)return!this.lexer.state.inLink&&this.rules.other.startATag.test(e[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(e[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(e[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(e[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:e[0]}}link(n){let e=this.rules.inline.link.exec(n);if(e){let t=e[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(t)){if(!this.rules.other.endAngleBracket.test(t))return;let i=ce(t.slice(0,-1),"\\");if((t.length-i.length)%2===0)return}else{let i=sl(e[2],"()");if(i===-2)return;if(i>-1){let s=(e[0].indexOf("!")===0?5:4)+e[1].length+i;e[2]=e[2].substring(0,i),e[0]=e[0].substring(0,s).trim(),e[3]=""}}let a=e[2],o="";if(this.options.pedantic){let i=this.rules.other.pedanticHrefTitle.exec(a);i&&(a=i[1],o=i[3])}else o=e[3]?e[3].slice(1,-1):"";return a=a.trim(),this.rules.other.startAngleBracket.test(a)&&(this.options.pedantic&&!this.rules.other.endAngleBracket.test(t)?a=a.slice(1):a=a.slice(1,-1)),Lo(e,{href:a&&a.replace(this.rules.inline.anyPunctuation,"$1"),title:o&&o.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer,this.rules)}}reflink(n,e){let t;if((t=this.rules.inline.reflink.exec(n))||(t=this.rules.inline.nolink.exec(n))){let a=(t[2]||t[1]).replace(this.rules.other.multipleSpaceGlobal," "),o=e[a.toLowerCase()];if(!o){let i=t[0].charAt(0);return{type:"text",raw:i,text:i}}return Lo(t,o,t[0],this.lexer,this.rules)}}emStrong(n,e,t=""){let a=this.rules.inline.emStrongLDelim.exec(n);if(!a||a[3]&&t.match(this.rules.other.unicodeAlphaNumeric))return;if(!(a[1]||a[2])||!t||this.rules.inline.punctuation.exec(t)){let o=[...a[0]].length-1,i,s,r=o,l=0,c=a[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,e=e.slice(-1*n.length+o);(a=c.exec(e))!=null;){if(i=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!i)continue;if(s=[...i].length,a[3]||a[4]){r+=s;continue}else if((a[5]||a[6])&&o%3&&!((o+s)%3)){l+=s;continue}if(r-=s,r>0)continue;s=Math.min(s,s+r+l);let h=[...a[0]][0].length,u=n.slice(0,o+a.index+h+s);if(Math.min(o,s)%2){let x=u.slice(1,-1);return{type:"em",raw:u,text:x,tokens:this.lexer.inlineTokens(x)}}let b=u.slice(2,-2);return{type:"strong",raw:u,text:b,tokens:this.lexer.inlineTokens(b)}}}}codespan(n){let e=this.rules.inline.code.exec(n);if(e){let t=e[2].replace(this.rules.other.newLineCharGlobal," "),a=this.rules.other.nonSpaceChar.test(t),o=this.rules.other.startingSpaceChar.test(t)&&this.rules.other.endingSpaceChar.test(t);return a&&o&&(t=t.substring(1,t.length-1)),{type:"codespan",raw:e[0],text:t}}}br(n){let e=this.rules.inline.br.exec(n);if(e)return{type:"br",raw:e[0]}}del(n){let e=this.rules.inline.del.exec(n);if(e)return{type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(n){let e=this.rules.inline.autolink.exec(n);if(e){let t,a;return e[2]==="@"?(t=e[1],a="mailto:"+t):(t=e[1],a=t),{type:"link",raw:e[0],text:t,href:a,tokens:[{type:"text",raw:t,text:t}]}}}url(n){let e;if(e=this.rules.inline.url.exec(n)){let t,a;if(e[2]==="@")t=e[0],a="mailto:"+t;else{let o;do o=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])?.[0]??"";while(o!==e[0]);t=e[0],e[1]==="www."?a="http://"+e[0]:a=e[0]}return{type:"link",raw:e[0],text:t,href:a,tokens:[{type:"text",raw:t,text:t}]}}}inlineText(n){let e=this.rules.inline.text.exec(n);if(e){let t=this.lexer.state.inRawBlock;return{type:"text",raw:e[0],text:e[0],escaped:t}}}},F=class n{tokens;options;state;tokenizer;inlineQueue;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Bn,this.options.tokenizer=this.options.tokenizer||new We,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:N,block:ze.normal,inline:de.normal};this.options.pedantic?(t.block=ze.pedantic,t.inline=de.pedantic):this.options.gfm&&(t.block=ze.gfm,this.options.breaks?t.inline=de.breaks:t.inline=de.gfm),this.tokenizer.rules=t}static get rules(){return{block:ze,inline:de}}static lex(e,t){return new n(t).lex(e)}static lexInline(e,t){return new n(t).inlineTokens(e)}lex(e){e=e.replace(N.carriageReturn,`
`),this.blockTokens(e,this.tokens);for(let t=0;t<this.inlineQueue.length;t++){let a=this.inlineQueue[t];this.inlineTokens(a.src,a.tokens)}return this.inlineQueue=[],this.tokens}blockTokens(e,t=[],a=!1){for(this.options.pedantic&&(e=e.replace(N.tabCharGlobal,"    ").replace(N.spaceLine,""));e;){let o;if(this.options.extensions?.block?.some((s)=>(o=s.call({lexer:this},e,t))?(e=e.substring(o.raw.length),t.push(o),!0):!1))continue;if(o=this.tokenizer.space(e)){e=e.substring(o.raw.length);let s=t.at(-1);o.raw.length===1&&s!==void 0?s.raw+=`
...
`+a+"</"+o+`>
`}listitem(n){let e="";if(n.task){let t=this.checkbox({checked:!!n.checked});n.loose?n.tokens[0]?.type==="paragraph"?(n.tokens[0].text=t+" "+n.tokens[0].text,n.tokens[0].tokens&&n.tokens[0].tokens.length>0&&n.tokens[0].tokens[0].type==="text"&&(n.tokens[0].tokens[0].text=t+" "+M(n.tokens[0].tokens[0].text),n.tokens[0].tokens[0].escaped=!0)):n.tokens.unshift({type:"text",raw:t+" ",text:t+" ",escaped:!0}):e+=t+" "}return e+=this.parser.parse(n.tokens,!!n.loose),`<li>${e}</li>
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];rs();var bn="tosijs";setTimeout(()=>{let n=y.fromVar(d.brandColor),e=y.fromVar(d.background);console.log(`welcome to %c${bn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var Jd=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Hd=it.find((n)=>n.filename===Jd)||it[0],ls=xe(),{app:O,prefs:A}=W({app:{title:bn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${bn}#readme`,npmUrl:`https://www.npmjs.com/package/${bn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${bn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${bn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${bn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${bn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:it,currentDoc:Hd,compact:!1},prefs:{colorScheme:ls.colorScheme,highContrast:ls.highContrast,locale:""}});qt((n)=>{if(n.startsWith("prefs"))return!0;return!1});tn.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};tn.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:O,tosi:W,img:rt,bindings:tn,elements:m,vars:d,touch:q,Color:y})},1000);var ds=document.querySelector("main"),{h2:Ld,div:cs,span:fe,a:st,img:rt,header:Md,button:hs,template:Ed,input:nc}=m;A.colorScheme.observe(()=>{Ha({colorScheme:A.colorScheme.value})});A.highContrast.observe(()=>{Ha({highContrast:A.highContrast.value})});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);O.currentDoc=O.docs.find((e)=>e.filename===n)||O.docs[0]});var ec=ie(()=>{console.time("filter");let n=ps.value.toLocaleLowerCase();O.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),q(O.docs),console.timeEnd("filter")}),ps=nc({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:ec});if(ds)ds.append(Md(hs({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:O.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(Hn.tagName);n.contentVisible=!n.contentVisible}},v.menu()),fe({style:{flex:"0 0 10px"}}),st({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${Ve}, tosijs-ui ${Qa}`},rt({src:"favicon.svg",style:{height:40,marginRight:10}}),Ld({bindText:"app.title"})),fe({class:"elastic"}),Fa({minWidth:750},fe({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},st({href:O.bundleUrl},rt({alt:"bundlejs size badge",src:O.bundleBadgeUrl})),st({href:O.cdnUrl},rt({alt:"jsdelivr",src:O.cdnBadgeUrl}))),fe({slot:"small"})),fe({style:{flex:"0 0 10px"}}),hs({title:"theme",class:"iconic",onClick(n){nn({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:O.githubUrl.value},{icon:"npm",caption:"npm",action:O.npmUrl.value},{icon:"discord",caption:"discord",action:O.discordUrl.value},{icon:"tosiUi",caption:"tosijs-ui",action:O.tosijsuiUrl.value},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return A.colorScheme.value==="system"},action(){A.colorScheme.value="system"}},{caption:"Dark",checked(){return A.colorScheme.value==="dark"},action(){A.colorScheme.value="dark"}},{caption:"Light",checked(){return A.colorScheme.value==="light"},action(){A.colorScheme.value="light"}},null,{caption:"High Contrast (System)",checked(){return A.highContrast.value==="system"},action(){A.highContrast.value="system"}},{caption:"High Contrast On",checked(){return A.highContrast.value===!0},action(){A.highContrast.value=!0}},{caption:"High Contrast Off",checked(){return A.highContrast.value===!1},action(){A.highContrast.value=!1}}]}]})}},v.moreVertical())),qa({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Hn.tagName);O.compact.value=n.compact}},ps,cs({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:O.docs}},Ed(st({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=In(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),O.currentDoc=t,n.preventDefault()}}))),cs({style:{position:"relative",overflowY:"scroll",height:"100%"}},Aa({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Jn.insertExamples(this,{tosijs:le,"tosijs-ui":$a})}}))));

//# debugId=FF63777ED101363B64756E2164756E21
