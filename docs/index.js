var Ti=Object.create;var{getPrototypeOf:Ei,defineProperty:Ft,getOwnPropertyNames:Ii}=Object;var Pi=Object.prototype.hasOwnProperty;var Bi=(n,t,e)=>{e=n!=null?Ti(Ei(n)):{};let a=t||!n||!n.__esModule?Ft(e,"default",{value:n,enumerable:!0}):e;for(let o of Ii(n))if(!Pi.call(a,o))Ft(a,o,{get:()=>n[o],enumerable:!0});return a};var Ta=(n,t)=>{for(var e in t)Ft(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var lt=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Gn={};Ta(Gn,{xinValue:()=>M,xinProxy:()=>ro,xinPath:()=>Bn,xin:()=>L,version:()=>ft,vars:()=>l,varDefault:()=>h,updates:()=>Mi,unobserve:()=>In,touchElement:()=>fe,touch:()=>un,tosi:()=>W,throttle:()=>Yn,svgElements:()=>bt,settings:()=>ct,on:()=>Mn,observe:()=>gt,mathML:()=>io,makeComponent:()=>xe,invertLuminance:()=>pe,initVars:()=>Qi,hotReload:()=>ve,getListItem:()=>mn,getListInstance:()=>ge,getListBinding:()=>be,getCssVar:()=>Qa,elements:()=>m,deleteListItem:()=>ps,debounce:()=>mt,css:()=>Un,boxedProxy:()=>we,boxed:()=>ut,blueprintLoader:()=>ws,blueprint:()=>vs,bindings:()=>G,bind:()=>z,StyleSheet:()=>$n,MoreMath:()=>$i,Component:()=>b,Color:()=>y,BlueprintLoader:()=>ke,Blueprint:()=>yt});function hn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(hn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=hn(a);else t[e]=a}return t}var qa="-xin-data",Pn=`.${qa}`,Wa="-xin-event",Ea=`.${Wa}`,q="xinPath",En="xinValue",Ia="xinObserve",Pa="xinBind",Ba="xinOn",ne=Symbol("list-binding"),te=Symbol("list-instance"),Bn=(n)=>{return n&&n[q]||void 0};function M(n){return typeof n==="object"&&n!==null?n[En]||n:n}var qn=new WeakMap,pn=new WeakMap,Wn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=pn.get(n),a=qn.get(n);if(e!=null)pn.set(t,hn(e));if(a!=null)qn.set(t,hn(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(Wn(e));else t.appendChild(e.cloneNode());return t},ct={debug:!1,perf:!1},Ma=Symbol("observer should be removed"),ht=[],pt=[],ee=!1,ae,oe;class Ya{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw Error("expect callback to be a path or function");ht.push(this)}}var Mi=async()=>{if(ae===void 0)return;await ae},Li=()=>{if(ct.perf)console.time("xin async update");let n=Array.from(pt);for(let t of n)ht.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Ma)return In(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Ma)In(e)});if(pt.splice(0),ee=!1,typeof oe==="function")oe();if(ct.perf)console.timeEnd("xin async update")},un=(n)=>{let t=typeof n==="string"?n:Bn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(ee===!1)ae=new Promise((e)=>{oe=e}),ee=setTimeout(Li);if(pt.find((e)=>t.startsWith(e))==null)pt.push(t)},Xn=(n,t)=>{return new Ya(n,t)},In=(n)=>{let t=ht.indexOf(n);if(t>-1)ht.splice(t,1);else throw Error("unobserve failed, listener not found")},ce={},ie=null,Di=(n)=>{ie=n},he=()=>{if(ie===null)throw Error("xin proxy not initialized");return ie},se=null,re=null,Ai=(n,t)=>{se=n,re=t},Ut=()=>{if(se===null)throw Error("bind not initialized");return se},Jt=()=>{if(re===null)throw Error("on not initialized");return re},Fa=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},Ua=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},zi=(n,t)=>{switch(Ua(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},Oi=(n)=>{switch(Ua(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:La}=globalThis,le=La!=null?new La((n)=>{for(let t of n){let e=t.target;Fa(e,"resize")}}):{observe(){},unobserve(){}},Da=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?Wn(a):a)});else if(t instanceof Node)n.append(e?Wn(t):t);else throw Error("expect text content or document node")},mt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Yn=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(e),e=setTimeout(()=>{n(...i),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},_i=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},Ja=(...n)=>Error(n.map(_i).join(" ")),Hi=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Vi=0,Ri=()=>(parseInt("10000",36)+ ++Vi).toString(36).slice(-5),Xi=()=>Hi()+Ri(),de=Symbol("delete"),$a=Symbol("new-object"),$t=Symbol("automatic-index");function Ga(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var $=new WeakMap;function Ka(n,t){if($.get(n)===void 0)$.set(n,{});if($.get(n)[t]===void 0)$.get(n)[t]={};let e=$.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[$t]===void 0)a[$t]=Xi();e[a[$t]+""]=o});else n.forEach((a,o)=>{e[Fn(a,t)+""]=o});return e}function Ni(n,t){if($.get(n)===void 0||$.get(n)[t]===void 0)return Ka(n,t);else return $.get(n)[t]}function qi(n,t,e){e=e+"";let a=Ni(n,t)[e];if(a===void 0||Fn(n[a],t)+""!==e)a=Ka(n,t)[e];return a}function Wi(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function Za(n,t,e,a){let o=t!==""?qi(n,t,e):e;if(a===de)return n.splice(o,1),$.delete(n),Symbol("deleted");else if(a===$a){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Fn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function Aa(n){if(!Array.isArray(n))throw Ja("setByPath failed: expected array, found",n)}function za(n){if(n==null||!(n instanceof Object))throw Ja("setByPath failed: expected Object, found",n)}function Fn(n,t){let e=Ga(t),a=n,o,i,s,r;for(o=0,i=e.length;a!==void 0&&o<i;o++){let d=e[o];if(Array.isArray(d))for(s=0,r=d.length;a!==void 0&&s<r;s++){let c=d[s];a=a[c]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[c,...p]=d.split("=");a=Za(a,c,p.join("="))}else s=parseInt(d,10),a=a[s]}return a}function Yi(n,t,e){let a=n;if(t==="")throw Error("setByPath cannot be used to set the root object");let o=Ga(t);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)za(a);else Aa(a);let r=i.slice(0,s),d=i.slice(s+1);if(a=Za(a,r,d,o.length>0?$a:e),o.length===0)return!0}else{Aa(a);let r=parseInt(i,10);if(o.length>0)a=a[r];else{if(e!==de){if(a[r]===e)return!1;a[r]=e}else a.splice(r,1);return!0}}}else if(Array.isArray(i)&&i.length>0){za(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=Wi(a,s,i.length>0?{}:[]);else{if(e!==de){if(a[s]===e)return!1;a[s]=e}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw Error(`setByPath failed, bad path ${t}`)}throw Error(`setByPath(${n}, ${t}, ${e}) failed`)}var G={value:{toDOM:zi,fromDOM(n){return Oi(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){be(n,t,e).update(t)}}};function tn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function Fi(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var Ui=180/Math.PI,Ji=Math.PI/180;function N(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function Z(n,t,e,a=!0){if(a)e=N(0,e,1);return e*(t-n)+n}var $i={RADIANS_TO_DEGREES:Ui,DEGREES_TO_RADIANS:Ji,clamp:N,lerp:Z};function Qa(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var Gi=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},ln=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class no{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),i=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Tn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class y{r;g;b;a;static fromVar(n,t=document.body){return y.fromCss(Qa(n,t))}static fromCss(n){let t=n;if(Tn instanceof HTMLSpanElement)Tn.style.color="black",Tn.style.color=n,document.body.appendChild(Tn),t=getComputedStyle(Tn).color,Tn.remove();let[e,a,o,i]=t.match(/[\d.]+/g)||["0","0","0","0"],s=t.startsWith("color(srgb")?255:1;return new y(Number(e)*s,Number(a)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,e,a=1){let o,i,s;if(t===0)o=i=s=e;else{let d=(g,v,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(v-g)*6*w;if(w<0.5)return v;if(w<0.6666666666666666)return g+(v-g)*(0.6666666666666666-w)*6;return g},c=e<0.5?e*(1+t):e+t-e*t,p=2*e-c,u=(n%360+360)%360/360;o=d(p,c,u+0.3333333333333333),i=d(p,c,u),s=d(p,c,u-0.3333333333333333)}let r=new y(o*255,i*255,s*255,a);return r.hslCached={h:(n%360+360)%360,s:t,l:e},r}static black=new y(0,0,0);static white=new y(255,255,255);constructor(n,t,e,a=1){this.r=N(0,n,255),this.g=N(0,t,255),this.b=N(0,e,255),this.a=N(0,a,1)}get inverse(){return new y(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return y.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new y(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?y.black:y.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new no(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new y(n,n,n)}get brightness(){return Gi(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+ln(this.r)+ln(this.g)+ln(this.b):"#"+ln(this.r)+ln(this.g)+ln(this.b)+ln(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,a+n*(1-a),1);return y.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,a*(1-n),1);return y.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,e+n*(1-e),1);return y.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=N(0,e*(1-n),1);return y.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return y.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return y.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new y(Z(this.r,n.r,t),Z(this.g,n.g,t),Z(this.b,n.b,t),Z(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return y.fromHsl(e.s===0?a.h:a.s===0?e.h:y.blendHue(e.h,a.h,t),Z(e.s,a.s,t),Z(e.l,a.l,t),Z(this.a,n.a,t))}colorMix(n,t){return y.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function $n(n,t){let e=m.style(Un(t));e.id=n,document.head.append(e)}var Ki=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],to=(n,t)=>{if(typeof t==="number"&&!Ki.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Zi=(n,t,e)=>{if(e===void 0)return"";if(e instanceof y)e=e.html;let a=to(t,e);return`${n}  ${a.prop}: ${a.value};`},eo=(n,t,e="")=>{let a=tn(n);if(typeof t==="object"&&!(t instanceof y)){let o=Object.keys(t).map((i)=>eo(i,t[i],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Zi(e,a,t)},Un=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>eo(i,a[i])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},Qi=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=tn(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},pe=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof y)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=y.fromCss(a).inverseLuminance}return t},h=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+tn(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),l=new Proxy({},{get(n,t){if(t==="default")return h;if(n[t]==null){t=tn(t);let[,e,,a,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${e}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=y.fromVar(s);n[t]=r>0?d.brighten(r).rgba:d.darken(-r).rgba}break;case"s":{let d=y.fromVar(s);n[t]=r>0?d.saturate(r).rgba:d.desaturate(-r).rgba}break;case"h":{let d=y.fromVar(s);n[t]=d.rotate(r*100).rgba}break;case"o":{let d=y.fromVar(s);n[t]=d.opacity(r).rgba}break;case"":n[t]=`calc(var(${s}) * ${r})`;break;default:throw console.error(i),Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),ns="http://www.w3.org/1998/Math/MathML",ts="http://www.w3.org/2000/svg",dt={},ao=(n,t,e)=>{let a=to(tn(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},es=(n)=>{return{toDOM(t,e){ao(t,n,e)}}},oo=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Bn(e[a]))z(n,e[a],es(a));else ao(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=tn(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},as=(n)=>{return{toDOM(t,e){oo(t,n,e)}}},os=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();Mn(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?G[e.binding]:e.binding)!==void 0&&e.value!==void 0)z(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=G[a];if(o!==void 0)z(n,e,o);else throw Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Bn(e))z(n,e,as(t));else oo(n,t,e)},ue=(n,...t)=>{if(dt[n]===void 0){let[o,i]=n.split("|");if(i===void 0)dt[n]=globalThis.document.createElement(o);else dt[n]=globalThis.document.createElementNS(i,o)}let e=dt[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(Bn(o))e.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];os(e,o,i)}return e},me=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},m=new Proxy({fragment:me},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>ue(t,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),bt=new Proxy({fragment:me},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>ue(`${t}|${ts}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),io=new Proxy({fragment:me},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>ue(`${t}|${ns}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),is=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],ss=!0,rs=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ls=(n)=>rs.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},ds={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}},Q=Symbol("undefined");function Gt(n,t){if(n===void 0||n===null)return new Proxy({[Q]:n===null?"null":"undefined"},nn(t,!0));let e=typeof n;if(e==="object"||e==="function")return n;else return new Proxy(ds[typeof n](n),nn(t,!0))}var Kt=()=>new Proxy({},nn("^",!0)),Oa=!1;function cn(){if(!Oa)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),Oa=!0}var _a=(n)=>{return n instanceof Number||n instanceof String||n instanceof Boolean||Q in n},nn=(n,t)=>({get(e,a){if(_a(e))switch(a){case"path":return n;case"value":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case"observe":return(s)=>{let r=Xn(n,s);return()=>In(r)};case"on":return(s,r)=>Jt()(s,r,M(e));case"bind":return(s,r,d)=>{Ut()(s,n,r,d)};case"binding":return(s)=>({bind:{value:n,binding:s}});case"listBinding":return(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Kt()))];case En:case"tosiValue":return cn(),e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case q:case"tosiPath":return cn(),n;case Ia:case"tosiObserve":return cn(),(s)=>{let r=Xn(n,s);return()=>In(r)};case Ba:case"tosiOn":return cn(),(s,r)=>Jt()(s,r,M(e));case Pa:case"tosiBind":return cn(),(s,r,d)=>{Ut()(s,n,r,d)};case"tosiBinding":return cn(),(s)=>({bind:{value:n,binding:s}});case"tosiListBinding":return cn(),(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Kt()))]}switch(a){case q:case"tosiPath":return n;case En:case"tosiValue":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case Ia:case"tosiObserve":return(s)=>{let r=Xn(n,s);return()=>In(r)};case Ba:case"tosiOn":return(s,r)=>Jt()(s,r,M(e));case Pa:case"tosiBind":return(s,r,d)=>{Ut()(s,n,r,d)};case"tosiBinding":return(s)=>({bind:{value:n,binding:s}});case"tosiListBinding":return(s=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(s(m,Kt()))]}if(typeof a==="symbol")return e[a];let o=a,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,r]=i,d=dn(n,s),c=Fn(e,s);return c!==null&&typeof c==="object"?new Proxy(c,nn(d,t))[r]:c}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(e)&&e[o]!==void 0||Array.isArray(e)&&o.includes("=")){let s;if(o.includes("=")){let[r,d]=o.split("=");s=e.find((c)=>`${Fn(c,r)}`===d)}else s=e[o];if(s instanceof Object){let r=dn(n,o);return new Proxy(s instanceof Function?s.bind(e):s,nn(r,t))}else return t?Gt(s,dn(n,o)):s}else if(Array.isArray(e)){let s=e[o];return typeof s==="function"?(...r)=>{let d=s.apply(e,r);if(is.includes(o))un(n);return d}:typeof s==="object"?new Proxy(s,nn(dn(n,o),t)):t?Gt(s,dn(n,o)):s}else return t?Gt(e[o],dn(n,o)):e[o]},set(e,a,o){o=M(o);let i=a===En||a==="value"&&_a(e)?n:dn(n,a);if(ss&&!ls(i))throw Error(`setting invalid path ${i}`);if(M(L[i])!==o&&Yi(ce,i,o))un(i);return!0}}),gt=(n,t)=>{let e=typeof t==="function"?t:L[t];if(typeof e!=="function")throw Error(`observe expects a function or path to a function, ${t} is neither`);return Xn(n,e)},L=new Proxy(ce,nn("",!1));Di(L);var ut=new Proxy(ce,nn("",!0)),cs=16,hs=100;function Ha(n,t){let e=Array.from(n.querySelectorAll(Pn));if(n.matches(Pn))e.unshift(n);for(let a of e){let o=pn.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,L[i.path])}}}class so{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=Wn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)le.observe(this.boundElement),this._update=Yn(()=>{this.update(this.array,!0)},cs),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this.array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,c=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(c/n.height)+(n.rowChunkSize||1),u=Math.ceil(a.length/n.visibleColumns),g=n.visibleColumns*p,v=Math.floor(this.boundElement.scrollTop/n.height);if(v>u-p+1)v=Math.max(0,u-p+1);if(n.rowChunkSize)v-=v%n.rowChunkSize;o=v*n.visibleColumns,i=o+g-1,s=v*n.height,r=Math.max((u-p)*n.height-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:r}}needle;filter=Yn((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},hs);update(n,t){if(n==null)n=[];this.array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Bn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:r,lastItem:d,topBuffer:c,bottomBuffer:p}=i;if(e===void 0&&a===void 0&&t===!0&&s!=null&&r===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let u=0,g=0,v=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let j=T[te];if(j==null)T.remove();else{let C=i.items.indexOf(j);if(C<r||C>d)T.remove(),this.itemToElement.delete(j),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(p)+"px";let w=[],{idPath:S}=this.options;for(let T=r;T<=d;T++){let j=i.items[T];if(j===void 0)continue;let C=this.itemToElement.get(M(j));if(C==null){if(v++,C=Wn(this.template),typeof j==="object")this.itemToElement.set(M(j),C),C[te]=M(j);if(this.boundElement.insertBefore(C,this.listBottom),S!=null){let B=j[S],Sn=`${o}[${S}=${B}]`;Ha(C,Sn)}else{let B=`${o}[${T}]`;Ha(C,B)}}w.push(C)}let J=null;for(let T of w){if(T.previousElementSibling!==J)if(g++,J?.nextElementSibling!=null)this.boundElement.insertBefore(T,J.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);J=T}if(ct.perf)console.log(o,"updated",{removed:u,created:v,moved:g})}}var be=(n,t,e)=>{let a=n[ne];if(t&&a===void 0)a=new so(n,t,e),n[ne]=a;return a},ge=(n)=>{let t;while(!(t=n[te])&&n&&n.parentElement)n=n.parentElement;return t?{element:n,item:t}:void 0},mn=(n)=>{let t=ge(n);return t?t.item:void 0},ps=(n)=>{let t=ge(n);if(!t)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let e=be(t.element.parentElement);if(!e.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,e),!1;let a=e.array.indexOf(t.item);if(a>-1)return e.array.splice(a,1),!0;return!1},{document:Jn,MutationObserver:Va}=globalThis,fe=(n,t)=>{let e=pn.get(n);if(e==null)return;for(let a of e){let{binding:o,options:i}=a,{path:s}=a,{toDOM:r}=o;if(r!=null){if(s.startsWith("^")){let d=mn(n);if(d!=null&&d[q]!=null)s=a.path=`${d[q]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))r(n,he()[s],i)}}};if(Va!=null)new Va((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Pn)).forEach((a)=>fe(a))})})}).observe(Jn.body,{subtree:!0,childList:!0});Xn(()=>!0,(n)=>{let t=Array.from(Jn.querySelectorAll(Pn));for(let e of t)fe(e,n)});var Ra=(n)=>{let t=n.target?.closest(Pn);while(t!=null){let e=pn.get(t);for(let a of e){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let r;try{r=s(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let d=he(),c=d[i];if(c==null)d[i]=r;else{let p=c[q]!=null?c[En]:c,u=r[q]!=null?r[En]:r;if(p!==u)d[i]=u}}}}t=t.parentElement.closest(Pn)}};if(globalThis.document!=null)Jn.body.addEventListener("change",Ra,!0),Jn.body.addEventListener("input",Ra,!0);function z(n,t,e,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[q]===void 0&&a===void 0){let{value:r}=t;o=typeof r==="string"?r:r[q],a=t,delete a.value}else o=typeof t==="string"?t:t[q];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:i}=e;n.classList?.add(qa);let s=pn.get(n);if(s==null)s=[],pn.set(n,s);if(s.push({path:o,binding:e,options:a}),i!=null&&!o.startsWith("^"))un(o);if(a?.filter&&a?.needle)z(n,a.needle,{toDOM(r,d){console.log({needle:d}),r[ne]?.filter(d)}});return n}var Xa=new Set,us=(n)=>{let t=n?.target?.closest(Ea),e=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let r=i[s];return typeof r==="function"?r.bind(i):r}}}),o=new Set;while(!e&&t!=null){let i=qn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let r=he()[s];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${s}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(Ea):null}};function Mn(n,t,e){let a=qn.get(n);if(n.classList.add(Wa),a==null)a={},qn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!Xa.has(t))Xa.add(t),Jn.body.addEventListener(t,us,!0);return()=>{a[t].delete(e)}}Ai(z,Mn);var ms=0;function Zt(){return`custom-elt${(ms++).toString(36)}`}var Na=0,Nn={};function bs(n,t){let e=Nn[n],a=Un(t).replace(/:host\b/g,n);Nn[n]=e?e+`
`+a:a}function gs(n){if(Nn[n])document.head.append(m.style({id:n+"-component"},Nn[n]));delete Nn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Un(n))}static elementCreator(n={}){let t=this;if(t._elementCreator==null){let{tag:e,styleSpec:a}=n,o=n!=null?e:null;if(o==null)if(typeof t.name==="string"&&t.name!==""){if(o=tn(t.name),o.startsWith("-"))o=o.slice(1)}else o=Zt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Zt();while(customElements.get(o)!==void 0)o=Zt();if(t._tagName=o,a!==void 0)bs(o,a);window.customElements.define(o,this,n),t._elementCreator=m[o]}return t._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(Fi(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=hn(this[a]);let o=tn(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(i){if(typeof t[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),e[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):hn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Na+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Na}`,this._value=hn(this.defaultValue)}connectedCallback(){if(gs(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(le.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){le.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)Fa(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content(m):this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=m.style(Un(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Da(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);Da(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(ye.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{s[r.name]=r}),o.forEach((r)=>{let d=s[""],c=r instanceof Element?s[r.slot]:d;(c!==void 0?c:d).append(r)})}}this._hydrated=!0}}render(){}}class ye extends b{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Jl=ye.elementCreator({tag:"xin-slot"}),ve=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(L[o]!==void 0)Object.assign(L[o],a[o]);else L[o]=a[o]}let e=mt(()=>{let a={},o=M(L);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);gt(n,e)},ft="1.0.10";function W(n){return Object.assign(ut,n),ut}function we(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),W(n)}function ro(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),we(n);return Object.keys(n).forEach((e)=>{L[e]=n[e]}),L}var fs={};async function xe(n,t){let{type:e,styleSpec:a}=await t(n,{Color:y,Component:b,elements:m,svgElements:bt,mathML:io,varDefault:h,vars:l,xin:L,boxed:ut,xinProxy:ro,boxedProxy:we,tosi:W,makeComponent:xe,bind:z,on:Mn,version:ft}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return fs[n]=o,o}var Qt={},ys=(n)=>import(n);class yt extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Qt[a]===void 0)Qt[a]=ys(t).then((o)=>{let i=o[e];return xe(n,i)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await Qt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var vs=yt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ke extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(yt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var ws=ke.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Sa={};Ta(Sa,{xrControllersText:()=>tl,xrControllers:()=>nl,xinTagList:()=>Hl,xinTag:()=>vi,xinSizer:()=>Al,xinSelect:()=>jn,xinSegmented:()=>Dl,xinRating:()=>xl,xinPasswordStrength:()=>wl,xinNotification:()=>ui,xinMenu:()=>jr,xinLocalized:()=>Ht,xinForm:()=>Zr,xinFloat:()=>Ue,xinField:()=>Kr,xinCarousel:()=>hr,version:()=>Ca,updateLocalized:()=>ta,trackDrag:()=>on,tosijs:()=>Gn,tosiMonth:()=>bl,tosiDialog:()=>At,tabSelector:()=>hi,svgIcon:()=>rr,svg2DataUrl:()=>Ot,styleSheet:()=>Yo,spacer:()=>_n,sizeBreak:()=>xa,sideNav:()=>va,setLocale:()=>gr,scriptTag:()=>xn,richTextWidgets:()=>yi,richText:()=>Il,removeLastMenu:()=>Cn,postNotification:()=>yl,positionFloat:()=>Go,popMenu:()=>U,popFloat:()=>$o,menu:()=>ai,markdownViewer:()=>pa,mapBox:()=>pl,makeSorter:()=>Ko,makeExamplesLive:()=>dl,localize:()=>I,localePicker:()=>vr,liveExample:()=>Rt,isBreached:()=>bi,initLocalization:()=>yr,icons:()=>f,i18n:()=>E,gamepadText:()=>Qr,gamepadState:()=>ci,findHighestZ:()=>_t,filterPart:()=>zt,filterBuilder:()=>Yr,elastic:()=>Sl,editableRect:()=>Rr,dragAndDrop:()=>ii,digest:()=>mi,defineIcons:()=>sr,dataTable:()=>Lr,createSubMenu:()=>ti,createMenuItem:()=>ei,createMenuAction:()=>ni,commandButton:()=>X,colorInput:()=>Jo,codeEditor:()=>Lt,bringToFront:()=>ot,bodymovinPlayer:()=>dr,blockStyle:()=>ga,b3d:()=>lr,availableFilters:()=>ra,abTest:()=>ir,XinTagList:()=>ja,XinTag:()=>Xt,XinSizer:()=>ka,XinSelect:()=>st,XinSegmented:()=>ya,XinRating:()=>ba,XinPasswordStrength:()=>ma,XinNotification:()=>kn,XinMenu:()=>oa,XinLocalized:()=>F,XinForm:()=>it,XinFloat:()=>sn,XinField:()=>Vt,XinCarousel:()=>na,TosiMonth:()=>ua,TosiDialog:()=>sa,TabSelector:()=>ca,SvgIcon:()=>Ze,SizeBreak:()=>wa,SideNav:()=>Vn,RichText:()=>fa,MarkdownViewer:()=>ha,MapBox:()=>wn,LocalePicker:()=>ea,LiveExample:()=>Hn,FilterPart:()=>la,FilterBuilder:()=>da,EditableRect:()=>V,DataTable:()=>ia,CodeEditor:()=>On,BodymovinPlayer:()=>zn,B3d:()=>Qe,AbTest:()=>An});function Ce(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var gn=Ce();function bo(n){gn=n}var nt={exec:()=>null};function k(n,t=""){let e=typeof n=="string"?n:n.source,a={replace:(o,i)=>{let s=typeof i=="string"?i:i.source;return s=s.replace(D.caret,"$1"),e=e.replace(o,s),a},getRegex:()=>new RegExp(e,t)};return a}var D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},xs=/^(?:[ \t]*(?:\n|$))+/,ks=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,js=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,tt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Cs=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Se=/(?:[*+-]|\d{1,9}[.)])/,go=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,fo=k(go).replace(/bull/g,Se).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ss=k(go).replace(/bull/g,Se).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Te=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ts=/^[^\n]+/,Ee=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Es=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ee).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Is=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Se).getRegex(),jt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ie=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ps=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Ie).replace("tag",jt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),yo=k(Te).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Bs=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",yo).getRegex(),Pe={blockquote:Bs,code:ks,def:Es,fences:js,heading:Cs,hr:tt,html:Ps,lheading:fo,list:Is,newline:xs,paragraph:yo,table:nt,text:Ts},lo=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Ms={...Pe,lheading:Ss,table:lo,paragraph:k(Te).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",lo).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex()},Ls={...Pe,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ie).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:nt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Te).replace("hr",tt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",fo).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Ds=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,As=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,vo=/^( {2,}|\\)\n(?!\s*$)/,zs=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ct=/[\p{P}\p{S}]/u,Be=/[\s\p{P}\p{S}]/u,wo=/[^\s\p{P}\p{S}]/u,Os=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Be).getRegex(),xo=/(?!~)[\p{P}\p{S}]/u,_s=/(?!~)[\s\p{P}\p{S}]/u,Hs=/(?:[^\s\p{P}\p{S}]|~)/u,Vs=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,ko=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Rs=k(ko,"u").replace(/punct/g,Ct).getRegex(),Xs=k(ko,"u").replace(/punct/g,xo).getRegex(),jo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Ns=k(jo,"gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Be).replace(/punct/g,Ct).getRegex(),qs=k(jo,"gu").replace(/notPunctSpace/g,Hs).replace(/punctSpace/g,_s).replace(/punct/g,xo).getRegex(),Ws=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,wo).replace(/punctSpace/g,Be).replace(/punct/g,Ct).getRegex(),Ys=k(/\\(punct)/,"gu").replace(/punct/g,Ct).getRegex(),Fs=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Us=k(Ie).replace("(?:-->|$)","-->").getRegex(),Js=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Us).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),wt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,$s=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",wt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Co=k(/^!?\[(label)\]\[(ref)\]/).replace("label",wt).replace("ref",Ee).getRegex(),So=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ee).getRegex(),Gs=k("reflink|nolink(?!\\()","g").replace("reflink",Co).replace("nolink",So).getRegex(),co=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Me={_backpedal:nt,anyPunctuation:Ys,autolink:Fs,blockSkip:Vs,br:vo,code:As,del:nt,emStrongLDelim:Rs,emStrongRDelimAst:Ns,emStrongRDelimUnd:Ws,escape:Ds,link:$s,nolink:So,punctuation:Os,reflink:Co,reflinkSearch:Gs,tag:Js,text:zs,url:nt},Ks={...Me,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",wt).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",wt).getRegex()},je={...Me,emStrongRDelimAst:qs,emStrongLDelim:Xs,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",co).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",co).getRegex()},Zs={...je,br:k(vo).replace("{2,}","*").getRegex(),text:k(je.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},vt={normal:Pe,gfm:Ms,pedantic:Ls},Kn={normal:Me,gfm:je,breaks:Zs,pedantic:Ks},Qs={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ho=(n)=>Qs[n];function Y(n,t){if(t){if(D.escapeTest.test(n))return n.replace(D.escapeReplace,ho)}else if(D.escapeTestNoEncode.test(n))return n.replace(D.escapeReplaceNoEncode,ho);return n}function po(n){try{n=encodeURI(n).replace(D.percentDecode,"%")}catch{return null}return n}function uo(n,t){let e=n.replace(D.findPipe,(i,s,r)=>{let d=!1,c=s;for(;--c>=0&&r[c]==="\\";)d=!d;return d?"|":" |"}),a=e.split(D.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(D.slashPipe,"|");return a}function Zn(n,t,e){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let i=n.charAt(a-o-1);if(i===t&&!e)o++;else if(i!==t&&e)o++;else break}return n.slice(0,a-o)}function nr(n,t){if(n.indexOf(t[1])===-1)return-1;let e=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===t[0])e++;else if(n[a]===t[1]&&(e--,e<0))return a;return e>0?-2:-1}function mo(n,t,e,a,o){let i=t.href,s=t.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let d={type:n[0].charAt(0)==="!"?"image":"link",raw:e,href:i,title:s,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,d}function tr(n,t,e){let a=n.match(e.other.indentCodeCompensation);if(a===null)return t;let o=a[1];return t.split(`
`).map((i)=>{let s=i.match(e.other.beginningSpace);if(s===null)return i;let[r]=s;return r.length>=o.length?i.slice(o.length):i}).join(`
`)}var xt=class{options;rules;lexer;constructor(n){this.options=n||gn}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let e=t[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:Zn(e,`
...
${c}`:c,o=o?`${o}
${p}`:p;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,i,!0),this.lexer.state.top=u,e.length===0)break;let g=i.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let v=g,w=v.raw+`
`+e.join(`
`),S=this.blockquote(w);i[i.length-1]=S,a=a.substring(0,a.length-v.raw.length)+S.raw,o=o.substring(0,o.length-v.text.length)+S.text;break}else if(g?.type==="list"){let v=g,w=v.raw+`
`+e.join(`
`),S=this.list(w);i[i.length-1]=S,a=a.substring(0,a.length-g.raw.length)+S.raw,o=o.substring(0,o.length-v.raw.length)+S.raw,e=w.substring(i.at(-1).raw.length).split(`
...
`,title:"A.4 Working with React",filename:"React.md",path:"React.md"},{text:`# CLAUDE.md
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];$n("demo-style",xi);var rn="tosijs";setTimeout(()=>{let n=y.fromVar(l.brandColor),t=y.fromVar(l.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Rl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Xl=Nt.find((n)=>n.filename===Rl)||Nt[0],{app:P,prefs:A}=W({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Nt,currentDoc:Xl,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});ve((n)=>{if(n.startsWith("prefs"))return!0;return!1});G.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};G.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:P,tosi:W,img:Wt,bindings:G,elements:m,vars:l,touch:un,Color:y})},1000);var ki=document.querySelector("main"),{h2:Nl,div:ji,span:rt,a:qt,img:Wt,header:ql,button:Ci,template:Wl,input:Yl}=m;z(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});z(document.body,A.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});z(document.body,A.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);P.currentDoc=P.docs.find((t)=>t.filename.xinValue===n)||P.docs[0]});var Fl=mt(()=>{console.time("filter");let n=Si.value.toLocaleLowerCase();P.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),un(P.docs),console.timeEnd("filter")}),Si=Yl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Fl});if(ki)ki.append(ql(Ci({class:"iconic",style:{color:l.linkColor},title:"navigation",bind:{value:P.compact,binding:{toDOM(n,t){n.style.display=t?"":"none",n.nextSibling.style.display=t?"":"none"}}},onClick(){let n=document.querySelector(Vn.tagName);n.contentVisible=!n.contentVisible}},f.menu()),rt({style:{flex:"0 0 10px"}}),qt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${ft}, tosijs-ui ${Ca}`},Wt({src:"favicon.svg",style:{height:40,marginRight:10}}),Nl({bindText:"app.title"})),rt({class:"elastic"}),xa({minWidth:750},rt({style:{marginRight:l.spacing,display:"flex",alignItems:"center",gap:l.spacing50}},qt({href:P.bundleUrl},Wt({alt:"bundlejs size badge",src:P.bundleBadgeUrl})),qt({href:P.cdnUrl},Wt({alt:"jsdelivr",src:P.cdnBadgeUrl}))),rt({slot:"small"})),rt({style:{flex:"0 0 10px"}}),Ci({title:"theme",class:"iconic",onClick(n){U({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:P.githubUrl.xinValue},{icon:"npm",caption:"npm",action:P.npmUrl.xinValue},{icon:"discord",caption:"discord",action:P.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:P.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return A.theme.xinValue==="system"},action(){A.theme.xinValue="system"}},{caption:"Dark",checked(){return A.theme.xinValue==="dark"},action(){A.theme.xinValue="dark"}},{caption:"Light",checked(){return A.theme.xinValue==="light"},action(){A.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return A.highContrast.xinValue},action(){A.highContrast.xinValue=!A.highContrast.xinValue}},{caption:"Monochrome",checked(){return A.monochrome.xinValue},action(){A.monochrome.xinValue=!A.monochrome.xinValue}}]}]})}},f.moreVertical())),va({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Vn.tagName);P.compact.xinValue=n.compact}},Si,ji({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:P.docs}},Wl(qt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=mn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),P.currentDoc=e,n.preventDefault()}}))),ji({style:{position:"relative",overflowY:"scroll",height:"100%"}},pa({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Gn,"tosijs-ui":Sa})}}))));

//# debugId=97F6DA5D653CE5BF64756E2164756E21
