var Ys=Object.defineProperty;var Na=(n,e)=>{for(var t in e)Ys(n,t,{get:e[t],enumerable:!0,configurable:!0,set:(a)=>e[t]=()=>a})};var ce=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Qn={};Na(Qn,{xinValue:()=>yn,xinProxy:()=>So,xinPath:()=>Ks,xin:()=>L,warnDeprecated:()=>$n,version:()=>Se,vars:()=>d,varDefault:()=>c,validateAgainstConstraints:()=>Co,updates:()=>li,unobserve:()=>cn,touchElement:()=>Ct,touch:()=>tn,tosiValue:()=>E,tosiSetValue:()=>$s,tosiPath:()=>X,tosi:()=>V,throttle:()=>Jn,svgElements:()=>Ce,settings:()=>ye,onThemePreferencesChange:()=>wt,onStylesheetChange:()=>wi,on:()=>En,observe:()=>Zn,mathML:()=>xo,makeComponent:()=>Dt,invertLuminance:()=>vt,initVars:()=>ji,hotReload:()=>Tt,getThemePreferences:()=>Kn,getListItem:()=>vn,getListInstance:()=>jt,getListBinding:()=>kt,getCssVar:()=>bo,elements:()=>m,deprecated:()=>gt,deleteListItem:()=>Ei,debounce:()=>je,css:()=>Ln,boxedProxy:()=>It,boxed:()=>ke,blueprintLoader:()=>Fi,blueprint:()=>Ui,bindings:()=>K,bind:()=>an,StyleSheet:()=>On,MoreMath:()=>gi,Component:()=>b,Color:()=>y,BlueprintLoader:()=>Pt,Blueprint:()=>Te});function un(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(un);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=un(a);else e[t]=a}return e}var ao="-xin-data",Mn=`.${ao}`,oo="-xin-event",Ra=`.${oo}`,_=Symbol.for("xin-path"),mn=Symbol.for("xin-value"),Wa="xinObserve",qa="xinBind",Ha="xinOn",st=Symbol("list-binding"),it=Symbol("list-instance"),rt=new Map;function Js(n,e){let t=rt.get(n);if(t===void 0)t=new Set,rt.set(n,t);t.add(e)}function Gs(n){return rt.get(n)}var Ua=new Set;function $n(n,e){if(!Ua.has(n))console.warn(e),Ua.add(n)}function gt(n,e){let t=!1;return(...a)=>{if(!t)console.warn(e),t=!0;return n(...a)}}var X=(n)=>{return n&&n[_]||void 0};function E(n){if(typeof n==="object"&&n!==null){let e=n[mn];return e!==void 0?e:n}return n}function $s(n,e){if(X(n)===void 0)throw Error("tosiSetValue requires a xin or boxed proxy");n[mn]=e}var Ks=gt(X,"xinPath is deprecated. Use tosiPath instead."),yn=gt(E,"xinValue is deprecated. Use tosiValue instead."),Xn=new WeakMap,gn=new WeakMap,Yn=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=gn.get(n),a=Xn.get(n);if(t!=null)gn.set(e,un(t));if(a!=null)Xn.set(e,un(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(Yn(t));else e.appendChild(t.cloneNode());return e},ye={debug:!1,perf:!1},Zs=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},so=(...n)=>Error(n.map(Zs).join(" ")),Qs=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),ni=0,ei=()=>(parseInt("10000",36)+ ++ni).toString(36).slice(-5),ti=()=>Qs()+ei(),lt=Symbol("delete"),io=Symbol("new-object"),nt=Symbol("automatic-index");function ro(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var $=new WeakMap;function lo(n,e){if($.get(n)===void 0)$.set(n,{});if($.get(n)[e]===void 0)$.get(n)[e]={};let t=$.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a[nt]===void 0)a[nt]=ti();t[a[nt]+""]=o});else n.forEach((a,o)=>{t[bn(a,e)+""]=o});return t}function ai(n,e){if($.get(n)===void 0||$.get(n)[e]===void 0)return lo(n,e);else return $.get(n)[e]}function oi(n,e,t){t=t+"";let a=ai(n,e)[t];if(a===void 0||bn(n[a],e)+""!==t)a=lo(n,e)[t];return a}function si(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function po(n,e,t,a){let o=e!==""?oi(n,e,t):t;if(a===lt)return n.splice(o,1),$.delete(n),Symbol("deleted");else if(a===io){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&bn(a,e)+""===t+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function Fa(n){if(!Array.isArray(n))throw so("setByPath failed: expected array, found",n)}function _a(n){if(n==null||!(n instanceof Object))throw so("setByPath failed: expected Object, found",n)}function bn(n,e){let t=ro(e),a=n,o,s,i,r;for(o=0,s=t.length;a!==void 0&&o<s;o++){let l=t[o];if(Array.isArray(l))for(i=0,r=l.length;a!==void 0&&i<r;i++){let p=l[i];a=a[p]}else if(a.length===0){if(a=a[Number(l.slice(1))],l[0]!=="=")return}else if(l.includes("=")){let[p,...h]=l.split("=");a=po(a,p,h.join("="))}else i=parseInt(l,10),a=a[i]}return a}function ii(n,e,t){let a=n;if(e==="")throw Error("setByPath cannot be used to set the root object");let o=ro(e);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)_a(a);else Fa(a);let r=s.slice(0,i),l=s.slice(i+1);if(a=po(a,r,l,o.length>0?io:t),o.length===0)return!0}else{Fa(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(t!==lt){if(a[r]===t)return!1;a[r]=t}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){_a(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=si(a,i,s.length>0?{}:[]);else{if(t!==lt){if(a[i]===t)return!1;a[i]=t}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${e}`)}throw Error(`setByPath(${n}, ${e}, ${t}) failed`)}var Xa=Symbol("observer should be removed"),ve=[],we=[],dt=!1,pt,ht;function ri(n,e,t,a){let o=Gs(n);if(o===void 0)return[];let s=[];for(let i of o){let r=bn(t,i);if(r!==void 0)s.push(`${n}[${i}=${r}]${a}`)}return s}class ho{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw Error("expect callback to be a path or function");ve.push(this)}}var li=async()=>{if(pt===void 0)return;await pt},di=()=>{if(ye.perf)console.time("xin async update");let n=Array.from(we);for(let e of n)ve.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===Xa)return cn(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===Xa)cn(t)});if(we.splice(0),dt=!1,typeof ht==="function")ht();if(ye.perf)console.timeEnd("xin async update")},tn=(n)=>{let e=typeof n==="string"?n:X(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(dt===!1)pt=new Promise((t)=>{ht=t}),dt=setTimeout(di);if(we.find((t)=>e.startsWith(t))==null)we.push(e)},An=(n,e)=>{return new ho(n,e)},cn=(n)=>{let e=ve.indexOf(n);if(e>-1)ve.splice(e,1);else throw Error("unobserve failed, listener not found")},fe={},ct=null,pi=(n)=>{ct=n},yt=()=>{if(ct===null)throw Error("xin proxy not initialized");return ct},ut=null,mt=null,hi=(n,e)=>{ut=n,mt=e},ue=()=>{if(ut===null)throw Error("bind not initialized");return ut},me=()=>{if(mt===null)throw Error("on not initialized");return mt},co=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},uo=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},ci=(n,e)=>{switch(uo(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},ui=(n)=>{switch(uo(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:Ya}=globalThis,bt=Ya!=null?new Ya((n)=>{for(let e of n){let t=e.target;co(t,"resize")}}):{observe(){},unobserve(){}},Ja=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?Yn(a):a)});else if(e instanceof Node)n.append(t?Yn(e):e);else throw Error("expect text content or document node")},je=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},Jn=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...s)=>{if(clearTimeout(t),t=setTimeout(()=>{n(...s),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},K={value:{toDOM:ci,fromDOM(n){return ui(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){kt(n,e,t).update(e)}}};function F(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function mo(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var mi=180/Math.PI,bi=Math.PI/180;function U(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function nn(n,e,t,a=!0){if(a)t=U(0,t,1);return t*(e-n)+n}var gi={RADIANS_TO_DEGREES:mi,DEGREES_TO_RADIANS:bi,clamp:U,lerp:nn};function bo(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var yi=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},pn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class go{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),s=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Bn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class y{r;g;b;a;static fromVar(n,e=document.body){return y.fromCss(bo(n,e))}static fromCss(n){let e=n.match(/^#([0-9a-fA-F]+)$/);if(e){let l=e[1];if(l.length===3)return new y(parseInt(l[0]+l[0],16),parseInt(l[1]+l[1],16),parseInt(l[2]+l[2],16));if(l.length===4)return new y(parseInt(l[0]+l[0],16),parseInt(l[1]+l[1],16),parseInt(l[2]+l[2],16),parseInt(l[3]+l[3],16)/255);if(l.length===6)return new y(parseInt(l.slice(0,2),16),parseInt(l.slice(2,4),16),parseInt(l.slice(4,6),16));if(l.length===8)return new y(parseInt(l.slice(0,2),16),parseInt(l.slice(2,4),16),parseInt(l.slice(4,6),16),parseInt(l.slice(6,8),16)/255)}let t=n;if(Bn instanceof HTMLSpanElement)Bn.style.color="black",Bn.style.color=n,document.body.appendChild(Bn),t=getComputedStyle(Bn).color,Bn.remove();let[a,o,s,i]=t.match(/[\d.]+/g)||["0","0","0","0"],r=t.startsWith("color(srgb")?255:1;return new y(Number(a)*r,Number(o)*r,Number(s)*r,i==null?1:Number(i))}static fromHsl(n,e,t,a=1){let o,s,i;if(e===0)o=s=i=t;else{let l=(g,f,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(f-g)*6*w;if(w<0.5)return f;if(w<0.6666666666666666)return g+(f-g)*(0.6666666666666666-w)*6;return g},p=t<0.5?t*(1+e):t+e-t*e,h=2*t-p,u=(n%360+360)%360/360;o=l(h,p,u+0.3333333333333333),s=l(h,p,u),i=l(h,p,u-0.3333333333333333)}let r=new y(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:e,l:t},r}static black=new y(0,0,0);static white=new y(255,255,255);constructor(n,e,t,a=1){this.r=U(0,n,255),this.g=U(0,e,255),this.b=U(0,t,255),this.a=U(0,a,1)}get inverse(){return new y(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return y.fromHsl(n,e,1-t,this.a)}get opaque(){return this.a===1?this:new y(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?y.black:y.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new go(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new y(n,n,n)}get brightness(){return yi(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+pn(this.r)+pn(this.g)+pn(this.b):"#"+pn(this.r)+pn(this.g)+pn(this.b)+pn(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=U(0,a+n*(1-a),1);return y.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=U(0,a*(1-n),1);return y.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=U(0,t+n*(1-t),1);return y.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=U(0,t*(1-n),1);return y.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return y.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return y.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new y(nn(this.r,n.r,e),nn(this.g,n.g,e),nn(this.b,n.b,e),nn(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return y.fromHsl(t.s===0?a.h:a.s===0?t.h:y.blendHue(t.h,a.h,e),nn(t.s,a.s,e),nn(t.l,a.l,e),nn(this.a,n.a,e))}colorMix(n,e){return y.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}static computedColorStylesheet=null;static computedColors=new Map;static recomputeQueued=!1;static registerComputedColor(n,e,t,a){if(!y.computedColors.has(n))y.computedColors.set(n,{varName:e,scale:t,method:a}),y.queueRecompute()}static queueRecompute(){if(y.recomputeQueued)return;y.recomputeQueued=!0,queueMicrotask(()=>{y.recomputeQueued=!1,y.recomputeColors()})}static recomputeColors(){if(y.computedColors.size===0)return;let n=[];for(let[t,{varName:a,scale:o,method:s}]of y.computedColors)try{let i=y.fromVar(a),r;switch(s){case"b":r=o>0?i.brighten(o):i.darken(-o);break;case"s":r=o>0?i.saturate(o):i.desaturate(-o);break;case"h":r=i.rotate(o*100);break;case"o":r=i.opacity(o);break;default:continue}n.push(`  ${t}: ${r.rgba};`)}catch(i){}if(n.length===0)return;let e=`:root {
${n.join(`
`)}
}`;if(y.computedColorStylesheet===null)y.computedColorStylesheet=document.createElement("style"),y.computedColorStylesheet.id="tosijs-computed-colors",document.head.append(y.computedColorStylesheet);y.computedColorStylesheet.textContent=e}}var xe=new Set,Ga=!1;function vi(){if(!Ga)Ga=!0,xe.add(()=>y.queueRecompute())}function wi(n){return xe.add(n),()=>xe.delete(n)}function fi(){vi();for(let n of xe)n()}function On(n,e){let t=E(e),a=m.style(Ln(t));a.id=n,document.head.append(a);let o=X(e);if(o!==void 0)Zn(o,()=>{a.textContent=Ln(E(e)),fi()})}var xi=/^(animation-iteration-count|column-count|flex(-grow|-shrink)?|font-weight|line-height|opacity|order|orphans|scale|tab-size|widows|z-index|zoom)$/,yo=(n,e)=>{if(typeof e==="number"&&!xi.test(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},ki=(n,e,t)=>{if(t===void 0)return"";if(t instanceof y)t=t.html;let a=yo(e,t);return`${n}  ${a.prop}: ${a.value};`},vo=(n,e,t="")=>{let a=F(n);if(typeof e==="object"&&!(e instanceof y)){let o=Object.keys(e).map((s)=>vo(s,e[s],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
${t}  }`}else return ki(t,a,e)},Ln=(n,e="")=>{return Object.keys(n).map((t)=>{let a=n[t];if(typeof a==="string"){if(t==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((s)=>vo(s,a[s])).join(`
`);return`${e}${t} {
${o}
}`}).join(`

`)},ji=(n)=>{$n("initVars","initVars is deprecated. Just use _ and __ prefixes instead.");let e={};for(let t of Object.keys(n)){let a=n[t],o=F(t);e[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return e},vt=(n)=>{let e={};for(let t of Object.keys(n)){let a=n[t];if(a instanceof y)e[t]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))e[t]=y.fromCss(a).inverseLuminance}return e},c=new Proxy({},{get(n,e){if(n[e]===void 0){let t="--"+F(e);n[e]=(a)=>`var(${t}, ${a})`}return n[e]}}),d=new Proxy({},{get(n,e){if(e==="default")return c;if(n[e]==null){e=F(e);let[,t,,a,o,s]=e.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",e],i=`--${t}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(s){case"b":case"s":case"h":case"o":{let l=`--${e}`;y.registerComputedColor(l,i,r,s),n[e]=`var(${l})`}break;case"":n[e]=`calc(var(${i}) * ${r})`;break;default:throw console.error(s),Error(`Unrecognized method ${s} for css variable ${i}`)}}else n[e]=`var(${i})`}return n[e]}});function Kn(){let n=(e)=>typeof matchMedia<"u"&&matchMedia(e).matches;return{colorScheme:n("(prefers-color-scheme: dark)")?"dark":"light",contrast:n("(prefers-contrast: more)")?"more":n("(prefers-contrast: less)")?"less":n("(prefers-contrast: custom)")?"custom":"no-preference",reducedMotion:n("(prefers-reduced-motion: reduce)"),reducedTransparency:n("(prefers-reduced-transparency: reduce)"),forcedColors:n("(forced-colors: active)")}}function wt(n){if(typeof matchMedia>"u")return()=>{};let e=["(prefers-color-scheme: dark)","(prefers-contrast: more)","(prefers-contrast: less)","(prefers-contrast: custom)","(prefers-reduced-motion: reduce)","(prefers-reduced-transparency: reduce)","(forced-colors: active)"],t=()=>n(Kn()),a=e.map((o)=>matchMedia(o));for(let o of a)o.addEventListener("change",t);return()=>{for(let o of a)o.removeEventListener("change",t)}}var Ci="http://www.w3.org/1998/Math/MathML",Si="http://www.w3.org/2000/svg",be={},wo=(n,e,t)=>{let a=yo(F(e),t);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[e]=a.value},Ti=(n)=>{return{toDOM(e,t){wo(e,n,t)}}},fo=(n,e,t)=>{if(e==="style")if(typeof t==="object")for(let a of Object.keys(t))if(X(t[a]))an(n,t[a],Ti(a));else wo(n,a,t[a]);else n.setAttribute("style",t);else{let a=F(e),o=n.constructor.observedAttributes;if(o?.includes(e)||o?.includes(a))if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t);else if(n[e]!==void 0){let{MathMLElement:s}=globalThis;if(n instanceof SVGElement||s!==void 0&&n instanceof s)n.setAttribute(e,t);else n[e]=t}else if(a==="class")t.split(" ").forEach((s)=>{n.classList.add(s)});else if(n[a]!==void 0)n[a]=t;else if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t)}},Ii=(n)=>{return{toDOM(e,t){fo(e,n,t)}}},Di=(n,e,t)=>{if(e==="apply")t(n);else if(e.match(/^on[A-Z]/)!=null){let a=e.substring(2).toLowerCase();En(n,a,t)}else if(e==="bind")if((typeof t.binding==="string"?K[t.binding]:t.binding)!==void 0&&t.value!==void 0)an(n,t.value,t.binding instanceof Function?{toDOM:t.binding}:t.binding);else throw Error("bad binding");else if(e.match(/^bind[A-Z]/)!=null){let a=e.substring(4,5).toLowerCase()+e.substring(5),o=K[a];if(o!==void 0)an(n,t,o);else throw Error(`${e} is not allowed, bindings.${a} is not defined`)}else if(X(t))an(n,t,Ii(e));else fo(n,e,t)},ft=(n,...e)=>{if(be[n]===void 0){let[o,s]=n.split("|");if(s===void 0)be[n]=globalThis.document.createElement(o);else be[n]=globalThis.document.createElementNS(s,o)}let t=be[n].cloneNode(),a={};for(let o of e)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(t instanceof HTMLTemplateElement)t.content.append(o);else t.append(o);else if(X(o))t.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let s=a[o];Di(t,o,s)}return t},xt=(...n)=>{let e=globalThis.document.createDocumentFragment();for(let t of n)e.append(t);return e},m=new Proxy({fragment:xt},{get(n,e){if(e=e.replace(/[A-Z]/g,(t)=>`-${t.toLocaleLowerCase()}`),n[e]===void 0)n[e]=(...t)=>ft(e,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Ce=new Proxy({fragment:xt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>ft(`${e}|${Si}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),xo=new Proxy({fragment:xt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>ft(`${e}|${Ci}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),Pi=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Bi=!0,Ai=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,Mi=(n)=>Ai.test(n),Q=(n="",e="")=>{if(n==="")return e;else if(e.match(/^\d+$/)!==null||e.includes("="))return`${n}[${e}]`;else return`${n}.${e}`},ko={};function et(n,e){if(n!==null&&(typeof n==="object"||typeof n==="function"))return n;return new Proxy(ko,en(e,!0))}var ge=()=>new Proxy({},en("^",!0)),$a=!1;function hn(){if(!$a)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),$a=!0}var Ka=(n)=>{return n===ko},en=(n,e)=>({get(t,a){if(Ka(t)){let r=()=>bn(fe,n);switch(a){case"path":return n;case"value":return r();case"valueOf":case"toJSON":return()=>r();case Symbol.toPrimitive:return(l)=>{let p=r();if(l==="number")return Number(p);if(l==="string")return String(p);return p};case"toString":return()=>String(r());case"observe":return(l)=>{let p=An(n,l);return()=>cn(p)};case"on":return(l,p)=>me()(l,p,r());case"bind":return(l,p,h)=>{ue()(l,n,p,h)};case"binding":return(l)=>({bind:{value:n,binding:l}});case"listBinding":return(l=({span:h})=>h({bindText:"^"}),p={})=>[{bindList:{value:n,...p}},m.template(l(m,ge()))];case mn:case"xinValue":case"tosiValue":return hn(),r();case _:case"xinPath":case"tosiPath":return hn(),n;case Wa:case"tosiObserve":return hn(),(l)=>{let p=An(n,l);return()=>cn(p)};case Ha:case"tosiOn":return hn(),(l,p)=>me()(l,p,r());case qa:case"tosiBind":return hn(),(l,p,h)=>{ue()(l,n,p,h)};case"tosiBinding":return hn(),(l)=>({bind:{value:n,binding:l}});case"tosiListBinding":return hn(),(l=({span:h})=>h({bindText:"^"}),p={})=>[{bindList:{value:n,...p}},m.template(l(m,ge()))]}if(typeof a==="string"&&/^\d+$/.test(a)){let l=r();if(typeof l==="string")return l[parseInt(a,10)]}if(a==="length"){let l=r();if(typeof l==="string")return l.length}return}if(e&&!(a in t))switch(a){case"path":return n;case"value":return t.valueOf?t.valueOf():t;case"valueOf":case"toJSON":return()=>t.valueOf?t.valueOf():t;case"observe":return(r)=>{let l=An(n,r);return()=>cn(l)};case"on":return(r,l)=>me()(r,l,E(t));case"bind":return(r,l,p)=>{ue()(r,n,l,p)};case"binding":return(r)=>({bind:{value:n,binding:r}});case"listBinding":return(r=({span:p})=>p({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,ge()))]}switch(a){case _:case"xinPath":case"tosiPath":return n;case mn:case"xinValue":case"tosiValue":return t.valueOf?t.valueOf():t;case Wa:case"xinObserve":case"tosiObserve":return(r)=>{let l=An(n,r);return()=>cn(l)};case Ha:case"xinOn":case"tosiOn":return(r,l)=>me()(r,l,E(t));case qa:case"xinBind":case"tosiBind":return(r,l,p)=>{ue()(r,n,l,p)};case"tosiBinding":return(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return(r=({span:p})=>p({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,ge()))]}if(typeof a==="symbol")return t[a];let o=Object.getOwnPropertyDescriptor(t,a);if(o&&!o.configurable&&!o.writable&&"value"in o)return o.value;let s=a,i=s.match(/^([^.[]+)\.(.+)$/)??s.match(/^([^\]]+)(\[.+)/)??s.match(/^(\[[^\]]+\])\.(.+)$/)??s.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,r,l]=i,p=Q(n,r),h=bn(t,r);return h!==null&&typeof h==="object"?new Proxy(h,en(p,e))[l]:h}if(s.startsWith("[")&&s.endsWith("]"))s=s.substring(1,s.length-1);if(!Array.isArray(t)&&t[s]!==void 0||Array.isArray(t)&&s.includes("=")){let r;if(s.includes("=")){let[l,p]=s.split("=");r=t.find((h)=>`${bn(h,l)}`===p)}else r=t[s];if(r instanceof Object){let l=Q(n,s);return new Proxy(r instanceof Function?r.bind(t):r,en(l,e))}else return e?et(r,Q(n,s)):r}else if(Array.isArray(t)){let r=t[s];return typeof r==="function"?(...l)=>{let p=l.map((u)=>E(u)),h=r.apply(t,p);if(Pi.includes(s))tn(n);if(h!=null&&typeof h==="object"){if(s==="find"||s==="findLast"||s==="at"){let u=t.indexOf(h);if(u!==-1)return new Proxy(h,en(Q(n,String(u)),e))}}return h}:typeof r==="object"?new Proxy(r,en(Q(n,s),e)):e?et(r,Q(n,s)):r}else return e?et(t[s],Q(n,s)):t[s]},set(t,a,o){o=E(o);let s=a===mn||a==="xinValue"||a==="tosiValue"||a==="value"&&(Ka(t)||e),i=s?n:Q(n,a);if(Bi&&!Mi(i))throw Error(`setting invalid path ${i}`);if(E(L[i])!==o&&ii(fe,i,o)){tn(i);let r=n.match(/^(.+)\[(\d+)\]$/);if(r!==null){let[,l,p]=r,h=parseInt(p,10),u=s?"":`.${a}`,g=ri(l,h,t,u);for(let f of g)tn(f)}}return!0}}),Zn=(n,e)=>{let t=typeof e==="function"?e:L[e];if(typeof t!=="function")throw Error(`observe expects a function or path to a function, ${e} is neither`);return An(n,t)},L=new Proxy(fe,en("",!1));pi(L);var ke=new Proxy(fe,en("",!0)),Li=16,Oi=100;function Za(n,e){let t=Array.from(n.querySelectorAll(Mn));if(n.matches(Mn))t.unshift(n);for(let a of t){let o=gn.get(a);for(let s of o){if(s.path.startsWith("^"))s.path=`${e}${s.path.substring(1)}`;if(s.binding.toDOM!=null)s.binding.toDOM(a,L[s.path])}}}class jo{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,e,t={}){if(this.boundElement=n,this.itemToElement=new WeakMap,t.idPath!=null){let a=X(e);if(a!=null)Js(a,t.idPath)}if(n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=Yn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=t,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),t.virtual!=null)if(bt.observe(this.boundElement),this._update=Jn(()=>{this.update(this.array,!0)},Li),this.boundElement.addEventListener("resize",this._update),t.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}visibleSlice(){let{virtual:n,hiddenProp:e,visibleProp:t}=this.options,a=this.array;if(e!==void 0)a=a.filter((l)=>l[e]!==!0);if(t!==void 0)a=a.filter((l)=>l[t]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,s=a.length-1,i=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let l=this.boundElement.offsetWidth,p=n.scrollContainer==="window",h,u;if(p){h=window.innerHeight;let T=this.boundElement.getBoundingClientRect();u=Math.max(0,-T.top)}else h=this.boundElement.offsetHeight,u=this.boundElement.scrollTop;let g=n.width!=null?Math.max(1,Math.floor(l/n.width)):n.visibleColumns??1,f=Math.ceil(h/n.height)+(n.rowChunkSize||1),w=Math.ceil(a.length/g),S=g*f,B=Math.floor(u/n.height);if(B>w-f+1)B=Math.max(0,w-f+1);if(n.rowChunkSize)B-=B%n.rowChunkSize;o=B*g,s=o+S-1,i=B*n.height,r=Math.max((w-f)*n.height-i,0)}return{items:a,firstItem:o,lastItem:s,topBuffer:i,bottomBuffer:r}}needle;filter=Jn((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},Oi);update(n,e){if(n==null)n=[];this.array=n;let{hiddenProp:t,visibleProp:a}=this.options,o=X(n),s=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",s.items.length===0);let i=this._previousSlice,{firstItem:r,lastItem:l,topBuffer:p,bottomBuffer:h}=s;if(t===void 0&&a===void 0&&e===!0&&i!=null&&r===i.firstItem&&l===i.lastItem&&p===i.topBuffer&&h===i.bottomBuffer)return;this._previousSlice=s;let u=0,g=0,f=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let j=T[it];if(j==null)T.remove();else{let C=s.items.indexOf(j);if(C<r||C>l)T.remove(),this.itemToElement.delete(j),u++}}this.listTop.style.height=String(p)+"px",this.listBottom.style.height=String(h)+"px";let w=[],{idPath:S}=this.options;for(let T=r;T<=l;T++){let j=s.items[T];if(j===void 0)continue;let C=this.itemToElement.get(E(j));if(C==null){if(f++,C=Yn(this.template),typeof j==="object")this.itemToElement.set(E(j),C),C[it]=E(j);if(this.boundElement.insertBefore(C,this.listBottom),S!=null){let A=j[S],Pn=`${o}[${S}=${A}]`;Za(C,Pn)}else{let A=`${o}[${T}]`;Za(C,A)}}w.push(C)}let B=null;for(let T of w){if(T.previousElementSibling!==B)if(g++,B?.nextElementSibling!=null)this.boundElement.insertBefore(T,B.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);B=T}if(ye.perf)console.log(o,"updated",{removed:u,created:f,moved:g})}}var kt=(n,e,t)=>{let a=n[st];if(e&&a===void 0)a=new jo(n,e,t),n[st]=a;return a},jt=(n)=>{let e;while(!(e=n[it])&&n&&n.parentElement)n=n.parentElement;return e?{element:n,item:e}:void 0},vn=(n)=>{let e=jt(n);return e?e.item:void 0},Ei=(n)=>{let e=jt(n);if(!e)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let t=kt(e.element.parentElement);if(!t.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,t),!1;let a=t.array.indexOf(e.item);if(a>-1)return t.array.splice(a,1),!0;return!1},{document:Gn,MutationObserver:Qa}=globalThis,Ct=(n,e)=>{let t=gn.get(n);if(t==null)return;for(let a of t){let{binding:o,options:s}=a,{path:i}=a,{toDOM:r}=o;if(r!=null){if(i.startsWith("^")){let l=vn(n);if(l!=null&&l[_]!=null)i=a.path=`${l[_]}${i.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${i}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${i}`)}if(e==null||i.startsWith(e))r(n,yt()[i],s)}}};if(Qa!=null)new Qa((n)=>{n.forEach((e)=>{Array.from(e.addedNodes).forEach((t)=>{if(t instanceof Element)Array.from(t.querySelectorAll(Mn)).forEach((a)=>Ct(a))})})}).observe(Gn.body,{subtree:!0,childList:!0});An(()=>!0,(n)=>{let e=Array.from(Gn.querySelectorAll(Mn));for(let t of e)Ct(t,n)});var no=(n)=>{let e=n.target?.closest(Mn);while(e!=null){let t=gn.get(e);for(let a of t){let{binding:o,path:s}=a,{fromDOM:i}=o;if(i!=null){let r;try{r=i(e,a.options)}catch(l){throw console.error("Cannot get value from",e,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let l=yt(),p=l[s];if(p==null)l[s]=r;else{let h=p[_]!=null?p[mn]:p,u=r[_]!=null?r[mn]:r;if(h!==u)l[s]=u}}}}e=e.parentElement.closest(Mn)}};if(globalThis.document!=null)Gn.body.addEventListener("change",no,!0),Gn.body.addEventListener("input",no,!0);function an(n,e,t,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof e==="object"&&e[_]===void 0&&a===void 0){let{value:r}=e;o=typeof r==="string"?r:r[_],a=e,delete a.value}else o=typeof e==="string"?e:e[_];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:s}=t;n.classList?.add(ao);let i=gn.get(n);if(i==null)i=[],gn.set(n,i);if(i.push({path:o,binding:t,options:a}),s!=null&&!o.startsWith("^"))tn(o);if(a?.filter&&a?.needle)an(n,a.needle,{toDOM(r,l){console.log({needle:l}),r[st]?.filter(l)}});return n}var eo=new Set,Vi=(n)=>{let e=n?.target?.closest(Ra),t=!1,a=new Proxy(n,{get(s,i){if(i==="stopPropagation")return()=>{n.stopPropagation(),t=!0};else{let r=s[i];return typeof r==="function"?r.bind(s):r}}}),o=new Set;while(!t&&e!=null){let s=Xn.get(e)[n.type]||o;for(let i of s){if(typeof i==="function")i(a);else{let r=yt()[i];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${i}`)}if(t)continue}e=e.parentElement!=null?e.parentElement.closest(Ra):null}};function En(n,e,t){let a=Xn.get(n);if(n.classList.add(oo),a==null)a={},Xn.set(n,a);if(!a[e])a[e]=new Set;if(a[e].add(t),!eo.has(e))eo.add(e),Gn.body.addEventListener(e,Vi,!0);return()=>{a[e].delete(t)}}hi(an,En);function Co(n,e){if(!n.internals)return;let t={},a="";if(n.hasAttribute("required")&&e==="")t.valueMissing=!0,a="Please fill out this field.";let o=n.getAttribute("minlength");if(o&&e.length<parseInt(o,10))t.tooShort=!0,a=`Please use at least ${o} characters.`;let s=n.getAttribute("maxlength");if(s&&e.length>parseInt(s,10))t.tooLong=!0,a=`Please use no more than ${s} characters.`;let i=n.getAttribute("pattern");if(i&&e!=="")try{if(!new RegExp(`^(?:${i})$`).test(e))t.patternMismatch=!0,a="Please match the requested format."}catch{}if(Object.keys(t).length>0)n.internals.setValidity(t,a,n);else n.internals.setValidity({})}var zi=0;function tt(){return`custom-elt${(zi++).toString(36)}`}var to=0,at=null;function Ni(){if(at===null)at=new MutationObserver((n)=>{let e=new Set;for(let t of n)if(t.type==="attributes"&&t.target instanceof b){let a=t.target,o=mo(t.attributeName);if(a._legacyTrackedAttrs?.has(o))e.add(a)}for(let t of e)t.queueRender(!1)});return at}var _n={};function Ri(n,e){let t=_n[n],a=Ln(e).replace(/:host\b/g,n);_n[n]=t?t+`
`+a:a}function Wi(n){if(_n[n])document.head.append(m.style({id:n+"-component"},_n[n]));delete _n[n]}class b extends HTMLElement{static elements=m;static _elementCreator;static initAttributes;static formAssociated;internals;get validity(){return this.internals?.validity}get validationMessage(){return this.internals?.validationMessage??""}get willValidate(){return this.internals?.willValidate??!1}checkValidity(){return this.internals?.checkValidity()??!0}reportValidity(){return this.internals?.reportValidity()??!0}setCustomValidity(n){if(this.internals)if(n)this.internals.setValidity({customError:!0},n);else this.internals.setValidity({})}setValidity(n,e,t){this.internals?.setValidity(n,e,t)}setFormValue(n,e){this.internals?.setFormValue(n,e)}static get observedAttributes(){let n=this.initAttributes;if(n)return["hidden",...Object.keys(n).map(F)];return["hidden"]}instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}_legacyTrackedAttrs;_attrValues;_valueChanged=!1;static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Ln(n))}static elementCreator(n={}){let e=this;if(e._elementCreator==null){let{tag:t,styleSpec:a}=n,o=n!=null?t:null;if(o==null)if(typeof e.name==="string"&&e.name!==""){if(o=F(e.name),o.startsWith("-"))o=o.slice(1)}else o=tt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=tt();while(customElements.get(o)!==void 0)o=tt();if(e._tagName=o,a!==void 0)Ri(o,a);window.customElements.define(o,this,n),e._elementCreator=m[o]}return e._elementCreator}initAttributes(...n){if($n("initAttributes","initAttributes() is deprecated. Use static initAttributes = { ... } instead."),!this._legacyTrackedAttrs)this._legacyTrackedAttrs=new Set;for(let a of n)this._legacyTrackedAttrs.add(a);Ni().observe(this,{attributes:!0});let e={},t={};n.forEach((a)=>{e[a]=un(this[a]);let o=F(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof e[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof e[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(t[a]!==void 0)return t[a];else return e[a]},set(s){if(typeof e[a]==="boolean"){if(s!==this[a]){if(s)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof e[a]==="number"){if(s!==parseFloat(this[a]))this.setAttribute(o,s),this.queueRender()}else if(typeof s==="object"||`${s}`!==`${this[a]}`){if(s===null||s===void 0||typeof s==="object")this.removeAttribute(o);else this.setAttribute(o,s);this.queueRender(),t[a]=s}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let e=this.hasAttribute("value")?this.getAttribute("value"):un(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return e},set(t){if(e!==t)e=t,this._valueChanged=!0,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(e,t){if(e[t]===void 0){let a=n.querySelector(`[part="${t}"]`);if(a==null)a=n.querySelector(t);if(a==null)throw Error(`elementRef "${t}" does not exist!`);a.removeAttribute("data-ref"),e[t]=a}return e[t]}});return this._parts}attributeChangedCallback(n,e,t){let a=mo(n);if(!this._legacyTrackedAttrs?.has(a))this.queueRender(!1)}constructor(){super();if(to+=1,this.constructor.formAssociated&&typeof this.attachInternals==="function"&&!this.internals)this.internals=this.attachInternals();let n=this.constructor.initAttributes;if(n)this._setupAttributeAccessors(n);this.instanceId=`${this.tagName.toLocaleLowerCase()}-${to}`,this._value=un(this.defaultValue)}_setupAttributeAccessors(n){if(!this._attrValues)this._attrValues=new Map;for(let e of Object.keys(n)){let t=F(e),a=n[e];if(e==="value"){console.warn(`${this.tagName}: 'value' cannot be an attribute. Use the Component value property instead.`);continue}if(typeof a==="object"&&a!==null){console.warn(`${this.tagName}: initAttributes.${e} is an object. Use a regular property instead.`);continue}let o=this,s=!1;while(o){let i=Object.getOwnPropertyDescriptor(o,e);if(i){if(!i.configurable||i.get||i.set){s=!0;break}break}o=Object.getPrototypeOf(o)}if(s)continue;Object.defineProperty(this,e,{enumerable:!1,get:()=>{if(typeof a==="boolean")return this.hasAttribute(t);else if(this.hasAttribute(t))return typeof a==="number"?parseFloat(this.getAttribute(t)):this.getAttribute(t);else if(this._attrValues.has(e))return this._attrValues.get(e);else return a},set:(i)=>{if(typeof a==="boolean"){if(i!==this[e]){if(i)this.setAttribute(t,"");else this.removeAttribute(t);this.queueRender()}}else if(typeof a==="number"){if(i!==parseFloat(this[e]))this.setAttribute(t,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[e]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(t);else this.setAttribute(t,i);this.queueRender(),this._attrValues.set(e,i)}}})}}connectedCallback(){if(Wi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.constructor.formAssociated&&!this.hasAttribute("tabindex"))this.setAttribute("tabindex","0");if(this.onResize!==void 0){if(bt.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");if(this.internals&&this.value!==void 0)this.internals.setFormValue(this.value),this.validateValue();this.queueRender()}disconnectedCallback(){bt.unobserve(this)}formResetCallback(){if(this.value!==void 0)this.value=this.defaultValue??""}formDisabledCallback(n){if(n)this.setAttribute("disabled","");else this.removeAttribute("disabled")}formStateRestoreCallback(n){if(this.value!==void 0&&typeof n==="string")this.value=n}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued){if(co(this,"change"),this.internals&&this.value!==void 0)this.internals.setFormValue(this.value)}this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",e=typeof this.content==="function"?this.content(m):this.content,{styleSpec:t}=this.constructor,{styleNode:a}=this.constructor;if(t)a=this.constructor.styleNode=m.style(Ln(t)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Ja(o,e,n)}else if(e!==null){let o=Array.from(this.childNodes);Ja(this,e,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let s=Array.from(this.querySelectorAll("slot"));if(s.length>0)s.forEach(St.replaceSlot);if(o.length>0){let i={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{i[r.name]=r}),o.forEach((r)=>{let l=i[""],p=r instanceof Element?i[r.slot]:l;(p!==void 0?p:l).append(r)})}}this._hydrated=!0}}render(){if(this._valueChanged&&this.internals&&this.value!==void 0)this.internals.setFormValue(this.value),this.validateValue();this._valueChanged=!1}validateValue(){if(!this.internals||this.value===void 0)return;let n=typeof this.value==="string"?this.value:String(this.value);Co(this,n)}}class St extends b{static initAttributes={name:""};content=null;static replaceSlot(n){let e=document.createElement("xin-slot");if(n.name!=="")e.setAttribute("name",n.name);n.replaceWith(e)}}var kd=St.elementCreator({tag:"xin-slot"}),Tt=(n=()=>!0)=>{let e=localStorage.getItem("xin-state");if(e!=null){let a=JSON.parse(e);for(let o of Object.keys(a).filter(n))if(L[o]!==void 0)Object.assign(L[o],a[o]);else L[o]=a[o]}let t=je(()=>{let a={},o=E(L);for(let s of Object.keys(o).filter(n))a[s]=o[s];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);Zn(n,t)},Se="1.3.2";function V(n){return Object.assign(ke,n),ke}function It(n){return $n("boxedProxy","boxedProxy is deprecated, please use tosi() instead"),V(n)}function So(n,e=!1){if(e)return $n("xinProxy-boxed","xinProxy(..., true) is deprecated; use tosi(...) instead"),It(n);return Object.keys(n).forEach((t)=>{L[t]=n[t]}),L}var qi={};async function Dt(n,e){let{type:t,styleSpec:a}=await e(n,{Color:y,Component:b,elements:m,svgElements:Ce,mathML:xo,varDefault:c,vars:d,xin:L,boxed:ke,xinProxy:So,boxedProxy:It,tosi:V,makeComponent:Dt,bind:an,on:En,version:Se}),o={type:t,creator:t.elementCreator({tag:n,styleSpec:a})};return qi[n]=o,o}var ot={},Hi=(n)=>import(n);class Te extends b{static initAttributes={tag:"anon-elt",src:"",property:"default"};loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:e,property:t}=this,a=`${n}.${t}:${e}`;if(!this.loaded){if(ot[a]===void 0)ot[a]=Hi(e).then((o)=>{let s=o[t];return Dt(n,s)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await ot[a],this.blueprintLoaded(this.loaded)}return this.loaded}}var Ui=Te.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class Pt extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(Te.tagName)).filter((e)=>e.src).map((e)=>e.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Fi=Pt.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Ma={};Na(Ma,{xrControllersText:()=>Sl,xrControllers:()=>Cl,xinTagList:()=>ld,xinTag:()=>Vs,xinSizer:()=>od,xinSelect:()=>In,xinSegmented:()=>ad,xinRating:()=>_l,xinPasswordStrength:()=>Fl,xinNotification:()=>Bs,xinMenu:()=>Yr,xinLocalized:()=>Xe,xinForm:()=>kl,xinFloat:()=>na,xinField:()=>xl,xinCarousel:()=>Er,version:()=>Aa,updateLocalized:()=>la,trackDrag:()=>rn,tosijs:()=>Qn,tosiMonth:()=>Rl,tosiDialog:()=>He,tabSelector:()=>Ds,svgIcon:()=>Ar,svg2DataUrl:()=>Fe,styleSheet:()=>ls,spacer:()=>qn,sizeBreak:()=>Da,sideNav:()=>Ta,setLocale:()=>Wr,scriptTag:()=>Sn,richTextWidgets:()=>Es,richText:()=>Zl,removeLastMenu:()=>Dn,postNotification:()=>Hl,positionFloat:()=>us,popMenu:()=>G,popFloat:()=>cs,menu:()=>fs,markdownViewer:()=>wa,mapBox:()=>Vl,makeSorter:()=>ms,makeExamplesLive:()=>Ll,localize:()=>D,localePicker:()=>Ur,liveExample:()=>Je,isBreached:()=>Ms,initLocalization:()=>Hr,icons:()=>v,i18n:()=>I,gamepadText:()=>jl,gamepadState:()=>Is,findHighestZ:()=>_e,filterPart:()=>Ue,filterBuilder:()=>bl,elastic:()=>Gl,editableRect:()=>pl,dragAndDrop:()=>ks,digest:()=>As,defineIcons:()=>Br,dataTable:()=>tl,createSubMenu:()=>vs,createMenuItem:()=>ws,createMenuAction:()=>ys,commandButton:()=>H,colorInput:()=>hs,codeEditor:()=>We,bringToFront:()=>re,bodymovinPlayer:()=>Lr,blockStyle:()=>ja,b3d:()=>Mr,availableFilters:()=>ma,abTest:()=>Pr,XinTagList:()=>Ba,XinTag:()=>Ge,XinSizer:()=>Pa,XinSelect:()=>de,XinSegmented:()=>Sa,XinRating:()=>ka,XinPasswordStrength:()=>xa,XinNotification:()=>Tn,XinMenu:()=>ha,XinLocalized:()=>J,XinForm:()=>le,XinFloat:()=>ln,XinField:()=>Ye,XinCarousel:()=>ra,TosiMonth:()=>fa,TosiDialog:()=>ua,TabSelector:()=>ya,SvgIcon:()=>sa,SizeBreak:()=>Ia,SideNav:()=>Un,RichText:()=>Ca,MarkdownViewer:()=>va,MapBox:()=>Cn,LocalePicker:()=>da,LiveExample:()=>Hn,FilterPart:()=>ba,FilterBuilder:()=>ga,EditableRect:()=>W,DataTable:()=>ca,CodeEditor:()=>Wn,BodymovinPlayer:()=>Rn,B3d:()=>ia,AbTest:()=>Nn});function At(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var fn=At();function Mo(n){fn=n}var ae={exec:()=>null};function k(n,e=""){let t=typeof n=="string"?n:n.source,a={replace:(o,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(O.caret,"$1"),t=t.replace(o,i),a},getRegex:()=>new RegExp(t,e)};return a}var O={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},_i=/^(?:[ \t]*(?:\n|$))+/,Xi=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Yi=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,oe=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ji=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Mt=/(?:[*+-]|\d{1,9}[.)])/,Lo=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Oo=k(Lo).replace(/bull/g,Mt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Gi=k(Lo).replace(/bull/g,Mt).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Lt=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,$i=/^[^\n]+/,Ot=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ki=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ot).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Zi=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Mt).getRegex(),Ae="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Et=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Qi=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Et).replace("tag",Ae).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Eo=k(Lt).replace("hr",oe).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ae).getRegex(),nr=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Eo).getRegex(),Vt={blockquote:nr,code:Xi,def:Ki,fences:Yi,heading:Ji,hr:oe,html:Qi,lheading:Oo,list:Zi,newline:_i,paragraph:Eo,table:ae,text:$i},To=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",oe).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ae).getRegex(),er={...Vt,lheading:Gi,table:To,paragraph:k(Lt).replace("hr",oe).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",To).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ae).getRegex()},tr={...Vt,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Et).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ae,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Lt).replace("hr",oe).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Oo).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},ar=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,or=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Vo=/^( {2,}|\\)\n(?!\s*$)/,sr=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Me=/[\p{P}\p{S}]/u,zt=/[\s\p{P}\p{S}]/u,zo=/[^\s\p{P}\p{S}]/u,ir=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,zt).getRegex(),No=/(?!~)[\p{P}\p{S}]/u,rr=/(?!~)[\s\p{P}\p{S}]/u,lr=/(?:[^\s\p{P}\p{S}]|~)/u,dr=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,Ro=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,pr=k(Ro,"u").replace(/punct/g,Me).getRegex(),hr=k(Ro,"u").replace(/punct/g,No).getRegex(),Wo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",cr=k(Wo,"gu").replace(/notPunctSpace/g,zo).replace(/punctSpace/g,zt).replace(/punct/g,Me).getRegex(),ur=k(Wo,"gu").replace(/notPunctSpace/g,lr).replace(/punctSpace/g,rr).replace(/punct/g,No).getRegex(),mr=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,zo).replace(/punctSpace/g,zt).replace(/punct/g,Me).getRegex(),br=k(/\\(punct)/,"gu").replace(/punct/g,Me).getRegex(),gr=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),yr=k(Et).replace("(?:-->|$)","-->").getRegex(),vr=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",yr).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),De=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,wr=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",De).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),qo=k(/^!?\[(label)\]\[(ref)\]/).replace("label",De).replace("ref",Ot).getRegex(),Ho=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ot).getRegex(),fr=k("reflink|nolink(?!\\()","g").replace("reflink",qo).replace("nolink",Ho).getRegex(),Io=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Nt={_backpedal:ae,anyPunctuation:br,autolink:gr,blockSkip:dr,br:Vo,code:or,del:ae,emStrongLDelim:pr,emStrongRDelimAst:cr,emStrongRDelimUnd:mr,escape:ar,link:wr,nolink:Ho,punctuation:ir,reflink:qo,reflinkSearch:fr,tag:vr,text:sr,url:ae},xr={...Nt,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",De).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",De).getRegex()},Bt={...Nt,emStrongRDelimAst:ur,emStrongLDelim:hr,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",Io).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",Io).getRegex()},kr={...Bt,br:k(Vo).replace("{2,}","*").getRegex(),text:k(Bt.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ie={normal:Vt,gfm:er,pedantic:tr},ne={normal:Nt,gfm:Bt,breaks:kr,pedantic:xr},jr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Do=(n)=>jr[n];function Y(n,e){if(e){if(O.escapeTest.test(n))return n.replace(O.escapeReplace,Do)}else if(O.escapeTestNoEncode.test(n))return n.replace(O.escapeReplaceNoEncode,Do);return n}function Po(n){try{n=encodeURI(n).replace(O.percentDecode,"%")}catch{return null}return n}function Bo(n,e){let t=n.replace(O.findPipe,(s,i,r)=>{let l=!1,p=i;for(;--p>=0&&r[p]==="\\";)l=!l;return l?"|":" |"}),a=t.split(O.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(O.slashPipe,"|");return a}function ee(n,e,t){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let s=n.charAt(a-o-1);if(s===e&&!t)o++;else if(s!==e&&t)o++;else break}return n.slice(0,a-o)}function Cr(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===e[0])t++;else if(n[a]===e[1]&&(t--,t<0))return a;return t>0?-2:-1}function Ao(n,e,t,a,o){let s=e.href,i=e.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:s,title:i,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,l}function Sr(n,e,t){let a=n.match(t.other.indentCodeCompensation);if(a===null)return e;let o=a[1];return e.split(`
`).map((s)=>{let i=s.match(t.other.beginningSpace);if(i===null)return s;let[r]=i;return r.length>=o.length?s.slice(o.length):s}).join(`
`)}var Pe=class{options;rules;lexer;constructor(n){this.options=n||fn}space(n){let e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){let e=this.rules.block.code.exec(n);if(e){let t=e[0].replace(this.rules.other.codeRemoveIndent,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:ee(t,`
`)}}}fences(n){let e=this.rules.block.fences.exec(n);if(e){let t=e[0],a=Sr(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:a}}}heading(n){let e=this.rules.block.heading.exec(n);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let a=ee(t,"#");(this.options.pedantic||!a||this.rules.other.endingSpaceChar.test(a))&&(t=a.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(n){let e=this.rules.block.hr.exec(n);if(e)return{type:"hr",raw:ee(e[0],`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];qs();var dn="tosijs";setTimeout(()=>{let n=y.fromVar(d.brandColor),e=y.fromVar(d.background);console.log(`welcome to %c${dn}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var md=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",bd=$e.find((n)=>n.filename===md)||$e[0],Hs=pe(),{app:P,prefs:M}=V({app:{title:dn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${dn}#readme`,npmUrl:`https://www.npmjs.com/package/${dn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${dn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${dn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${dn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${dn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:$e,currentDoc:bd,compact:!1},prefs:{colorScheme:Hs.colorScheme,highContrast:Hs.highContrast,locale:""}});Tt((n)=>{if(n.startsWith("prefs"))return!0;return!1});K.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};K.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:P,tosi:V,img:Ze,bindings:K,elements:m,vars:d,touch:tn,Color:y})},1000);var Us=document.querySelector("main"),{h2:gd,div:Fs,span:he,a:Ke,img:Ze,header:yd,button:_s,template:vd,input:wd}=m;M.colorScheme.observe(()=>{za({colorScheme:M.colorScheme.value})});M.highContrast.observe(()=>{za({highContrast:M.highContrast.value})});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);P.currentDoc=P.docs.find((e)=>e.filename===n)||P.docs[0]});var fd=je(()=>{console.time("filter");let n=Xs.value.toLocaleLowerCase();P.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),tn(P.docs),console.timeEnd("filter")}),Xs=wd({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:fd});if(Us)Us.append(yd(_s({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:P.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(Un.tagName);n.contentVisible=!n.contentVisible}},v.menu()),he({style:{flex:"0 0 10px"}}),Ke({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${Se}, tosijs-ui ${Aa}`},Ze({src:"favicon.svg",style:{height:40,marginRight:10}}),gd({bindText:"app.title"})),he({class:"elastic"}),Da({minWidth:750},he({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},Ke({href:P.bundleUrl},Ze({alt:"bundlejs size badge",src:P.bundleBadgeUrl})),Ke({href:P.cdnUrl},Ze({alt:"jsdelivr",src:P.cdnBadgeUrl}))),he({slot:"small"})),he({style:{flex:"0 0 10px"}}),_s({title:"theme",class:"iconic",onClick(n){G({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:P.githubUrl.value},{icon:"npm",caption:"npm",action:P.npmUrl.value},{icon:"discord",caption:"discord",action:P.discordUrl.value},{icon:"tosiUi",caption:"tosijs-ui",action:P.tosijsuiUrl.value},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return M.colorScheme.value==="system"},action(){M.colorScheme.value="system"}},{caption:"Dark",checked(){return M.colorScheme.value==="dark"},action(){M.colorScheme.value="dark"}},{caption:"Light",checked(){return M.colorScheme.value==="light"},action(){M.colorScheme.value="light"}},null,{caption:"High Contrast (System)",checked(){return M.highContrast.value==="system"},action(){M.highContrast.value="system"}},{caption:"High Contrast On",checked(){return M.highContrast.value===!0},action(){M.highContrast.value=!0}},{caption:"High Contrast Off",checked(){return M.highContrast.value===!1},action(){M.highContrast.value=!1}}]}]})}},v.moreVertical())),Ta({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Un.tagName);P.compact.value=n.compact}},Xs,Fs({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:P.docs}},vd(Ke({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=vn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),P.currentDoc=t,n.preventDefault()}}))),Fs({style:{position:"relative",overflowY:"scroll",height:"100%"}},wa({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Qn,"tosijs-ui":Ma})}}))));

//# debugId=2B492BD4336C610A64756E2164756E21
