var No=Object.defineProperty;var Ke=(n,t)=>{for(var e in t)No(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var $n={};Ke($n,{xinValue:()=>X,xinProxy:()=>Pa,xinPath:()=>Wn,xin:()=>_,version:()=>pt,vars:()=>r,varDefault:()=>u,updates:()=>$o,unobserve:()=>lt,touchElement:()=>Ut,touch:()=>mn,tosi:()=>Q,throttle:()=>qn,svgElements:()=>ut,settings:()=>ot,on:()=>ht,observe:()=>Yn,mathML:()=>Sa,makeComponent:()=>ee,invertLuminance:()=>Qt,initVars:()=>Ti,hotReload:()=>ne,getListItem:()=>cn,getCssVar:()=>va,elements:()=>g,debounce:()=>dt,css:()=>Ln,boxedProxy:()=>te,boxed:()=>rt,blueprintLoader:()=>Oi,blueprint:()=>Bi,bindings:()=>Z,bind:()=>q,StyleSheet:()=>Fn,MoreMath:()=>bi,Component:()=>y,Color:()=>v,BlueprintLoader:()=>ae,Blueprint:()=>mt});var ot={debug:!1,perf:!1};function un(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(un);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=un(a);else t[e]=a}return t}var ra="-xin-data",Tn=`.${ra}`,da="-xin-event",Ze=`.${da}`,K="xinPath",zn="xinValue",Lo="xinSet",Wo="xinObserve",Yo="xinBind",Fo="xinOn",Wn=(n)=>{return n&&n[K]||void 0};function X(n){return typeof n==="object"&&n!==null?n[zn]||n:n}var Vn=new WeakMap,pn=new WeakMap,Xn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=pn.get(n),a=Vn.get(n);if(e!=null)pn.set(t,un(e));if(a!=null)Vn.set(t,un(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(Xn(e));else t.appendChild(e.cloneNode());return t},at=new WeakMap,cn=(n)=>{let t=document.body.parentElement;while(n.parentElement!=null&&n.parentElement!==t){let e=at.get(n);if(e!=null)return e;n=n.parentElement}return!1},Qe=Symbol("observer should be removed"),it=[],st=[],Wt=!1,Yt,Ft;class ha{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw new Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw new Error("expect callback to be a path or function");it.push(this)}}var $o=async()=>{if(Yt===void 0)return;await Yt},Jo=()=>{if(ot.perf)console.time("xin async update");let n=Array.from(st);for(let t of n)it.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw new Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Qe)return lt(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Qe)lt(e)});if(st.splice(0),Wt=!1,typeof Ft==="function")Ft();if(ot.perf)console.timeEnd("xin async update")},mn=(n)=>{let t=typeof n==="string"?n:Wn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),new Error("touch was called on an invalid target");if(Wt===!1)Yt=new Promise((e)=>{Ft=e}),Wt=setTimeout(Jo);if(st.find((e)=>t.startsWith(e))==null)st.push(t)},ua=(n,t)=>{return new ha(n,t)},lt=(n)=>{let t=it.indexOf(n);if(t>-1)it.splice(t,1);else throw new Error("unobserve failed, listener not found")},Go=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},pa=(...n)=>new Error(n.map(Go).join(" ")),Ro=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Uo=0,Ko=()=>(parseInt("10000",36)+ ++Uo).toString(36).slice(-5),Zo=()=>Ro()+Ko(),$t=Symbol("delete"),ma=Symbol("new-object"),Ht=Symbol("automatic-index");function ca(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var U=new WeakMap;function ba(n,t){if(U.get(n)===void 0)U.set(n,{});if(U.get(n)[t]===void 0)U.get(n)[t]={};let e=U.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[Ht]===void 0)a[Ht]=Zo();e[a[Ht]+""]=o});else n.forEach((a,o)=>{e[Hn(a,t)+""]=o});return e}function Qo(n,t){if(U.get(n)===void 0||U.get(n)[t]===void 0)return ba(n,t);else return U.get(n)[t]}function ko(n,t,e){e=e+"";let a=Qo(n,t)[e];if(a===void 0||Hn(n[a],t)+""!==e)a=ba(n,t)[e];return a}function ni(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function ga(n,t,e,a){let o=t!==""?ko(n,t,e):e;if(a===$t)return n.splice(o,1),U.delete(n),Symbol("deleted");else if(a===ma){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Hn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw new Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function ke(n){if(!Array.isArray(n))throw pa("setByPath failed: expected array, found",n)}function na(n){if(n==null||!(n instanceof Object))throw pa("setByPath failed: expected Object, found",n)}function Hn(n,t){let e=ca(t),a=n,o,i,s,l;for(o=0,i=e.length;a!==void 0&&o<i;o++){let d=e[o];if(Array.isArray(d))for(s=0,l=d.length;a!==void 0&&s<l;s++){let h=d[s];a=a[h]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[h,...p]=d.split("=");a=ga(a,h,p.join("="))}else s=parseInt(d,10),a=a[s]}return a}function ti(n,t,e){let a=n;if(t==="")throw new Error("setByPath cannot be used to set the root object");let o=ca(t);while(a!=null&&o.length>0){let i=o.shift();if(typeof i==="string"){let s=i.indexOf("=");if(s>-1){if(s===0)na(a);else ke(a);let l=i.slice(0,s),d=i.slice(s+1);if(a=ga(a,l,d,o.length>0?ma:e),o.length===0)return!0}else{ke(a);let l=parseInt(i,10);if(o.length>0)a=a[l];else{if(e!==$t){if(a[l]===e)return!1;a[l]=e}else a.splice(l,1);return!0}}}else if(Array.isArray(i)&&i.length>0){na(a);while(i.length>0){let s=i.shift();if(i.length>0||o.length>0)a=ni(a,s,i.length>0?{}:[]);else{if(e!==$t){if(a[s]===e)return!1;a[s]=e}else{if(!Object.prototype.hasOwnProperty.call(a,s))return!1;delete a[s]}return!0}}}else throw new Error(`setByPath failed, bad path ${t}`)}throw new Error(`setByPath(${n}, ${t}, ${e}) failed`)}var ei=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],Rt={},ai=!0,oi=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ii=(n)=>oi.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},si={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}};function qt(n,t){let e=typeof n;if(n===void 0||e==="object"||e==="function")return n;else return new Proxy(si[typeof n](n),Sn(t,!0))}var Sn=(n,t)=>({get(e,a){switch(a){case K:return n;case zn:return e.valueOf?e.valueOf():e;case Lo:return(s)=>_[n]=s;case Wo:return(s)=>{let l=ua(n,s);return()=>lt(l)};case Fo:return(s,l)=>ht(s,l,X(e));case Yo:return(s,l,d)=>{q(s,n,l,d)}}if(typeof a==="symbol")return e[a];let o=a,i=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,s,l]=i,d=dn(n,s),h=Hn(e,s);return h!==null&&typeof h==="object"?new Proxy(h,Sn(d,t))[l]:h}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(e)&&e[o]!==void 0||Array.isArray(e)&&o.includes("=")){let s;if(o.includes("=")){let[l,d]=o.split("=");s=e.find((h)=>`${Hn(h,l)}`===d)}else s=e[o];if(s instanceof Object){let l=dn(n,o);return new Proxy(s instanceof Function?s.bind(e):s,Sn(l,t))}else return t?qt(s,dn(n,o)):s}else if(Array.isArray(e)){let s=e[o];return typeof s==="function"?(...l)=>{let d=s.apply(e,l);if(ei.includes(o))mn(n);return d}:typeof s==="object"?new Proxy(s,Sn(dn(n,o),t)):t?qt(s,dn(n,o)):s}else return t?qt(e[o],dn(n,o)):e[o]},set(e,a,o){o=X(o);let i=a!==zn?dn(n,a):n;if(ai&&!ii(i))throw new Error(`setting invalid path ${i}`);if(X(_[i])!==o&&ti(Rt,i,o))mn(i);return!0}}),Yn=(n,t)=>{let e=typeof t==="function"?t:_[t];if(typeof e!=="function")throw new Error(`observe expects a function or path to a function, ${t} is neither`);return ua(n,e)},_=new Proxy(Rt,Sn("",!1)),rt=new Proxy(Rt,Sn("",!0)),ya=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},fa=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},li=(n,t)=>{switch(fa(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},ri=(n)=>{switch(fa(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:ta}=globalThis,Jt=ta!=null?new ta((n)=>{for(let t of n){let e=t.target;ya(e,"resize")}}):{observe(){},unobserve(){}},ea=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?Xn(a):a)});else if(t instanceof Node)n.append(e?Xn(t):t);else throw new Error("expect text content or document node")},dt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},qn=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...i)=>{if(clearTimeout(e),e=setTimeout(async()=>{n(...i),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...i),a=Date.now()}finally{o=!1}}}},Gt=Symbol("list-binding"),di=16,hi=100;function aa(n,t){let e=Array.from(n.querySelectorAll(Tn));if(n.matches(Tn))e.unshift(n);for(let a of e){let o=pn.get(a);for(let i of o){if(i.path.startsWith("^"))i.path=`${t}${i.path.substring(1)}`;if(i.binding.toDOM!=null)i.binding.toDOM(a,_[i.path])}}}class wa{boundElement;listTop;listBottom;template;options;itemToElement;_array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw new Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw new Error("ListBinding expects a template with exactly one child element");this.template=Xn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)Jt.observe(this.boundElement),this._update=qn(()=>{this.update(this._array,!0)},di),this.boundElement.addEventListener("scroll",this._update),this.boundElement.addEventListener("resize",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this._array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,i=a.length-1,s=0,l=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,h=this.boundElement.offsetHeight;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let p=Math.ceil(h/n.height)+(n.rowChunkSize||1),m=Math.ceil(a.length/n.visibleColumns),c=n.visibleColumns*p,x=Math.floor(this.boundElement.scrollTop/n.height);if(x>m-p+1)x=Math.max(0,m-p+1);if(n.rowChunkSize)x-=x%n.rowChunkSize;o=x*n.visibleColumns,i=o+c-1,s=x*n.height,l=Math.max((m-p)*n.height-s,0)}return{items:a,firstItem:o,lastItem:i,topBuffer:s,bottomBuffer:l}}needle;filter=qn((n)=>{if(this.needle!==n)this.needle=n,this.update(this._array)},hi);update(n,t){if(n==null)n=[];this._array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Wn(n),i=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",i.items.length===0);let s=this._previousSlice,{firstItem:l,lastItem:d,topBuffer:h,bottomBuffer:p}=i;if(e===void 0&&a===void 0&&t===!0&&s!=null&&l===s.firstItem&&d===s.lastItem)return;this._previousSlice=i;let m=0,c=0,x=0;for(let C of Array.from(this.boundElement.children)){if(C===this.listTop||C===this.listBottom)continue;let E=at.get(C);if(E==null)C.remove();else{let j=i.items.indexOf(E);if(j<l||j>d)C.remove(),this.itemToElement.delete(E),at.delete(C),m++}}this.listTop.style.height=String(h)+"px",this.listBottom.style.height=String(p)+"px";let I=[],{idPath:O}=this.options;for(let C=l;C<=d;C++){let E=i.items[C];if(E===void 0)continue;let j=this.itemToElement.get(X(E));if(j==null){if(x++,j=Xn(this.template),typeof E==="object")this.itemToElement.set(X(E),j),at.set(j,X(E));if(this.boundElement.insertBefore(j,this.listBottom),O!=null){let M=E[O],V=`${o}[${O}=${M}]`;aa(j,V)}else{let M=`${o}[${C}]`;aa(j,M)}}I.push(j)}let T=null;for(let C of I){if(C.previousElementSibling!==T)if(c++,T?.nextElementSibling!=null)this.boundElement.insertBefore(C,T.nextElementSibling);else this.boundElement.insertBefore(C,this.listBottom);T=C}if(ot.perf)console.log(o,"updated",{removed:m,created:x,moved:c})}}var ui=(n,t,e)=>{let a=n[Gt];if(a===void 0)a=new wa(n,t,e),n[Gt]=a;return a},{document:Nn,MutationObserver:oa}=globalThis,Ut=(n,t)=>{let e=pn.get(n);if(e==null)return;for(let a of e){let{binding:o,options:i}=a,{path:s}=a,{toDOM:l}=o;if(l!=null){if(s.startsWith("^")){let d=cn(n);if(d!=null&&d[K]!=null)s=a.path=`${d[K]}${s.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${s}`,n,"is not part of a list"),new Error(`Cannot resolve relative binding ${s}`)}if(t==null||s.startsWith(t))l(n,_[s],i)}}};if(oa!=null)new oa((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Tn)).forEach((a)=>Ut(a))})})}).observe(Nn.body,{subtree:!0,childList:!0});Yn(()=>!0,(n)=>{let t=Array.from(Nn.querySelectorAll(Tn));for(let e of t)Ut(e,n)});var ia=(n)=>{let t=n.target.closest(Tn);while(t!=null){let e=pn.get(t);for(let a of e){let{binding:o,path:i}=a,{fromDOM:s}=o;if(s!=null){let l;try{l=s(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),new Error("Cannot obtain value fromDOM")}if(l!=null){let d=_[i];if(d==null)_[i]=l;else{let h=d[K]!=null?d[zn]:d,p=l[K]!=null?l[zn]:l;if(h!==p)_[i]=p}}}}t=t.parentElement.closest(Tn)}};if(globalThis.document!=null)Nn.body.addEventListener("change",ia,!0),Nn.body.addEventListener("input",ia,!0);function q(n,t,e,a){if(n instanceof DocumentFragment)throw new Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[K]===void 0&&a===void 0){let{value:l}=t;o=typeof l==="string"?l:l[K],a=t,delete a.value}else o=typeof t==="string"?t:t[K];if(o==null)throw new Error("bind requires a path or object with xin Proxy");let{toDOM:i}=e;n.classList?.add(ra);let s=pn.get(n);if(s==null)s=[],pn.set(n,s);if(s.push({path:o,binding:e,options:a}),i!=null&&!o.startsWith("^"))mn(o);if(a?.filter&&a?.needle)q(n,a.needle,{toDOM(l,d){console.log({needle:d}),l[Gt]?.filter(d)}});return n}var sa=new Set,pi=(n)=>{let t=n?.target.closest(Ze),e=!1,a=new Proxy(n,{get(i,s){if(s==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let l=i[s];return typeof l==="function"?l.bind(i):l}}}),o=new Set;while(!e&&t!=null){let i=Vn.get(t)[n.type]||o;for(let s of i){if(typeof s==="function")s(a);else{let l=_[s];if(typeof l==="function")l(a);else throw new Error(`no event handler found at path ${s}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(Ze):null}};function ht(n,t,e){let a=Vn.get(n);if(n.classList.add(da),a==null)a={},Vn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!sa.has(t))sa.add(t),Nn.body.addEventListener(t,pi,!0);return()=>{a[t].delete(e)}}var Z={value:{toDOM:li,fromDOM(n){return ri(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){ui(n,t,e).update(t)}}},mi=180/Math.PI,ci=Math.PI/180;function F(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function k(n,t,e,a=!0){if(a)e=F(0,e,1);return e*(t-n)+n}var bi={RADIANS_TO_DEGREES:mi,DEGREES_TO_RADIANS:ci,clamp:F,lerp:k};function va(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var gi=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},hn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class xa{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),i=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*i<0?60*i+360:60*i,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var jn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class v{r;g;b;a;static fromVar(n,t=document.body){return v.fromCss(va(n,t))}static fromCss(n){let t=n;if(jn instanceof HTMLSpanElement)jn.style.color="black",jn.style.color=n,document.body.appendChild(jn),t=getComputedStyle(jn).color,jn.remove();let[e,a,o,i]=t.match(/[\d.]+/g)||["0","0","0","0"],s=t.startsWith("color(srgb")?255:1;return new v(Number(e)*s,Number(a)*s,Number(o)*s,i==null?1:Number(i))}static fromHsl(n,t,e,a=1){let o,i,s;if(t===0)o=i=s=e;else{let d=(c,x,I)=>{if(I<0)I+=1;if(I>1)I-=1;if(I<0.16666666666666666)return c+(x-c)*6*I;if(I<0.5)return x;if(I<0.6666666666666666)return c+(x-c)*(0.6666666666666666-I)*6;return c},h=e<0.5?e*(1+t):e+t-e*t,p=2*e-h,m=(n%360+360)%360/360;o=d(p,h,m+0.3333333333333333),i=d(p,h,m),s=d(p,h,m-0.3333333333333333)}let l=new v(o*255,i*255,s*255,a);return l.hslCached={h:(n%360+360)%360,s:t,l:e},l}static black=new v(0,0,0);static white=new v(255,255,255);constructor(n,t,e,a=1){this.r=F(0,n,255),this.g=F(0,t,255),this.b=F(0,e,255),this.a=F(0,a,1)}get inverse(){return new v(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return v.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new v(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?v.black:v.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new xa(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new v(n,n,n)}get brightness(){return gi(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+hn(this.r)+hn(this.g)+hn(this.b):"#"+hn(this.r)+hn(this.g)+hn(this.b)+hn(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=F(0,a+n*(1-a),1);return v.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=F(0,a*(1-n),1);return v.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=F(0,e+n*(1-e),1);return v.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=F(0,e*(1-n),1);return v.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return v.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return v.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new v(k(this.r,n.r,t),k(this.g,n.g,t),k(this.b,n.b,t),k(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return v.fromHsl(e.s===0?a.h:a.s===0?e.h:v.blendHue(e.h,a.h,t),k(e.s,a.s,t),k(e.l,a.l,t),k(this.a,n.a,t))}colorMix(n,t){return v.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function nn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function yi(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var fi="http://www.w3.org/1998/Math/MathML",wi="http://www.w3.org/2000/svg",et={},Ca=(n,t,e)=>{let a=Ta(nn(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},vi=(n)=>{return{toDOM(t,e){Ca(t,n,e)}}},ja=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Wn(e[a]))q(n,e[a],vi(a));else Ca(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=nn(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},xi=(n)=>{return{toDOM(t,e){ja(t,n,e)}}},Ci=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();ht(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?Z[e.binding]:e.binding)!==void 0&&e.value!==void 0)q(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw new Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=Z[a];if(o!==void 0)q(n,e,o);else throw new Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Wn(e))q(n,e,xi(t));else ja(n,t,e)},Kt=(n,...t)=>{if(et[n]===void 0){let[o,i]=n.split("|");if(i===void 0)et[n]=globalThis.document.createElement(o);else et[n]=globalThis.document.createElementNS(i,o)}let e=et[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(o.xinPath)e.append(g.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let i=a[o];Ci(e,o,i)}return e},Zt=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},g=new Proxy({fragment:Zt},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>Kt(t,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),ut=new Proxy({fragment:Zt},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>Kt(`${t}|${wi}`,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}}),Sa=new Proxy({fragment:Zt},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>Kt(`${t}|${fi}`,...e);return n[t]},set(){throw new Error("You may not add new properties to elements")}});function Fn(n,t){let e=g.style(Ln(t));e.id=n,document.head.append(e)}var ji=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],Ta=(n,t)=>{if(typeof t==="number"&&!ji.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Si=(n,t,e)=>{if(e===void 0)return"";if(e instanceof v)e=e.html;let a=Ta(t,e);return`${n}  ${a.prop}: ${a.value};`},Ea=(n,t,e="")=>{let a=nn(n);if(typeof t==="object"&&!(t instanceof v)){let o=Object.keys(t).map((i)=>Ea(i,t[i],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Si(e,a,t)},Ln=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw new Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((i)=>Ea(i,a[i])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},Ti=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=nn(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},Qt=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof v)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=v.fromCss(a).inverseLuminance}return t},u=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+nn(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),r=new Proxy({},{get(n,t){if(t==="default")return u;if(n[t]==null){t=nn(t);let[,e,,a,o,i]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],s=`--${e}`;if(o!=null){let l=a==null?Number(o)/100:-Number(o)/100;switch(i){case"b":{let d=v.fromVar(s);n[t]=l>0?d.brighten(l).rgba:d.darken(-l).rgba}break;case"s":{let d=v.fromVar(s);n[t]=l>0?d.saturate(l).rgba:d.desaturate(-l).rgba}break;case"h":{let d=v.fromVar(s);n[t]=d.rotate(l*100).rgba}break;case"o":{let d=v.fromVar(s);n[t]=d.opacity(l).rgba}break;case"":n[t]=`calc(var(${s}) * ${l})`;break;default:throw console.error(i),new Error(`Unrecognized method ${i} for css variable ${s}`)}}else n[t]=`var(${s})`}return n[t]}}),Ei=0;function Nt(){return`custom-elt${(Ei++).toString(36)}`}var la=0,An={};function Pi(n,t){let e=An[n],a=Ln(t).replace(/:host\b/g,n);An[n]=e?e+`
`+a:a}function Ii(n){if(An[n])document.head.append(g.style({id:n+"-component"},An[n]));delete An[n]}class y extends HTMLElement{static elements=g;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=g.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),g.style(Ln(n))}static elementCreator(n={}){if(this._elementCreator==null){let{tag:t,styleSpec:e}=n,a=n!=null?t:null;if(a==null)if(typeof this.name==="string"&&this.name!==""){if(a=nn(this.name),a.startsWith("-"))a=a.slice(1)}else a=Nt();if(customElements.get(a)!=null)console.warn(`${a} is already defined`);if(a.match(/\w+(-\w+)+/)==null)console.warn(`${a} is not a legal tag for a custom-element`),a=Nt();while(customElements.get(a)!==void 0)a=Nt();if(this._tagName=a,e!==void 0)Pi(a,e);window.customElements.define(a,this,n),this._elementCreator=g[a]}return this._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((i)=>{o=!!(i.attributeName&&n.includes(yi(i.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=un(this[a]);let o=nn(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(i){if(typeof t[a]==="boolean"){if(i!==this[a]){if(i)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(i!==parseFloat(this[a]))this.setAttribute(o,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[a]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(o);else this.setAttribute(o,i);this.queueRender(),e[a]=i}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):un(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw new Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();la+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${la}`,this._value=un(this.defaultValue)}connectedCallback(){if(Ii(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(Jt.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){Jt.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)ya(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content():this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=g.style(Ln(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),ea(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);ea(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let i=Array.from(this.querySelectorAll("slot"));if(i.length>0)i.forEach(kt.replaceSlot);if(o.length>0){let s={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((l)=>{s[l.name]=l}),o.forEach((l)=>{let d=s[""],h=l instanceof Element?s[l.slot]:d;(h!==void 0?h:d).append(l)})}}this._hydrated=!0}}render(){}}class kt extends y{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Dl=kt.elementCreator({tag:"xin-slot"}),ne=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(_[o]!==void 0)Object.assign(_[o],a[o]);else _[o]=a[o]}let e=dt(()=>{let a={},o=X(_);for(let i of Object.keys(o).filter(n))a[i]=o[i];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);Yn(n,e)},pt="1.0.3";function Q(n){return Object.assign(rt,n),rt}function te(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),Q(n)}function Pa(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),te(n);return Object.keys(n).forEach((e)=>{_[e]=n[e]}),_}var Mi={};async function ee(n,t){let{type:e,styleSpec:a}=await t(n,{Color:v,Component:y,elements:g,svgElements:ut,mathML:Sa,varDefault:u,vars:r,xin:_,boxed:rt,xinProxy:Pa,boxedProxy:te,makeComponent:ee,bind:q,on:ht,version:pt}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return Mi[n]=o,o}var Lt={},_i=(n)=>import(n);class mt extends y{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Lt[a]===void 0)Lt[a]=_i(t).then((o)=>{let i=o[e];return ee(n,i)});else console.log(`using cached ${n}`);this.loaded=await Lt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var Bi=mt.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ae extends y{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(mt.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var Oi=ae.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Re={};Ke(Re,{xrControllersText:()=>Ns,xrControllers:()=>qs,xinTagList:()=>jl,xinTag:()=>Do,xinSizer:()=>wl,xinSelect:()=>kn,xinSegmented:()=>fl,xinRating:()=>sl,xinPasswordStrength:()=>il,xinNotification:()=>Po,xinMenu:()=>cs,xinLocalized:()=>_t,xinForm:()=>Xs,xinFloat:()=>be,xinField:()=>Vs,xinCarousel:()=>es,version:()=>Ge,updateLocalized:()=>Se,trackDrag:()=>on,tosijs:()=>$n,tosiMonth:()=>nl,tabSelector:()=>To,svgIcon:()=>Qi,svg2DataUrl:()=>Mt,styleSheet:()=>oo,spacer:()=>Bn,sizeBreak:()=>Fe,sideNav:()=>We,setLocale:()=>ls,scriptTag:()=>vn,richTextWidgets:()=>Oo,richText:()=>ml,removeLastMenu:()=>Cn,postNotification:()=>al,positionFloat:()=>ho,popMenu:()=>R,popFloat:()=>ro,menu:()=>yo,markdownViewer:()=>Ae,mapBox:()=>Zs,makeSorter:()=>uo,makeExamplesLive:()=>Rs,localize:()=>D,localePicker:()=>hs,liveExample:()=>Ot,isBreached:()=>Mo,initLocalization:()=>ds,icons:()=>f,i18n:()=>B,gamepadText:()=>Hs,gamepadState:()=>So,findHighestZ:()=>je,filterPart:()=>It,filterBuilder:()=>_s,elastic:()=>hl,editableRect:()=>Ts,dragAndDrop:()=>wo,digest:()=>Io,defineIcons:()=>Zi,dataTable:()=>js,createSubMenu:()=>bo,createMenuItem:()=>go,createMenuAction:()=>co,commandButton:()=>Y,colorInput:()=>lo,codeEditor:()=>Et,bringToFront:()=>Qn,bodymovinPlayer:()=>ns,blockStyle:()=>He,b3d:()=>ki,availableFilters:()=>Me,abTest:()=>Ki,XinTagList:()=>Je,XinTag:()=>Dt,XinSizer:()=>$e,XinSelect:()=>tt,XinSegmented:()=>Ne,XinRating:()=>Xe,XinPasswordStrength:()=>Ve,XinNotification:()=>xn,XinMenu:()=>Pe,XinLocalized:()=>G,XinForm:()=>nt,XinFloat:()=>sn,XinField:()=>Bt,XinCarousel:()=>Ce,TosiMonth:()=>ze,TabSelector:()=>Oe,SvgIcon:()=>ve,SizeBreak:()=>Ye,SideNav:()=>Le,RichText:()=>qe,MarkdownViewer:()=>De,MapBox:()=>wn,LocalePicker:()=>Te,LiveExample:()=>On,FilterPart:()=>_e,FilterBuilder:()=>Be,EditableRect:()=>L,DataTable:()=>Ie,CodeEditor:()=>_n,BodymovinPlayer:()=>Mn,B3d:()=>xe,AbTest:()=>In});function oe(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}var tn=oe();function Da(n){tn=n}var Aa=/[&<>"']/,Di=new RegExp(Aa.source,"g"),za=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Ai=new RegExp(za.source,"g"),zi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ia=(n)=>zi[n];function A(n,t){if(t){if(Aa.test(n))return n.replace(Di,Ia)}else if(za.test(n))return n.replace(Ai,Ia);return n}var Vi=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Va(n){return n.replace(Vi,(t,e)=>{if(e=e.toLowerCase(),e==="colon")return":";if(e.charAt(0)==="#")return e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1));return""})}var Xi=/(^|[^\[])\^/g;function P(n,t){n=typeof n==="string"?n:n.source,t=t||"";let e={replace:(a,o)=>{return o=o.source||o,o=o.replace(Xi,"$1"),n=n.replace(a,o),e},getRegex:()=>{return new RegExp(n,t)}};return e}var Hi=/[^\w:]/g,qi=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Ma(n,t,e){if(n){let a;try{a=decodeURIComponent(Va(e)).replace(Hi,"").toLowerCase()}catch(o){return null}if(a.indexOf("javascript:")===0||a.indexOf("vbscript:")===0||a.indexOf("data:")===0)return null}if(t&&!qi.test(e))e=Yi(t,e);try{e=encodeURI(e).replace(/%25/g,"%")}catch(a){return null}return e}var ct={},Ni=/^[^:]+:\/*[^/]*$/,Li=/^([^:]+:)[\s\S]*$/,Wi=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Yi(n,t){if(!ct[" "+n])if(Ni.test(n))ct[" "+n]=n+"/";else ct[" "+n]=bt(n,"/",!0);n=ct[" "+n];let e=n.indexOf(":")===-1;if(t.substring(0,2)==="//"){if(e)return t;return n.replace(Li,"$1")+t}else if(t.charAt(0)==="/"){if(e)return t;return n.replace(Wi,"$1")+t}else return n+t}var gt={exec:function n(){}};function _a(n,t){let e=n.replace(/\|/g,(i,s,l)=>{let d=!1,h=s;while(--h>=0&&l[h]==="\\")d=!d;if(d)return"|";else return" |"}),a=e.split(/ \|/),o=0;if(!a[0].trim())a.shift();if(a.length>0&&!a[a.length-1].trim())a.pop();if(a.length>t)a.splice(t);else while(a.length<t)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(/\\\|/g,"|");return a}function bt(n,t,e){let a=n.length;if(a===0)return"";let o=0;while(o<a){let i=n.charAt(a-o-1);if(i===t&&!e)o++;else if(i!==t&&e)o++;else break}return n.slice(0,a-o)}function Fi(n,t){if(n.indexOf(t[1])===-1)return-1;let e=n.length,a=0,o=0;for(;o<e;o++)if(n[o]==="\\")o++;else if(n[o]===t[0])a++;else if(n[o]===t[1]){if(a--,a<0)return o}return-1}function $i(n,t){if(!n||n.silent)return;if(t)console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async");if(n.sanitize||n.sanitizer)console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options");if(n.highlight||n.langPrefix!=="language-")console.warn("marked(): highlight and langPrefix parameters are deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-highlight.");if(n.mangle)console.warn("marked(): mangle parameter is enabled by default, but is deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install https://www.npmjs.com/package/marked-mangle, or disable by setting `{mangle: false}`.");if(n.baseUrl)console.warn("marked(): baseUrl parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-base-url.");if(n.smartypants)console.warn("marked(): smartypants parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-smartypants.");if(n.xhtml)console.warn("marked(): xhtml parameter is deprecated since version 5.0.0, should not be used and will be removed in the future. Instead use https://www.npmjs.com/package/marked-xhtml.");if(n.headerIds||n.headerPrefix)console.warn("marked(): headerIds and headerPrefix parameters enabled by default, but are deprecated since version 5.0.0, and will be removed in the future. To clear this warning, install  https://www.npmjs.com/package/marked-gfm-heading-id, or disable by setting `{headerIds: false}`.")}function Ba(n,t,e,a){let o=t.href,i=t.title?A(t.title):null,s=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){a.state.inLink=!0;let l={type:"link",raw:e,href:o,title:i,text:s,tokens:a.inlineTokens(s)};return a.state.inLink=!1,l}return{type:"image",raw:e,href:o,title:i,text:A(s)}}function Ji(n,t){let e=n.match(/^(\s+)(?:```)/);if(e===null)return t;let a=e[1];return t.split(`
`).map((o)=>{let i=o.match(/^\s+/);if(i===null)return o;let[s]=i;if(s.length>=a.length)return o.slice(a.length);return o}).join(`
`)}class Gn{constructor(n){this.options=n||tn}space(n){let t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){let t=this.rules.block.code.exec(n);if(t){let e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:!this.options.pedantic?bt(e,`
`):e}}}fences(n){let t=this.rules.block.fences.exec(n);if(t){let e=t[0],a=Ji(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:a}}}heading(n){let t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(/#$/.test(e)){let a=bt(e,"#");if(this.options.pedantic)e=a.trim();else if(!a||/ $/.test(a))e=a.trim()}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){let t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){let t=this.rules.block.blockquote.exec(n);if(t){let e=t[0].replace(/^ *>[ \t]?/gm,""),a=this.lexer.state.top;this.lexer.state.top=!0;let o=this.lexer.blockTokens(e);return this.lexer.state.top=a,{type:"blockquote",raw:t[0],tokens:o,text:e}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e,a,o,i,s,l,d,h,p,m,c,x,I=t[1].trim(),O=I.length>1,T={type:"list",raw:"",ordered:O,start:O?+I.slice(0,-1):"",loose:!1,items:[]};if(I=O?`\\d{1,9}\\${I.slice(-1)}`:`\\${I}`,this.options.pedantic)I=O?I:"[*+-]";let C=new RegExp(`^( {0,3}${I})((?:[	 ][^\\n]*)?(?:\\n|$))`);while(n){if(x=!1,!(t=C.exec(n)))break;if(this.rules.block.hr.test(n))break;if(e=t[0],n=n.substring(e.length),h=t[2].split(`
`,1)[0].replace(/^\t+/,(j)=>" ".repeat(3*j.length)),p=n.split(`
`,1)[0],this.options.pedantic)i=2,c=h.trimLeft();else i=t[2].search(/[^ ]/),i=i>4?1:i,c=h.slice(i),i+=t[1].length;if(l=!1,!h&&/^ *$/.test(p))e+=p+`
`,n=n.substring(p.length+1),x=!0;if(!x){let j=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),M=new RegExp(`^ {0,${Math.min(3,i-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),V=new RegExp(`^ {0,${Math.min(3,i-1)}}(?:\`\`\`|~~~)`),Dn=new RegExp(`^ {0,${Math.min(3,i-1)}}#`);while(n){if(m=n.split(`
`,1)[0],p=m,this.options.pedantic)p=p.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ");if(V.test(p))break;if(Dn.test(p))break;if(j.test(p))break;if(M.test(n))break;if(p.search(/[^ ]/)>=i||!p.trim())c+=`
`+p.slice(i);else{if(l)break;if(h.search(/[^ ]/)>=4)break;if(V.test(h))break;if(Dn.test(h))break;if(M.test(h))break;c+=`
`+p}if(!l&&!p.trim())l=!0;e+=m+`
`,n=n.substring(m.length+1),h=p.slice(i)}}if(!T.loose){if(d)T.loose=!0;else if(/\n *\n *$/.test(e))d=!0}if(this.options.gfm){if(a=/^\[[ xX]\] /.exec(c),a)o=a[0]!=="[ ] ",c=c.replace(/^\[[ xX]\] +/,"")}T.items.push({type:"list_item",raw:e,task:!!a,checked:o,loose:!1,text:c}),T.raw+=e}T.items[T.items.length-1].raw=e.trimRight(),T.items[T.items.length-1].text=c.trimRight(),T.raw=T.raw.trimRight();let E=T.items.length;for(s=0;s<E;s++)if(this.lexer.state.top=!1,T.items[s].tokens=this.lexer.blockTokens(T.items[s].text,[]),!T.loose){let j=T.items[s].tokens.filter((V)=>V.type==="space"),M=j.length>0&&j.some((V)=>/\n.*\n/.test(V.raw));T.loose=M}if(T.loose)for(s=0;s<E;s++)T.items[s].loose=!0;return T}}html(n){let t=this.rules.block.html.exec(n);if(t){let e={type:"html",block:!0,raw:t[0],pre:!this.options.sanitizer&&(t[1]==="pre"||t[1]==="script"||t[1]==="style"),text:t[0]};if(this.options.sanitize){let a=this.options.sanitizer?this.options.sanitizer(t[0]):A(t[0]);e.type="paragraph",e.text=a,e.tokens=this.lexer.inline(a)}return e}}def(n){let t=this.rules.block.def.exec(n);if(t){let e=t[1].toLowerCase().replace(/\s+/g," "),a=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline._escapes,"$1"):"",o=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline._escapes,"$1"):t[3];return{type:"def",tag:e,raw:t[0],href:a,title:o}}}table(n){let t=this.rules.block.table.exec(n);if(t){let e={type:"table",header:_a(t[1]).map((a)=>{return{text:a}}),align:t[2].replace(/^ *|\| *$/g,"").split(/ *\| */),rows:t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
`):[]};if(e.header.length===e.align.length){e.raw=t[0];let a=e.align.length,o,i,s,l;for(o=0;o<a;o++)if(/^ *-+: *$/.test(e.align[o]))e.align[o]="right";else if(/^ *:-+: *$/.test(e.align[o]))e.align[o]="center";else if(/^ *:-+ *$/.test(e.align[o]))e.align[o]="left";else e.align[o]=null;a=e.rows.length;for(o=0;o<a;o++)e.rows[o]=_a(e.rows[o],e.header.length).map((d)=>{return{text:d}});a=e.header.length;for(i=0;i<a;i++)e.header[i].tokens=this.lexer.inline(e.header[i].text);a=e.rows.length;for(i=0;i<a;i++){l=e.rows[i];for(s=0;s<l.length;s++)l[s].tokens=this.lexer.inline(l[s].text)}return e}}}lheading(n){let t=this.rules.block.lheading.exec(n);if(t)return{type:"heading",raw:t[0],depth:t[2].charAt(0)==="="?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(n){let t=this.rules.block.paragraph.exec(n);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(n){let t=this.rules.block.text.exec(n);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(n){let t=this.rules.inline.escape.exec(n);if(t)return{type:"escape",raw:t[0],text:A(t[1])}}tag(n){let t=this.rules.inline.tag.exec(n);if(t){if(!this.lexer.state.inLink&&/^<a /i.test(t[0]))this.lexer.state.inLink=!0;else if(this.lexer.state.inLink&&/^<\/a>/i.test(t[0]))this.lexer.state.inLink=!1;if(!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0]))this.lexer.state.inRawBlock=!0;else if(this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0]))this.lexer.state.inRawBlock=!1;return{type:this.options.sanitize?"text":"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(t[0]):A(t[0]):t[0]}}}link(n){let t=this.rules.inline.link.exec(n);if(t){let e=t[2].trim();if(!this.options.pedantic&&/^</.test(e)){if(!/>$/.test(e))return;let i=bt(e.slice(0,-1),"\\");if((e.length-i.length)%2===0)return}else{let i=Fi(t[2],"()");if(i>-1){let l=(t[0].indexOf("!")===0?5:4)+t[1].length+i;t[2]=t[2].substring(0,i),t[0]=t[0].substring(0,l).trim(),t[3]=""}}let a=t[2],o="";if(this.options.pedantic){let i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(a);if(i)a=i[1],o=i[3]}else o=t[3]?t[3].slice(1,-1):"";if(a=a.trim(),/^</.test(a))if(this.options.pedantic&&!/>$/.test(e))a=a.slice(1);else a=a.slice(1,-1);return Ba(t,{href:a?a.replace(this.rules.inline._escapes,"$1"):a,title:o?o.replace(this.rules.inline._escapes,"$1"):o},t[0],this.lexer)}}reflink(n,t){let e;if((e=this.rules.inline.reflink.exec(n))||(e=this.rules.inline.nolink.exec(n))){let a=(e[2]||e[1]).replace(/\s+/g," ");if(a=t[a.toLowerCase()],!a){let o=e[0].charAt(0);return{type:"text",raw:o,text:o}}return Ba(e,a,e[0],this.lexer)}}emStrong(n,t,e=""){let a=this.rules.inline.emStrong.lDelim.exec(n);if(!a)return;if(a[3]&&e.match(/[\p{L}\p{N}]/u))return;if(!(a[1]||a[2])||!e||this.rules.inline.punctuation.exec(e)){let i=a[0].length-1,s,l,d=i,h=0,p=a[0][0]==="*"?this.rules.inline.emStrong.rDelimAst:this.rules.inline.emStrong.rDelimUnd;p.lastIndex=0,t=t.slice(-1*n.length+i);while((a=p.exec(t))!=null){if(s=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!s)continue;if(l=s.length,a[3]||a[4]){d+=l;continue}else if(a[5]||a[6]){if(i%3&&!((i+l)%3)){h+=l;continue}}if(d-=l,d>0)continue;l=Math.min(l,l+d+h);let m=n.slice(0,i+a.index+l+1);if(Math.min(i,l)%2){let x=m.slice(1,-1);return{type:"em",raw:m,text:x,tokens:this.lexer.inlineTokens(x)}}let c=m.slice(2,-2);return{type:"strong",raw:m,text:c,tokens:this.lexer.inlineTokens(c)}}}}codespan(n){let t=this.rules.inline.code.exec(n);if(t){let e=t[2].replace(/\n/g," "),a=/[^ ]/.test(e),o=/^ /.test(e)&&/ $/.test(e);if(a&&o)e=e.substring(1,e.length-1);return e=A(e,!0),{type:"codespan",raw:t[0],text:e}}}br(n){let t=this.rules.inline.br.exec(n);if(t)return{type:"br",raw:t[0]}}del(n){let t=this.rules.inline.del.exec(n);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(n,t){let e=this.rules.inline.autolink.exec(n);if(e){let a,o;if(e[2]==="@")a=A(this.options.mangle?t(e[1]):e[1]),o="mailto:"+a;else a=A(e[1]),o=a;return{type:"link",raw:e[0],text:a,href:o,tokens:[{type:"text",raw:a,text:a}]}}}url(n,t){let e;if(e=this.rules.inline.url.exec(n)){let a,o;if(e[2]==="@")a=A(this.options.mangle?t(e[0]):e[0]),o="mailto:"+a;else{let i;do i=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])[0];while(i!==e[0]);if(a=A(e[0]),e[1]==="www.")o="http://"+e[0];else o=e[0]}return{type:"link",raw:e[0],text:a,href:o,tokens:[{type:"text",raw:a,text:a}]}}}inlineText(n,t){let e=this.rules.inline.text.exec(n);if(e){let a;if(this.lexer.state.inRawBlock)a=this.options.sanitize?this.options.sanitizer?this.options.sanitizer(e[0]):A(e[0]):e[0];else a=A(this.options.smartypants?t(e[0]):e[0]);return{type:"text",raw:e[0],text:a}}}}var w={newline:/^(?: *(?:\n|$))+/,code:/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,fences:/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,hr:/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/,html:"^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))",def:/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/,table:gt,lheading:/^((?:(?!^bull ).|\n(?!\n|bull ))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,text:/^[^\n]+/};w._label=/(?!\s*\])(?:\\.|[^\[\]\\])+/;w._title=/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/;w.def=P(w.def).replace("label",w._label).replace("title",w._title).getRegex();w.bullet=/(?:[*+-]|\d{1,9}[.)])/;w.listItemStart=P(/^( *)(bull) */).replace("bull",w.bullet).getRegex();w.list=P(w.list).replace(/bull/g,w.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+w.def.source+")").getRegex();w._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul";w._comment=/<!--(?!-?>)[\s\S]*?(?:-->|$)/;w.html=P(w.html,"i").replace("comment",w._comment).replace("tag",w._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();w.lheading=P(w.lheading).replace(/bull/g,w.bullet).getRegex();w.paragraph=P(w._paragraph).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.blockquote=P(w.blockquote).replace("paragraph",w.paragraph).getRegex();w.normal={...w};w.gfm={...w.normal,table:"^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)"};w.gfm.table=P(w.gfm.table).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.gfm.paragraph=P(w._paragraph).replace("hr",w.hr).replace("heading"," {0,3}#{1,6} ").replace("|lheading","").replace("table",w.gfm.table).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",w._tag).getRegex();w.pedantic={...w.normal,html:P(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",w._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:gt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:P(w.normal._paragraph).replace("hr",w.hr).replace("heading",` *#{1,6} *[^
]`).replace("lheading",w.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()};var b={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:gt,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(ref)\]/,nolink:/^!?\[(ref)\](?:\[\])?/,reflinkSearch:"reflink|nolink(?!\\()",emStrong:{lDelim:/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,rDelimAst:/^[^_*]*?__[^_*]*?\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\*)[punct](\*+)(?=[\s]|$)|[^punct\s](\*+)(?!\*)(?=[punct\s]|$)|(?!\*)[punct\s](\*+)(?=[^punct\s])|[\s](\*+)(?!\*)(?=[punct])|(?!\*)[punct](\*+)(?!\*)(?=[punct])|[^punct\s](\*+)(?=[^punct\s])/,rDelimUnd:/^[^_*]*?\*\*[^_*]*?_[^_*]*?(?=\*\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\s]|$)|[^punct\s](_+)(?!_)(?=[punct\s]|$)|(?!_)[punct\s](_+)(?=[^punct\s])|[\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])/},code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:gt,text:/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,punctuation:/^((?![*_])[\spunctuation])/};b._punctuation="\\p{P}$+<=>`^|~";b.punctuation=P(b.punctuation,"u").replace(/punctuation/g,b._punctuation).getRegex();b.blockSkip=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g;b.anyPunctuation=/\\[punct]/g;b._escapes=/\\([punct])/g;b._comment=P(w._comment).replace("(?:-->|$)","-->").getRegex();b.emStrong.lDelim=P(b.emStrong.lDelim,"u").replace(/punct/g,b._punctuation).getRegex();b.emStrong.rDelimAst=P(b.emStrong.rDelimAst,"gu").replace(/punct/g,b._punctuation).getRegex();b.emStrong.rDelimUnd=P(b.emStrong.rDelimUnd,"gu").replace(/punct/g,b._punctuation).getRegex();b.anyPunctuation=P(b.anyPunctuation,"gu").replace(/punct/g,b._punctuation).getRegex();b._escapes=P(b._escapes,"gu").replace(/punct/g,b._punctuation).getRegex();b._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/;b._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/;b.autolink=P(b.autolink).replace("scheme",b._scheme).replace("email",b._email).getRegex();b._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/;b.tag=P(b.tag).replace("comment",b._comment).replace("attribute",b._attribute).getRegex();b._label=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/;b._href=/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/;b._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/;b.link=P(b.link).replace("label",b._label).replace("href",b._href).replace("title",b._title).getRegex();b.reflink=P(b.reflink).replace("label",b._label).replace("ref",w._label).getRegex();b.nolink=P(b.nolink).replace("ref",w._label).getRegex();b.reflinkSearch=P(b.reflinkSearch,"g").replace("reflink",b.reflink).replace("nolink",b.nolink).getRegex();b.normal={...b};b.pedantic={...b.normal,strong:{start:/^__|\*\*/,middle:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,endAst:/\*\*(?!\*)/g,endUnd:/__(?!_)/g},em:{start:/^_|\*/,middle:/^()\*(?=\S)([\s\S]*?\S)\*(?!\*)|^_(?=\S)([\s\S]*?\S)_(?!_)/,endAst:/\*(?!\*)/g,endUnd:/_(?!_)/g},link:P(/^!?\[(label)\]\((.*?)\)/).replace("label",b._label).getRegex(),reflink:P(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",b._label).getRegex()};b.gfm={...b.normal,escape:P(b.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/};b.gfm.url=P(b.gfm.url,"i").replace("email",b.gfm._extended_email).getRegex();b.breaks={...b.gfm,br:P(b.br).replace("{2,}","*").getRegex(),text:P(b.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()};function Gi(n){return n.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…")}function Oa(n){let t="",e,a,o=n.length;for(e=0;e<o;e++){if(a=n.charCodeAt(e),Math.random()>0.5)a="x"+a.toString(16);t+="&#"+a+";"}return t}class ${constructor(n){this.tokens=[],this.tokens.links=Object.create(null),this.options=n||tn,this.options.tokenizer=this.options.tokenizer||new Gn,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={block:w.normal,inline:b.normal};if(this.options.pedantic)t.block=w.pedantic,t.inline=b.pedantic;else if(this.options.gfm)if(t.block=w.gfm,this.options.breaks)t.inline=b.breaks;else t.inline=b.gfm;this.tokenizer.rules=t}static get rules(){return{block:w,inline:b}}static lex(n,t){return new $(t).lex(n)}static lexInline(n,t){return new $(t).inlineTokens(n)}lex(n){n=n.replace(/\r\n|\r/g,`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];Fn("demo-style",zo);var rn="tosijs";setTimeout(()=>{let n=v.fromVar(r.brandColor),t=v.fromVar(r.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Tl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",El=At.find((n)=>n.filename===Tl)||At[0],{app:z,prefs:H}=Q({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,xinjsuiUrl:"https://ui.xinjs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:At,currentDoc:El},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});ne((n)=>{if(n.startsWith("prefs"))return!0;return!1});Z.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};Z.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:z,tosi:Q,img:Xt,bindings:Z,elements:g,vars:r,touch:mn,Color:v})},1000);var Vo=document.querySelector("main"),{h2:Pl,div:Xo,span:zt,a:Vt,img:Xt,header:Il,button:Ho,template:Ml,input:_l}=g;q(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});q(document.body,H.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});q(document.body,H.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);z.currentDoc=z.docs.find((t)=>t.filename===n)||z.docs[0]});var Bl=dt(()=>{console.time("filter");let n=qo.value.toLocaleLowerCase();z.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),mn(z.docs),console.timeEnd("filter")}),qo=_l({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Bl});if(Vo)Vo.append(Il(Vt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${pt}, tosijs-ui ${Ge}`},Xt({src:"favicon.svg",style:{height:40,marginRight:10}}),Pl({bindText:"app.title"})),zt({class:"elastic"}),Fe({minWidth:750},zt({style:{marginRight:r.spacing,display:"flex",alignItems:"center",gap:r.spacing50}},Vt({href:z.bundleUrl},Xt({alt:"bundlejs size badge",src:z.bundleBadgeUrl})),Vt({href:z.cdnUrl},Xt({alt:"jsdelivr",src:z.cdnBadgeUrl}))),zt({slot:"small"})),zt({style:{flex:"0 0 10px"}}),Ho({title:"theme",class:"iconic",onClick(n){R({target:n.target,menuItems:[{icon:"github",caption:"github",action:z.githubUrl},{icon:"npm",caption:"npm",action:z.npmUrl},{icon:"discord",caption:"discord",action:z.discordUrl},{icon:"xinjsUiColor",caption:"xinjs-ui",action:z.xinjsuiUrl},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return H.theme==="system"},action(){H.theme="system"}},{caption:"Dark",checked(){return H.theme==="dark"},action(){H.theme="dark"}},{caption:"Light",checked(){return H.theme==="light"},action(){H.theme="light"}},null,{caption:"High Contrast",checked(){return H.highContrast.valueOf()},action(){H.highContrast=!H.highContrast.valueOf()}},{caption:"Monochrome",checked(){return H.monochrome.valueOf()},action(){H.monochrome=!H.monochrome.valueOf()}}]}]})}},f.moreVertical())),We({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"}},qo,Xo({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:z.docs}},Ml(Vt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=cn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),z.currentDoc=e,n.preventDefault()}}))),Xo({style:{position:"relative",overflowY:"scroll",height:"100%"}},Ho({title:"show navigation",class:"transparent close-nav show-within-compact",style:{marginTop:"2px",position:"fixed"},onClick(n){n.target.closest("xin-sidenav").contentVisible=!1}},f.chevronLeft()),Ae({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){On.insertExamples(this,{tosijs:$n,tosijsui:Re})}}))));

//# debugId=7CE468D64BC4DD3F64756E2164756E21
