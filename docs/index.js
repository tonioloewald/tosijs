...
Please report this to https://github.com/markedjs/marked.`,n){let i="<p>An error occurred:</p><pre>"+On(t.message+"",!0)+"</pre>";return e?Promise.resolve(i):i}if(e)return Promise.reject(t);throw t}}},ne=new sd;function I(n,e){return ne.parse(n,e)}I.options=I.setOptions=function(n){return ne.setOptions(n),I.defaults=ne.defaults,Ya(I.defaults),I};I.getDefaults=So;I.defaults=ee;I.use=function(...n){return ne.use(...n),I.defaults=ne.defaults,Ya(I.defaults),I};I.walkTokens=function(n,e){return ne.walkTokens(n,e)};I.parseInline=ne.parseInline;I.Parser=xn;I.parser=xn.parse;I.Renderer=Xt;I.TextRenderer=qo;I.Lexer=gn;I.lexer=gn.lex;I.Tokenizer=Yt;I.Hooks=Me;I.parse=I;var{options:ap,setOptions:lp,use:rp,walkTokens:dp,parseInline:hp}=I;var cp=xn.parse,pp=gn.lex;function nl(n,e){if(e==null)e="";else if(typeof e!=="string")e=String(e);return e.replace(/\{\{([^}]+)\}\}/g,(t,i)=>{let o=Q[`${n}${i.startsWith("[")?i:"."+i}`];return o===void 0?t:nl(n,String(o))})}class $t extends f{static preferredTagName="tosi-md";static initAttributes={src:"",elements:!1};context={};value="";content=null;options={};connectedCallback(){if(super.connectedCallback(),this.src!=="")(async()=>{let n=await fetch(this.src);this.value=await n.text()})();else if(this.value==="")if(this.elements)this.value=this.innerHTML;else this.value=this.textContent!=null?this.textContent:""}didRender=()=>{};render(){super.render(),Q[this.instanceId]=typeof this.context==="string"?JSON.parse(this.context):this.context;let n=nl(this.instanceId,this.value);if(this.elements){let e=n.split(`
...
//# debugId=9B66CD20DF6E636464756E2164756E21
