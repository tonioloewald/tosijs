var Ts=Object.create;var{getPrototypeOf:Es,defineProperty:Ft,getOwnPropertyNames:Is}=Object;var Bs=Object.prototype.hasOwnProperty;var Ps=(n,t,e)=>{e=n!=null?Ts(Es(n)):{};let a=t||!n||!n.__esModule?Ft(e,"default",{value:n,enumerable:!0}):e;for(let o of Is(n))if(!Bs.call(a,o))Ft(a,o,{get:()=>n[o],enumerable:!0});return a};var Ta=(n,t)=>{for(var e in t)Ft(n,e,{get:t[e],enumerable:!0,configurable:!0,set:(a)=>t[e]=()=>a})};var lt=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(t,e)=>(typeof require<"u"?require:t)[e]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Jn={};Ta(Jn,{xinValue:()=>M,xinProxy:()=>ro,xinPath:()=>Pn,xin:()=>L,version:()=>yt,vars:()=>l,varDefault:()=>h,updates:()=>Ms,unobserve:()=>In,touchElement:()=>ye,touch:()=>un,tosi:()=>U,throttle:()=>Un,svgElements:()=>bt,settings:()=>ct,on:()=>Mn,observe:()=>gt,mathML:()=>so,makeComponent:()=>xe,invertLuminance:()=>pe,initVars:()=>Qs,hotReload:()=>we,getListItem:()=>mn,getListInstance:()=>ge,getListBinding:()=>be,getCssVar:()=>Qa,elements:()=>m,deleteListItem:()=>pi,debounce:()=>mt,css:()=>Yn,boxedProxy:()=>ve,boxed:()=>ut,blueprintLoader:()=>vi,blueprint:()=>wi,bindings:()=>J,bind:()=>O,StyleSheet:()=>$n,MoreMath:()=>$s,Component:()=>b,Color:()=>f,BlueprintLoader:()=>ke,Blueprint:()=>ft});function hn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(hn);let t={};for(let e in n){let a=n[e];if(n!=null&&typeof n==="object")t[e]=hn(a);else t[e]=a}return t}var Xa="-xin-data",Bn=`.${Xa}`,qa="-xin-event",Ea=`.${qa}`,q="xinPath",En="xinValue",Ia="xinObserve",Ba="xinBind",Pa="xinOn",ne=Symbol("list-binding"),te=Symbol("list-instance"),Pn=(n)=>{return n&&n[q]||void 0};function M(n){return typeof n==="object"&&n!==null?n[En]||n:n}var Xn=new WeakMap,pn=new WeakMap,qn=(n)=>{let t=n.cloneNode();if(t instanceof Element){let e=pn.get(n),a=Xn.get(n);if(e!=null)pn.set(t,hn(e));if(a!=null)Xn.set(t,hn(a))}for(let e of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(e instanceof Element||e instanceof DocumentFragment)t.appendChild(qn(e));else t.appendChild(e.cloneNode());return t},ct={debug:!1,perf:!1},Ma=Symbol("observer should be removed"),ht=[],pt=[],ee=!1,ae,oe;class Ua{description;test;callback;constructor(n,t){let e=typeof t==="string"?`"${t}"`:`function ${t.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${e}`,typeof t==="function")this.callback=t;else throw Error("expect callback to be a path or function");ht.push(this)}}var Ms=async()=>{if(ae===void 0)return;await ae},Ls=()=>{if(ct.perf)console.time("xin async update");let n=Array.from(pt);for(let t of n)ht.filter((e)=>{let a;try{a=e.test(t)}catch(o){throw Error(`Listener ${e.description} threw "${o}" at "${t}"`)}if(a===Ma)return In(e),!1;return a}).forEach((e)=>{let a;try{a=e.callback(t)}catch(o){console.error(`Listener ${e.description} threw "${o}" handling "${t}"`)}if(a===Ma)In(e)});if(pt.splice(0),ee=!1,typeof oe==="function")oe();if(ct.perf)console.timeEnd("xin async update")},un=(n)=>{let t=typeof n==="string"?n:Pn(n);if(t===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(ee===!1)ae=new Promise((e)=>{oe=e}),ee=setTimeout(Ls);if(pt.find((e)=>t.startsWith(e))==null)pt.push(t)},Nn=(n,t)=>{return new Ua(n,t)},In=(n)=>{let t=ht.indexOf(n);if(t>-1)ht.splice(t,1);else throw Error("unobserve failed, listener not found")},ce={},se=null,Ds=(n)=>{se=n},he=()=>{if(se===null)throw Error("xin proxy not initialized");return se},ie=null,re=null,As=(n,t)=>{ie=n,re=t},Yt=()=>{if(ie===null)throw Error("bind not initialized");return ie},Gt=()=>{if(re===null)throw Error("on not initialized");return re},Fa=(n,t)=>{let e=new Event(t);n.dispatchEvent(e)},Ya=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Os=(n,t)=>{switch(Ya(n)){case"radio":n.checked=n.value===t;break;case"checkbox":n.checked=!!t;break;case"date":n.valueAsDate=new Date(t);break;case"multi-select":for(let e of Array.from(n.querySelectorAll("option")))e.selected=t[e.value];break;default:n.value=t}},zs=(n)=>{switch(Ya(n)){case"radio":{let t=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return t!=null?t.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((t,e)=>{return t[e.value]=e.selected,t},{});default:return n.value}},{ResizeObserver:La}=globalThis,le=La!=null?new La((n)=>{for(let t of n){let e=t.target;Fa(e,"resize")}}):{observe(){},unobserve(){}},Da=(n,t,e=!0)=>{if(n!=null&&t!=null)if(typeof t==="string")n.textContent=t;else if(Array.isArray(t))t.forEach((a)=>{n.append(a instanceof Node&&e?qn(a):a)});else if(t instanceof Node)n.append(e?qn(t):t);else throw Error("expect text content or document node")},mt=(n,t=250)=>{let e;return(...a)=>{if(e!==void 0)clearTimeout(e);e=setTimeout(()=>{n(...a)},t)}},Un=(n,t=250)=>{let e,a=Date.now()-t,o=!1;return(...s)=>{if(clearTimeout(e),e=setTimeout(()=>{n(...s),a=Date.now()},t),!o&&Date.now()-a>=t){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},_s=(n)=>{try{return JSON.stringify(n)}catch(t){return"{has circular references}"}},Ga=(...n)=>Error(n.map(_s).join(" ")),Hs=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Rs=0,Vs=()=>(parseInt("10000",36)+ ++Rs).toString(36).slice(-5),Ns=()=>Hs()+Vs(),de=Symbol("delete"),$a=Symbol("new-object"),$t=Symbol("automatic-index");function Ja(n){if(n==="")return[];if(Array.isArray(n))return n;else{let t=[];while(n.length>0){let e=n.search(/\[[^\]]+\]/);if(e===-1){t.push(n.split("."));break}else{let a=n.slice(0,e);if(n=n.slice(e),a!=="")t.push(a.split("."));if(e=n.indexOf("]")+1,t.push(n.slice(1,e-1)),n.slice(e,e+1)===".")e+=1;n=n.slice(e)}}return t}}var $=new WeakMap;function Ka(n,t){if($.get(n)===void 0)$.set(n,{});if($.get(n)[t]===void 0)$.get(n)[t]={};let e=$.get(n)[t];if(t==="_auto_")n.forEach((a,o)=>{if(a[$t]===void 0)a[$t]=Ns();e[a[$t]+""]=o});else n.forEach((a,o)=>{e[Fn(a,t)+""]=o});return e}function Ws(n,t){if($.get(n)===void 0||$.get(n)[t]===void 0)return Ka(n,t);else return $.get(n)[t]}function Xs(n,t,e){e=e+"";let a=Ws(n,t)[e];if(a===void 0||Fn(n[a],t)+""!==e)a=Ka(n,t)[e];return a}function qs(n,t,e){if(n[t]===void 0&&e!==void 0)n[t]=e;return n[t]}function Za(n,t,e,a){let o=t!==""?Xs(n,t,e):e;if(a===de)return n.splice(o,1),$.delete(n),Symbol("deleted");else if(a===$a){if(t===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(t!==""&&Fn(a,t)+""===e+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${t}=${e}]`);return n[o]}function Aa(n){if(!Array.isArray(n))throw Ga("setByPath failed: expected array, found",n)}function Oa(n){if(n==null||!(n instanceof Object))throw Ga("setByPath failed: expected Object, found",n)}function Fn(n,t){let e=Ja(t),a=n,o,s,i,r;for(o=0,s=e.length;a!==void 0&&o<s;o++){let d=e[o];if(Array.isArray(d))for(i=0,r=d.length;a!==void 0&&i<r;i++){let c=d[i];a=a[c]}else if(a.length===0){if(a=a[Number(d.slice(1))],d[0]!=="=")return}else if(d.includes("=")){let[c,...p]=d.split("=");a=Za(a,c,p.join("="))}else i=parseInt(d,10),a=a[i]}return a}function Us(n,t,e){let a=n;if(t==="")throw Error("setByPath cannot be used to set the root object");let o=Ja(t);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)Oa(a);else Aa(a);let r=s.slice(0,i),d=s.slice(i+1);if(a=Za(a,r,d,o.length>0?$a:e),o.length===0)return!0}else{Aa(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(e!==de){if(a[r]===e)return!1;a[r]=e}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){Oa(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=qs(a,i,s.length>0?{}:[]);else{if(e!==de){if(a[i]===e)return!1;a[i]=e}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${t}`)}throw Error(`setByPath(${n}, ${t}, ${e}) failed`)}var J={value:{toDOM:Os,fromDOM(n){return zs(n)}},text:{toDOM(n,t){n.textContent=t}},enabled:{toDOM(n,t){n.disabled=!t}},disabled:{toDOM(n,t){n.disabled=Boolean(t)}},list:{toDOM(n,t,e){be(n,t,e).update(t)}}};function tn(n){return n.replace(/[A-Z]/g,(t)=>{return`-${t.toLocaleLowerCase()}`})}function Fs(n){return n.replace(/-([a-z])/g,(t,e)=>{return e.toLocaleUpperCase()})}var Ys=180/Math.PI,Gs=Math.PI/180;function X(n,t,e){return e<n?NaN:t<n?n:t>e?e:t}function Z(n,t,e,a=!0){if(a)e=X(0,e,1);return e*(t-n)+n}var $s={RADIANS_TO_DEGREES:Ys,DEGREES_TO_RADIANS:Gs,clamp:X,lerp:Z};function Qa(n,t=document.body){let e=getComputedStyle(t);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return e.getPropertyValue(n).trim()}var Js=(n,t,e)=>{return(0.299*n+0.587*t+0.114*e)/255},ln=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class no{h;s;l;constructor(n,t,e){n/=255,t/=255,e/=255;let a=Math.max(n,t,e),o=a-Math.min(n,t,e),s=o!==0?a===n?(t-e)/o:a===t?2+(e-n)/o:4+(n-t)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var Tn=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class f{r;g;b;a;static fromVar(n,t=document.body){return f.fromCss(Qa(n,t))}static fromCss(n){let t=n;if(Tn instanceof HTMLSpanElement)Tn.style.color="black",Tn.style.color=n,document.body.appendChild(Tn),t=getComputedStyle(Tn).color,Tn.remove();let[e,a,o,s]=t.match(/[\d.]+/g)||["0","0","0","0"],i=t.startsWith("color(srgb")?255:1;return new f(Number(e)*i,Number(a)*i,Number(o)*i,s==null?1:Number(s))}static fromHsl(n,t,e,a=1){let o,s,i;if(t===0)o=s=i=e;else{let d=(g,v,w)=>{if(w<0)w+=1;if(w>1)w-=1;if(w<0.16666666666666666)return g+(v-g)*6*w;if(w<0.5)return v;if(w<0.6666666666666666)return g+(v-g)*(0.6666666666666666-w)*6;return g},c=e<0.5?e*(1+t):e+t-e*t,p=2*e-c,u=(n%360+360)%360/360;o=d(p,c,u+0.3333333333333333),s=d(p,c,u),i=d(p,c,u-0.3333333333333333)}let r=new f(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:t,l:e},r}static black=new f(0,0,0);static white=new f(255,255,255);constructor(n,t,e,a=1){this.r=X(0,n,255),this.g=X(0,t,255),this.b=X(0,e,255),this.a=X(0,a,1)}get inverse(){return new f(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:t,l:e}=this._hsl;return f.fromHsl(n,t,1-e,this.a)}get opaque(){return this.a===1?this:new f(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?f.black:f.white,n)}get rgb(){let{r:n,g:t,b:e}=this;return`rgb(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)})`}get rgba(){let{r:n,g:t,b:e,a}=this;return`rgba(${n.toFixed(0)},${t.toFixed(0)},${e.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new no(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}%)`}get hsla(){let{h:n,s:t,l:e}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(t*100).toFixed(0)}% ${(e*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new f(n,n,n)}get brightness(){return Js(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+ln(this.r)+ln(this.g)+ln(this.b):"#"+ln(this.r)+ln(this.g)+ln(this.b)+ln(Math.floor(255*this.a))}brighten(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a+n*(1-a),1);return f.fromHsl(t,e,o,this.a)}darken(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,a*(1-n),1);return f.fromHsl(t,e,o,this.a)}saturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e+n*(1-e),1);return f.fromHsl(t,o,a,this.a)}desaturate(n){let{h:t,s:e,l:a}=this._hsl,o=X(0,e*(1-n),1);return f.fromHsl(t,o,a,this.a)}rotate(n){let{h:t,s:e,l:a}=this._hsl,o=(t+360+n)%360;return f.fromHsl(o,e,a,this.a)}opacity(n){let{h:t,s:e,l:a}=this._hsl;return f.fromHsl(t,e,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,t){return new f(Z(this.r,n.r,t),Z(this.g,n.g,t),Z(this.b,n.b,t),Z(this.a,n.a,t))}static blendHue(n,t,e){let a=(t-n+720)%360;if(a<180)return n+e*a;else return n-(360-a)*e}mix(n,t){let e=this._hsl,a=n._hsl;return f.fromHsl(e.s===0?a.h:a.s===0?e.h:f.blendHue(e.h,a.h,t),Z(e.s,a.s,t),Z(e.l,a.l,t),Z(this.a,n.a,t))}colorMix(n,t){return f.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(t*100).toFixed(0)}%)`)}}function $n(n,t){let e=m.style(Yn(t));e.id=n,document.head.append(e)}var Ks=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],to=(n,t)=>{if(typeof t==="number"&&!Ks.includes(n))t=`${t}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),t=`var(${n}-default, ${t})`;else n="--"+n.substring(1);return{prop:n,value:String(t)}},Zs=(n,t,e)=>{if(e===void 0)return"";if(e instanceof f)e=e.html;let a=to(t,e);return`${n}  ${a.prop}: ${a.value};`},eo=(n,t,e="")=>{let a=tn(n);if(typeof t==="object"&&!(t instanceof f)){let o=Object.keys(t).map((s)=>eo(s,t[s],`${e}  `)).join(`
`);return`${e}  ${n} {
${o}
${e}  }`}else return Zs(e,a,t)},Yn=(n,t="")=>{return Object.keys(n).map((e)=>{let a=n[e];if(typeof a==="string"){if(e==="@import")return`@import url('${a}');`;throw Error("top-level string value only allowed for `@import`")}let o=Object.keys(a).map((s)=>eo(s,a[s])).join(`
`);return`${t}${e} {
${o}
}`}).join(`

`)},Qs=(n)=>{console.warn("initVars is deprecated. Just use _ and __ prefixes instead.");let t={};for(let e of Object.keys(n)){let a=n[e],o=tn(e);t[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return t},pe=(n)=>{let t={};for(let e of Object.keys(n)){let a=n[e];if(a instanceof f)t[e]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))t[e]=f.fromCss(a).inverseLuminance}return t},h=new Proxy({},{get(n,t){if(n[t]===void 0){let e="--"+tn(t);n[t]=(a)=>`var(${e}, ${a})`}return n[t]}}),l=new Proxy({},{get(n,t){if(t==="default")return h;if(n[t]==null){t=tn(t);let[,e,,a,o,s]=t.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",t],i=`--${e}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(s){case"b":{let d=f.fromVar(i);n[t]=r>0?d.brighten(r).rgba:d.darken(-r).rgba}break;case"s":{let d=f.fromVar(i);n[t]=r>0?d.saturate(r).rgba:d.desaturate(-r).rgba}break;case"h":{let d=f.fromVar(i);n[t]=d.rotate(r*100).rgba}break;case"o":{let d=f.fromVar(i);n[t]=d.opacity(r).rgba}break;case"":n[t]=`calc(var(${i}) * ${r})`;break;default:throw console.error(s),Error(`Unrecognized method ${s} for css variable ${i}`)}}else n[t]=`var(${i})`}return n[t]}}),ni="http://www.w3.org/1998/Math/MathML",ti="http://www.w3.org/2000/svg",dt={},ao=(n,t,e)=>{let a=to(tn(t),e);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[t]=a.value},ei=(n)=>{return{toDOM(t,e){ao(t,n,e)}}},oo=(n,t,e)=>{if(t==="style")if(typeof e==="object")for(let a of Object.keys(e))if(Pn(e[a]))O(n,e[a],ei(a));else ao(n,a,e[a]);else n.setAttribute("style",e);else if(n[t]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(t,e);else n[t]=e}else{let a=tn(t);if(a==="class")e.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=e;else if(typeof e==="boolean")e?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,e)}},ai=(n)=>{return{toDOM(t,e){oo(t,n,e)}}},oi=(n,t,e)=>{if(t==="apply")e(n);else if(t.match(/^on[A-Z]/)!=null){let a=t.substring(2).toLowerCase();Mn(n,a,e)}else if(t==="bind")if((typeof e.binding==="string"?J[e.binding]:e.binding)!==void 0&&e.value!==void 0)O(n,e.value,e.binding instanceof Function?{toDOM:e.binding}:e.binding);else throw Error("bad binding");else if(t.match(/^bind[A-Z]/)!=null){let a=t.substring(4,5).toLowerCase()+t.substring(5),o=J[a];if(o!==void 0)O(n,e,o);else throw Error(`${t} is not allowed, bindings.${a} is not defined`)}else if(Pn(e))O(n,e,ai(t));else oo(n,t,e)},ue=(n,...t)=>{if(dt[n]===void 0){let[o,s]=n.split("|");if(s===void 0)dt[n]=globalThis.document.createElement(o);else dt[n]=globalThis.document.createElementNS(s,o)}let e=dt[n].cloneNode(),a={};for(let o of t)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(e instanceof HTMLTemplateElement)e.content.append(o);else e.append(o);else if(Pn(o))e.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let s=a[o];oi(e,o,s)}return e},me=(...n)=>{let t=globalThis.document.createDocumentFragment();for(let e of n)t.append(e);return t},m=new Proxy({fragment:me},{get(n,t){if(t=t.replace(/[A-Z]/g,(e)=>`-${e.toLocaleLowerCase()}`),n[t]===void 0)n[t]=(...e)=>ue(t,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),bt=new Proxy({fragment:me},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>ue(`${t}|${ti}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),so=new Proxy({fragment:me},{get(n,t){if(n[t]===void 0)n[t]=(...e)=>ue(`${t}|${ni}`,...e);return n[t]},set(){throw Error("You may not add new properties to elements")}}),si=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],ii=!0,ri=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,li=(n)=>ri.test(n),dn=(n="",t="")=>{if(n==="")return t;else if(t.match(/^\d+$/)!==null||t.includes("="))return`${n}[${t}]`;else return`${n}.${t}`},di={string(n){return new String(n)},boolean(n){return new Boolean(n)},bigint(n){return n},symbol(n){return n},number(n){return new Number(n)}},Q=Symbol("undefined");function Jt(n,t){if(n===void 0||n===null)return new Proxy({[Q]:n===null?"null":"undefined"},nn(t,!0));let e=typeof n;if(e==="object"||e==="function")return n;else return new Proxy(di[typeof n](n),nn(t,!0))}var Kt=()=>new Proxy({},nn("^",!0)),za=!1;function cn(){if(!za)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),za=!0}var _a=(n)=>{return n instanceof Number||n instanceof String||n instanceof Boolean||Q in n},nn=(n,t)=>({get(e,a){if(_a(e))switch(a){case"path":return n;case"value":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case"observe":return(i)=>{let r=Nn(n,i);return()=>In(r)};case"on":return(i,r)=>Gt()(i,r,M(e));case"bind":return(i,r,d)=>{Yt()(i,n,r,d)};case"binding":return(i)=>({bind:{value:n,binding:i}});case"listBinding":return(i=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(i(m,Kt()))];case En:case"tosiValue":return cn(),e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case q:case"tosiPath":return cn(),n;case Ia:case"tosiObserve":return cn(),(i)=>{let r=Nn(n,i);return()=>In(r)};case Pa:case"tosiOn":return cn(),(i,r)=>Gt()(i,r,M(e));case Ba:case"tosiBind":return cn(),(i,r,d)=>{Yt()(i,n,r,d)};case"tosiBinding":return cn(),(i)=>({bind:{value:n,binding:i}});case"tosiListBinding":return cn(),(i=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(i(m,Kt()))]}switch(a){case q:case"tosiPath":return n;case En:case"tosiValue":return e[Q]?e[Q]==="null"?null:void 0:e.valueOf?e.valueOf():e;case Ia:case"tosiObserve":return(i)=>{let r=Nn(n,i);return()=>In(r)};case Pa:case"tosiOn":return(i,r)=>Gt()(i,r,M(e));case Ba:case"tosiBind":return(i,r,d)=>{Yt()(i,n,r,d)};case"tosiBinding":return(i)=>({bind:{value:n,binding:i}});case"tosiListBinding":return(i=({span:d})=>d({bindText:"^"}),r={})=>[{bindList:{value:n,...r}},m.template(i(m,Kt()))]}if(typeof a==="symbol")return e[a];let o=a,s=o.match(/^([^.[]+)\.(.+)$/)??o.match(/^([^\]]+)(\[.+)/)??o.match(/^(\[[^\]]+\])\.(.+)$/)??o.match(/^(\[[^\]]+\])\[(.+)$/);if(s!==null){let[,i,r]=s,d=dn(n,i),c=Fn(e,i);return c!==null&&typeof c==="object"?new Proxy(c,nn(d,t))[r]:c}if(o.startsWith("[")&&o.endsWith("]"))o=o.substring(1,o.length-1);if(!Array.isArray(e)&&e[o]!==void 0||Array.isArray(e)&&o.includes("=")){let i;if(o.includes("=")){let[r,d]=o.split("=");i=e.find((c)=>`${Fn(c,r)}`===d)}else i=e[o];if(i instanceof Object){let r=dn(n,o);return new Proxy(i instanceof Function?i.bind(e):i,nn(r,t))}else return t?Jt(i,dn(n,o)):i}else if(Array.isArray(e)){let i=e[o];return typeof i==="function"?(...r)=>{let d=i.apply(e,r);if(si.includes(o))un(n);return d}:typeof i==="object"?new Proxy(i,nn(dn(n,o),t)):t?Jt(i,dn(n,o)):i}else return t?Jt(e[o],dn(n,o)):e[o]},set(e,a,o){o=M(o);let s=a===En||a==="value"&&_a(e)?n:dn(n,a);if(ii&&!li(s))throw Error(`setting invalid path ${s}`);if(M(L[s])!==o&&Us(ce,s,o))un(s);return!0}}),gt=(n,t)=>{let e=typeof t==="function"?t:L[t];if(typeof e!=="function")throw Error(`observe expects a function or path to a function, ${t} is neither`);return Nn(n,e)},L=new Proxy(ce,nn("",!1));Ds(L);var ut=new Proxy(ce,nn("",!0)),ci=16,hi=100;function Ha(n,t){let e=Array.from(n.querySelectorAll(Bn));if(n.matches(Bn))e.unshift(n);for(let a of e){let o=pn.get(a);for(let s of o){if(s.path.startsWith("^"))s.path=`${t}${s.path.substring(1)}`;if(s.binding.toDOM!=null)s.binding.toDOM(a,L[s.path])}}}class io{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,t,e={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=qn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=e,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),e.virtual!=null)if(le.observe(this.boundElement),this._update=Un(()=>{this.update(this.array,!0)},ci),this.boundElement.addEventListener("resize",this._update),e.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}visibleSlice(){let{virtual:n,hiddenProp:t,visibleProp:e}=this.options,a=this.array;if(t!==void 0)a=a.filter((d)=>d[t]!==!0);if(e!==void 0)a=a.filter((d)=>d[e]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,s=a.length-1,i=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let d=this.boundElement.offsetWidth,c=n.scrollContainer==="window",p,u;if(c){p=window.innerHeight;let z=this.boundElement.getBoundingClientRect();u=Math.max(0,-z.top)}else p=this.boundElement.offsetHeight,u=this.boundElement.scrollTop;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(d/n.width)):1;let g=Math.ceil(p/n.height)+(n.rowChunkSize||1),v=Math.ceil(a.length/n.visibleColumns),w=n.visibleColumns*g,j=Math.floor(u/n.height);if(j>v-g+1)j=Math.max(0,v-g+1);if(n.rowChunkSize)j-=j%n.rowChunkSize;o=j*n.visibleColumns,s=o+w-1,i=j*n.height,r=Math.max((v-g)*n.height-i,0)}return{items:a,firstItem:o,lastItem:s,topBuffer:i,bottomBuffer:r}}needle;filter=Un((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},hi);update(n,t){if(n==null)n=[];this.array=n;let{hiddenProp:e,visibleProp:a}=this.options,o=Pn(n),s=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",s.items.length===0);let i=this._previousSlice,{firstItem:r,lastItem:d,topBuffer:c,bottomBuffer:p}=s;if(e===void 0&&a===void 0&&t===!0&&i!=null&&r===i.firstItem&&d===i.lastItem)return;this._previousSlice=s;let u=0,g=0,v=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let C=T[te];if(C==null)T.remove();else{let S=s.items.indexOf(C);if(S<r||S>d)T.remove(),this.itemToElement.delete(C),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(p)+"px";let w=[],{idPath:j}=this.options;for(let T=r;T<=d;T++){let C=s.items[T];if(C===void 0)continue;let S=this.itemToElement.get(M(C));if(S==null){if(v++,S=qn(this.template),typeof C==="object")this.itemToElement.set(M(C),S),S[te]=M(C);if(this.boundElement.insertBefore(S,this.listBottom),j!=null){let P=C[j],Sn=`${o}[${j}=${P}]`;Ha(S,Sn)}else{let P=`${o}[${T}]`;Ha(S,P)}}w.push(S)}let z=null;for(let T of w){if(T.previousElementSibling!==z)if(g++,z?.nextElementSibling!=null)this.boundElement.insertBefore(T,z.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);z=T}if(ct.perf)console.log(o,"updated",{removed:u,created:v,moved:g})}}var be=(n,t,e)=>{let a=n[ne];if(t&&a===void 0)a=new io(n,t,e),n[ne]=a;return a},ge=(n)=>{let t;while(!(t=n[te])&&n&&n.parentElement)n=n.parentElement;return t?{element:n,item:t}:void 0},mn=(n)=>{let t=ge(n);return t?t.item:void 0},pi=(n)=>{let t=ge(n);if(!t)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let e=be(t.element.parentElement);if(!e.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,e),!1;let a=e.array.indexOf(t.item);if(a>-1)return e.array.splice(a,1),!0;return!1},{document:Gn,MutationObserver:Ra}=globalThis,ye=(n,t)=>{let e=pn.get(n);if(e==null)return;for(let a of e){let{binding:o,options:s}=a,{path:i}=a,{toDOM:r}=o;if(r!=null){if(i.startsWith("^")){let d=mn(n);if(d!=null&&d[q]!=null)i=a.path=`${d[q]}${i.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${i}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${i}`)}if(t==null||i.startsWith(t))r(n,he()[i],s)}}};if(Ra!=null)new Ra((n)=>{n.forEach((t)=>{Array.from(t.addedNodes).forEach((e)=>{if(e instanceof Element)Array.from(e.querySelectorAll(Bn)).forEach((a)=>ye(a))})})}).observe(Gn.body,{subtree:!0,childList:!0});Nn(()=>!0,(n)=>{let t=Array.from(Gn.querySelectorAll(Bn));for(let e of t)ye(e,n)});var Va=(n)=>{let t=n.target?.closest(Bn);while(t!=null){let e=pn.get(t);for(let a of e){let{binding:o,path:s}=a,{fromDOM:i}=o;if(i!=null){let r;try{r=i(t,a.options)}catch(d){throw console.error("Cannot get value from",t,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let d=he(),c=d[s];if(c==null)d[s]=r;else{let p=c[q]!=null?c[En]:c,u=r[q]!=null?r[En]:r;if(p!==u)d[s]=u}}}}t=t.parentElement.closest(Bn)}};if(globalThis.document!=null)Gn.body.addEventListener("change",Va,!0),Gn.body.addEventListener("input",Va,!0);function O(n,t,e,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof t==="object"&&t[q]===void 0&&a===void 0){let{value:r}=t;o=typeof r==="string"?r:r[q],a=t,delete a.value}else o=typeof t==="string"?t:t[q];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:s}=e;n.classList?.add(Xa);let i=pn.get(n);if(i==null)i=[],pn.set(n,i);if(i.push({path:o,binding:e,options:a}),s!=null&&!o.startsWith("^"))un(o);if(a?.filter&&a?.needle)O(n,a.needle,{toDOM(r,d){console.log({needle:d}),r[ne]?.filter(d)}});return n}var Na=new Set,ui=(n)=>{let t=n?.target?.closest(Ea),e=!1,a=new Proxy(n,{get(s,i){if(i==="stopPropagation")return()=>{n.stopPropagation(),e=!0};else{let r=s[i];return typeof r==="function"?r.bind(s):r}}}),o=new Set;while(!e&&t!=null){let s=Xn.get(t)[n.type]||o;for(let i of s){if(typeof i==="function")i(a);else{let r=he()[i];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${i}`)}if(e)continue}t=t.parentElement!=null?t.parentElement.closest(Ea):null}};function Mn(n,t,e){let a=Xn.get(n);if(n.classList.add(qa),a==null)a={},Xn.set(n,a);if(!a[t])a[t]=new Set;if(a[t].add(e),!Na.has(t))Na.add(t),Gn.body.addEventListener(t,ui,!0);return()=>{a[t].delete(e)}}As(O,Mn);var mi=0;function Zt(){return`custom-elt${(mi++).toString(36)}`}var Wa=0,Wn={};function bi(n,t){let e=Wn[n],a=Yn(t).replace(/:host\b/g,n);Wn[n]=e?e+`
`+a:a}function gi(n){if(Wn[n])document.head.append(m.style({id:n+"-component"},Wn[n]));delete Wn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Yn(n))}static elementCreator(n={}){let t=this;if(t._elementCreator==null){let{tag:e,styleSpec:a}=n,o=n!=null?e:null;if(o==null)if(typeof t.name==="string"&&t.name!==""){if(o=tn(t.name),o.startsWith("-"))o=o.slice(1)}else o=Zt();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Zt();while(customElements.get(o)!==void 0)o=Zt();if(t._tagName=o,a!==void 0)bi(o,a);window.customElements.define(o,this,n),t._elementCreator=m[o]}return t._elementCreator}initAttributes(...n){let t={},e={};new MutationObserver((a)=>{let o=!1;if(a.forEach((s)=>{o=!!(s.attributeName&&n.includes(Fs(s.attributeName)))}),o&&this.queueRender!==void 0)this.queueRender(!1)}).observe(this,{attributes:!0}),n.forEach((a)=>{t[a]=hn(this[a]);let o=tn(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof t[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof t[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(e[a]!==void 0)return e[a];else return t[a]},set(s){if(typeof t[a]==="boolean"){if(s!==this[a]){if(s)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof t[a]==="number"){if(s!==parseFloat(this[a]))this.setAttribute(o,s),this.queueRender()}else if(typeof s==="object"||`${s}`!==`${this[a]}`){if(s===null||s===void 0||typeof s==="object")this.removeAttribute(o);else this.setAttribute(o,s);this.queueRender(),e[a]=s}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let t=this.hasAttribute("value")?this.getAttribute("value"):hn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return t},set(e){if(t!==e)t=e,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(t,e){if(t[e]===void 0){let a=n.querySelector(`[part="${e}"]`);if(a==null)a=n.querySelector(e);if(a==null)throw Error(`elementRef "${e}" does not exist!`);a.removeAttribute("data-ref"),t[e]=a}return t[e]}});return this._parts}constructor(){super();Wa+=1,this.initAttributes("hidden"),this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Wa}`,this._value=hn(this.defaultValue)}connectedCallback(){if(gi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(le.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){le.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)Fa(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",t=typeof this.content==="function"?this.content(m):this.content,{styleSpec:e}=this.constructor,{styleNode:a}=this.constructor;if(e)a=this.constructor.styleNode=m.style(Yn(e)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),Da(o,t,n)}else if(t!==null){let o=Array.from(this.childNodes);Da(this,t,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let s=Array.from(this.querySelectorAll("slot"));if(s.length>0)s.forEach(fe.replaceSlot);if(o.length>0){let i={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{i[r.name]=r}),o.forEach((r)=>{let d=i[""],c=r instanceof Element?i[r.slot]:d;(c!==void 0?c:d).append(r)})}}this._hydrated=!0}}render(){}}class fe extends b{name="";content=null;static replaceSlot(n){let t=document.createElement("xin-slot");if(n.name!=="")t.setAttribute("name",n.name);n.replaceWith(t)}constructor(){super();this.initAttributes("name")}}var Gl=fe.elementCreator({tag:"xin-slot"}),we=(n=()=>!0)=>{let t=localStorage.getItem("xin-state");if(t!=null){let a=JSON.parse(t);for(let o of Object.keys(a).filter(n))if(L[o]!==void 0)Object.assign(L[o],a[o]);else L[o]=a[o]}let e=mt(()=>{let a={},o=M(L);for(let s of Object.keys(o).filter(n))a[s]=o[s];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);gt(n,e)},yt="1.0.10";function U(n){return Object.assign(ut,n),ut}function ve(n){return console.warn("boxedProxy is deprecated, please use tosi() instead"),U(n)}function ro(n,t=!1){if(t)return console.warn("xinProxy(..., true) is deprecated; use tosi(...) instead"),ve(n);return Object.keys(n).forEach((e)=>{L[e]=n[e]}),L}var yi={};async function xe(n,t){let{type:e,styleSpec:a}=await t(n,{Color:f,Component:b,elements:m,svgElements:bt,mathML:so,varDefault:h,vars:l,xin:L,boxed:ut,xinProxy:ro,boxedProxy:ve,tosi:U,makeComponent:xe,bind:O,on:Mn,version:yt}),o={type:e,creator:e.elementCreator({tag:n,styleSpec:a})};return yi[n]=o,o}var Qt={},fi=(n)=>import(n);class ft extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:t,property:e}=this,a=`${n}.${e}:${t}`;if(!this.loaded){if(Qt[a]===void 0)Qt[a]=fi(t).then((o)=>{let s=o[e];return xe(n,s)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await Qt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var wi=ft.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class ke extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(ft.tagName)).filter((t)=>t.src).map((t)=>t.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var vi=ke.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Sa={};Ta(Sa,{xrControllersText:()=>tl,xrControllers:()=>nl,xinTagList:()=>Hl,xinTag:()=>ws,xinSizer:()=>Al,xinSelect:()=>jn,xinSegmented:()=>Dl,xinRating:()=>xl,xinPasswordStrength:()=>vl,xinNotification:()=>us,xinMenu:()=>jr,xinLocalized:()=>Ht,xinForm:()=>Zr,xinFloat:()=>Ye,xinField:()=>Kr,xinCarousel:()=>hr,version:()=>Ca,updateLocalized:()=>ta,trackDrag:()=>on,tosijs:()=>Jn,tosiMonth:()=>bl,tosiDialog:()=>At,tabSelector:()=>hs,svgIcon:()=>rr,svg2DataUrl:()=>zt,styleSheet:()=>Uo,spacer:()=>_n,sizeBreak:()=>xa,sideNav:()=>wa,setLocale:()=>gr,scriptTag:()=>xn,richTextWidgets:()=>fs,richText:()=>Il,removeLastMenu:()=>Cn,postNotification:()=>fl,positionFloat:()=>Jo,popMenu:()=>G,popFloat:()=>$o,menu:()=>as,markdownViewer:()=>pa,mapBox:()=>pl,makeSorter:()=>Ko,makeExamplesLive:()=>dl,localize:()=>I,localePicker:()=>wr,liveExample:()=>Vt,isBreached:()=>bs,initLocalization:()=>fr,icons:()=>y,i18n:()=>E,gamepadText:()=>Qr,gamepadState:()=>cs,findHighestZ:()=>_t,filterPart:()=>Ot,filterBuilder:()=>Ur,elastic:()=>Sl,editableRect:()=>Vr,dragAndDrop:()=>ss,digest:()=>ms,defineIcons:()=>ir,dataTable:()=>Lr,createSubMenu:()=>ts,createMenuItem:()=>es,createMenuAction:()=>ns,commandButton:()=>W,colorInput:()=>Go,codeEditor:()=>Lt,bringToFront:()=>ot,bodymovinPlayer:()=>dr,blockStyle:()=>ga,b3d:()=>lr,availableFilters:()=>ra,abTest:()=>sr,XinTagList:()=>ja,XinTag:()=>Nt,XinSizer:()=>ka,XinSelect:()=>it,XinSegmented:()=>fa,XinRating:()=>ba,XinPasswordStrength:()=>ma,XinNotification:()=>kn,XinMenu:()=>oa,XinLocalized:()=>Y,XinForm:()=>st,XinFloat:()=>sn,XinField:()=>Rt,XinCarousel:()=>na,TosiMonth:()=>ua,TosiDialog:()=>ia,TabSelector:()=>ca,SvgIcon:()=>Ze,SizeBreak:()=>va,SideNav:()=>Rn,RichText:()=>ya,MarkdownViewer:()=>ha,MapBox:()=>vn,LocalePicker:()=>ea,LiveExample:()=>Hn,FilterPart:()=>la,FilterBuilder:()=>da,EditableRect:()=>V,DataTable:()=>sa,CodeEditor:()=>zn,BodymovinPlayer:()=>On,B3d:()=>Qe,AbTest:()=>An});function Ce(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var gn=Ce();function bo(n){gn=n}var nt={exec:()=>null};function k(n,t=""){let e=typeof n=="string"?n:n.source,a={replace:(o,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(D.caret,"$1"),e=e.replace(o,i),a},getRegex:()=>new RegExp(e,t)};return a}var D={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},xi=/^(?:[ \t]*(?:\n|$))+/,ki=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ji=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,tt=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ci=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Se=/(?:[*+-]|\d{1,9}[.)])/,go=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,yo=k(go).replace(/bull/g,Se).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Si=k(go).replace(/bull/g,Se).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Te=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ti=/^[^\n]+/,Ee=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ei=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Ee).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ii=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Se).getRegex(),jt="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ie=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Bi=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Ie).replace("tag",jt).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),fo=k(Te).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Pi=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",fo).getRegex(),Be={blockquote:Pi,code:ki,def:Ei,fences:ji,heading:Ci,hr:tt,html:Bi,lheading:yo,list:Ii,newline:xi,paragraph:fo,table:nt,text:Ti},lo=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex(),Mi={...Be,lheading:Si,table:lo,paragraph:k(Te).replace("hr",tt).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",lo).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",jt).getRegex()},Li={...Be,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ie).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:nt,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Te).replace("hr",tt).replace("heading",` *#{1,6} *[^
]`).replace("lheading",yo).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Di=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Ai=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,wo=/^( {2,}|\\)\n(?!\s*$)/,Oi=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ct=/[\p{P}\p{S}]/u,Pe=/[\s\p{P}\p{S}]/u,vo=/[^\s\p{P}\p{S}]/u,zi=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Pe).getRegex(),xo=/(?!~)[\p{P}\p{S}]/u,_i=/(?!~)[\s\p{P}\p{S}]/u,Hi=/(?:[^\s\p{P}\p{S}]|~)/u,Ri=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,ko=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Vi=k(ko,"u").replace(/punct/g,Ct).getRegex(),Ni=k(ko,"u").replace(/punct/g,xo).getRegex(),jo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Wi=k(jo,"gu").replace(/notPunctSpace/g,vo).replace(/punctSpace/g,Pe).replace(/punct/g,Ct).getRegex(),Xi=k(jo,"gu").replace(/notPunctSpace/g,Hi).replace(/punctSpace/g,_i).replace(/punct/g,xo).getRegex(),qi=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,vo).replace(/punctSpace/g,Pe).replace(/punct/g,Ct).getRegex(),Ui=k(/\\(punct)/,"gu").replace(/punct/g,Ct).getRegex(),Fi=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Yi=k(Ie).replace("(?:-->|$)","-->").getRegex(),Gi=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Yi).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),vt=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,$i=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",vt).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Co=k(/^!?\[(label)\]\[(ref)\]/).replace("label",vt).replace("ref",Ee).getRegex(),So=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Ee).getRegex(),Ji=k("reflink|nolink(?!\\()","g").replace("reflink",Co).replace("nolink",So).getRegex(),co=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Me={_backpedal:nt,anyPunctuation:Ui,autolink:Fi,blockSkip:Ri,br:wo,code:Ai,del:nt,emStrongLDelim:Vi,emStrongRDelimAst:Wi,emStrongRDelimUnd:qi,escape:Di,link:$i,nolink:So,punctuation:zi,reflink:Co,reflinkSearch:Ji,tag:Gi,text:Oi,url:nt},Ki={...Me,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",vt).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",vt).getRegex()},je={...Me,emStrongRDelimAst:Xi,emStrongLDelim:Ni,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",co).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",co).getRegex()},Zi={...je,br:k(wo).replace("{2,}","*").getRegex(),text:k(je.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},wt={normal:Be,gfm:Mi,pedantic:Li},Kn={normal:Me,gfm:je,breaks:Zi,pedantic:Ki},Qi={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ho=(n)=>Qi[n];function F(n,t){if(t){if(D.escapeTest.test(n))return n.replace(D.escapeReplace,ho)}else if(D.escapeTestNoEncode.test(n))return n.replace(D.escapeReplaceNoEncode,ho);return n}function po(n){try{n=encodeURI(n).replace(D.percentDecode,"%")}catch{return null}return n}function uo(n,t){let e=n.replace(D.findPipe,(s,i,r)=>{let d=!1,c=i;for(;--c>=0&&r[c]==="\\";)d=!d;return d?"|":" |"}),a=e.split(D.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),t)if(a.length>t)a.splice(t);else for(;a.length<t;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(D.slashPipe,"|");return a}function Zn(n,t,e){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let s=n.charAt(a-o-1);if(s===t&&!e)o++;else if(s!==t&&e)o++;else break}return n.slice(0,a-o)}function nr(n,t){if(n.indexOf(t[1])===-1)return-1;let e=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===t[0])e++;else if(n[a]===t[1]&&(e--,e<0))return a;return e>0?-2:-1}function mo(n,t,e,a,o){let s=t.href,i=t.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let d={type:n[0].charAt(0)==="!"?"image":"link",raw:e,href:s,title:i,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,d}function tr(n,t,e){let a=n.match(e.other.indentCodeCompensation);if(a===null)return t;let o=a[1];return t.split(`
...
${c}`:c,o=o?`${o}
${p}`:p;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(p,s,!0),this.lexer.state.top=u,e.length===0)break;let g=s.at(-1);if(g?.type==="code")break;if(g?.type==="blockquote"){let v=g,w=v.raw+`
`+e.join(`
`),j=this.blockquote(w);s[s.length-1]=j,a=a.substring(0,a.length-v.raw.length)+j.raw,o=o.substring(0,o.length-v.text.length)+j.text;break}else if(g?.type==="list"){let v=g,w=v.raw+`
`+e.join(`
`),j=this.list(w);s[s.length-1]=j,a=a.substring(0,a.length-g.raw.length)+j.raw,o=o.substring(0,o.length-v.raw.length)+j.raw,e=w.substring(s.at(-1).raw.length).split(`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];$n("demo-style",xs);var rn="tosijs";setTimeout(()=>{let n=f.fromVar(l.brandColor),t=f.fromVar(l.background);console.log(`welcome to %c${rn}`,`background: ${n.html}; color: ${t.html}; padding: 0 5px;`)},100);var Vl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Nl=Wt.find((n)=>n.filename===Vl)||Wt[0],{app:B,prefs:A}=U({app:{title:rn,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${rn}#readme`,npmUrl:`https://www.npmjs.com/package/${rn}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${rn}&badge=`,bundleUrl:`https://bundlejs.com/?q=${rn}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${rn}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${rn}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Wt,currentDoc:Nl,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});we((n)=>{if(n.startsWith("prefs"))return!0;return!1});J.docLink={toDOM(n,t){n.setAttribute("href",`?${t}`)}};J.current={toDOM(n,t){let e=n.getAttribute("href")||"";n.classList.toggle("current",t===e.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:U,img:qt,bindings:J,elements:m,vars:l,touch:un,Color:f})},1000);var ks=document.querySelector("main"),{h2:Wl,div:js,span:rt,a:Xt,img:qt,header:Xl,button:Cs,template:ql,input:Ul}=m;O(document.body,"prefs.theme",{toDOM(n,t){if(t==="system")t=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",t==="dark")}});O(document.body,A.highContrast,{toDOM(n,t){n.classList.toggle("high-contrast",t.valueOf())}});O(document.body,A.monochrome,{toDOM(n,t){n.classList.toggle("monochrome",t.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((t)=>t.filename.xinValue===n)||B.docs[0]});var Fl=mt(()=>{console.time("filter");let n=Ss.value.toLocaleLowerCase();B.docs.forEach((t)=>{t.hidden=!t.title.toLocaleLowerCase().includes(n)&&!t.text.toLocaleLowerCase().includes(n)}),un(B.docs),console.timeEnd("filter")}),Ss=Ul({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:Fl});if(ks)ks.append(Xl(Cs({class:"iconic",style:{color:l.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,t){n.style.display=t?"":"none",n.nextSibling.style.display=t?"":"none"}}},onClick(){let n=document.querySelector(Rn.tagName);n.contentVisible=!n.contentVisible}},y.menu()),rt({style:{flex:"0 0 10px"}}),Xt({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${yt}, tosijs-ui ${Ca}`},qt({src:"favicon.svg",style:{height:40,marginRight:10}}),Wl({bindText:"app.title"})),rt({class:"elastic"}),xa({minWidth:750},rt({style:{marginRight:l.spacing,display:"flex",alignItems:"center",gap:l.spacing50}},Xt({href:B.bundleUrl},qt({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),Xt({href:B.cdnUrl},qt({alt:"jsdelivr",src:B.cdnBadgeUrl}))),rt({slot:"small"})),rt({style:{flex:"0 0 10px"}}),Cs({title:"theme",class:"iconic",onClick(n){G({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.xinValue},{icon:"npm",caption:"npm",action:B.npmUrl.xinValue},{icon:"discord",caption:"discord",action:B.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return A.theme.xinValue==="system"},action(){A.theme.xinValue="system"}},{caption:"Dark",checked(){return A.theme.xinValue==="dark"},action(){A.theme.xinValue="dark"}},{caption:"Light",checked(){return A.theme.xinValue==="light"},action(){A.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return A.highContrast.xinValue},action(){A.highContrast.xinValue=!A.highContrast.xinValue}},{caption:"Monochrome",checked(){return A.monochrome.xinValue},action(){A.monochrome.xinValue=!A.monochrome.xinValue}}]}]})}},y.moreVertical())),wa({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Rn.tagName);B.compact.xinValue=n.compact}},Ss,js({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},ql(Xt({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let t=n.target.closest("a");if(!t)return;let e=mn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=t;window.history.pushState({href:o},"",o),B.currentDoc=e,n.preventDefault()}}))),js({style:{position:"relative",overflowY:"scroll",height:"100%"}},pa({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Hn.insertExamples(this,{tosijs:Jn,"tosijs-ui":Sa})}}))));

//# debugId=DD99F1146D48259164756E2164756E21
