var Ps=Object.defineProperty;var Ea=(n,e)=>{for(var t in e)Ps(n,t,{get:e[t],enumerable:!0,configurable:!0,set:(a)=>e[t]=()=>a})};var le=((n)=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(n,{get:(e,t)=>(typeof require<"u"?require:e)[t]}):n)(function(n){if(typeof require<"u")return require.apply(this,arguments);throw Error('Dynamic require of "'+n+'" is not supported')});var Gn={};Ea(Gn,{xinValue:()=>M,xinProxy:()=>mo,xinPath:()=>Mn,xin:()=>P,warnDeprecated:()=>$n,version:()=>xe,vars:()=>d,varDefault:()=>p,updates:()=>Ds,unobserve:()=>dn,touchElement:()=>vt,touch:()=>mn,tosiValue:()=>$a,tosiSetValue:()=>As,tosiPath:()=>pt,tosi:()=>U,throttle:()=>Fn,svgElements:()=>ve,settings:()=>ue,on:()=>Pn,observe:()=>we,mathML:()=>ho,makeComponent:()=>Ct,invertLuminance:()=>mt,initVars:()=>ei,hotReload:()=>xt,getListItem:()=>bn,getListInstance:()=>ft,getListBinding:()=>yt,getCssVar:()=>oo,elements:()=>m,deprecated:()=>ht,deleteListItem:()=>ui,debounce:()=>fe,css:()=>Un,boxedProxy:()=>kt,boxed:()=>ye,blueprintLoader:()=>ki,blueprint:()=>xi,bindings:()=>K,bind:()=>O,StyleSheet:()=>Jn,MoreMath:()=>Ks,Component:()=>b,Color:()=>f,BlueprintLoader:()=>jt,Blueprint:()=>ke});function cn(n){if(n==null||typeof n!=="object")return n;if(n instanceof Set)return new Set(n);else if(Array.isArray(n))return n.map(cn);let e={};for(let t in n){let a=n[t];if(n!=null&&typeof n==="object")e[t]=cn(a);else e[t]=a}return e}var Ua="-xin-data",Ln=`.${Ua}`,Ya="-xin-event",Ba=`.${Ya}`,F=Symbol.for("xin-path"),hn=Symbol.for("xin-value"),La="xinObserve",Ma="xinBind",Pa="xinOn",et=Symbol("list-binding"),tt=Symbol("list-instance"),Aa=new Set;function $n(n,e){if(!Aa.has(n))console.warn(e),Aa.add(n)}function ht(n,e){let t=!1;return(...a)=>{if(!t)console.warn(e),t=!0;return n(...a)}}var pt=(n)=>{return n&&n[F]||void 0};function $a(n){if(typeof n==="object"&&n!==null){let e=n[hn];return e!==void 0?e:n}return n}function As(n,e){if(pt(n)===void 0)throw Error("tosiSetValue requires a xin or boxed proxy");n[hn]=e}var Mn=ht(pt,"xinPath is deprecated. Use tosiPath instead."),M=ht($a,"xinValue is deprecated. Use tosiValue instead."),Xn=new WeakMap,un=new WeakMap,qn=(n)=>{let e=n.cloneNode();if(e instanceof Element){let t=un.get(n),a=Xn.get(n);if(t!=null)un.set(e,cn(t));if(a!=null)Xn.set(e,cn(a))}for(let t of Array.from(n instanceof HTMLTemplateElement?n.content.childNodes:n.childNodes))if(t instanceof Element||t instanceof DocumentFragment)e.appendChild(qn(t));else e.appendChild(t.cloneNode());return e},ue={debug:!1,perf:!1},Da=Symbol("observer should be removed"),me=[],be=[],at=!1,ot,st;class Ja{description;test;callback;constructor(n,e){let t=typeof e==="string"?`"${e}"`:`function ${e.name}`,a;if(typeof n==="string")this.test=(o)=>typeof o==="string"&&o!==""&&(n.startsWith(o)||o.startsWith(n)),a=`test = "${n}"`;else if(n instanceof RegExp)this.test=n.test.bind(n),a=`test = "${n.toString()}"`;else if(n instanceof Function)this.test=n,a=`test = function ${n.name}`;else throw Error("expect listener test to be a string, RegExp, or test function");if(this.description=`${a}, ${t}`,typeof e==="function")this.callback=e;else throw Error("expect callback to be a path or function");me.push(this)}}var Ds=async()=>{if(ot===void 0)return;await ot},Os=()=>{if(ue.perf)console.time("xin async update");let n=Array.from(be);for(let e of n)me.filter((t)=>{let a;try{a=t.test(e)}catch(o){throw Error(`Listener ${t.description} threw "${o}" at "${e}"`)}if(a===Da)return dn(t),!1;return a}).forEach((t)=>{let a;try{a=t.callback(e)}catch(o){console.error(`Listener ${t.description} threw "${o}" handling "${e}"`)}if(a===Da)dn(t)});if(be.splice(0),at=!1,typeof st==="function")st();if(ue.perf)console.timeEnd("xin async update")},mn=(n)=>{let e=typeof n==="string"?n:Mn(n);if(e===void 0)throw console.error("touch was called on an invalid target",n),Error("touch was called on an invalid target");if(at===!1)ot=new Promise((t)=>{st=t}),at=setTimeout(Os);if(be.find((t)=>e.startsWith(t))==null)be.push(e)},En=(n,e)=>{return new Ja(n,e)},dn=(n)=>{let e=me.indexOf(n);if(e>-1)me.splice(e,1);else throw Error("unobserve failed, listener not found")},ge={},it=null,zs=(n)=>{it=n},ut=()=>{if(it===null)throw Error("xin proxy not initialized");return it},rt=null,lt=null,_s=(n,e)=>{rt=n,lt=e},de=()=>{if(rt===null)throw Error("bind not initialized");return rt},ce=()=>{if(lt===null)throw Error("on not initialized");return lt},Ga=(n,e)=>{let t=new Event(e);n.dispatchEvent(t)},Ka=(n)=>{if(n instanceof HTMLInputElement)return n.type;else if(n instanceof HTMLSelectElement&&n.hasAttribute("multiple"))return"multi-select";else return"other"},Hs=(n,e)=>{switch(Ka(n)){case"radio":n.checked=n.value===e;break;case"checkbox":n.checked=!!e;break;case"date":n.valueAsDate=new Date(e);break;case"multi-select":for(let t of Array.from(n.querySelectorAll("option")))t.selected=e[t.value];break;default:n.value=e}},Rs=(n)=>{switch(Ka(n)){case"radio":{let e=n.parentElement?.querySelector(`[name="${n.name}"]:checked`);return e!=null?e.value:null}case"checkbox":return n.checked;case"date":return n.valueAsDate?.toISOString();case"multi-select":return Array.from(n.querySelectorAll("option")).reduce((e,t)=>{return e[t.value]=t.selected,e},{});default:return n.value}},{ResizeObserver:Oa}=globalThis,dt=Oa!=null?new Oa((n)=>{for(let e of n){let t=e.target;Ga(t,"resize")}}):{observe(){},unobserve(){}},za=(n,e,t=!0)=>{if(n!=null&&e!=null)if(typeof e==="string")n.textContent=e;else if(Array.isArray(e))e.forEach((a)=>{n.append(a instanceof Node&&t?qn(a):a)});else if(e instanceof Node)n.append(t?qn(e):e);else throw Error("expect text content or document node")},fe=(n,e=250)=>{let t;return(...a)=>{if(t!==void 0)clearTimeout(t);t=setTimeout(()=>{n(...a)},e)}},Fn=(n,e=250)=>{let t,a=Date.now()-e,o=!1;return(...s)=>{if(clearTimeout(t),t=setTimeout(()=>{n(...s),a=Date.now()},e),!o&&Date.now()-a>=e){o=!0;try{n(...s),a=Date.now()}finally{o=!1}}}},Vs=(n)=>{try{return JSON.stringify(n)}catch(e){return"{has circular references}"}},Za=(...n)=>Error(n.map(Vs).join(" ")),Ns=()=>new Date(parseInt("1000000000",36)+Date.now()).valueOf().toString(36).slice(1),Ws=0,Xs=()=>(parseInt("10000",36)+ ++Ws).toString(36).slice(-5),qs=()=>Ns()+Xs(),ct=Symbol("delete"),Qa=Symbol("new-object"),Ge=Symbol("automatic-index");function no(n){if(n==="")return[];if(Array.isArray(n))return n;else{let e=[];while(n.length>0){let t=n.search(/\[[^\]]+\]/);if(t===-1){e.push(n.split("."));break}else{let a=n.slice(0,t);if(n=n.slice(t),a!=="")e.push(a.split("."));if(t=n.indexOf("]")+1,e.push(n.slice(1,t-1)),n.slice(t,t+1)===".")t+=1;n=n.slice(t)}}return e}}var G=new WeakMap;function eo(n,e){if(G.get(n)===void 0)G.set(n,{});if(G.get(n)[e]===void 0)G.get(n)[e]={};let t=G.get(n)[e];if(e==="_auto_")n.forEach((a,o)=>{if(a[Ge]===void 0)a[Ge]=qs();t[a[Ge]+""]=o});else n.forEach((a,o)=>{t[Bn(a,e)+""]=o});return t}function Fs(n,e){if(G.get(n)===void 0||G.get(n)[e]===void 0)return eo(n,e);else return G.get(n)[e]}function Us(n,e,t){t=t+"";let a=Fs(n,e)[t];if(a===void 0||Bn(n[a],e)+""!==t)a=eo(n,e)[t];return a}function Ys(n,e,t){if(n[e]===void 0&&t!==void 0)n[e]=t;return n[e]}function to(n,e,t,a){let o=e!==""?Us(n,e,t):t;if(a===ct)return n.splice(o,1),G.delete(n),Symbol("deleted");else if(a===Qa){if(e===""&&n[o]===void 0)n[o]={}}else if(a!==void 0)if(o!==void 0)n[o]=a;else if(e!==""&&Bn(a,e)+""===t+"")n.push(a),o=n.length-1;else throw Error(`byIdPath insert failed at [${e}=${t}]`);return n[o]}function _a(n){if(!Array.isArray(n))throw Za("setByPath failed: expected array, found",n)}function Ha(n){if(n==null||!(n instanceof Object))throw Za("setByPath failed: expected Object, found",n)}function Bn(n,e){let t=no(e),a=n,o,s,i,r;for(o=0,s=t.length;a!==void 0&&o<s;o++){let l=t[o];if(Array.isArray(l))for(i=0,r=l.length;a!==void 0&&i<r;i++){let c=l[i];a=a[c]}else if(a.length===0){if(a=a[Number(l.slice(1))],l[0]!=="=")return}else if(l.includes("=")){let[c,...h]=l.split("=");a=to(a,c,h.join("="))}else i=parseInt(l,10),a=a[i]}return a}function $s(n,e,t){let a=n;if(e==="")throw Error("setByPath cannot be used to set the root object");let o=no(e);while(a!=null&&o.length>0){let s=o.shift();if(typeof s==="string"){let i=s.indexOf("=");if(i>-1){if(i===0)Ha(a);else _a(a);let r=s.slice(0,i),l=s.slice(i+1);if(a=to(a,r,l,o.length>0?Qa:t),o.length===0)return!0}else{_a(a);let r=parseInt(s,10);if(o.length>0)a=a[r];else{if(t!==ct){if(a[r]===t)return!1;a[r]=t}else a.splice(r,1);return!0}}}else if(Array.isArray(s)&&s.length>0){Ha(a);while(s.length>0){let i=s.shift();if(s.length>0||o.length>0)a=Ys(a,i,s.length>0?{}:[]);else{if(t!==ct){if(a[i]===t)return!1;a[i]=t}else{if(!Object.prototype.hasOwnProperty.call(a,i))return!1;delete a[i]}return!0}}}else throw Error(`setByPath failed, bad path ${e}`)}throw Error(`setByPath(${n}, ${e}, ${t}) failed`)}var K={value:{toDOM:Hs,fromDOM(n){return Rs(n)}},text:{toDOM(n,e){n.textContent=e}},enabled:{toDOM(n,e){n.disabled=!e}},disabled:{toDOM(n,e){n.disabled=Boolean(e)}},list:{toDOM(n,e,t){yt(n,e,t).update(e)}}};function q(n){return n.replace(/[A-Z]/g,(e)=>{return`-${e.toLocaleLowerCase()}`})}function ao(n){return n.replace(/-([a-z])/g,(e,t)=>{return t.toLocaleUpperCase()})}var Js=180/Math.PI,Gs=Math.PI/180;function X(n,e,t){return t<n?NaN:e<n?n:e>t?t:e}function Q(n,e,t,a=!0){if(a)t=X(0,t,1);return t*(e-n)+n}var Ks={RADIANS_TO_DEGREES:Js,DEGREES_TO_RADIANS:Gs,clamp:X,lerp:Q};function oo(n,e=document.body){let t=getComputedStyle(e);if(n.endsWith(")")&&n.startsWith("var("))n=n.slice(4,-1);return t.getPropertyValue(n).trim()}var Zs=(n,e,t)=>{return(0.299*n+0.587*e+0.114*t)/255},sn=(n)=>("00"+Math.round(Number(n)).toString(16)).slice(-2);class so{h;s;l;constructor(n,e,t){n/=255,e/=255,t/=255;let a=Math.max(n,e,t),o=a-Math.min(n,e,t),s=o!==0?a===n?(e-t)/o:a===e?2+(t-n)/o:4+(n-e)/o:0;this.h=60*s<0?60*s+360:60*s,this.s=o!==0?a<=0.5?o/(2*a-o):o/(2-(2*a-o)):0,this.l=(2*a-o)/2}}var In=globalThis.document!==void 0?globalThis.document.createElement("span"):void 0;class f{r;g;b;a;static fromVar(n,e=document.body){return f.fromCss(oo(n,e))}static fromCss(n){let e=n;if(In instanceof HTMLSpanElement)In.style.color="black",In.style.color=n,document.body.appendChild(In),e=getComputedStyle(In).color,In.remove();let[t,a,o,s]=e.match(/[\d.]+/g)||["0","0","0","0"],i=e.startsWith("color(srgb")?255:1;return new f(Number(t)*i,Number(a)*i,Number(o)*i,s==null?1:Number(s))}static fromHsl(n,e,t,a=1){let o,s,i;if(e===0)o=s=i=t;else{let l=(g,w,v)=>{if(v<0)v+=1;if(v>1)v-=1;if(v<0.16666666666666666)return g+(w-g)*6*v;if(v<0.5)return w;if(v<0.6666666666666666)return g+(w-g)*(0.6666666666666666-v)*6;return g},c=t<0.5?t*(1+e):t+e-t*e,h=2*t-c,u=(n%360+360)%360/360;o=l(h,c,u+0.3333333333333333),s=l(h,c,u),i=l(h,c,u-0.3333333333333333)}let r=new f(o*255,s*255,i*255,a);return r.hslCached={h:(n%360+360)%360,s:e,l:t},r}static black=new f(0,0,0);static white=new f(255,255,255);constructor(n,e,t,a=1){this.r=X(0,n,255),this.g=X(0,e,255),this.b=X(0,t,255),this.a=X(0,a,1)}get inverse(){return new f(255-this.r,255-this.g,255-this.b,this.a)}get inverseLuminance(){let{h:n,s:e,l:t}=this._hsl;return f.fromHsl(n,e,1-t,this.a)}get opaque(){return this.a===1?this:new f(this.r,this.g,this.b,1)}contrasting(n=1){return this.opaque.blend(this.brightness>0.5?f.black:f.white,n)}get rgb(){let{r:n,g:e,b:t}=this;return`rgb(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)})`}get rgba(){let{r:n,g:e,b:t,a}=this;return`rgba(${n.toFixed(0)},${e.toFixed(0)},${t.toFixed(0)},${a.toFixed(2)})`}get RGBA(){return[this.r/255,this.g/255,this.b/255,this.a]}get ARGB(){return[this.a,this.r/255,this.g/255,this.b/255]}hslCached;get _hsl(){if(this.hslCached==null)this.hslCached=new so(this.r,this.g,this.b);return this.hslCached}get hsl(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}%)`}get hsla(){let{h:n,s:e,l:t}=this._hsl;return`hsl(${n.toFixed(0)}deg ${(e*100).toFixed(0)}% ${(t*100).toFixed(0)}% / ${(this.a*100).toFixed(0)}%)`}get mono(){let n=this.brightness*255;return new f(n,n,n)}get brightness(){return Zs(this.r,this.g,this.b)}get html(){return this.toString()}toString(){return this.a===1?"#"+sn(this.r)+sn(this.g)+sn(this.b):"#"+sn(this.r)+sn(this.g)+sn(this.b)+sn(Math.floor(255*this.a))}brighten(n){let{h:e,s:t,l:a}=this._hsl,o=X(0,a+n*(1-a),1);return f.fromHsl(e,t,o,this.a)}darken(n){let{h:e,s:t,l:a}=this._hsl,o=X(0,a*(1-n),1);return f.fromHsl(e,t,o,this.a)}saturate(n){let{h:e,s:t,l:a}=this._hsl,o=X(0,t+n*(1-t),1);return f.fromHsl(e,o,a,this.a)}desaturate(n){let{h:e,s:t,l:a}=this._hsl,o=X(0,t*(1-n),1);return f.fromHsl(e,o,a,this.a)}rotate(n){let{h:e,s:t,l:a}=this._hsl,o=(e+360+n)%360;return f.fromHsl(o,t,a,this.a)}opacity(n){let{h:e,s:t,l:a}=this._hsl;return f.fromHsl(e,t,a,n)}swatch(){return console.log(`%c      %c ${this.html}, ${this.rgba}`,`background-color: ${this.html}`,"background-color: transparent"),this}blend(n,e){return new f(Q(this.r,n.r,e),Q(this.g,n.g,e),Q(this.b,n.b,e),Q(this.a,n.a,e))}static blendHue(n,e,t){let a=(e-n+720)%360;if(a<180)return n+t*a;else return n-(360-a)*t}mix(n,e){let t=this._hsl,a=n._hsl;return f.fromHsl(t.s===0?a.h:a.s===0?t.h:f.blendHue(t.h,a.h,e),Q(t.s,a.s,e),Q(t.l,a.l,e),Q(this.a,n.a,e))}colorMix(n,e){return f.fromCss(`color-mix(in hsl, ${this.html}, ${n.html} ${(e*100).toFixed(0)}%)`)}}function Jn(n,e){let t=m.style(Un(e));t.id=n,document.head.append(t)}var Qs=["animation-iteration-count","flex","flex-base","flex-grow","flex-shrink","opacity","order","tab-size","widows","z-index","zoom"],io=(n,e)=>{if(typeof e==="number"&&!Qs.includes(n))e=`${e}px`;if(n.startsWith("_"))if(n.startsWith("__"))n="--"+n.substring(2),e=`var(${n}-default, ${e})`;else n="--"+n.substring(1);return{prop:n,value:String(e)}},ni=(n,e,t)=>{if(t===void 0)return"";if(t instanceof f)t=t.html;let a=io(e,t);return`${n}  ${a.prop}: ${a.value};`},ro=(n,e,t="")=>{let a=q(n);if(typeof e==="object"&&!(e instanceof f)){let o=Object.keys(e).map((s)=>ro(s,e[s],`${t}  `)).join(`
`);return`${t}  ${n} {
${o}
...
`)},ei=(n)=>{$n("initVars","initVars is deprecated. Just use _ and __ prefixes instead.");let e={};for(let t of Object.keys(n)){let a=n[t],o=q(t);e[`--${o}`]=typeof a==="number"&&a!==0?String(a)+"px":a}return e},mt=(n)=>{let e={};for(let t of Object.keys(n)){let a=n[t];if(a instanceof f)e[t]=a.inverseLuminance;else if(typeof a==="string"&&a.match(/^(#[0-9a-fA-F]{3}|rgba?\(|hsla?\()/))e[t]=f.fromCss(a).inverseLuminance}return e},p=new Proxy({},{get(n,e){if(n[e]===void 0){let t="--"+q(e);n[e]=(a)=>`var(${t}, ${a})`}return n[e]}}),d=new Proxy({},{get(n,e){if(e==="default")return p;if(n[e]==null){e=q(e);let[,t,,a,o,s]=e.match(/^([-\w]*?)((_)?(\d+)(\w?))?$/)||["",e],i=`--${t}`;if(o!=null){let r=a==null?Number(o)/100:-Number(o)/100;switch(s){case"b":{let l=f.fromVar(i);n[e]=r>0?l.brighten(r).rgba:l.darken(-r).rgba}break;case"s":{let l=f.fromVar(i);n[e]=r>0?l.saturate(r).rgba:l.desaturate(-r).rgba}break;case"h":{let l=f.fromVar(i);n[e]=l.rotate(r*100).rgba}break;case"o":{let l=f.fromVar(i);n[e]=l.opacity(r).rgba}break;case"":n[e]=`calc(var(${i}) * ${r})`;break;default:throw console.error(s),Error(`Unrecognized method ${s} for css variable ${i}`)}}else n[e]=`var(${i})`}return n[e]}}),ti="http://www.w3.org/1998/Math/MathML",ai="http://www.w3.org/2000/svg",he={},lo=(n,e,t)=>{let a=io(q(e),t);if(a.prop.startsWith("--"))n.style.setProperty(a.prop,a.value);else n.style[e]=a.value},oi=(n)=>{return{toDOM(e,t){lo(e,n,t)}}},co=(n,e,t)=>{if(e==="style")if(typeof t==="object")for(let a of Object.keys(t))if(Mn(t[a]))O(n,t[a],oi(a));else lo(n,a,t[a]);else n.setAttribute("style",t);else if(n[e]!==void 0){let{MathMLElement:a}=globalThis;if(n instanceof SVGElement||a!==void 0&&n instanceof a)n.setAttribute(e,t);else n[e]=t}else{let a=q(e);if(a==="class")t.split(" ").forEach((o)=>{n.classList.add(o)});else if(n[a]!==void 0)n[a]=t;else if(typeof t==="boolean")t?n.setAttribute(a,""):n.removeAttribute(a);else n.setAttribute(a,t)}},si=(n)=>{return{toDOM(e,t){co(e,n,t)}}},ii=(n,e,t)=>{if(e==="apply")t(n);else if(e.match(/^on[A-Z]/)!=null){let a=e.substring(2).toLowerCase();Pn(n,a,t)}else if(e==="bind")if((typeof t.binding==="string"?K[t.binding]:t.binding)!==void 0&&t.value!==void 0)O(n,t.value,t.binding instanceof Function?{toDOM:t.binding}:t.binding);else throw Error("bad binding");else if(e.match(/^bind[A-Z]/)!=null){let a=e.substring(4,5).toLowerCase()+e.substring(5),o=K[a];if(o!==void 0)O(n,t,o);else throw Error(`${e} is not allowed, bindings.${a} is not defined`)}else if(Mn(t))O(n,t,si(e));else co(n,e,t)},bt=(n,...e)=>{if(he[n]===void 0){let[o,s]=n.split("|");if(s===void 0)he[n]=globalThis.document.createElement(o);else he[n]=globalThis.document.createElementNS(s,o)}let t=he[n].cloneNode(),a={};for(let o of e)if(o instanceof Element||o instanceof DocumentFragment||typeof o==="string"||typeof o==="number")if(t instanceof HTMLTemplateElement)t.content.append(o);else t.append(o);else if(Mn(o))t.append(m.span({bindText:o}));else Object.assign(a,o);for(let o of Object.keys(a)){let s=a[o];ii(t,o,s)}return t},gt=(...n)=>{let e=globalThis.document.createDocumentFragment();for(let t of n)e.append(t);return e},m=new Proxy({fragment:gt},{get(n,e){if(e=e.replace(/[A-Z]/g,(t)=>`-${t.toLocaleLowerCase()}`),n[e]===void 0)n[e]=(...t)=>bt(e,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),ve=new Proxy({fragment:gt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>bt(`${e}|${ai}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),ho=new Proxy({fragment:gt},{get(n,e){if(n[e]===void 0)n[e]=(...t)=>bt(`${e}|${ti}`,...t);return n[e]},set(){throw Error("You may not add new properties to elements")}}),ri=["sort","splice","copyWithin","fill","pop","push","reverse","shift","unshift"],li=!0,di=/^\.?([^.[\](),])+(\.[^.[\](),]+|\[\d+\]|\[[^=[\](),]*=[^[\]()]+\])*$/,ci=(n)=>di.test(n),rn=(n="",e="")=>{if(n==="")return e;else if(e.match(/^\d+$/)!==null||e.includes("="))return`${n}[${e}]`;else return`${n}.${e}`},po={};function Ke(n,e){if(n!==null&&(typeof n==="object"||typeof n==="function"))return n;return new Proxy(po,pn(e,!0))}var pe=()=>new Proxy({},pn("^",!0)),Ra=!1;function ln(){if(!Ra)console.warn("xinValue, tosiValue, xinPath, tosiPath, etc. are deprecated. Use value, path, observe, bind, on, binding, listBinding instead."),Ra=!0}var Va=(n)=>{return n===po},pn=(n,e)=>({get(t,a){if(Va(t)){let r=()=>Bn(ge,n);switch(a){case"path":return n;case"value":return r();case"valueOf":case"toJSON":return()=>r();case Symbol.toPrimitive:return(l)=>{let c=r();if(l==="number")return Number(c);if(l==="string")return String(c);return c};case"toString":return()=>String(r());case"observe":return(l)=>{let c=En(n,l);return()=>dn(c)};case"on":return(l,c)=>ce()(l,c,r());case"bind":return(l,c,h)=>{de()(l,n,c,h)};case"binding":return(l)=>({bind:{value:n,binding:l}});case"listBinding":return(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,pe()))];case hn:case"xinValue":case"tosiValue":return ln(),r();case F:case"xinPath":case"tosiPath":return ln(),n;case La:case"tosiObserve":return ln(),(l)=>{let c=En(n,l);return()=>dn(c)};case Pa:case"tosiOn":return ln(),(l,c)=>ce()(l,c,r());case Ma:case"tosiBind":return ln(),(l,c,h)=>{de()(l,n,c,h)};case"tosiBinding":return ln(),(l)=>({bind:{value:n,binding:l}});case"tosiListBinding":return ln(),(l=({span:h})=>h({bindText:"^"}),c={})=>[{bindList:{value:n,...c}},m.template(l(m,pe()))]}if(typeof a==="string"&&/^\d+$/.test(a)){let l=r();if(typeof l==="string")return l[parseInt(a,10)]}if(a==="length"){let l=r();if(typeof l==="string")return l.length}return}if(e&&!(a in t))switch(a){case"path":return n;case"value":return t.valueOf?t.valueOf():t;case"valueOf":case"toJSON":return()=>t.valueOf?t.valueOf():t;case"observe":return(r)=>{let l=En(n,r);return()=>dn(l)};case"on":return(r,l)=>ce()(r,l,M(t));case"bind":return(r,l,c)=>{de()(r,n,l,c)};case"binding":return(r)=>({bind:{value:n,binding:r}});case"listBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,pe()))]}switch(a){case F:case"xinPath":case"tosiPath":return n;case hn:case"xinValue":case"tosiValue":return t.valueOf?t.valueOf():t;case La:case"xinObserve":case"tosiObserve":return(r)=>{let l=En(n,r);return()=>dn(l)};case Pa:case"xinOn":case"tosiOn":return(r,l)=>ce()(r,l,M(t));case Ma:case"xinBind":case"tosiBind":return(r,l,c)=>{de()(r,n,l,c)};case"tosiBinding":return(r)=>({bind:{value:n,binding:r}});case"tosiListBinding":return(r=({span:c})=>c({bindText:"^"}),l={})=>[{bindList:{value:n,...l}},m.template(r(m,pe()))]}if(typeof a==="symbol")return t[a];let o=Object.getOwnPropertyDescriptor(t,a);if(o&&!o.configurable&&!o.writable&&"value"in o)return o.value;let s=a,i=s.match(/^([^.[]+)\.(.+)$/)??s.match(/^([^\]]+)(\[.+)/)??s.match(/^(\[[^\]]+\])\.(.+)$/)??s.match(/^(\[[^\]]+\])\[(.+)$/);if(i!==null){let[,r,l]=i,c=rn(n,r),h=Bn(t,r);return h!==null&&typeof h==="object"?new Proxy(h,pn(c,e))[l]:h}if(s.startsWith("[")&&s.endsWith("]"))s=s.substring(1,s.length-1);if(!Array.isArray(t)&&t[s]!==void 0||Array.isArray(t)&&s.includes("=")){let r;if(s.includes("=")){let[l,c]=s.split("=");r=t.find((h)=>`${Bn(h,l)}`===c)}else r=t[s];if(r instanceof Object){let l=rn(n,s);return new Proxy(r instanceof Function?r.bind(t):r,pn(l,e))}else return e?Ke(r,rn(n,s)):r}else if(Array.isArray(t)){let r=t[s];return typeof r==="function"?(...l)=>{let c=l.map((u)=>M(u)),h=r.apply(t,c);if(ri.includes(s))mn(n);return h}:typeof r==="object"?new Proxy(r,pn(rn(n,s),e)):e?Ke(r,rn(n,s)):r}else return e?Ke(t[s],rn(n,s)):t[s]},set(t,a,o){o=M(o);let s=a===hn||a==="xinValue"||a==="tosiValue"||a==="value"&&(Va(t)||e)?n:rn(n,a);if(li&&!ci(s))throw Error(`setting invalid path ${s}`);if(M(P[s])!==o&&$s(ge,s,o))mn(s);return!0}}),we=(n,e)=>{let t=typeof e==="function"?e:P[e];if(typeof t!=="function")throw Error(`observe expects a function or path to a function, ${e} is neither`);return En(n,t)},P=new Proxy(ge,pn("",!1));zs(P);var ye=new Proxy(ge,pn("",!0)),hi=16,pi=100;function Na(n,e){let t=Array.from(n.querySelectorAll(Ln));if(n.matches(Ln))t.unshift(n);for(let a of t){let o=un.get(a);for(let s of o){if(s.path.startsWith("^"))s.path=`${e}${s.path.substring(1)}`;if(s.binding.toDOM!=null)s.binding.toDOM(a,P[s.path])}}}class uo{boundElement;listTop;listBottom;template;options;itemToElement;array=[];_update;_previousSlice;static filterBoundObservers=new WeakMap;constructor(n,e,t={}){if(this.boundElement=n,this.itemToElement=new WeakMap,n.children.length!==1)throw Error("ListBinding expects an element with exactly one child element");if(n.children[0]instanceof HTMLTemplateElement){let a=n.children[0];if(a.content.children.length!==1)throw Error("ListBinding expects a template with exactly one child element");this.template=qn(a.content.children[0])}else this.template=n.children[0],this.template.remove();if(this.options=t,this.listTop=document.createElement("div"),this.listBottom=document.createElement("div"),this.listTop.classList.add("virtual-list-padding"),this.listBottom.classList.add("virtual-list-padding"),this.boundElement.append(this.listTop),this.boundElement.append(this.listBottom),t.virtual!=null)if(dt.observe(this.boundElement),this._update=Fn(()=>{this.update(this.array,!0)},hi),this.boundElement.addEventListener("resize",this._update),t.virtual.scrollContainer==="window")window.addEventListener("scroll",this._update),window.addEventListener("resize",this._update);else this.boundElement.addEventListener("scroll",this._update)}visibleSlice(){let{virtual:n,hiddenProp:e,visibleProp:t}=this.options,a=this.array;if(e!==void 0)a=a.filter((l)=>l[e]!==!0);if(t!==void 0)a=a.filter((l)=>l[t]===!0);if(this.options.filter&&this.needle!==void 0)a=this.options.filter(a,this.needle);let o=0,s=a.length-1,i=0,r=0;if(n!=null&&this.boundElement instanceof HTMLElement){let l=this.boundElement.offsetWidth,c=n.scrollContainer==="window",h,u;if(c){h=window.innerHeight;let z=this.boundElement.getBoundingClientRect();u=Math.max(0,-z.top)}else h=this.boundElement.offsetHeight,u=this.boundElement.scrollTop;if(n.visibleColumns==null)n.visibleColumns=n.width!=null?Math.max(1,Math.floor(l/n.width)):1;let g=Math.ceil(h/n.height)+(n.rowChunkSize||1),w=Math.ceil(a.length/n.visibleColumns),v=n.visibleColumns*g,C=Math.floor(u/n.height);if(C>w-g+1)C=Math.max(0,w-g+1);if(n.rowChunkSize)C-=C%n.rowChunkSize;o=C*n.visibleColumns,s=o+v-1,i=C*n.height,r=Math.max((w-g)*n.height-i,0)}return{items:a,firstItem:o,lastItem:s,topBuffer:i,bottomBuffer:r}}needle;filter=Fn((n)=>{if(this.needle!==n)this.needle=n,this.update(this.array)},pi);update(n,e){if(n==null)n=[];this.array=n;let{hiddenProp:t,visibleProp:a}=this.options,o=Mn(n),s=this.visibleSlice();this.boundElement.classList.toggle("-xin-empty-list",s.items.length===0);let i=this._previousSlice,{firstItem:r,lastItem:l,topBuffer:c,bottomBuffer:h}=s;if(t===void 0&&a===void 0&&e===!0&&i!=null&&r===i.firstItem&&l===i.lastItem)return;this._previousSlice=s;let u=0,g=0,w=0;for(let T of Array.from(this.boundElement.children)){if(T===this.listTop||T===this.listBottom)continue;let j=T[tt];if(j==null)T.remove();else{let S=s.items.indexOf(j);if(S<r||S>l)T.remove(),this.itemToElement.delete(j),u++}}this.listTop.style.height=String(c)+"px",this.listBottom.style.height=String(h)+"px";let v=[],{idPath:C}=this.options;for(let T=r;T<=l;T++){let j=s.items[T];if(j===void 0)continue;let S=this.itemToElement.get(M(j));if(S==null){if(w++,S=qn(this.template),typeof j==="object")this.itemToElement.set(M(j),S),S[tt]=M(j);if(this.boundElement.insertBefore(S,this.listBottom),C!=null){let L=j[C],Tn=`${o}[${C}=${L}]`;Na(S,Tn)}else{let L=`${o}[${T}]`;Na(S,L)}}v.push(S)}let z=null;for(let T of v){if(T.previousElementSibling!==z)if(g++,z?.nextElementSibling!=null)this.boundElement.insertBefore(T,z.nextElementSibling);else this.boundElement.insertBefore(T,this.listBottom);z=T}if(ue.perf)console.log(o,"updated",{removed:u,created:w,moved:g})}}var yt=(n,e,t)=>{let a=n[et];if(e&&a===void 0)a=new uo(n,e,t),n[et]=a;return a},ft=(n)=>{let e;while(!(e=n[tt])&&n&&n.parentElement)n=n.parentElement;return e?{element:n,item:e}:void 0},bn=(n)=>{let e=ft(n);return e?e.item:void 0},ui=(n)=>{let e=ft(n);if(!e)return console.error("deleteListItem failed, element is not part of a list instance",n),!1;let t=yt(e.element.parentElement);if(!t.options.idPath)return console.error("deleteListItem failed, list binding has no idPath",n.parentElement,t),!1;let a=t.array.indexOf(e.item);if(a>-1)return t.array.splice(a,1),!0;return!1},{document:Yn,MutationObserver:Wa}=globalThis,vt=(n,e)=>{let t=un.get(n);if(t==null)return;for(let a of t){let{binding:o,options:s}=a,{path:i}=a,{toDOM:r}=o;if(r!=null){if(i.startsWith("^")){let l=bn(n);if(l!=null&&l[F]!=null)i=a.path=`${l[F]}${i.substring(1)}`;else throw console.error(`Cannot resolve relative binding ${i}`,n,"is not part of a list"),Error(`Cannot resolve relative binding ${i}`)}if(e==null||i.startsWith(e))r(n,ut()[i],s)}}};if(Wa!=null)new Wa((n)=>{n.forEach((e)=>{Array.from(e.addedNodes).forEach((t)=>{if(t instanceof Element)Array.from(t.querySelectorAll(Ln)).forEach((a)=>vt(a))})})}).observe(Yn.body,{subtree:!0,childList:!0});En(()=>!0,(n)=>{let e=Array.from(Yn.querySelectorAll(Ln));for(let t of e)vt(t,n)});var Xa=(n)=>{let e=n.target?.closest(Ln);while(e!=null){let t=un.get(e);for(let a of t){let{binding:o,path:s}=a,{fromDOM:i}=o;if(i!=null){let r;try{r=i(e,a.options)}catch(l){throw console.error("Cannot get value from",e,"via",a),Error("Cannot obtain value fromDOM")}if(r!=null){let l=ut(),c=l[s];if(c==null)l[s]=r;else{let h=c[F]!=null?c[hn]:c,u=r[F]!=null?r[hn]:r;if(h!==u)l[s]=u}}}}e=e.parentElement.closest(Ln)}};if(globalThis.document!=null)Yn.body.addEventListener("change",Xa,!0),Yn.body.addEventListener("input",Xa,!0);function O(n,e,t,a){if(n instanceof DocumentFragment)throw Error("bind cannot bind to a DocumentFragment");let o;if(typeof e==="object"&&e[F]===void 0&&a===void 0){let{value:r}=e;o=typeof r==="string"?r:r[F],a=e,delete a.value}else o=typeof e==="string"?e:e[F];if(o==null)throw Error("bind requires a path or object with xin Proxy");let{toDOM:s}=t;n.classList?.add(Ua);let i=un.get(n);if(i==null)i=[],un.set(n,i);if(i.push({path:o,binding:t,options:a}),s!=null&&!o.startsWith("^"))mn(o);if(a?.filter&&a?.needle)O(n,a.needle,{toDOM(r,l){console.log({needle:l}),r[et]?.filter(l)}});return n}var qa=new Set,mi=(n)=>{let e=n?.target?.closest(Ba),t=!1,a=new Proxy(n,{get(s,i){if(i==="stopPropagation")return()=>{n.stopPropagation(),t=!0};else{let r=s[i];return typeof r==="function"?r.bind(s):r}}}),o=new Set;while(!t&&e!=null){let s=Xn.get(e)[n.type]||o;for(let i of s){if(typeof i==="function")i(a);else{let r=ut()[i];if(typeof r==="function")r(a);else throw Error(`no event handler found at path ${i}`)}if(t)continue}e=e.parentElement!=null?e.parentElement.closest(Ba):null}};function Pn(n,e,t){let a=Xn.get(n);if(n.classList.add(Ya),a==null)a={},Xn.set(n,a);if(!a[e])a[e]=new Set;if(a[e].add(t),!qa.has(e))qa.add(e),Yn.body.addEventListener(e,mi,!0);return()=>{a[e].delete(t)}}_s(O,Pn);var bi=0;function Ze(){return`custom-elt${(bi++).toString(36)}`}var Fa=0,Qe=null;function gi(){if(Qe===null)Qe=new MutationObserver((n)=>{let e=new Set;for(let t of n)if(t.type==="attributes"&&t.target instanceof b){let a=t.target,o=ao(t.attributeName);if(a._legacyTrackedAttrs?.has(o))e.add(a)}for(let t of e)t.queueRender(!1)});return Qe}var Wn={};function yi(n,e){let t=Wn[n],a=Un(e).replace(/:host\b/g,n);Wn[n]=t?t+`
`+a:a}function fi(n){if(Wn[n])document.head.append(m.style({id:n+"-component"},Wn[n]));delete Wn[n]}class b extends HTMLElement{static elements=m;static _elementCreator;static initAttributes;static formAssociated;internals;static get observedAttributes(){let n=this.initAttributes;if(n)return["hidden",...Object.keys(n).map(q)];return["hidden"]}instanceId;styleNode;static styleSpec;static styleNode;content=m.slot();isSlotted;static _tagName=null;static get tagName(){return this._tagName}_legacyTrackedAttrs;_attrValues;static StyleNode(n){return console.warn("StyleNode is deprecated, just assign static styleSpec: XinStyleSheet to the class directly"),m.style(Un(n))}static elementCreator(n={}){let e=this;if(e._elementCreator==null){let{tag:t,styleSpec:a}=n,o=n!=null?t:null;if(o==null)if(typeof e.name==="string"&&e.name!==""){if(o=q(e.name),o.startsWith("-"))o=o.slice(1)}else o=Ze();if(customElements.get(o)!=null)console.warn(`${o} is already defined`);if(o.match(/\w+(-\w+)+/)==null)console.warn(`${o} is not a legal tag for a custom-element`),o=Ze();while(customElements.get(o)!==void 0)o=Ze();if(e._tagName=o,a!==void 0)yi(o,a);window.customElements.define(o,this,n),e._elementCreator=m[o]}return e._elementCreator}initAttributes(...n){if($n("initAttributes","initAttributes() is deprecated. Use static initAttributes = { ... } instead."),!this._legacyTrackedAttrs)this._legacyTrackedAttrs=new Set;for(let a of n)this._legacyTrackedAttrs.add(a);gi().observe(this,{attributes:!0});let e={},t={};n.forEach((a)=>{e[a]=cn(this[a]);let o=q(a);Object.defineProperty(this,a,{enumerable:!1,get(){if(typeof e[a]==="boolean")return this.hasAttribute(o);else if(this.hasAttribute(o))return typeof e[a]==="number"?parseFloat(this.getAttribute(o)):this.getAttribute(o);else if(t[a]!==void 0)return t[a];else return e[a]},set(s){if(typeof e[a]==="boolean"){if(s!==this[a]){if(s)this.setAttribute(o,"");else this.removeAttribute(o);this.queueRender()}}else if(typeof e[a]==="number"){if(s!==parseFloat(this[a]))this.setAttribute(o,s),this.queueRender()}else if(typeof s==="object"||`${s}`!==`${this[a]}`){if(s===null||s===void 0||typeof s==="object")this.removeAttribute(o);else this.setAttribute(o,s);this.queueRender(),t[a]=s}}})})}initValue(){let n=Object.getOwnPropertyDescriptor(this,"value");if(n===void 0||n.get!==void 0||n.set!==void 0)return;let e=this.hasAttribute("value")?this.getAttribute("value"):cn(this.value);delete this.value,Object.defineProperty(this,"value",{enumerable:!1,get(){return e},set(t){if(e!==t)e=t,this.queueRender(!0)}})}_parts;get parts(){let n=this.shadowRoot!=null?this.shadowRoot:this;if(this._parts==null)this._parts=new Proxy({},{get(e,t){if(e[t]===void 0){let a=n.querySelector(`[part="${t}"]`);if(a==null)a=n.querySelector(t);if(a==null)throw Error(`elementRef "${t}" does not exist!`);a.removeAttribute("data-ref"),e[t]=a}return e[t]}});return this._parts}attributeChangedCallback(n,e,t){let a=ao(n);if(!this._legacyTrackedAttrs?.has(a))this.queueRender(!1)}constructor(){super();if(Fa+=1,this.constructor.formAssociated&&typeof this.attachInternals==="function")this.internals=this.attachInternals();let n=this.constructor.initAttributes;if(n)this._setupAttributeAccessors(n);this.instanceId=`${this.tagName.toLocaleLowerCase()}-${Fa}`,this._value=cn(this.defaultValue)}_setupAttributeAccessors(n){if(!this._attrValues)this._attrValues=new Map;for(let e of Object.keys(n)){let t=q(e),a=n[e];if(typeof a==="object"&&a!==null){console.warn(`${this.tagName}: initAttributes.${e} is an object. Use a regular property instead.`);continue}let o=this,s=!1;while(o){let i=Object.getOwnPropertyDescriptor(o,e);if(i){if(!i.configurable||i.get||i.set){s=!0;break}break}o=Object.getPrototypeOf(o)}if(s)continue;Object.defineProperty(this,e,{enumerable:!1,get:()=>{if(typeof a==="boolean")return this.hasAttribute(t);else if(this.hasAttribute(t))return typeof a==="number"?parseFloat(this.getAttribute(t)):this.getAttribute(t);else if(this._attrValues.has(e))return this._attrValues.get(e);else return a},set:(i)=>{if(typeof a==="boolean"){if(i!==this[e]){if(i)this.setAttribute(t,"");else this.removeAttribute(t);this.queueRender()}}else if(typeof a==="number"){if(i!==parseFloat(this[e]))this.setAttribute(t,i),this.queueRender()}else if(typeof i==="object"||`${i}`!==`${this[e]}`){if(i===null||i===void 0||typeof i==="object")this.removeAttribute(t);else this.setAttribute(t,i);this.queueRender(),this._attrValues.set(e,i)}}})}}connectedCallback(){if(fi(this.constructor.tagName),this.hydrate(),this.role!=null)this.setAttribute("role",this.role);if(this.onResize!==void 0){if(dt.observe(this),this._onResize==null)this._onResize=this.onResize.bind(this);this.addEventListener("resize",this._onResize)}if(this.value!=null&&this.getAttribute("value")!=null)this._value=this.getAttribute("value");this.queueRender()}disconnectedCallback(){dt.unobserve(this)}_changeQueued=!1;_renderQueued=!1;queueRender(n=!1){if(!this._hydrated)return;if(!this._changeQueued)this._changeQueued=n;if(!this._renderQueued)this._renderQueued=!0,requestAnimationFrame(()=>{if(this._changeQueued)Ga(this,"change");this._changeQueued=!1,this._renderQueued=!1,this.render()})}_hydrated=!1;hydrate(){if(!this._hydrated){this.initValue();let n=typeof this.content!=="function",e=typeof this.content==="function"?this.content(m):this.content,{styleSpec:t}=this.constructor,{styleNode:a}=this.constructor;if(t)a=this.constructor.styleNode=m.style(Un(t)),delete this.constructor.styleNode;if(this.styleNode)console.warn(this,"styleNode is deprecrated, use static styleNode or statc styleSpec instead"),a=this.styleNode;if(a){let o=this.attachShadow({mode:"open"});o.appendChild(a.cloneNode(!0)),za(o,e,n)}else if(e!==null){let o=Array.from(this.childNodes);za(this,e,n),this.isSlotted=this.querySelector("slot,xin-slot")!==void 0;let s=Array.from(this.querySelectorAll("slot"));if(s.length>0)s.forEach(wt.replaceSlot);if(o.length>0){let i={"":this};Array.from(this.querySelectorAll("xin-slot")).forEach((r)=>{i[r.name]=r}),o.forEach((r)=>{let l=i[""],c=r instanceof Element?i[r.slot]:l;(c!==void 0?c:l).append(r)})}}this._hydrated=!0}}render(){}}class wt extends b{name="";content=null;static replaceSlot(n){let e=document.createElement("xin-slot");if(n.name!=="")e.setAttribute("name",n.name);n.replaceWith(e)}constructor(){super();this.initAttributes("name")}}var Gl=wt.elementCreator({tag:"xin-slot"}),xt=(n=()=>!0)=>{let e=localStorage.getItem("xin-state");if(e!=null){let a=JSON.parse(e);for(let o of Object.keys(a).filter(n))if(P[o]!==void 0)Object.assign(P[o],a[o]);else P[o]=a[o]}let t=fe(()=>{let a={},o=M(P);for(let s of Object.keys(o).filter(n))a[s]=o[s];localStorage.setItem("xin-state",JSON.stringify(a)),console.log("xin state saved to localStorage")},500);we(n,t)},xe="1.1.3";function U(n){return Object.assign(ye,n),ye}function kt(n){return $n("boxedProxy","boxedProxy is deprecated, please use tosi() instead"),U(n)}function mo(n,e=!1){if(e)return $n("xinProxy-boxed","xinProxy(..., true) is deprecated; use tosi(...) instead"),kt(n);return Object.keys(n).forEach((t)=>{P[t]=n[t]}),P}var vi={};async function Ct(n,e){let{type:t,styleSpec:a}=await e(n,{Color:f,Component:b,elements:m,svgElements:ve,mathML:ho,varDefault:p,vars:d,xin:P,boxed:ye,xinProxy:mo,boxedProxy:kt,tosi:U,makeComponent:Ct,bind:O,on:Pn,version:xe}),o={type:t,creator:t.elementCreator({tag:n,styleSpec:a})};return vi[n]=o,o}var nt={},wi=(n)=>import(n);class ke extends b{tag="anon-elt";src="";property="default";loaded;blueprintLoaded=(n)=>{};async packaged(){let{tag:n,src:e,property:t}=this,a=`${n}.${t}:${e}`;if(!this.loaded){if(nt[a]===void 0)nt[a]=wi(e).then((o)=>{let s=o[t];return Ct(n,s)});else console.log(`using cached ${n} with signature ${a}`);this.loaded=await nt[a],this.blueprintLoaded(this.loaded)}return this.loaded}constructor(){super();this.initAttributes("tag","src","property")}}var xi=ke.elementCreator({tag:"xin-blueprint",styleSpec:{":host":{display:"none"}}});class jt extends b{allLoaded=()=>{};constructor(){super()}async load(){let n=Array.from(this.querySelectorAll(ke.tagName)).filter((e)=>e.src).map((e)=>e.packaged());await Promise.all(n),this.allLoaded()}connectedCallback(){super.connectedCallback(),this.load()}}var ki=jt.elementCreator({tag:"xin-loader",styleSpec:{":host":{display:"none"}}});var Ia={};Ea(Ia,{xrControllersText:()=>al,xrControllers:()=>tl,xinTagList:()=>Vl,xinTag:()=>Ss,xinSizer:()=>zl,xinSelect:()=>jn,xinSegmented:()=>Ol,xinRating:()=>Cl,xinPasswordStrength:()=>kl,xinNotification:()=>vs,xinMenu:()=>Sr,xinLocalized:()=>We,xinForm:()=>nl,xinFloat:()=>Jt,xinField:()=>Qr,xinCarousel:()=>ur,version:()=>Ta,updateLocalized:()=>aa,trackDrag:()=>tn,tosijs:()=>Gn,tosiMonth:()=>yl,tosiDialog:()=>He,tabSelector:()=>ys,svgIcon:()=>dr,svg2DataUrl:()=>Ve,styleSheet:()=>Ko,spacer:()=>Hn,sizeBreak:()=>Ca,sideNav:()=>xa,setLocale:()=>fr,scriptTag:()=>kn,richTextWidgets:()=>js,richText:()=>Ll,removeLastMenu:()=>Sn,postNotification:()=>wl,positionFloat:()=>ts,popMenu:()=>J,popFloat:()=>es,menu:()=>ds,markdownViewer:()=>ma,mapBox:()=>ml,makeSorter:()=>as,makeExamplesLive:()=>hl,localize:()=>E,localePicker:()=>xr,liveExample:()=>qe,isBreached:()=>xs,initLocalization:()=>wr,icons:()=>y,i18n:()=>I,gamepadText:()=>el,gamepadState:()=>gs,findHighestZ:()=>Ne,filterPart:()=>Re,filterBuilder:()=>Yr,elastic:()=>Il,editableRect:()=>Wr,dragAndDrop:()=>hs,digest:()=>ws,defineIcons:()=>lr,dataTable:()=>Dr,createSubMenu:()=>rs,createMenuItem:()=>ls,createMenuAction:()=>is,commandButton:()=>W,colorInput:()=>ns,codeEditor:()=>ze,bringToFront:()=>oe,bodymovinPlayer:()=>hr,blockStyle:()=>fa,b3d:()=>cr,availableFilters:()=>da,abTest:()=>rr,XinTagList:()=>Sa,XinTag:()=>Fe,XinSizer:()=>ja,XinSelect:()=>ie,XinSegmented:()=>wa,XinRating:()=>ya,XinPasswordStrength:()=>ga,XinNotification:()=>Cn,XinMenu:()=>ia,XinLocalized:()=>$,XinForm:()=>se,XinFloat:()=>an,XinField:()=>Xe,XinCarousel:()=>ta,TosiMonth:()=>ba,TosiDialog:()=>la,TabSelector:()=>pa,SvgIcon:()=>na,SizeBreak:()=>ka,SideNav:()=>Vn,RichText:()=>va,MarkdownViewer:()=>ua,MapBox:()=>xn,LocalePicker:()=>oa,LiveExample:()=>Rn,FilterPart:()=>ca,FilterBuilder:()=>ha,EditableRect:()=>V,DataTable:()=>ra,CodeEditor:()=>_n,BodymovinPlayer:()=>zn,B3d:()=>ea,AbTest:()=>On});function Tt(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var yn=Tt();function xo(n){yn=n}var ne={exec:()=>null};function k(n,e=""){let t=typeof n=="string"?n:n.source,a={replace:(o,s)=>{let i=typeof s=="string"?s:s.source;return i=i.replace(A.caret,"$1"),t=t.replace(o,i),a},getRegex:()=>new RegExp(t,e)};return a}var A={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:(n)=>new RegExp(`^( {0,3}${n})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}#`),htmlBeginRegex:(n)=>new RegExp(`^ {0,${Math.min(3,n-1)}}<(?:[a-z].*>|!--)`,"i")},Ci=/^(?:[ \t]*(?:\n|$))+/,ji=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Si=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ee=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ti=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,It=/(?:[*+-]|\d{1,9}[.)])/,ko=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Co=k(ko).replace(/bull/g,It).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Ii=k(ko).replace(/bull/g,It).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Et=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ei=/^[^\n]+/,Bt=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Bi=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Bt).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Li=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,It).getRegex(),Ie="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Lt=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mi=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ \t]*)+\\n|$))","i").replace("comment",Lt).replace("tag",Ie).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),jo=k(Et).replace("hr",ee).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ie).getRegex(),Pi=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",jo).getRegex(),Mt={blockquote:Pi,code:ji,def:Bi,fences:Si,heading:Ti,hr:ee,html:Mi,lheading:Co,list:Li,newline:Ci,paragraph:jo,table:ne,text:Ei},bo=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ee).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}\t)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ie).getRegex(),Ai={...Mt,lheading:Ii,table:bo,paragraph:k(Et).replace("hr",ee).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",bo).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ie).getRegex()},Di={...Mt,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Lt).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:ne,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(Et).replace("hr",ee).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Co).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Oi=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,zi=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,So=/^( {2,}|\\)\n(?!\s*$)/,_i=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,Ee=/[\p{P}\p{S}]/u,Pt=/[\s\p{P}\p{S}]/u,To=/[^\s\p{P}\p{S}]/u,Hi=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Pt).getRegex(),Io=/(?!~)[\p{P}\p{S}]/u,Ri=/(?!~)[\s\p{P}\p{S}]/u,Vi=/(?:[^\s\p{P}\p{S}]|~)/u,Ni=/\[(?:[^\[\]`]|`[^`]*?`)*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)|`[^`]*?`|<(?! )[^<>]*?>/g,Eo=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Wi=k(Eo,"u").replace(/punct/g,Ee).getRegex(),Xi=k(Eo,"u").replace(/punct/g,Io).getRegex(),Bo="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",qi=k(Bo,"gu").replace(/notPunctSpace/g,To).replace(/punctSpace/g,Pt).replace(/punct/g,Ee).getRegex(),Fi=k(Bo,"gu").replace(/notPunctSpace/g,Vi).replace(/punctSpace/g,Ri).replace(/punct/g,Io).getRegex(),Ui=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,To).replace(/punctSpace/g,Pt).replace(/punct/g,Ee).getRegex(),Yi=k(/\\(punct)/,"gu").replace(/punct/g,Ee).getRegex(),$i=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Ji=k(Lt).replace("(?:-->|$)","-->").getRegex(),Gi=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Ji).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),je=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Ki=k(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",je).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Lo=k(/^!?\[(label)\]\[(ref)\]/).replace("label",je).replace("ref",Bt).getRegex(),Mo=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",Bt).getRegex(),Zi=k("reflink|nolink(?!\\()","g").replace("reflink",Lo).replace("nolink",Mo).getRegex(),go=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,At={_backpedal:ne,anyPunctuation:Yi,autolink:$i,blockSkip:Ni,br:So,code:zi,del:ne,emStrongLDelim:Wi,emStrongRDelimAst:qi,emStrongRDelimUnd:Ui,escape:Oi,link:Ki,nolink:Mo,punctuation:Hi,reflink:Lo,reflinkSearch:Zi,tag:Gi,text:_i,url:ne},Qi={...At,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",je).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",je).getRegex()},St={...At,emStrongRDelimAst:Fi,emStrongLDelim:Xi,url:k(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",go).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:k(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",go).getRegex()},nr={...St,br:k(So).replace("{2,}","*").getRegex(),text:k(St.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ce={normal:Mt,gfm:Ai,pedantic:Di},Kn={normal:At,gfm:St,breaks:nr,pedantic:Qi},er={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},yo=(n)=>er[n];function Y(n,e){if(e){if(A.escapeTest.test(n))return n.replace(A.escapeReplace,yo)}else if(A.escapeTestNoEncode.test(n))return n.replace(A.escapeReplaceNoEncode,yo);return n}function fo(n){try{n=encodeURI(n).replace(A.percentDecode,"%")}catch{return null}return n}function vo(n,e){let t=n.replace(A.findPipe,(s,i,r)=>{let l=!1,c=i;for(;--c>=0&&r[c]==="\\";)l=!l;return l?"|":" |"}),a=t.split(A.splitPipe),o=0;if(a[0].trim()||a.shift(),a.length>0&&!a.at(-1)?.trim()&&a.pop(),e)if(a.length>e)a.splice(e);else for(;a.length<e;)a.push("");for(;o<a.length;o++)a[o]=a[o].trim().replace(A.slashPipe,"|");return a}function Zn(n,e,t){let a=n.length;if(a===0)return"";let o=0;for(;o<a;){let s=n.charAt(a-o-1);if(s===e&&!t)o++;else if(s!==e&&t)o++;else break}return n.slice(0,a-o)}function tr(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let a=0;a<n.length;a++)if(n[a]==="\\")a++;else if(n[a]===e[0])t++;else if(n[a]===e[1]&&(t--,t<0))return a;return t>0?-2:-1}function wo(n,e,t,a,o){let s=e.href,i=e.title||null,r=n[1].replace(o.other.outputLinkReplace,"$1");a.state.inLink=!0;let l={type:n[0].charAt(0)==="!"?"image":"link",raw:t,href:s,title:i,text:r,tokens:a.inlineTokens(r)};return a.state.inLink=!1,l}function ar(n,e,t){let a=n.match(t.other.indentCodeCompensation);if(a===null)return e;let o=a[1];return e.split(`
...
`,n=n.substring(g.length+1),l=!0),!l){let T=this.rules.other.nextBulletRegex(v),j=this.rules.other.hrRegex(v),S=this.rules.other.fencesBeginRegex(v),L=this.rules.other.headingBeginRegex(v),Tn=this.rules.other.htmlBeginRegex(v);for(;n;){let Je=n.split(`
`,1)[0],Nn;if(g=Je,this.options.pedantic?(g=g.replace(this.rules.other.listReplaceNesting,"  "),Nn=g):Nn=g.replace(this.rules.other.tabCharGlobal,"    "),S.test(g)||L.test(g)||Tn.test(g)||T.test(g)||j.test(g))break;if(Nn.search(this.rules.other.nonSpaceChar)>=v||!g.trim())h+=`
...
`,title:"todo",filename:"TODO.md",path:"TODO.md",pin:"bottom"}];Jn("demo-style",Is);var on="tosijs";setTimeout(()=>{let n=f.fromVar(d.brandColor),e=f.fromVar(d.background);console.log(`welcome to %c${on}`,`background: ${n.html}; color: ${e.html}; padding: 0 5px;`)},100);var Wl=document.location.search!==""?document.location.search.substring(1).split("&")[0]:"README.md",Xl=Ue.find((n)=>n.filename===Wl)||Ue[0],{app:B,prefs:D}=U({app:{title:on,blogUrl:"https://loewald.com",discordUrl:"https://discord.com/invite/ramJ9rgky5",githubUrl:`https://github.com/tonioloewald/${on}#readme`,npmUrl:`https://www.npmjs.com/package/${on}`,tosijsuiUrl:"https://ui.tosijs.net",bundleBadgeUrl:`https://deno.bundlejs.com/?q=${on}&badge=`,bundleUrl:`https://bundlejs.com/?q=${on}`,cdnBadgeUrl:`https://data.jsdelivr.com/v1/package/npm/${on}/badge`,cdnUrl:`https://www.jsdelivr.com/package/npm/${on}`,optimizeLottie:!1,lottieFilename:"",lottieData:"",docs:Ue,currentDoc:Xl,compact:!1},prefs:{theme:"system",highContrast:!1,monochrome:!1,locale:""}});xt((n)=>{if(n.startsWith("prefs"))return!0;return!1});K.docLink={toDOM(n,e){n.setAttribute("href",`?${e}`)}};K.current={toDOM(n,e){let t=n.getAttribute("href")||"";n.classList.toggle("current",e===t.substring(1))}};setTimeout(()=>{Object.assign(globalThis,{app:B,tosi:U,img:$e,bindings:K,elements:m,vars:d,touch:mn,Color:f})},1000);var Es=document.querySelector("main"),{h2:ql,div:Bs,span:re,a:Ye,img:$e,header:Fl,button:Ls,template:Ul,input:Yl}=m;O(document.body,"prefs.theme",{toDOM(n,e){if(e==="system")e=getComputedStyle(document.body).getPropertyValue("--darkmode")==="true"?"dark":"light";n.classList.toggle("darkmode",e==="dark")}});O(document.body,D.highContrast,{toDOM(n,e){n.classList.toggle("high-contrast",e.valueOf())}});O(document.body,D.monochrome,{toDOM(n,e){n.classList.toggle("monochrome",e.valueOf())}});window.addEventListener("popstate",()=>{let n=window.location.search.substring(1);B.currentDoc=B.docs.find((e)=>e.filename.xinValue===n)||B.docs[0]});var $l=fe(()=>{console.time("filter");let n=Ms.value.toLocaleLowerCase();B.docs.forEach((e)=>{e.hidden=!e.title.toLocaleLowerCase().includes(n)&&!e.text.toLocaleLowerCase().includes(n)}),mn(B.docs),console.timeEnd("filter")}),Ms=Yl({slot:"nav",placeholder:"search",type:"search",style:{width:"calc(100% - 10px)",margin:"5px"},onInput:$l});if(Es)Es.append(Fl(Ls({class:"iconic",style:{color:d.linkColor},title:"navigation",bind:{value:B.compact,binding:{toDOM(n,e){n.style.display=e?"":"none",n.nextSibling.style.display=e?"":"none"}}},onClick(){let n=document.querySelector(Vn.tagName);n.contentVisible=!n.contentVisible}},y.menu()),re({style:{flex:"0 0 10px"}}),Ye({href:"/",style:{display:"flex",alignItems:"center",borderBottom:"none"},title:`tosijs ${xe}, tosijs-ui ${Ta}`},$e({src:"favicon.svg",style:{height:40,marginRight:10}}),ql({bindText:"app.title"})),re({class:"elastic"}),Ca({minWidth:750},re({style:{marginRight:d.spacing,display:"flex",alignItems:"center",gap:d.spacing50}},Ye({href:B.bundleUrl},$e({alt:"bundlejs size badge",src:B.bundleBadgeUrl})),Ye({href:B.cdnUrl},$e({alt:"jsdelivr",src:B.cdnBadgeUrl}))),re({slot:"small"})),re({style:{flex:"0 0 10px"}}),Ls({title:"theme",class:"iconic",onClick(n){J({target:n.target.closest("button"),menuItems:[{icon:"github",caption:"github",action:B.githubUrl.xinValue},{icon:"npm",caption:"npm",action:B.npmUrl.xinValue},{icon:"discord",caption:"discord",action:B.discordUrl.xinValue},{icon:"tosiUi",caption:"tosijs-ui",action:B.tosijsuiUrl.xinValue},{icon:"blog",caption:"Blog",action:"https://loewald.com"},null,{icon:"rgb",caption:"Color Theme",menuItems:[{caption:"System",checked(){return D.theme.xinValue==="system"},action(){D.theme.xinValue="system"}},{caption:"Dark",checked(){return D.theme.xinValue==="dark"},action(){D.theme.xinValue="dark"}},{caption:"Light",checked(){return D.theme.xinValue==="light"},action(){D.theme.xinValue="light"}},null,{caption:"High Contrast",checked(){return D.highContrast.xinValue},action(){D.highContrast.xinValue=!D.highContrast.xinValue}},{caption:"Monochrome",checked(){return D.monochrome.xinValue},action(){D.monochrome.xinValue=!D.monochrome.xinValue}}]}]})}},y.moreVertical())),xa({name:"Documentation",navSize:200,minSize:600,style:{flex:"1 1 auto",overflow:"hidden"},onChange(){let n=document.querySelector(Vn.tagName);B.compact.xinValue=n.compact}},Ms,Bs({slot:"nav",style:{display:"flex",flexDirection:"column",width:"100%",height:"100%",overflowY:"scroll"},bindList:{hiddenProp:"hidden",value:B.docs}},Ul(Ye({class:"doc-link",bindCurrent:"app.currentDoc.filename",bindDocLink:"^.filename",bindText:"^.title",onClick(n){let e=n.target.closest("a");if(!e)return;let t=bn(n.target),a=n.target.closest("xin-sidenav");a.contentVisible=!0;let{href:o}=e;window.history.pushState({href:o},"",o),B.currentDoc=t,n.preventDefault()}}))),Bs({style:{position:"relative",overflowY:"scroll",height:"100%"}},ma({style:{display:"block",maxWidth:"44em",margin:"auto",padding:"0 1em",overflow:"hidden"},bindValue:"app.currentDoc.text",didRender(){Rn.insertExamples(this,{tosijs:Gn,"tosijs-ui":Ia})}}))));

//# debugId=DA715AB07D11DD1F64756E2164756E21
