...
export declare function tosiUnique<T extends object>(obj: T, owner?: object): [BoxedProxy<T>, () => void];
export declare function xinProxy<T extends object>(obj: T, boxed?: boolean): TosiProxy<T>;
