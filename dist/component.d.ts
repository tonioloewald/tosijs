 ...
 * runtime.
 */
export declare const withAttributes: <A extends Record<string, any>>(initAttributes: A) => (new <T = PartsMap>() => Component<T> & A) & Omit<typeof Component, "prototype" | "initAttributes"> & {
    initAttributes: A;
};
